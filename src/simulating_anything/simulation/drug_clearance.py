...
class DrugClearanceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0790*x1 - 0.0788*x0 + 0.0750*np.sin(0.0398*self._t)
        dx1 = -0.1046*x0*x1 + 0.0547*x2 - 0.0812*x1
        dx2 = 0.0535*x0 - 0.1171*x2 + 0.0705*x3 - 0.0292*x1*x2
        dx3 = 0.0943*x1*x2 - 0.0501*x3 + 0.0955*x0
