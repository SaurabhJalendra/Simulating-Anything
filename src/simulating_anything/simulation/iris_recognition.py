...
class IrisRecognitionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1127*x1 - 0.0623*x0 + 0.0767*np.sin(0.0207*self._t)
        dx1 = -0.0704*x0*x1 + 0.0533*x2 - 0.0300*x1
        dx2 = 0.0420*x0 - 0.0662*x2 + 0.0334*x3 - 0.1127*x1*x2
        dx3 = 0.0313*x1*x2 - 0.0789*x3 + 0.0809*x0
