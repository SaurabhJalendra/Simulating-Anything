...
class GalaxyFormationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1100*x1 - 0.0648*x0 + 0.0236*np.sin(0.0379*self._t)
        dx1 = -0.0979*x0*x1 + 0.0570*x2 - 0.0486*x1
        dx2 = 0.0700*x0 - 0.0727*x2 + 0.0435*x3 - 0.0945*x1*x2
        dx3 = 0.0343*x1*x2 - 0.0545*x3 + 0.0787*x0
