...
class BioethanolSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0471*x1 - 0.1150*x0 + 0.1028*np.sin(0.1140*self._t)
        dx1 = -0.0941*x0*x1 + 0.0330*x2 - 0.0873*x1
        dx2 = 0.0562*x0 - 0.0603*x2 + 0.0213*x3 - 0.0213*x1*x2
        dx3 = 0.0907*x1*x2 - 0.0966*x3 + 0.0931*x0
