...
class EstrogenCycleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0844*x1 - 0.0837*x0 + 0.0997*np.sin(0.0521*self._t)
        dx1 = -0.0341*x0*x1 + 0.0632*x2 - 0.0955*x1
        dx2 = 0.0580*x0 - 0.0604*x2 + 0.1163*x3 - 0.0378*x1*x2
        dx3 = 0.0958*x1*x2 - 0.0600*x3 + 0.0978*x0
