...
class OceanAcidificationCoralSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0284*x1 - 0.0519*x0 + 0.0707*np.sin(0.0902*self._t)
        dx1 = -0.0787*x0*x1 + 0.0449*x2 - 0.0519*x1
        dx2 = 0.0448*x0 - 0.0973*x2 + 0.0365*x3 - 0.0395*x1*x2
        dx3 = 0.0683*x1*x2 - 0.0496*x3 + 0.0209*x0
