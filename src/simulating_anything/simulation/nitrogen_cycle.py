...
class NitrogenCycleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0968*x1 - 0.1515*x0 + 0.104*np.sin(0.058*self._t)
        dx1 = -0.029*x0*x1 + 0.1181*x2 - 0.1633*x1
        dx2 = 0.0898*x0 - 0.1246*x2 + 0.0693*x3 - 0.0439*x1*x2
        dx3 = 0.028*x1*x2 - 0.1145*x3 + 0.1077*x0
