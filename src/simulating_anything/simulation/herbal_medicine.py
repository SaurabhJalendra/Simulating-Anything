...
class HerbalMedicineSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0986*x1 - 0.1086*x0 + 0.0943*np.sin(0.1186*self._t)
        dx1 = -0.0830*x0*x1 + 0.0622*x2 - 0.0206*x1
        dx2 = 0.0220*x0 - 0.0471*x2 + 0.0273*x3 - 0.0623*x1*x2
        dx3 = 0.0667*x1*x2 - 0.0494*x3 + 0.0736*x0
