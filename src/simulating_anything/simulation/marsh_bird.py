...
class MarshBirdSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0233*x1 - 0.0643*x0 + 0.0225*np.sin(0.0379*self._t)
        dx1 = -0.0932*x0*x1 + 0.0978*x2 - 0.0493*x1
        dx2 = 0.0361*x0 - 0.1178*x2 + 0.0251*x3 - 0.0843*x1*x2
        dx3 = 0.0366*x1*x2 - 0.0542*x3 + 0.0448*x0
