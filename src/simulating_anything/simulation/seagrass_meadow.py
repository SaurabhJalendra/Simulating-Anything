...
class SeagrassMeadowSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1037*x1 - 0.1140*x0 + 0.0938*np.sin(0.0284*self._t)
        dx1 = -0.1420*x0*x1 + 0.1697*x2 - 0.1038*x1
        dx2 = 0.0242*x0 - 0.1439*x2 + 0.1475*x3 - 0.0588*x1*x2
        dx3 = 0.1401*x1*x2 - 0.0255*x3 + 0.0970*x0
