...
class ProstateCancerSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0280*x1 - 0.0226*x0 + 0.0803*np.sin(0.0659*self._t)
        dx1 = -0.1054*x0*x1 + 0.0575*x2 - 0.0898*x1
        dx2 = 0.0301*x0 - 0.0437*x2 + 0.0934*x3 - 0.0281*x1*x2
        dx3 = 0.0401*x1*x2 - 0.0444*x3 + 0.1175*x0
