...
class AcidBaseBalanceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0232*x1 - 0.1093*x0 + 0.0486*np.sin(0.1103*self._t)
        dx1 = -0.1052*x0*x1 + 0.0884*x2 - 0.0586*x1
        dx2 = 0.0310*x0 - 0.0901*x2 + 0.0534*x3 - 0.1132*x1*x2
        dx3 = 0.1063*x1*x2 - 0.0379*x3 + 0.1066*x0
