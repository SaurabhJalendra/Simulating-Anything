...
class ConstructionDustSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0654*x1 - 0.0600*x0 + 0.0731*np.sin(0.1151*self._t)
        dx1 = -0.0349*x0*x1 + 0.0452*x2 - 0.0812*x1
        dx2 = 0.0202*x0 - 0.0390*x2 + 0.0349*x3 - 0.0446*x1*x2
        dx3 = 0.1058*x1*x2 - 0.0633*x3 + 0.0682*x0
