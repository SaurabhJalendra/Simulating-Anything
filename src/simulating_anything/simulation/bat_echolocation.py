...
class BatEcholocationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0304*x1 - 0.0803*x0 + 0.0857*np.sin(0.0640*self._t)
        dx1 = -0.1100*x0*x1 + 0.0871*x2 - 0.0767*x1
        dx2 = 0.0278*x0 - 0.0496*x2 + 0.1159*x3 - 0.0414*x1*x2
        dx3 = 0.1200*x1*x2 - 0.0368*x3 + 0.0988*x0
