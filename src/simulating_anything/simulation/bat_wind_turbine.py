...
class BatWindTurbineSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1139*x1 - 0.114*x0 + 0.1526*np.sin(0.0637*self._t)
        dx1 = -0.0714*x0*x1 + 0.093*x2 - 0.1102*x1
        dx2 = 0.1152*x0 - 0.0988*x2 + 0.1683*x3 - 0.1611*x1*x2
        dx3 = 0.0784*x1*x2 - 0.0253*x3 + 0.0264*x0
