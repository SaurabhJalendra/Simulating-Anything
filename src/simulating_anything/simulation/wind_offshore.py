...
class WindOffshoreSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0837*x1 - 0.0976*x0 + 0.0458*np.sin(0.1077*self._t)
        dx1 = -0.0611*x0*x1 + 0.0331*x2 - 0.0682*x1
        dx2 = 0.0613*x0 - 0.0215*x2 + 0.1143*x3 - 0.0825*x1*x2
        dx3 = 0.0464*x1*x2 - 0.0614*x3 + 0.0724*x0
