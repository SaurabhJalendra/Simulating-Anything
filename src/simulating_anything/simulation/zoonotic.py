...
class ZoonoticSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0293*x1 - 0.0734*x0 + 0.0492*np.sin(0.1086*self._t)
        dx1 = -0.1002*x0*x1 + 0.0626*x2 - 0.0467*x1
        dx2 = 0.1056*x0 - 0.0822*x2 + 0.0320*x3 - 0.0960*x1*x2
        dx3 = 0.0740*x1*x2 - 0.0680*x3 + 0.0326*x0
