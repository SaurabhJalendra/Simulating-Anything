...
class AirConditioningSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0840*x1 - 0.0402*x0 + 0.0538*np.sin(0.0735*self._t)
        dx1 = -0.0627*x0*x1 + 0.0745*x2 - 0.0239*x1
        dx2 = 0.0236*x0 - 0.1102*x2 + 0.0487*x3 - 0.0336*x1*x2
        dx3 = 0.1118*x1*x2 - 0.0916*x3 + 0.1002*x0
