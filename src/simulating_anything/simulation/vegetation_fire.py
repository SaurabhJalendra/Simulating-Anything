...
class VegetationFireSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0966*x1 - 0.0812*x0 + 0.0406*np.sin(0.0729*self._t)
        dx1 = -0.0960*x0*x1 + 0.0745*x2 - 0.0634*x1
        dx2 = 0.0731*x0 - 0.0790*x2 + 0.0584*x3 - 0.0664*x1*x2
        dx3 = 0.1017*x1*x2 - 0.0246*x3 + 0.0489*x0
