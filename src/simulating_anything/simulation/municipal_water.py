...
class MunicipalWaterSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0543*x1 - 0.0531*x0 + 0.0844*np.sin(0.0543*self._t)
        dx1 = -0.0946*x0*x1 + 0.0559*x2 - 0.0808*x1
        dx2 = 0.0662*x0 - 0.1168*x2 + 0.1166*x3 - 0.0308*x1*x2
        dx3 = 0.1191*x1*x2 - 0.0808*x3 + 0.1029*x0
