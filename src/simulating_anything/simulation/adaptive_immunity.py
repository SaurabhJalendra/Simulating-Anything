...
class AdaptiveImmunitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1126*x1 - 0.0493*x0 + 0.0517*np.sin(0.1185*self._t)
        dx1 = -0.0992*x0*x1 + 0.1032*x2 - 0.0367*x1
        dx2 = 0.0455*x0 - 0.0585*x2 + 0.0377*x3 - 0.1153*x1*x2
        dx3 = 0.0279*x1*x2 - 0.0941*x3 + 0.0820*x0
