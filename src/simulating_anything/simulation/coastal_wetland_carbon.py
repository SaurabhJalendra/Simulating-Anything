...
class CoastalWetlandCarbonSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0395*x1 - 0.1114*x0 + 0.0944*np.sin(0.0365*self._t)
        dx1 = -0.0582*x0*x1 + 0.0365*x2 - 0.1172*x1
        dx2 = 0.0674*x0 - 0.0681*x2 + 0.0661*x3 - 0.0552*x1*x2
        dx3 = 0.0264*x1*x2 - 0.0688*x3 + 0.0743*x0
