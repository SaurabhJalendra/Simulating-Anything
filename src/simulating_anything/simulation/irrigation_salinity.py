...
class IrrigationSalinitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0341*x1 - 0.0392*x0 + 0.0582*np.sin(0.0768*self._t)
        dx1 = -0.0931*x0*x1 + 0.0614*x2 - 0.0204*x1
        dx2 = 0.0662*x0 - 0.1009*x2 + 0.0951*x3 - 0.0457*x1*x2
        dx3 = 0.0995*x1*x2 - 0.0796*x3 + 0.0623*x0
