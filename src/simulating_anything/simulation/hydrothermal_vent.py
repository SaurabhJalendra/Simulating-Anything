...
class HydrothermalVentSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0375*x1 - 0.0580*x0 + 0.0673*np.sin(0.0414*self._t)
        dx1 = -0.0405*x0*x1 + 0.0522*x2 - 0.0294*x1
        dx2 = 0.1064*x0 - 0.0375*x2 + 0.0682*x3 - 0.0466*x1*x2
        dx3 = 0.0615*x1*x2 - 0.0490*x3 + 0.1031*x0
