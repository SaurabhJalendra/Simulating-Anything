...
class ProteinFoldingDiseaseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1163*x1 - 0.1123*x0 + 0.1002*np.sin(0.0604*self._t)
        dx1 = -0.0803*x0*x1 + 0.0441*x2 - 0.1123*x1
        dx2 = 0.0650*x0 - 0.0907*x2 + 0.0604*x3 - 0.1082*x1*x2
        dx3 = 0.1196*x1*x2 - 0.0322*x3 + 0.0382*x0
