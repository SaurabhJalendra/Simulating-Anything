...
class IceBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0816*x1 - 0.0359*x0 + 0.0798*np.sin(0.0864*self._t)
        dx1 = -0.0232*x0*x1 + 0.1004*x2 - 0.0726*x1
        dx2 = 0.0844*x0 - 0.0518*x2 + 0.1007*x3 - 0.0771*x1*x2
        dx3 = 0.0208*x1*x2 - 0.0676*x3 + 0.0473*x0
