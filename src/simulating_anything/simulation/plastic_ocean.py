...
class PlasticOceanSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1076*x1 - 0.0798*x0 + 0.0279*np.sin(0.0946*self._t)
        dx1 = -0.0642*x0*x1 + 0.0306*x2 - 0.0459*x1
        dx2 = 0.1082*x0 - 0.0207*x2 + 0.0578*x3 - 0.0636*x1*x2
        dx3 = 0.0316*x1*x2 - 0.0998*x3 + 0.1004*x0
