...
class GeneExpressionNoiseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1433*x1 - 0.1006*x0 + 0.0305*np.sin(0.0754*self._t)
        dx1 = -0.1010*x0*x1 + 0.0931*x2 - 0.0294*x1
        dx2 = 0.0883*x0 - 0.1312*x2 + 0.0492*x3 - 0.0217*x1*x2
        dx3 = 0.0227*x1*x2 - 0.0345*x3 + 0.1686*x0
