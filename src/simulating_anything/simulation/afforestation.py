...
class AfforestationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0352*x1 - 0.0363*x0 + 0.0902*np.sin(0.0269*self._t)
        dx1 = -0.0612*x0*x1 + 0.0986*x2 - 0.0808*x1
        dx2 = 0.1120*x0 - 0.0265*x2 + 0.0710*x3 - 0.0596*x1*x2
        dx3 = 0.1077*x1*x2 - 0.1115*x3 + 0.1170*x0
