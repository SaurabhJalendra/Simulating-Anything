...
class DiabetesInsulinSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1138*x1 - 0.0943*x0 + 0.0273*np.sin(0.0759*self._t)
        dx1 = -0.1189*x0*x1 + 0.0399*x2 - 0.0384*x1
        dx2 = 0.0981*x0 - 0.0675*x2 + 0.0205*x3 - 0.0705*x1*x2
        dx3 = 0.0883*x1*x2 - 0.0808*x3 + 0.0931*x0
