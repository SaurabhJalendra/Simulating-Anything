...
class HurricaneTrackSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0952*x1 - 0.1542*x0 + 0.0978*np.sin(0.1343*self._t)
        dx1 = -0.0319*x0*x1 + 0.0235*x2 - 0.1476*x1
        dx2 = 0.123*x0 - 0.0715*x2 + 0.1424*x3 - 0.1574*x1*x2
        dx3 = 0.1447*x1*x2 - 0.0506*x3 + 0.1296*x0
