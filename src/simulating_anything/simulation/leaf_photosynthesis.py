...
class LeafPhotosynthesisSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0246*x1 - 0.1571*x0 + 0.1152*np.sin(0.1658*self._t)
        dx1 = -0.1481*x0*x1 + 0.1322*x2 - 0.0889*x1
        dx2 = 0.0391*x0 - 0.0936*x2 + 0.1609*x3 - 0.1480*x1*x2
        dx3 = 0.1145*x1*x2 - 0.1292*x3 + 0.0520*x0
