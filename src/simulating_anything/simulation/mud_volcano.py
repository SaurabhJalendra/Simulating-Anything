...
class MudVolcanoSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1132*x1 - 0.1249*x0 + 0.1136*np.sin(0.1682*self._t)
        dx1 = -0.1333*x0*x1 + 0.1166*x2 - 0.0887*x1
        dx2 = 0.0479*x0 - 0.1483*x2 + 0.0975*x3 - 0.1699*x1*x2
        dx3 = 0.1418*x1*x2 - 0.1057*x3 + 0.1060*x0
