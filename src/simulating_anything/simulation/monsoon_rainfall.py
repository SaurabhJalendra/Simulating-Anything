...
class MonsoonRainfallSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1024*x1 - 0.0564*x0 + 0.0293*np.sin(0.0292*self._t)
        dx1 = -0.0511*x0*x1 + 0.0323*x2 - 0.0440*x1
        dx2 = 0.0850*x0 - 0.0492*x2 + 0.1114*x3 - 0.1006*x1*x2
        dx3 = 0.0759*x1*x2 - 0.0691*x3 + 0.1029*x0
