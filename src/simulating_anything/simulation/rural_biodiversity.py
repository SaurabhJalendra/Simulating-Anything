...
class RuralBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0739*x1 - 0.0399*x0 + 0.0773*np.sin(0.0519*self._t)
        dx1 = -0.1130*x0*x1 + 0.0626*x2 - 0.0618*x1
        dx2 = 0.0476*x0 - 0.1160*x2 + 0.1077*x3 - 0.0660*x1*x2
        dx3 = 0.1124*x1*x2 - 0.0752*x3 + 0.0793*x0
