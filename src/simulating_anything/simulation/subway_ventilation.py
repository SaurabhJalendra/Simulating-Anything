...
class SubwayVentilationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0730*x1 - 0.0406*x0 + 0.0254*np.sin(0.0426*self._t)
        dx1 = -0.0361*x0*x1 + 0.0749*x2 - 0.0392*x1
        dx2 = 0.0720*x0 - 0.1118*x2 + 0.0388*x3 - 0.0888*x1*x2
        dx3 = 0.0649*x1*x2 - 0.0841*x3 + 0.0763*x0
