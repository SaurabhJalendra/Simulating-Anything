...
class CoastalArmorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0358*x1 - 0.0605*x0 + 0.0557*np.sin(0.0585*self._t)
        dx1 = -0.1103*x0*x1 + 0.1014*x2 - 0.0831*x1
        dx2 = 0.0648*x0 - 0.0386*x2 + 0.0879*x3 - 0.0811*x1*x2
        dx3 = 0.0868*x1*x2 - 0.0210*x3 + 0.0663*x0
