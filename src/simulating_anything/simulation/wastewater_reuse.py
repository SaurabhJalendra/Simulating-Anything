...
class WastewaterReuseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0491*x1 - 0.0405*x0 + 0.0531*np.sin(0.0995*self._t)
        dx1 = -0.0385*x0*x1 + 0.0538*x2 - 0.1051*x1
        dx2 = 0.0523*x0 - 0.0727*x2 + 0.0533*x3 - 0.0789*x1*x2
        dx3 = 0.0514*x1*x2 - 0.0436*x3 + 0.0410*x0
