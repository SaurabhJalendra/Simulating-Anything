...
class LakeChemistrySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0394*x1 - 0.0588*x0 + 0.0866*np.sin(0.0556*self._t)
        dx1 = -0.0475*x0*x1 + 0.0630*x2 - 0.0340*x1
        dx2 = 0.0450*x0 - 0.0549*x2 + 0.0974*x3 - 0.0766*x1*x2
        dx3 = 0.0620*x1*x2 - 0.1162*x3 + 0.0986*x0
