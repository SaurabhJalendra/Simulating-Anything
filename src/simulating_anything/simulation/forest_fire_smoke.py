...
class ForestFireSmokeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0348*x1 - 0.0728*x0 + 0.0306*np.sin(0.1045*self._t)
        dx1 = -0.0912*x0*x1 + 0.0843*x2 - 0.1261*x1
        dx2 = 0.1013*x0 - 0.0405*x2 + 0.0919*x3 - 0.0542*x1*x2
        dx3 = 0.1044*x1*x2 - 0.0703*x3 + 0.0550*x0
