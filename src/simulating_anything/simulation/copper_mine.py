...
class CopperMineSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1019*x1 - 0.0880*x0 + 0.1029*np.sin(0.0240*self._t)
        dx1 = -0.1005*x0*x1 + 0.0515*x2 - 0.0976*x1
        dx2 = 0.0240*x0 - 0.0230*x2 + 0.0594*x3 - 0.0742*x1*x2
        dx3 = 0.0987*x1*x2 - 0.1001*x3 + 0.0947*x0
