...
class BloodPressureSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1392*x1 - 0.1284*x0 + 0.1258*np.sin(0.0637*self._t)
        dx1 = -0.0705*x0*x1 + 0.0682*x2 - 0.0655*x1
        dx2 = 0.1556*x0 - 0.0895*x2 + 0.1700*x3 - 0.1408*x1*x2
        dx3 = 0.0348*x1*x2 - 0.0500*x3 + 0.1143*x0
