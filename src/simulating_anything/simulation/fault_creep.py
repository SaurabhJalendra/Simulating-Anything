...
class FaultCreepSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0850*x1 - 0.1101*x0 + 0.1012*np.sin(0.0773*self._t)
        dx1 = -0.0320*x0*x1 + 0.1196*x2 - 0.0368*x1
        dx2 = 0.0423*x0 - 0.0974*x2 + 0.0980*x3 - 0.0594*x1*x2
        dx3 = 0.0256*x1*x2 - 0.0733*x3 + 0.0723*x0
