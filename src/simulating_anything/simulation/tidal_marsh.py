...
class TidalMarshSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0229*x1 - 0.0225*x0 + 0.0689*np.sin(0.1069*self._t)
        dx1 = -0.0707*x0*x1 + 0.0699*x2 - 0.1030*x1
        dx2 = 0.0395*x0 - 0.0789*x2 + 0.1011*x3 - 0.0802*x1*x2
        dx3 = 0.0515*x1*x2 - 0.0812*x3 + 0.0972*x0
