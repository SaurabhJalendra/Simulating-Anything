...
class AsthmaTreatmentSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0359*x1 - 0.0515*x0 + 0.0429*np.sin(0.0204*self._t)
        dx1 = -0.0327*x0*x1 + 0.1044*x2 - 0.0887*x1
        dx2 = 0.0246*x0 - 0.0238*x2 + 0.0321*x3 - 0.1143*x1*x2
        dx3 = 0.1172*x1*x2 - 0.0854*x3 + 0.0490*x0
