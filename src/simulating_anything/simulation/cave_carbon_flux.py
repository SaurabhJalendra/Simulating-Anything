...
class CaveCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0691*x1 - 0.1118*x0 + 0.0588*np.sin(0.0884*self._t)
        dx1 = -0.0845*x0*x1 + 0.0802*x2 - 0.0526*x1
        dx2 = 0.1140*x0 - 0.1080*x2 + 0.0946*x3 - 0.1169*x1*x2
        dx3 = 0.1081*x1*x2 - 0.0714*x3 + 0.0231*x0
