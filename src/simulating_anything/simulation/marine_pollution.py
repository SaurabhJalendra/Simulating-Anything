...
class MarinePollutionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0594*x1 - 0.0730*x0 + 0.0488*np.sin(0.0962*self._t)
        dx1 = -0.0707*x0*x1 + 0.0982*x2 - 0.0482*x1
        dx2 = 0.0527*x0 - 0.1086*x2 + 0.0771*x3 - 0.0493*x1*x2
        dx3 = 0.0304*x1*x2 - 0.0333*x3 + 0.1069*x0
