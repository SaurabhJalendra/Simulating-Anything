...
class LandReclamationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1076*x1 - 0.1037*x0 + 0.0937*np.sin(0.0779*self._t)
        dx1 = -0.0693*x0*x1 + 0.0472*x2 - 0.0695*x1
        dx2 = 0.0847*x0 - 0.0422*x2 + 0.0315*x3 - 0.0369*x1*x2
        dx3 = 0.1065*x1*x2 - 0.0354*x3 + 0.0955*x0
