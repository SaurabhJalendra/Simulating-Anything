...
class AtmosphericNitrogenSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1179*x1 - 0.1142*x0 + 0.0663*np.sin(0.0791*self._t)
        dx1 = -0.1161*x0*x1 + 0.0485*x2 - 0.0635*x1
        dx2 = 0.0891*x0 - 0.1126*x2 + 0.0455*x3 - 0.0289*x1*x2
        dx3 = 0.1090*x1*x2 - 0.0801*x3 + 0.0927*x0
