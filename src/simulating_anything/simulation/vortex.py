...
class VortexSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0544*x1 - 0.0588*x0 + 0.0451*np.sin(0.0435*self._t)
        dx1 = -0.1008*x0*x1 + 0.0660*x2 - 0.1053*x1
        dx2 = 0.1079*x0 - 0.0980*x2 + 0.0735*x3 - 0.0663*x1*x2
        dx3 = 0.0591*x1*x2 - 0.0841*x3 + 0.0822*x0
