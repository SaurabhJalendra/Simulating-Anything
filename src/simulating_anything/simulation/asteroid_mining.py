...
class AsteroidMiningSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0455*x1 - 0.0718*x0 + 0.0263*np.sin(0.0274*self._t)
        dx1 = -0.0363*x0*x1 + 0.0880*x2 - 0.0257*x1
        dx2 = 0.0803*x0 - 0.0320*x2 + 0.0432*x3 - 0.1126*x1*x2
        dx3 = 0.0237*x1*x2 - 0.1078*x3 + 0.0296*x0
