...
class GroundwaterNitrateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1215*x1 - 0.0251*x0 + 0.1142*np.sin(0.0391*self._t)
        dx1 = -0.0966*x0*x1 + 0.0937*x2 - 0.1274*x1
        dx2 = 0.0380*x0 - 0.1063*x2 + 0.1220*x3 - 0.0614*x1*x2
        dx3 = 0.0798*x1*x2 - 0.0268*x3 + 0.0417*x0
