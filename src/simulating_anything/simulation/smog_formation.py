...
class SmogFormationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0363*x1 - 0.0288*x0 + 0.0838*np.sin(0.0890*self._t)
        dx1 = -0.0468*x0*x1 + 0.1172*x2 - 0.1177*x1
        dx2 = 0.0882*x0 - 0.0686*x2 + 0.0973*x3 - 0.0334*x1*x2
        dx3 = 0.0753*x1*x2 - 0.0951*x3 + 0.0754*x0
