...
class AnnualCropSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0562*x1 - 0.1053*x0 + 0.0288*np.sin(0.0932*self._t)
        dx1 = -0.0477*x0*x1 + 0.0244*x2 - 0.0828*x1
        dx2 = 0.0977*x0 - 0.0402*x2 + 0.0979*x3 - 0.0749*x1*x2
        dx3 = 0.0687*x1*x2 - 0.0885*x3 + 0.0823*x0
