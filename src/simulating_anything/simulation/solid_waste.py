...
class SolidWasteSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0812*x1 - 0.0811*x0 + 0.0217*np.sin(0.1069*self._t)
        dx1 = -0.0436*x0*x1 + 0.0831*x2 - 0.0618*x1
        dx2 = 0.1038*x0 - 0.0401*x2 + 0.0530*x3 - 0.1087*x1*x2
        dx3 = 0.0422*x1*x2 - 0.0859*x3 + 0.1113*x0
