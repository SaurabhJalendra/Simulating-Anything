...
class FacialRecognitionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0284*x1 - 0.0305*x0 + 0.0991*np.sin(0.0613*self._t)
        dx1 = -0.1189*x0*x1 + 0.1164*x2 - 0.0247*x1
        dx2 = 0.0221*x0 - 0.0792*x2 + 0.0511*x3 - 0.0691*x1*x2
        dx3 = 0.0941*x1*x2 - 0.0821*x3 + 0.1158*x0
