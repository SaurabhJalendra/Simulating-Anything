...
class PeatlandFireSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0224*x1 - 0.0693*x0 + 0.1152*np.sin(0.0504*self._t)
        dx1 = -0.0605*x0*x1 + 0.0295*x2 - 0.0215*x1
        dx2 = 0.0459*x0 - 0.0458*x2 + 0.0408*x3 - 0.0504*x1*x2
        dx3 = 0.0278*x1*x2 - 0.1148*x3 + 0.0791*x0
