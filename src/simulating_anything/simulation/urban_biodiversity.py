...
class UrbanBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0223*x1 - 0.0634*x0 + 0.0340*np.sin(0.1011*self._t)
        dx1 = -0.0359*x0*x1 + 0.0899*x2 - 0.0659*x1
        dx2 = 0.1098*x0 - 0.0743*x2 + 0.0975*x3 - 0.0699*x1*x2
        dx3 = 0.0758*x1*x2 - 0.1098*x3 + 0.0278*x0
