...
class TyphoidWaterSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1033*x1 - 0.0361*x0 + 0.0654*np.sin(0.0755*self._t)
        dx1 = -0.0457*x0*x1 + 0.1061*x2 - 0.0748*x1
        dx2 = 0.0892*x0 - 0.0447*x2 + 0.0653*x3 - 0.0319*x1*x2
        dx3 = 0.0716*x1*x2 - 0.0892*x3 + 0.0628*x0
