...
class AlzheimerDiseaseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0478*x1 - 0.0573*x0 + 0.0855*np.sin(0.0724*self._t)
        dx1 = -0.0489*x0*x1 + 0.0984*x2 - 0.0309*x1
        dx2 = 0.0750*x0 - 0.0918*x2 + 0.1007*x3 - 0.1151*x1*x2
        dx3 = 0.0217*x1*x2 - 0.0783*x3 + 0.0923*x0
