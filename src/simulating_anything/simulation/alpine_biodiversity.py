...
class AlpineBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0598*x1 - 0.0709*x0 + 0.0360*np.sin(0.0682*self._t)
        dx1 = -0.0743*x0*x1 + 0.1155*x2 - 0.0290*x1
        dx2 = 0.0965*x0 - 0.1137*x2 + 0.0851*x3 - 0.0558*x1*x2
        dx3 = 0.0952*x1*x2 - 0.1040*x3 + 0.0674*x0
