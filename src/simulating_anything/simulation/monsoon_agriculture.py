...
class MonsoonAgricultureSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0930*x1 - 0.0744*x0 + 0.0962*np.sin(0.0998*self._t)
        dx1 = -0.0498*x0*x1 + 0.0951*x2 - 0.0879*x1
        dx2 = 0.0534*x0 - 0.1074*x2 + 0.0229*x3 - 0.0556*x1*x2
        dx3 = 0.0316*x1*x2 - 0.0490*x3 + 0.0590*x0
