...
class DewFormationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1634*x1 - 0.1481*x0 + 0.0937*np.sin(0.0909*self._t)
        dx1 = -0.0740*x0*x1 + 0.0344*x2 - 0.1070*x1
        dx2 = 0.1508*x0 - 0.0650*x2 + 0.0852*x3 - 0.1602*x1*x2
        dx3 = 0.0639*x1*x2 - 0.1611*x3 + 0.0562*x0
