...
class AlluvialFanSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0663*x1 - 0.0527*x0 + 0.0736*np.sin(0.0206*self._t)
        dx1 = -0.1129*x0*x1 + 0.0588*x2 - 0.0734*x1
        dx2 = 0.0238*x0 - 0.0998*x2 + 0.1094*x3 - 0.0414*x1*x2
        dx3 = 0.0509*x1*x2 - 0.0273*x3 + 0.1157*x0
