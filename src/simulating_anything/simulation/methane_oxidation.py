...
class MethaneOxidationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0440*x1 - 0.0791*x0 + 0.0211*np.sin(0.1075*self._t)
        dx1 = -0.1007*x0*x1 + 0.0610*x2 - 0.0639*x1
        dx2 = 0.0481*x0 - 0.0802*x2 + 0.0959*x3 - 0.0384*x1*x2
        dx3 = 0.0585*x1*x2 - 0.0755*x3 + 0.1081*x0
