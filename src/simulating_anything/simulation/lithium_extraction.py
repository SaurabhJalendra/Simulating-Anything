...
class LithiumExtractionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0889*x1 - 0.0516*x0 + 0.0591*np.sin(0.1008*self._t)
        dx1 = -0.0685*x0*x1 + 0.1101*x2 - 0.0594*x1
        dx2 = 0.0545*x0 - 0.0558*x2 + 0.1118*x3 - 0.0319*x1*x2
        dx3 = 0.0232*x1*x2 - 0.1133*x3 + 0.1198*x0
