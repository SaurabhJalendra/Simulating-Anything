...
class VaccineImmunitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0439*x1 - 0.0595*x0 + 0.0248*np.sin(0.0725*self._t)
        dx1 = -0.1132*x0*x1 + 0.0298*x2 - 0.1069*x1
        dx2 = 0.0652*x0 - 0.0735*x2 + 0.0987*x3 - 0.1058*x1*x2
        dx3 = 0.0418*x1*x2 - 0.0985*x3 + 0.0497*x0
