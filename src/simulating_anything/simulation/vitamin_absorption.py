...
class VitaminAbsorptionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0414*x1 - 0.0548*x0 + 0.0729*np.sin(0.0460*self._t)
        dx1 = -0.0499*x0*x1 + 0.0619*x2 - 0.0937*x1
        dx2 = 0.0690*x0 - 0.0941*x2 + 0.0484*x3 - 0.1018*x1*x2
        dx3 = 0.0322*x1*x2 - 0.0786*x3 + 0.0687*x0
