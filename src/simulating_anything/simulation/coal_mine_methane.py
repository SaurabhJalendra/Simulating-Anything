...
class CoalMineMethaneSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0235*x1 - 0.0677*x0 + 0.1020*np.sin(0.0317*self._t)
        dx1 = -0.1030*x0*x1 + 0.0618*x2 - 0.0618*x1
        dx2 = 0.0896*x0 - 0.0771*x2 + 0.0872*x3 - 0.1053*x1*x2
        dx3 = 0.0789*x1*x2 - 0.0984*x3 + 0.0276*x0
