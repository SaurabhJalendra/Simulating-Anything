...
class EyePressureSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0227*x1 - 0.0415*x0 + 0.0523*np.sin(0.0243*self._t)
        dx1 = -0.1102*x0*x1 + 0.0853*x2 - 0.0378*x1
        dx2 = 0.1130*x0 - 0.0263*x2 + 0.0478*x3 - 0.0866*x1*x2
        dx3 = 0.0488*x1*x2 - 0.0489*x3 + 0.0518*x0
