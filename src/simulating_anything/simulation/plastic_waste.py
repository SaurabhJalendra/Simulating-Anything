...
class PlasticWasteSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0727*x1 - 0.0471*x0 + 0.0475*np.sin(0.0614*self._t)
        dx1 = -0.1022*x0*x1 + 0.1092*x2 - 0.0905*x1
        dx2 = 0.0958*x0 - 0.0693*x2 + 0.0350*x3 - 0.0652*x1*x2
        dx3 = 0.1154*x1*x2 - 0.0354*x3 + 0.0580*x0
