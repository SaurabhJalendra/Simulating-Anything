...
class AtmosphericOzoneSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0712*x1 - 0.1035*x0 + 0.1336*np.sin(0.1343*self._t)
        dx1 = -0.1218*x0*x1 + 0.0623*x2 - 0.0694*x1
        dx2 = 0.1050*x0 - 0.1198*x2 + 0.0276*x3 - 0.0829*x1*x2
        dx3 = 0.1242*x1*x2 - 0.0435*x3 + 0.0598*x0
