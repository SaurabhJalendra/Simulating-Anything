...
class TundraThawSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0300*x1 - 0.0841*x0 + 0.0874*np.sin(0.0830*self._t)
        dx1 = -0.1057*x0*x1 + 0.0254*x2 - 0.0981*x1
        dx2 = 0.0825*x0 - 0.0534*x2 + 0.0919*x3 - 0.0381*x1*x2
        dx3 = 0.1004*x1*x2 - 0.0793*x3 + 0.1135*x0
