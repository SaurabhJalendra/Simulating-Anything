...
class FossilFuelSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1180*x1 - 0.1042*x0 + 0.0766*np.sin(0.1184*self._t)
        dx1 = -0.0884*x0*x1 + 0.0390*x2 - 0.1027*x1
        dx2 = 0.0497*x0 - 0.1198*x2 + 0.0276*x3 - 0.0497*x1*x2
        dx3 = 0.1021*x1*x2 - 0.0344*x3 + 0.0890*x0
