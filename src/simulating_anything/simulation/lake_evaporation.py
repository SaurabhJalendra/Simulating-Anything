...
class LakeEvaporationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1622*x1 - 0.1106*x0 + 0.0838*np.sin(0.1207*self._t)
        dx1 = -0.0397*x0*x1 + 0.1237*x2 - 0.1037*x1
        dx2 = 0.1614*x0 - 0.1465*x2 + 0.0340*x3 - 0.1535*x1*x2
        dx3 = 0.1306*x1*x2 - 0.0600*x3 + 0.1234*x0
