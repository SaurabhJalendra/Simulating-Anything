...
class ErosionCliffSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0571*x1 - 0.0711*x0 + 0.0553*np.sin(0.1161*self._t)
        dx1 = -0.0445*x0*x1 + 0.0531*x2 - 0.1058*x1
        dx2 = 0.1061*x0 - 0.0531*x2 + 0.0851*x3 - 0.1172*x1*x2
        dx3 = 0.0249*x1*x2 - 0.0714*x3 + 0.0471*x0
