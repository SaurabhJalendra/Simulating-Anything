...
class AvalancheRiskSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0946*x1 - 0.0516*x0 + 0.0812*np.sin(0.0991*self._t)
        dx1 = -0.1068*x0*x1 + 0.0805*x2 - 0.0310*x1
        dx2 = 0.0542*x0 - 0.0532*x2 + 0.0315*x3 - 0.0608*x1*x2
        dx3 = 0.0958*x1*x2 - 0.0821*x3 + 0.1136*x0
