...
class HarborSiltationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0734*x1 - 0.0268*x0 + 0.0670*np.sin(0.1167*self._t)
        dx1 = -0.1076*x0*x1 + 0.0638*x2 - 0.0812*x1
        dx2 = 0.0593*x0 - 0.0263*x2 + 0.0876*x3 - 0.1168*x1*x2
        dx3 = 0.0382*x1*x2 - 0.0346*x3 + 0.0696*x0
