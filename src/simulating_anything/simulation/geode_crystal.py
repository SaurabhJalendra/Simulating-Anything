...
class GeodeCrystalSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0200*x1 - 0.0728*x0 + 0.1160*np.sin(0.0989*self._t)
        dx1 = -0.1100*x0*x1 + 0.0759*x2 - 0.0240*x1
        dx2 = 0.0323*x0 - 0.0708*x2 + 0.0314*x3 - 0.0422*x1*x2
        dx3 = 0.0407*x1*x2 - 0.0323*x3 + 0.0519*x0
