...
class AbsorptionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1142*x1 - 0.0611*x0 + 0.0797*np.sin(0.0464*self._t)
        dx1 = -0.0892*x0*x1 + 0.0933*x2 - 0.1011*x1
        dx2 = 0.1182*x0 - 0.1091*x2 + 0.0661*x3 - 0.0710*x1*x2
        dx3 = 0.0238*x1*x2 - 0.0486*x3 + 0.0725*x0
