...
class CanyonErosionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0601*x1 - 0.1110*x0 + 0.0810*np.sin(0.0396*self._t)
        dx1 = -0.1027*x0*x1 + 0.0795*x2 - 0.1014*x1
        dx2 = 0.0703*x0 - 0.0855*x2 + 0.0424*x3 - 0.0634*x1*x2
        dx3 = 0.0966*x1*x2 - 0.1164*x3 + 0.0747*x0
