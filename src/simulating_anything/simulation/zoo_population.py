...
class ZooPopulationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0866*x1 - 0.0879*x0 + 0.0755*np.sin(0.0233*self._t)
        dx1 = -0.0650*x0*x1 + 0.1014*x2 - 0.0485*x1
        dx2 = 0.0241*x0 - 0.0203*x2 + 0.0677*x3 - 0.1056*x1*x2
        dx3 = 0.0865*x1*x2 - 0.0433*x3 + 0.0725*x0
