...
class BeetleOutbreakSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0873*x1 - 0.0491*x0 + 0.0760*np.sin(0.0757*self._t)
        dx1 = -0.0753*x0*x1 + 0.0481*x2 - 0.0997*x1
        dx2 = 0.0982*x0 - 0.0569*x2 + 0.0570*x3 - 0.0690*x1*x2
        dx3 = 0.0734*x1*x2 - 0.1119*x3 + 0.0358*x0
