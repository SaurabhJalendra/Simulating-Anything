...
class BiodegradationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0421*x1 - 0.1078*x0 + 0.0570*np.sin(0.1108*self._t)
        dx1 = -0.1155*x0*x1 + 0.0278*x2 - 0.0543*x1
        dx2 = 0.0865*x0 - 0.1062*x2 + 0.0928*x3 - 0.0574*x1*x2
        dx3 = 0.0398*x1*x2 - 0.0725*x3 + 0.1076*x0
