...
class MethaneLeakSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0430*x1 - 0.0559*x0 + 0.0922*np.sin(0.0773*self._t)
        dx1 = -0.1170*x0*x1 + 0.0964*x2 - 0.0440*x1
        dx2 = 0.0213*x0 - 0.1158*x2 + 0.0415*x3 - 0.0761*x1*x2
        dx3 = 0.0375*x1*x2 - 0.1092*x3 + 0.0670*x0
