...
class RedTideSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0678*x1 - 0.1088*x0 + 0.0371*np.sin(0.1519*self._t)
        dx1 = -0.1685*x0*x1 + 0.1387*x2 - 0.0591*x1
        dx2 = 0.1496*x0 - 0.1398*x2 + 0.0657*x3 - 0.1077*x1*x2
        dx3 = 0.0379*x1*x2 - 0.0426*x3 + 0.1330*x0
