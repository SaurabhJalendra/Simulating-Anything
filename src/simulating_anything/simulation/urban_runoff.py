...
class UrbanRunoffSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0764*x1 - 0.0703*x0 + 0.0604*np.sin(0.0923*self._t)
        dx1 = -0.0735*x0*x1 + 0.0673*x2 - 0.0627*x1
        dx2 = 0.1118*x0 - 0.0885*x2 + 0.0434*x3 - 0.1186*x1*x2
        dx3 = 0.0798*x1*x2 - 0.0858*x3 + 0.0363*x0
