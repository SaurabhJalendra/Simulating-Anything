...
class DatePalmSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0527*x1 - 0.0460*x0 + 0.0466*np.sin(0.0361*self._t)
        dx1 = -0.1169*x0*x1 + 0.0288*x2 - 0.1091*x1
        dx2 = 0.0776*x0 - 0.0962*x2 + 0.1151*x3 - 0.0589*x1*x2
        dx3 = 0.1035*x1*x2 - 0.0497*x3 + 0.0237*x0
