...
class UrbanAirSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0522*x1 - 0.0519*x0 + 0.0628*np.sin(0.0600*self._t)
        dx1 = -0.0559*x0*x1 + 0.0440*x2 - 0.0338*x1
        dx2 = 0.1165*x0 - 0.0276*x2 + 0.0354*x3 - 0.0586*x1*x2
        dx3 = 0.0292*x1*x2 - 0.1008*x3 + 0.0832*x0
