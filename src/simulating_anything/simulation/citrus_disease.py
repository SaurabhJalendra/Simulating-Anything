...
class CitrusDiseaseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0420*x1 - 0.0377*x0 + 0.0636*np.sin(0.0738*self._t)
        dx1 = -0.0532*x0*x1 + 0.1119*x2 - 0.1118*x1
        dx2 = 0.0965*x0 - 0.0743*x2 + 0.0540*x3 - 0.1073*x1*x2
        dx3 = 0.1134*x1*x2 - 0.0766*x3 + 0.0966*x0
