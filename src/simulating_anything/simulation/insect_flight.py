...
class InsectFlightSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0994*x1 - 0.0270*x0 + 0.0866*np.sin(0.1017*self._t)
        dx1 = -0.0250*x0*x1 + 0.1070*x2 - 0.0801*x1
        dx2 = 0.1148*x0 - 0.0386*x2 + 0.1106*x3 - 0.0684*x1*x2
        dx3 = 0.0296*x1*x2 - 0.0773*x3 + 0.0321*x0
