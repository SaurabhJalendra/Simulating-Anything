...
class SeabirdColonySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0202*x1 - 0.1116*x0 + 0.1029*np.sin(0.0211*self._t)
        dx1 = -0.0375*x0*x1 + 0.0811*x2 - 0.0898*x1
        dx2 = 0.0733*x0 - 0.0221*x2 + 0.0813*x3 - 0.1197*x1*x2
        dx3 = 0.0866*x1*x2 - 0.0747*x3 + 0.0619*x0
