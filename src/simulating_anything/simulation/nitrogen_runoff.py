...
class NitrogenRunoffSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0633*x1 - 0.0711*x0 + 0.0794*np.sin(0.0230*self._t)
        dx1 = -0.0365*x0*x1 + 0.0239*x2 - 0.1104*x1
        dx2 = 0.0553*x0 - 0.0945*x2 + 0.1052*x3 - 0.0813*x1*x2
        dx3 = 0.0277*x1*x2 - 0.0840*x3 + 0.0900*x0
