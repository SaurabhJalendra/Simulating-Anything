...
class GreenhouseClimateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0446*x1 - 0.0556*x0 + 0.1379*np.sin(0.0712*self._t)
        dx1 = -0.1483*x0*x1 + 0.0326*x2 - 0.1690*x1
        dx2 = 0.1476*x0 - 0.1699*x2 + 0.1173*x3 - 0.1527*x1*x2
        dx3 = 0.1076*x1*x2 - 0.1335*x3 + 0.0960*x0
