...
class WhaleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0770*x1 - 0.0552*x0 + 0.0492*np.sin(0.0957*self._t)
        dx1 = -0.0514*x0*x1 + 0.1014*x2 - 0.1174*x1
        dx2 = 0.1167*x0 - 0.0629*x2 + 0.0296*x3 - 0.0919*x1*x2
        dx3 = 0.0959*x1*x2 - 0.1147*x3 + 0.0978*x0
