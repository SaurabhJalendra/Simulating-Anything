...
class CrystalNucleationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1051*x1 - 0.0279*x0 + 0.0379*np.sin(0.0365*self._t)
        dx1 = -0.0870*x0*x1 + 0.0219*x2 - 0.0624*x1
        dx2 = 0.1154*x0 - 0.0620*x2 + 0.0850*x3 - 0.0934*x1*x2
        dx3 = 0.0799*x1*x2 - 0.0230*x3 + 0.0508*x0
