...
class AvianFluSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0996*x1 - 0.0864*x0 + 0.0955*np.sin(0.0609*self._t)
        dx1 = -0.0585*x0*x1 + 0.1124*x2 - 0.1179*x1
        dx2 = 0.0424*x0 - 0.0484*x2 + 0.1152*x3 - 0.0744*x1*x2
        dx3 = 0.1080*x1*x2 - 0.0681*x3 + 0.1152*x0
