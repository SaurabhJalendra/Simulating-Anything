...
class KneeJointSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1053*x1 - 0.0515*x0 + 0.0980*np.sin(0.1176*self._t)
        dx1 = -0.0668*x0*x1 + 0.0840*x2 - 0.0257*x1
        dx2 = 0.0415*x0 - 0.0380*x2 + 0.0277*x3 - 0.0840*x1*x2
        dx3 = 0.0251*x1*x2 - 0.0592*x3 + 0.0647*x0
