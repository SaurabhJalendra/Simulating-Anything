...
class BoneDensitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0424*x1 - 0.0328*x0 + 0.0570*np.sin(0.0306*self._t)
        dx1 = -0.0986*x0*x1 + 0.0803*x2 - 0.0673*x1
        dx2 = 0.1182*x0 - 0.1175*x2 + 0.0854*x3 - 0.0742*x1*x2
        dx3 = 0.1183*x1*x2 - 0.0308*x3 + 0.0393*x0
