...
class SurgicalWoundSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0587*x1 - 0.0891*x0 + 0.0562*np.sin(0.0845*self._t)
        dx1 = -0.0417*x0*x1 + 0.0898*x2 - 0.0424*x1
        dx2 = 0.1151*x0 - 0.0694*x2 + 0.0681*x3 - 0.1108*x1*x2
        dx3 = 0.0842*x1*x2 - 0.0995*x3 + 0.0511*x0
