...
class SolarStormSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0357*x1 - 0.0823*x0 + 0.1073*np.sin(0.0583*self._t)
        dx1 = -0.0703*x0*x1 + 0.1050*x2 - 0.1163*x1
        dx2 = 0.0393*x0 - 0.1088*x2 + 0.0879*x3 - 0.0645*x1*x2
        dx3 = 0.0206*x1*x2 - 0.0747*x3 + 0.0911*x0
