...
class LakeSedimentSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0678*x1 - 0.1143*x0 + 0.0759*np.sin(0.0470*self._t)
        dx1 = -0.0746*x0*x1 + 0.1187*x2 - 0.0749*x1
        dx2 = 0.0414*x0 - 0.0726*x2 + 0.0431*x3 - 0.0317*x1*x2
        dx3 = 0.1074*x1*x2 - 0.0888*x3 + 0.1194*x0
