...
class CarbonSequestrationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0736*x1 - 0.0243*x0 + 0.0566*np.sin(0.0558*self._t)
        dx1 = -0.0238*x0*x1 + 0.0781*x2 - 0.1150*x1
        dx2 = 0.0497*x0 - 0.1262*x2 + 0.0568*x3 - 0.0799*x1*x2
        dx3 = 0.0709*x1*x2 - 0.1388*x3 + 0.0487*x0
