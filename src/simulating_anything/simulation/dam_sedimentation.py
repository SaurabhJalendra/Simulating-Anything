...
class DamSedimentationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0227*x1 - 0.1475*x0 + 0.028*np.sin(0.0214*self._t)
        dx1 = -0.0741*x0*x1 + 0.1391*x2 - 0.1211*x1
        dx2 = 0.0334*x0 - 0.155*x2 + 0.1279*x3 - 0.1192*x1*x2
        dx3 = 0.1369*x1*x2 - 0.0488*x3 + 0.0564*x0
