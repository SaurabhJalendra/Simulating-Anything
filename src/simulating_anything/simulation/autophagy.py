...
class AutophagySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1019*x1 - 0.1108*x0 + 0.0558*np.sin(0.0425*self._t)
        dx1 = -0.0765*x0*x1 + 0.0213*x2 - 0.1072*x1
        dx2 = 0.0312*x0 - 0.0874*x2 + 0.0232*x3 - 0.1008*x1*x2
        dx3 = 0.0997*x1*x2 - 0.0892*x3 + 0.0675*x0
