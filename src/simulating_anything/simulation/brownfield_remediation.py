...
class BrownfieldRemediationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1043*x1 - 0.1140*x0 + 0.0930*np.sin(0.0619*self._t)
        dx1 = -0.0947*x0*x1 + 0.0404*x2 - 0.0404*x1
        dx2 = 0.0274*x0 - 0.0857*x2 + 0.0414*x3 - 0.1047*x1*x2
        dx3 = 0.0495*x1*x2 - 0.0203*x3 + 0.0237*x0
