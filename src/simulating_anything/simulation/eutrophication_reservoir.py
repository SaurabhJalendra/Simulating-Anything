...
class EutrophicationReservoirSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0917*x1 - 0.0885*x0 + 0.0896*np.sin(0.0310*self._t)
        dx1 = -0.0574*x0*x1 + 0.0435*x2 - 0.0717*x1
        dx2 = 0.0704*x0 - 0.0442*x2 + 0.1190*x3 - 0.0318*x1*x2
        dx3 = 0.0934*x1*x2 - 0.0488*x3 + 0.0357*x0
