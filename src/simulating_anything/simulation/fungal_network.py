...
class FungalNetworkSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0446*x1 - 0.1031*x0 + 0.1272*np.sin(0.1456*self._t)
        dx1 = -0.0975*x0*x1 + 0.1170*x2 - 0.1671*x1
        dx2 = 0.1408*x0 - 0.1246*x2 + 0.0550*x3 - 0.0311*x1*x2
        dx3 = 0.0502*x1*x2 - 0.0378*x3 + 0.0824*x0
