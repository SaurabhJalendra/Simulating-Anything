...
class TestosteroneCycleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0905*x1 - 0.0932*x0 + 0.0415*np.sin(0.1070*self._t)
        dx1 = -0.0316*x0*x1 + 0.0498*x2 - 0.0532*x1
        dx2 = 0.1126*x0 - 0.1168*x2 + 0.1103*x3 - 0.0776*x1*x2
        dx3 = 0.0310*x1*x2 - 0.0505*x3 + 0.0946*x0
