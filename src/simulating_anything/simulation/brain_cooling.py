...
class BrainCoolingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0379*x1 - 0.0248*x0 + 0.0943*np.sin(0.0540*self._t)
        dx1 = -0.0542*x0*x1 + 0.1114*x2 - 0.0628*x1
        dx2 = 0.0737*x0 - 0.0456*x2 + 0.0419*x3 - 0.0485*x1*x2
        dx3 = 0.0557*x1*x2 - 0.0344*x3 + 0.0476*x0
