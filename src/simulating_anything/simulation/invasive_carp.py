...
class InvasiveCarpSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1241*x1 - 0.1438*x0 + 0.1401*np.sin(0.0398*self._t)
        dx1 = -0.0993*x0*x1 + 0.0218*x2 - 0.0737*x1
        dx2 = 0.0771*x0 - 0.0408*x2 + 0.0355*x3 - 0.1573*x1*x2
        dx3 = 0.0742*x1*x2 - 0.0202*x3 + 0.047*x0
