...
class LimestoneCaveSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0200*x1 - 0.0596*x0 + 0.1176*np.sin(0.0823*self._t)
        dx1 = -0.1017*x0*x1 + 0.0684*x2 - 0.1062*x1
        dx2 = 0.0297*x0 - 0.0947*x2 + 0.0511*x3 - 0.0839*x1*x2
        dx3 = 0.0982*x1*x2 - 0.0346*x3 + 0.0835*x0
