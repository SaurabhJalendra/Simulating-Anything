...
class PrairieCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0806*x1 - 0.0671*x0 + 0.0941*np.sin(0.1093*self._t)
        dx1 = -0.0515*x0*x1 + 0.0296*x2 - 0.0766*x1
        dx2 = 0.0423*x0 - 0.0840*x2 + 0.0867*x3 - 0.1179*x1*x2
        dx3 = 0.0707*x1*x2 - 0.0442*x3 + 0.1135*x0
