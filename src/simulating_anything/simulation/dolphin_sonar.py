...
class DolphinSonarSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0356*x1 - 0.0537*x0 + 0.0577*np.sin(0.0595*self._t)
        dx1 = -0.0368*x0*x1 + 0.1177*x2 - 0.0914*x1
        dx2 = 0.0270*x0 - 0.0985*x2 + 0.1115*x3 - 0.0862*x1*x2
        dx3 = 0.0393*x1*x2 - 0.0939*x3 + 0.1129*x0
