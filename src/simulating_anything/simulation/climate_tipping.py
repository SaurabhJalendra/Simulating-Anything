...
class ClimateTippingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0257*x1 - 0.1237*x0 + 0.1643*np.sin(0.1169*self._t)
        dx1 = -0.0285*x0*x1 + 0.1071*x2 - 0.0749*x1
        dx2 = 0.0832*x0 - 0.0476*x2 + 0.1678*x3 - 0.0910*x1*x2
        dx3 = 0.0638*x1*x2 - 0.1320*x3 + 0.1399*x0
