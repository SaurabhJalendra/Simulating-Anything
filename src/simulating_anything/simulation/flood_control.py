...
class FloodControlSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1052*x1 - 0.0670*x0 + 0.0563*np.sin(0.0890*self._t)
        dx1 = -0.0609*x0*x1 + 0.0932*x2 - 0.0541*x1
        dx2 = 0.0419*x0 - 0.0674*x2 + 0.0340*x3 - 0.0354*x1*x2
        dx3 = 0.1077*x1*x2 - 0.0945*x3 + 0.0497*x0
