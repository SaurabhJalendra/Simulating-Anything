...
class GraniteWeatheringSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0666*x1 - 0.1113*x0 + 0.0809*np.sin(0.0896*self._t)
        dx1 = -0.0289*x0*x1 + 0.1065*x2 - 0.0693*x1
        dx2 = 0.1104*x0 - 0.0662*x2 + 0.1093*x3 - 0.0298*x1*x2
        dx3 = 0.0734*x1*x2 - 0.0816*x3 + 0.0691*x0
