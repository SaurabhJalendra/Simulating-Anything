...
class ElectricMotorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0233*x1 - 0.1054*x0 + 0.1096*np.sin(0.0543*self._t)
        dx1 = -0.0983*x0*x1 + 0.1039*x2 - 0.1181*x1
        dx2 = 0.0992*x0 - 0.0730*x2 + 0.0523*x3 - 0.1117*x1*x2
        dx3 = 0.0206*x1*x2 - 0.1004*x3 + 0.0749*x0
