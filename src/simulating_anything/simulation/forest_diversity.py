...
class ForestDiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0389*x1 - 0.0683*x0 + 0.0858*np.sin(0.1114*self._t)
        dx1 = -0.1130*x0*x1 + 0.0798*x2 - 0.0305*x1
        dx2 = 0.0389*x0 - 0.1019*x2 + 0.0458*x3 - 0.0731*x1*x2
        dx3 = 0.0674*x1*x2 - 0.0641*x3 + 0.0396*x0
