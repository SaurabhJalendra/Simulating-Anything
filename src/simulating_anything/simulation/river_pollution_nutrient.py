...
class RiverPollutionNutrientSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0794*x1 - 0.1085*x0 + 0.0308*np.sin(0.0512*self._t)
        dx1 = -0.0983*x0*x1 + 0.0464*x2 - 0.0784*x1
        dx2 = 0.0552*x0 - 0.0556*x2 + 0.0257*x3 - 0.0792*x1*x2
        dx3 = 0.0673*x1*x2 - 0.1072*x3 + 0.0851*x0
