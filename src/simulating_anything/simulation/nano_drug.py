...
class NanoDrugSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0402*x1 - 0.0778*x0 + 0.1035*np.sin(0.0286*self._t)
        dx1 = -0.0707*x0*x1 + 0.0350*x2 - 0.1128*x1
        dx2 = 0.0594*x0 - 0.0676*x2 + 0.1134*x3 - 0.0885*x1*x2
        dx3 = 0.0378*x1*x2 - 0.0509*x3 + 0.0384*x0
