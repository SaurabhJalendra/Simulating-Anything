...
class JungleBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0953*x1 - 0.0692*x0 + 0.1127*np.sin(0.0213*self._t)
        dx1 = -0.0360*x0*x1 + 0.0486*x2 - 0.1017*x1
        dx2 = 0.0337*x0 - 0.0544*x2 + 0.0356*x3 - 0.1018*x1*x2
        dx3 = 0.0495*x1*x2 - 0.0929*x3 + 0.0677*x0
