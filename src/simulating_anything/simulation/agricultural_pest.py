...
class AgriculturalPestSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0580*x1 - 0.0308*x0 + 0.0506*np.sin(0.1080*self._t)
        dx1 = -0.0406*x0*x1 + 0.0619*x2 - 0.0389*x1
        dx2 = 0.0478*x0 - 0.0440*x2 + 0.0676*x3 - 0.0566*x1*x2
        dx3 = 0.0671*x1*x2 - 0.0520*x3 + 0.1068*x0
