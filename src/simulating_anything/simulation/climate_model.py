...
class ClimateModelSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0235*x1 - 0.1050*x0 + 0.0650*np.sin(0.0424*self._t)
        dx1 = -0.1158*x0*x1 + 0.1097*x2 - 0.0511*x1
        dx2 = 0.1167*x0 - 0.0253*x2 + 0.0224*x3 - 0.0912*x1*x2
        dx3 = 0.0786*x1*x2 - 0.0678*x3 + 0.0572*x0
