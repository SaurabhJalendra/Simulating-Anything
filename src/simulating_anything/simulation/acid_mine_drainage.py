...
class AcidMineDrainageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1121*x1 - 0.0338*x0 + 0.0321*np.sin(0.0394*self._t)
        dx1 = -0.1368*x0*x1 + 0.1642*x2 - 0.0228*x1
        dx2 = 0.0698*x0 - 0.0359*x2 + 0.042*x3 - 0.0649*x1*x2
        dx3 = 0.1397*x1*x2 - 0.0582*x3 + 0.1642*x0
