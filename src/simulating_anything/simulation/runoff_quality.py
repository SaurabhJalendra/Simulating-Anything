...
class RunoffQualitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0825*x1 - 0.0560*x0 + 0.0247*np.sin(0.1146*self._t)
        dx1 = -0.0611*x0*x1 + 0.0565*x2 - 0.0415*x1
        dx2 = 0.0341*x0 - 0.0711*x2 + 0.1118*x3 - 0.1142*x1*x2
        dx3 = 0.0539*x1*x2 - 0.0799*x3 + 0.0330*x0
