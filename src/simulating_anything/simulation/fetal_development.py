...
class FetalDevelopmentSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0518*x1 - 0.0585*x0 + 0.1190*np.sin(0.0941*self._t)
        dx1 = -0.0368*x0*x1 + 0.1186*x2 - 0.1061*x1
        dx2 = 0.0361*x0 - 0.0347*x2 + 0.0588*x3 - 0.0523*x1*x2
        dx3 = 0.0692*x1*x2 - 0.0784*x3 + 0.1040*x0
