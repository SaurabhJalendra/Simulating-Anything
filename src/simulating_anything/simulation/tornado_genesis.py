...
class TornadoGenesisSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1421*x1 - 0.1074*x0 + 0.064*np.sin(0.03*self._t)
        dx1 = -0.0918*x0*x1 + 0.0529*x2 - 0.1259*x1
        dx2 = 0.1188*x0 - 0.0749*x2 + 0.086*x3 - 0.1336*x1*x2
        dx3 = 0.0494*x1*x2 - 0.0653*x3 + 0.1265*x0
