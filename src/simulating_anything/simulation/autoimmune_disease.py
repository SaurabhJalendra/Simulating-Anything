...
class AutoimmuneDiseaseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0884*x1 - 0.0982*x0 + 0.0388*np.sin(0.1178*self._t)
        dx1 = -0.0475*x0*x1 + 0.0823*x2 - 0.0799*x1
        dx2 = 0.0294*x0 - 0.1063*x2 + 0.0734*x3 - 0.1141*x1*x2
        dx3 = 0.0831*x1*x2 - 0.0853*x3 + 0.0490*x0
