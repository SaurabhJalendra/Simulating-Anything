...
class BeneficialInsectSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0631*x1 - 0.0766*x0 + 0.0334*np.sin(0.0850*self._t)
        dx1 = -0.0204*x0*x1 + 0.1065*x2 - 0.1133*x1
        dx2 = 0.0693*x0 - 0.1012*x2 + 0.0722*x3 - 0.0329*x1*x2
        dx3 = 0.0829*x1*x2 - 0.0885*x3 + 0.1170*x0
