...
class DroughtIndexSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0783*x1 - 0.0227*x0 + 0.1169*np.sin(0.1090*self._t)
        dx1 = -0.1069*x0*x1 + 0.0502*x2 - 0.0565*x1
        dx2 = 0.0958*x0 - 0.0578*x2 + 0.0407*x3 - 0.0935*x1*x2
        dx3 = 0.0401*x1*x2 - 0.0895*x3 + 0.0314*x0
