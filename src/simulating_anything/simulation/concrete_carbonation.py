...
class ConcreteCarbonationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0748*x1 - 0.0263*x0 + 0.1176*np.sin(0.0968*self._t)
        dx1 = -0.0254*x0*x1 + 0.1186*x2 - 0.1177*x1
        dx2 = 0.0583*x0 - 0.0528*x2 + 0.0422*x3 - 0.1063*x1*x2
        dx3 = 0.0973*x1*x2 - 0.0625*x3 + 0.0673*x0
