...
class OzoneDepletionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0606*x1 - 0.1012*x0 + 0.1557*np.sin(0.0702*self._t)
        dx1 = -0.1149*x0*x1 + 0.0417*x2 - 0.1384*x1
        dx2 = 0.0603*x0 - 0.0786*x2 + 0.1166*x3 - 0.0383*x1*x2
        dx3 = 0.0585*x1*x2 - 0.0913*x3 + 0.0526*x0
