...
class CarbonNanotubeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0386*x1 - 0.1320*x0 + 0.0655*np.sin(0.1020*self._t)
        dx1 = -0.0735*x0*x1 + 0.1199*x2 - 0.1528*x1
        dx2 = 0.0551*x0 - 0.1479*x2 + 0.0853*x3 - 0.0861*x1*x2
        dx3 = 0.1198*x1*x2 - 0.1245*x3 + 0.1129*x0
