...
class BasaltWeatheringSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0551*x1 - 0.0223*x0 + 0.0322*np.sin(0.0602*self._t)
        dx1 = -0.0990*x0*x1 + 0.0726*x2 - 0.0835*x1
        dx2 = 0.0852*x0 - 0.1046*x2 + 0.0232*x3 - 0.0267*x1*x2
        dx3 = 0.0756*x1*x2 - 0.0770*x3 + 0.0984*x0
