...
class ChameleonThermoregulationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0624*x1 - 0.0990*x0 + 0.1129*np.sin(0.0634*self._t)
        dx1 = -0.1054*x0*x1 + 0.0288*x2 - 0.0399*x1
        dx2 = 0.0284*x0 - 0.1152*x2 + 0.0369*x3 - 0.0878*x1*x2
        dx3 = 0.0509*x1*x2 - 0.0562*x3 + 0.0346*x0
