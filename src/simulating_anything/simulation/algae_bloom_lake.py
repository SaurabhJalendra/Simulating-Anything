...
class AlgaeBloomLakeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1639*x1 - 0.0414*x0 + 0.1526*np.sin(0.0603*self._t)
        dx1 = -0.1524*x0*x1 + 0.0319*x2 - 0.0369*x1
        dx2 = 0.1391*x0 - 0.0303*x2 + 0.1058*x3 - 0.1376*x1*x2
        dx3 = 0.0678*x1*x2 - 0.0635*x3 + 0.0559*x0
