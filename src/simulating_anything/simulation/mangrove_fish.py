...
class MangroveFishSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0336*x1 - 0.0618*x0 + 0.0941*np.sin(0.13*self._t)
        dx1 = -0.0913*x0*x1 + 0.0749*x2 - 0.0399*x1
        dx2 = 0.0886*x0 - 0.0699*x2 + 0.0969*x3 - 0.0897*x1*x2
        dx3 = 0.0659*x1*x2 - 0.0273*x3 + 0.0406*x0
