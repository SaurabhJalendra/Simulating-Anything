...
class CoffeeRustSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0447*x1 - 0.0816*x0 + 0.0985*np.sin(0.0488*self._t)
        dx1 = -0.0346*x0*x1 + 0.0259*x2 - 0.0660*x1
        dx2 = 0.0877*x0 - 0.1046*x2 + 0.0321*x3 - 0.0574*x1*x2
        dx3 = 0.0779*x1*x2 - 0.0263*x3 + 0.0276*x0
