...
class LymphFlowSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0513*x1 - 0.1164*x0 + 0.0503*np.sin(0.0776*self._t)
        dx1 = -0.0832*x0*x1 + 0.0465*x2 - 0.1045*x1
        dx2 = 0.1036*x0 - 0.0443*x2 + 0.0661*x3 - 0.1127*x1*x2
        dx3 = 0.0957*x1*x2 - 0.0587*x3 + 0.1023*x0
