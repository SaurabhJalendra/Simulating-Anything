...
class BuildingEnergySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0337*x1 - 0.0594*x0 + 0.0314*np.sin(0.0725*self._t)
        dx1 = -0.0949*x0*x1 + 0.0513*x2 - 0.1073*x1
        dx2 = 0.0514*x0 - 0.0482*x2 + 0.0450*x3 - 0.1131*x1*x2
        dx3 = 0.0221*x1*x2 - 0.0603*x3 + 0.0359*x0
