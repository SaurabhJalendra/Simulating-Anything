...
class VolcanoGasSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0618*x1 - 0.0842*x0 + 0.0568*np.sin(0.0946*self._t)
        dx1 = -0.1052*x0*x1 + 0.0808*x2 - 0.1101*x1
        dx2 = 0.0290*x0 - 0.1175*x2 + 0.0472*x3 - 0.0326*x1*x2
        dx3 = 0.0461*x1*x2 - 0.0501*x3 + 0.0332*x0
