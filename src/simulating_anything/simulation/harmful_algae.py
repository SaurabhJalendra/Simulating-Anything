...
class HarmfulAlgaeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0237*x1 - 0.1313*x0 + 0.0532*np.sin(0.0925*self._t)
        dx1 = -0.0636*x0*x1 + 0.0963*x2 - 0.0593*x1
        dx2 = 0.0721*x0 - 0.0651*x2 + 0.0822*x3 - 0.0998*x1*x2
        dx3 = 0.0989*x1*x2 - 0.0968*x3 + 0.0443*x0
