...
class BiofortificationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0461*x1 - 0.0242*x0 + 0.0858*np.sin(0.0873*self._t)
        dx1 = -0.1122*x0*x1 + 0.0721*x2 - 0.0755*x1
        dx2 = 0.0609*x0 - 0.0968*x2 + 0.0520*x3 - 0.0732*x1*x2
        dx3 = 0.0544*x1*x2 - 0.0979*x3 + 0.0321*x0
