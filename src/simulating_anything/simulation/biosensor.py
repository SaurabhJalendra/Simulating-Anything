...
class BiosensorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0245*x1 - 0.1099*x0 + 0.0648*np.sin(0.0683*self._t)
        dx1 = -0.0776*x0*x1 + 0.1030*x2 - 0.1005*x1
        dx2 = 0.1102*x0 - 0.1160*x2 + 0.0736*x3 - 0.0807*x1*x2
        dx3 = 0.0940*x1*x2 - 0.0496*x3 + 0.0877*x0
