...
class SolarFlareSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1187*x1 - 0.1158*x0 + 0.0591*np.sin(0.0621*self._t)
        dx1 = -0.0274*x0*x1 + 0.0469*x2 - 0.1135*x1
        dx2 = 0.0530*x0 - 0.0636*x2 + 0.0575*x3 - 0.0566*x1*x2
        dx3 = 0.0676*x1*x2 - 0.1165*x3 + 0.0846*x0
