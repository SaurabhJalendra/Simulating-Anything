...
class KarstCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1127*x1 - 0.0769*x0 + 0.0438*np.sin(0.1049*self._t)
        dx1 = -0.0985*x0*x1 + 0.0694*x2 - 0.0985*x1
        dx2 = 0.0654*x0 - 0.0302*x2 + 0.0433*x3 - 0.0418*x1*x2
        dx3 = 0.0694*x1*x2 - 0.0725*x3 + 0.0715*x0
