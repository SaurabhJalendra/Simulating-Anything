...
class MalariaDrugSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0816*x1 - 0.0554*x0 + 0.0326*np.sin(0.0740*self._t)
        dx1 = -0.0225*x0*x1 + 0.0929*x2 - 0.0413*x1
        dx2 = 0.0744*x0 - 0.0322*x2 + 0.0623*x3 - 0.0973*x1*x2
        dx3 = 0.0650*x1*x2 - 0.0933*x3 + 0.0659*x0
