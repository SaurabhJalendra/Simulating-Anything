...
class HarborBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0802*x1 - 0.1085*x0 + 0.0489*np.sin(0.0765*self._t)
        dx1 = -0.1126*x0*x1 + 0.0736*x2 - 0.1164*x1
        dx2 = 0.0549*x0 - 0.0867*x2 + 0.0288*x3 - 0.1142*x1*x2
        dx3 = 0.0965*x1*x2 - 0.1058*x3 + 0.0453*x0
