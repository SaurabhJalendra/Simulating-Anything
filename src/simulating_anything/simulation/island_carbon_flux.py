...
class IslandCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1087*x1 - 0.0638*x0 + 0.0990*np.sin(0.0572*self._t)
        dx1 = -0.1152*x0*x1 + 0.0383*x2 - 0.0540*x1
        dx2 = 0.1057*x0 - 0.0271*x2 + 0.0705*x3 - 0.0993*x1*x2
        dx3 = 0.0328*x1*x2 - 0.0848*x3 + 0.1166*x0
