...
class DieselParticulateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0521*x1 - 0.0657*x0 + 0.0744*np.sin(0.1122*self._t)
        dx1 = -0.0416*x0*x1 + 0.0619*x2 - 0.0328*x1
        dx2 = 0.0238*x0 - 0.0780*x2 + 0.0825*x3 - 0.0327*x1*x2
        dx3 = 0.0282*x1*x2 - 0.1021*x3 + 0.0818*x0
