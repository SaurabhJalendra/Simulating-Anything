...
class ArcticCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0380*x1 - 0.0736*x0 + 0.0259*np.sin(0.0773*self._t)
        dx1 = -0.0511*x0*x1 + 0.0891*x2 - 0.0207*x1
        dx2 = 0.0862*x0 - 0.0532*x2 + 0.0491*x3 - 0.0394*x1*x2
        dx3 = 0.1158*x1*x2 - 0.0938*x3 + 0.0572*x0
