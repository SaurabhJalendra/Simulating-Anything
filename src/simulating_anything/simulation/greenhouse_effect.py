...
class GreenhouseEffectSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0646*x1 - 0.0536*x0 + 0.0995*np.sin(0.0976*self._t)
        dx1 = -0.0352*x0*x1 + 0.0900*x2 - 0.0387*x1
        dx2 = 0.0875*x0 - 0.1160*x2 + 0.0956*x3 - 0.0582*x1*x2
        dx3 = 0.0939*x1*x2 - 0.0827*x3 + 0.0924*x0
