...
class BoneHealingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0648*x1 - 0.0390*x0 + 0.0204*np.sin(0.0910*self._t)
        dx1 = -0.0768*x0*x1 + 0.0753*x2 - 0.0390*x1
        dx2 = 0.1100*x0 - 0.0430*x2 + 0.0306*x3 - 0.1154*x1*x2
        dx3 = 0.0674*x1*x2 - 0.0473*x3 + 0.0770*x0
