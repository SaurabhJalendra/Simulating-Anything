...
class PopulationGeneticsSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0687*x1 - 0.0376*x0 + 0.0306*np.sin(0.1143*self._t)
        dx1 = -0.1181*x0*x1 + 0.0994*x2 - 0.1089*x1
        dx2 = 0.1066*x0 - 0.1155*x2 + 0.0821*x3 - 0.0467*x1*x2
        dx3 = 0.1084*x1*x2 - 0.0217*x3 + 0.0328*x0
