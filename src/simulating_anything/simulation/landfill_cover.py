...
class LandfillCoverSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0869*x1 - 0.0681*x0 + 0.1009*np.sin(0.0461*self._t)
        dx1 = -0.1093*x0*x1 + 0.0492*x2 - 0.1183*x1
        dx2 = 0.0725*x0 - 0.0289*x2 + 0.1060*x3 - 0.0855*x1*x2
        dx3 = 0.0986*x1*x2 - 0.0805*x3 + 0.0448*x0
