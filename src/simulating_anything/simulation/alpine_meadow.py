...
class AlpineMeadowSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0414*x1 - 0.1192*x0 + 0.1020*np.sin(0.0621*self._t)
        dx1 = -0.1195*x0*x1 + 0.0670*x2 - 0.1150*x1
        dx2 = 0.0549*x0 - 0.0306*x2 + 0.0582*x3 - 0.0929*x1*x2
        dx3 = 0.0337*x1*x2 - 0.0495*x3 + 0.0999*x0
