...
class StormWaterSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0911*x1 - 0.0735*x0 + 0.0833*np.sin(0.0758*self._t)
        dx1 = -0.0399*x0*x1 + 0.0340*x2 - 0.0289*x1
        dx2 = 0.0745*x0 - 0.0712*x2 + 0.1161*x3 - 0.0438*x1*x2
        dx3 = 0.0628*x1*x2 - 0.1162*x3 + 0.0505*x0
