...
class ReefConnectivitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0531*x1 - 0.0588*x0 + 0.0260*np.sin(0.1077*self._t)
        dx1 = -0.0406*x0*x1 + 0.0827*x2 - 0.0736*x1
        dx2 = 0.0349*x0 - 0.0965*x2 + 0.0918*x3 - 0.0772*x1*x2
        dx3 = 0.0848*x1*x2 - 0.0579*x3 + 0.0424*x0
