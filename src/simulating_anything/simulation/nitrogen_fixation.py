...
class NitrogenFixationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1362*x1 - 0.0933*x0 + 0.0777*np.sin(0.1670*self._t)
        dx1 = -0.0604*x0*x1 + 0.0993*x2 - 0.1551*x1
        dx2 = 0.1489*x0 - 0.0423*x2 + 0.0949*x3 - 0.1416*x1*x2
        dx3 = 0.1659*x1*x2 - 0.1244*x3 + 0.1092*x0
