...
class DengueMosquitoSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0621*x1 - 0.0923*x0 + 0.0871*np.sin(0.1194*self._t)
        dx1 = -0.0489*x0*x1 + 0.0601*x2 - 0.0734*x1
        dx2 = 0.0788*x0 - 0.0215*x2 + 0.0500*x3 - 0.0714*x1*x2
        dx3 = 0.1059*x1*x2 - 0.0393*x3 + 0.0536*x0
