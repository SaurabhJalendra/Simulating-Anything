...
class GrassFireSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1347*x1 - 0.1377*x0 + 0.0639*np.sin(0.0401*self._t)
        dx1 = -0.1073*x0*x1 + 0.0843*x2 - 0.0316*x1
        dx2 = 0.1204*x0 - 0.0492*x2 + 0.0876*x3 - 0.0595*x1*x2
        dx3 = 0.0940*x1*x2 - 0.0378*x3 + 0.1275*x0
