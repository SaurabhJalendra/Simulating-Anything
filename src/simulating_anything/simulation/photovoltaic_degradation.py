...
class PhotovoltaicDegradationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1687*x1 - 0.1609*x0 + 0.1555*np.sin(0.1402*self._t)
        dx1 = -0.1137*x0*x1 + 0.0921*x2 - 0.0207*x1
        dx2 = 0.1565*x0 - 0.0988*x2 + 0.0727*x3 - 0.1569*x1*x2
        dx3 = 0.1055*x1*x2 - 0.1072*x3 + 0.1520*x0
