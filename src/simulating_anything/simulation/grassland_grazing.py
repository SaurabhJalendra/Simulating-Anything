...
class GrasslandGrazingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0873*x1 - 0.0839*x0 + 0.1014*np.sin(0.1231*self._t)
        dx1 = -0.1381*x0*x1 + 0.1553*x2 - 0.0590*x1
        dx2 = 0.0968*x0 - 0.1501*x2 + 0.0241*x3 - 0.0684*x1*x2
        dx3 = 0.1024*x1*x2 - 0.0679*x3 + 0.0230*x0
