...
class OilDegradationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0997*x1 - 0.0353*x0 + 0.0209*np.sin(0.0400*self._t)
        dx1 = -0.0780*x0*x1 + 0.0700*x2 - 0.0402*x1
        dx2 = 0.0923*x0 - 0.0675*x2 + 0.0561*x3 - 0.0551*x1*x2
        dx3 = 0.0706*x1*x2 - 0.0615*x3 + 0.1099*x0
