...
class SaltBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1193*x1 - 0.0210*x0 + 0.0230*np.sin(0.0831*self._t)
        dx1 = -0.0938*x0*x1 + 0.0560*x2 - 0.0945*x1
        dx2 = 0.0829*x0 - 0.0866*x2 + 0.0203*x3 - 0.0550*x1*x2
        dx3 = 0.0540*x1*x2 - 0.0306*x3 + 0.1108*x0
