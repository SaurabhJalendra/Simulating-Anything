...
class DuneMigrationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1159*x1 - 0.0255*x0 + 0.1283*np.sin(0.1248*self._t)
        dx1 = -0.0612*x0*x1 + 0.1366*x2 - 0.1092*x1
        dx2 = 0.0970*x0 - 0.0372*x2 + 0.1315*x3 - 0.0279*x1*x2
        dx3 = 0.0954*x1*x2 - 0.0422*x3 + 0.0693*x0
