...
class CompostTemperatureSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1190*x1 - 0.0244*x0 + 0.0532*np.sin(0.0834*self._t)
        dx1 = -0.0593*x0*x1 + 0.0652*x2 - 0.0733*x1
        dx2 = 0.1319*x0 - 0.0368*x2 + 0.1134*x3 - 0.0538*x1*x2
        dx3 = 0.0469*x1*x2 - 0.1113*x3 + 0.0690*x0
