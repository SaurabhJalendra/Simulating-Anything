...
class RiverEcosystemSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0762*x1 - 0.0669*x0 + 0.0757*np.sin(0.0622*self._t)
        dx1 = -0.0245*x0*x1 + 0.0354*x2 - 0.0828*x1
        dx2 = 0.0850*x0 - 0.1011*x2 + 0.0828*x3 - 0.0461*x1*x2
        dx3 = 0.0652*x1*x2 - 0.0406*x3 + 0.0580*x0
