...
class CellMembraneSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0745*x1 - 0.1097*x0 + 0.1134*np.sin(0.0830*self._t)
        dx1 = -0.1060*x0*x1 + 0.0443*x2 - 0.0320*x1
        dx2 = 0.0987*x0 - 0.0555*x2 + 0.0354*x3 - 0.1020*x1*x2
        dx3 = 0.1170*x1*x2 - 0.0644*x3 + 0.0415*x0
