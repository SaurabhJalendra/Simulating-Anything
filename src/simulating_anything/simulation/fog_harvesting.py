...
class FogHarvestingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1327*x1 - 0.1281*x0 + 0.0220*np.sin(0.1630*self._t)
        dx1 = -0.0353*x0*x1 + 0.0915*x2 - 0.0735*x1
        dx2 = 0.1092*x0 - 0.1134*x2 + 0.1691*x3 - 0.0833*x1*x2
        dx3 = 0.0456*x1*x2 - 0.1003*x3 + 0.1523*x0
