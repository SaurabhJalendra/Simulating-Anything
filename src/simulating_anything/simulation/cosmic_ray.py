...
class CosmicRaySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0309*x1 - 0.0606*x0 + 0.0901*np.sin(0.0552*self._t)
        dx1 = -0.0436*x0*x1 + 0.0915*x2 - 0.0633*x1
        dx2 = 0.1015*x0 - 0.0707*x2 + 0.0505*x3 - 0.0776*x1*x2
        dx3 = 0.0527*x1*x2 - 0.0742*x3 + 0.0708*x0
