...
class UrbanMicroclimateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1156*x1 - 0.0684*x0 + 0.0454*np.sin(0.0842*self._t)
        dx1 = -0.0944*x0*x1 + 0.0923*x2 - 0.1071*x1
        dx2 = 0.1026*x0 - 0.1160*x2 + 0.0410*x3 - 0.0484*x1*x2
        dx3 = 0.0736*x1*x2 - 0.0463*x3 + 0.0397*x0
