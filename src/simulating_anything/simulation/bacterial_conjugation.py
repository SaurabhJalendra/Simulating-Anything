...
class BacterialConjugationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0583*x1 - 0.0701*x0 + 0.0995*np.sin(0.0314*self._t)
        dx1 = -0.0544*x0*x1 + 0.0822*x2 - 0.0887*x1
        dx2 = 0.0389*x0 - 0.0649*x2 + 0.1080*x3 - 0.0879*x1*x2
        dx3 = 0.1124*x1*x2 - 0.0643*x3 + 0.0522*x0
