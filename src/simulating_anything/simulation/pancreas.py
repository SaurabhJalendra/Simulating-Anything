...
class PancreasSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1115*x1 - 0.0829*x0 + 0.0641*np.sin(0.1066*self._t)
        dx1 = -0.0328*x0*x1 + 0.0527*x2 - 0.0771*x1
        dx2 = 0.1102*x0 - 0.0690*x2 + 0.0407*x3 - 0.1058*x1*x2
        dx3 = 0.0662*x1*x2 - 0.0550*x3 + 0.0909*x0
