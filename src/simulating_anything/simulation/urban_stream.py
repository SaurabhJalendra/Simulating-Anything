...
class UrbanStreamSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0689*x1 - 0.0879*x0 + 0.0263*np.sin(0.0330*self._t)
        dx1 = -0.1048*x0*x1 + 0.0340*x2 - 0.1021*x1
        dx2 = 0.0223*x0 - 0.0701*x2 + 0.1193*x3 - 0.0236*x1*x2
        dx3 = 0.0335*x1*x2 - 0.0921*x3 + 0.0422*x0
