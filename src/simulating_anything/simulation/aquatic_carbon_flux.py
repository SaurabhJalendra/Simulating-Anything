...
class AquaticCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0763*x1 - 0.1021*x0 + 0.1020*np.sin(0.0365*self._t)
        dx1 = -0.0489*x0*x1 + 0.0741*x2 - 0.0744*x1
        dx2 = 0.0898*x0 - 0.0244*x2 + 0.0308*x3 - 0.0390*x1*x2
        dx3 = 0.0413*x1*x2 - 0.1111*x3 + 0.1135*x0
