...
class HumanTraffickingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0833*x1 - 0.0475*x0 + 0.0918*np.sin(0.1037*self._t)
        dx1 = -0.0715*x0*x1 + 0.1007*x2 - 0.1197*x1
        dx2 = 0.0918*x0 - 0.0574*x2 + 0.0300*x3 - 0.1034*x1*x2
        dx3 = 0.1067*x1*x2 - 0.1143*x3 + 0.0959*x0
