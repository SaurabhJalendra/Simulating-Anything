...
class OrganicCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0296*x1 - 0.0210*x0 + 0.0470*np.sin(0.0306*self._t)
        dx1 = -0.0705*x0*x1 + 0.0948*x2 - 0.0291*x1
        dx2 = 0.0508*x0 - 0.0957*x2 + 0.0268*x3 - 0.0798*x1*x2
        dx3 = 0.0315*x1*x2 - 0.0389*x3 + 0.0598*x0
