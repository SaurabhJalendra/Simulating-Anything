...
class WaterfallErosionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0290*x1 - 0.0291*x0 + 0.0210*np.sin(0.1099*self._t)
        dx1 = -0.0707*x0*x1 + 0.0510*x2 - 0.0505*x1
        dx2 = 0.0557*x0 - 0.0888*x2 + 0.0890*x3 - 0.0839*x1*x2
        dx3 = 0.0277*x1*x2 - 0.0371*x3 + 0.0246*x0
