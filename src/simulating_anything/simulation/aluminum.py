...
class AluminumSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1135*x1 - 0.0927*x0 + 0.0246*np.sin(0.1095*self._t)
        dx1 = -0.1152*x0*x1 + 0.0359*x2 - 0.0931*x1
        dx2 = 0.0242*x0 - 0.0769*x2 + 0.0593*x3 - 0.0721*x1*x2
        dx3 = 0.0486*x1*x2 - 0.1020*x3 + 0.0381*x0
