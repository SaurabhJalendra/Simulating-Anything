...
class MagnesiumAlloySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0727*x1 - 0.1058*x0 + 0.0778*np.sin(0.0878*self._t)
        dx1 = -0.0650*x0*x1 + 0.1085*x2 - 0.0806*x1
        dx2 = 0.1190*x0 - 0.0443*x2 + 0.0254*x3 - 0.0514*x1*x2
        dx3 = 0.0353*x1*x2 - 0.0237*x3 + 0.0524*x0
