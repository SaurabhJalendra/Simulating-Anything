...
class AuroraSubstormSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0720*x1 - 0.1192*x0 + 0.0649*np.sin(0.1006*self._t)
        dx1 = -0.1033*x0*x1 + 0.1026*x2 - 0.0498*x1
        dx2 = 0.0772*x0 - 0.0249*x2 + 0.1139*x3 - 0.0308*x1*x2
        dx3 = 0.0578*x1*x2 - 0.0856*x3 + 0.0343*x0
