...
class MusselFarmingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0631*x1 - 0.0484*x0 + 0.0228*np.sin(0.0366*self._t)
        dx1 = -0.1105*x0*x1 + 0.1136*x2 - 0.1155*x1
        dx2 = 0.1052*x0 - 0.0610*x2 + 0.0971*x3 - 0.1073*x1*x2
        dx3 = 0.0903*x1*x2 - 0.0992*x3 + 0.0951*x0
