...
class TopsoilLossSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0559*x1 - 0.0561*x0 + 0.0432*np.sin(0.0582*self._t)
        dx1 = -0.0592*x0*x1 + 0.1074*x2 - 0.0911*x1
        dx2 = 0.1179*x0 - 0.0674*x2 + 0.0861*x3 - 0.0531*x1*x2
        dx3 = 0.0721*x1*x2 - 0.0976*x3 + 0.0313*x0
