...
class RadioactiveDecaySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0738*x1 - 0.0814*x0 + 0.0697*np.sin(0.0351*self._t)
        dx1 = -0.0714*x0*x1 + 0.0679*x2 - 0.0521*x1
        dx2 = 0.1155*x0 - 0.0390*x2 + 0.0934*x3 - 0.0309*x1*x2
        dx3 = 0.1165*x1*x2 - 0.0644*x3 + 0.1113*x0
