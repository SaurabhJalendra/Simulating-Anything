...
class SavannaFireSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1155*x1 - 0.1429*x0 + 0.1579*np.sin(0.0355*self._t)
        dx1 = -0.1679*x0*x1 + 0.0246*x2 - 0.08*x1
        dx2 = 0.1379*x0 - 0.0762*x2 + 0.1224*x3 - 0.1118*x1*x2
        dx3 = 0.0255*x1*x2 - 0.0673*x3 + 0.1116*x0
