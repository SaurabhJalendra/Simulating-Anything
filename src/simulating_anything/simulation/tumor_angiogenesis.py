...
class TumorAngiogenesisSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1149*x1 - 0.1108*x0 + 0.0866*np.sin(0.0415*self._t)
        dx1 = -0.0939*x0*x1 + 0.0324*x2 - 0.1163*x1
        dx2 = 0.0959*x0 - 0.0274*x2 + 0.0590*x3 - 0.1181*x1*x2
        dx3 = 0.0510*x1*x2 - 0.1153*x3 + 0.0512*x0
