...
class BarnacleFoulingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0264*x1 - 0.0499*x0 + 0.0872*np.sin(0.0999*self._t)
        dx1 = -0.0388*x0*x1 + 0.0759*x2 - 0.0387*x1
        dx2 = 0.1145*x0 - 0.0324*x2 + 0.0663*x3 - 0.0422*x1*x2
        dx3 = 0.0248*x1*x2 - 0.0695*x3 + 0.0643*x0
