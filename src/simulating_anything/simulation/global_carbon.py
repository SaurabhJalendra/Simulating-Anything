...
class GlobalCarbonSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0556*x1 - 0.0755*x0 + 0.1020*np.sin(0.1169*self._t)
        dx1 = -0.0729*x0*x1 + 0.0401*x2 - 0.1053*x1
        dx2 = 0.0306*x0 - 0.1052*x2 + 0.0415*x3 - 0.0861*x1*x2
        dx3 = 0.0973*x1*x2 - 0.0842*x3 + 0.0710*x0
