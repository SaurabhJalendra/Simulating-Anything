...
class EvergladesHydrologySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0356*x1 - 0.1378*x0 + 0.0271*np.sin(0.0260*self._t)
        dx1 = -0.0372*x0*x1 + 0.1332*x2 - 0.0947*x1
        dx2 = 0.1285*x0 - 0.1422*x2 + 0.0330*x3 - 0.0706*x1*x2
        dx3 = 0.0853*x1*x2 - 0.0472*x3 + 0.0687*x0
