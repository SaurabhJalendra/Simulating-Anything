...
class ActivatedCarbonSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1061*x1 - 0.0504*x0 + 0.0609*np.sin(0.0764*self._t)
        dx1 = -0.0722*x0*x1 + 0.0834*x2 - 0.0710*x1
        dx2 = 0.0843*x0 - 0.0470*x2 + 0.0623*x3 - 0.0596*x1*x2
        dx3 = 0.0468*x1*x2 - 0.0953*x3 + 0.0727*x0
