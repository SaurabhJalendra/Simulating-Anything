...
class GeothermalHeatSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1131*x1 - 0.0468*x0 + 0.0638*np.sin(0.0627*self._t)
        dx1 = -0.0264*x0*x1 + 0.0386*x2 - 0.0676*x1
        dx2 = 0.0318*x0 - 0.1078*x2 + 0.0334*x3 - 0.0375*x1*x2
        dx3 = 0.0272*x1*x2 - 0.0523*x3 + 0.0516*x0
