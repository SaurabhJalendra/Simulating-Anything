...
class SteelFurnaceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0504*x1 - 0.0675*x0 + 0.0355*np.sin(0.0333*self._t)
        dx1 = -0.0506*x0*x1 + 0.1089*x2 - 0.0409*x1
        dx2 = 0.0968*x0 - 0.0425*x2 + 0.0369*x3 - 0.0910*x1*x2
        dx3 = 0.0491*x1*x2 - 0.0482*x3 + 0.0356*x0
