...
class MudslideSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0932*x1 - 0.0977*x0 + 0.0760*np.sin(0.0468*self._t)
        dx1 = -0.1089*x0*x1 + 0.0806*x2 - 0.1112*x1
        dx2 = 0.0435*x0 - 0.0767*x2 + 0.0853*x3 - 0.1055*x1*x2
        dx3 = 0.0522*x1*x2 - 0.0822*x3 + 0.0753*x0
