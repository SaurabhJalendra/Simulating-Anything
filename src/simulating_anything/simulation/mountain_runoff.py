...
class MountainRunoffSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0338*x1 - 0.0318*x0 + 0.0531*np.sin(0.1056*self._t)
        dx1 = -0.0547*x0*x1 + 0.0298*x2 - 0.0730*x1
        dx2 = 0.0534*x0 - 0.1130*x2 + 0.0971*x3 - 0.0710*x1*x2
        dx3 = 0.0352*x1*x2 - 0.0750*x3 + 0.0885*x0
