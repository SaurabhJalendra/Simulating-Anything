...
class HarborCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0767*x1 - 0.0963*x0 + 0.1031*np.sin(0.0641*self._t)
        dx1 = -0.0782*x0*x1 + 0.1190*x2 - 0.1186*x1
        dx2 = 0.0668*x0 - 0.0561*x2 + 0.0210*x3 - 0.1155*x1*x2
        dx3 = 0.0309*x1*x2 - 0.0423*x3 + 0.0942*x0
