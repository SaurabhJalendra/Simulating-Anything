...
class PaperDegradationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0311*x1 - 0.0442*x0 + 0.0439*np.sin(0.1097*self._t)
        dx1 = -0.0800*x0*x1 + 0.0564*x2 - 0.1076*x1
        dx2 = 0.0520*x0 - 0.1185*x2 + 0.0553*x3 - 0.0488*x1*x2
        dx3 = 0.0327*x1*x2 - 0.0446*x3 + 0.0696*x0
