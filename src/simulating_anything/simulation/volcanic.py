...
class VolcanicSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1134*x1 - 0.0275*x0 + 0.1079*np.sin(0.0737*self._t)
        dx1 = -0.1014*x0*x1 + 0.0744*x2 - 0.0346*x1
        dx2 = 0.0217*x0 - 0.0819*x2 + 0.1151*x3 - 0.0759*x1*x2
        dx3 = 0.0808*x1*x2 - 0.0629*x3 + 0.0637*x0
