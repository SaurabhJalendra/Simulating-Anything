...
class DroughtReservoirSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0324*x1 - 0.0585*x0 + 0.0960*np.sin(0.0484*self._t)
        dx1 = -0.1060*x0*x1 + 0.1587*x2 - 0.1367*x1
        dx2 = 0.0757*x0 - 0.0448*x2 + 0.0533*x3 - 0.0240*x1*x2
        dx3 = 0.0819*x1*x2 - 0.1132*x3 + 0.0487*x0
