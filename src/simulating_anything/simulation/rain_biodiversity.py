...
class RainBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0879*x1 - 0.0644*x0 + 0.1122*np.sin(0.0840*self._t)
        dx1 = -0.0269*x0*x1 + 0.0783*x2 - 0.0925*x1
        dx2 = 0.0771*x0 - 0.1031*x2 + 0.1168*x3 - 0.0236*x1*x2
        dx3 = 0.0711*x1*x2 - 0.0850*x3 + 0.0586*x0
