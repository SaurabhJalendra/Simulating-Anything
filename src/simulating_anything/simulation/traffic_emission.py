...
class TrafficEmissionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0659*x1 - 0.0829*x0 + 0.0899*np.sin(0.0801*self._t)
        dx1 = -0.0356*x0*x1 + 0.0383*x2 - 0.0874*x1
        dx2 = 0.0576*x0 - 0.0431*x2 + 0.0469*x3 - 0.0542*x1*x2
        dx3 = 0.0399*x1*x2 - 0.0759*x3 + 0.0411*x0
