...
class CoralLarvalSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1248*x1 - 0.1382*x0 + 0.1241*np.sin(0.0850*self._t)
        dx1 = -0.1365*x0*x1 + 0.1333*x2 - 0.1287*x1
        dx2 = 0.0425*x0 - 0.0328*x2 + 0.1143*x3 - 0.0271*x1*x2
        dx3 = 0.1121*x1*x2 - 0.0723*x3 + 0.1128*x0
