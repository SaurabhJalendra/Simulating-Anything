...
class MeadowCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0661*x1 - 0.1124*x0 + 0.0258*np.sin(0.0915*self._t)
        dx1 = -0.0508*x0*x1 + 0.0936*x2 - 0.0895*x1
        dx2 = 0.0558*x0 - 0.1147*x2 + 0.1007*x3 - 0.0386*x1*x2
        dx3 = 0.1143*x1*x2 - 0.1001*x3 + 0.0228*x0
