...
class PesticideSoilSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0614*x1 - 0.1070*x0 + 0.1119*np.sin(0.0472*self._t)
        dx1 = -0.0293*x0*x1 + 0.0293*x2 - 0.0757*x1
        dx2 = 0.1069*x0 - 0.0249*x2 + 0.0654*x3 - 0.0570*x1*x2
        dx3 = 0.0222*x1*x2 - 0.1017*x3 + 0.0719*x0
