...
class NaturalGasSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0401*x1 - 0.0725*x0 + 0.0490*np.sin(0.0220*self._t)
        dx1 = -0.0612*x0*x1 + 0.0779*x2 - 0.0669*x1
        dx2 = 0.1187*x0 - 0.0321*x2 + 0.0345*x3 - 0.1103*x1*x2
        dx3 = 0.0207*x1*x2 - 0.0978*x3 + 0.1026*x0
