...
class LakeAcidificationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1188*x1 - 0.1129*x0 + 0.1137*np.sin(0.0841*self._t)
        dx1 = -0.1544*x0*x1 + 0.0942*x2 - 0.1677*x1
        dx2 = 0.0989*x0 - 0.0586*x2 + 0.0743*x3 - 0.0806*x1*x2
        dx3 = 0.0321*x1*x2 - 0.1355*x3 + 0.1415*x0
