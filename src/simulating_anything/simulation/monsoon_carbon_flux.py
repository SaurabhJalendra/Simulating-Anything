...
class MonsoonCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0680*x1 - 0.1049*x0 + 0.1145*np.sin(0.1177*self._t)
        dx1 = -0.0231*x0*x1 + 0.1177*x2 - 0.0675*x1
        dx2 = 0.0652*x0 - 0.0934*x2 + 0.0210*x3 - 0.1181*x1*x2
        dx3 = 0.0586*x1*x2 - 0.1090*x3 + 0.0292*x0
