...
class PulmonaryFunctionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0956*x1 - 0.0497*x0 + 0.0922*np.sin(0.0736*self._t)
        dx1 = -0.0596*x0*x1 + 0.0671*x2 - 0.0675*x1
        dx2 = 0.0315*x0 - 0.1160*x2 + 0.0813*x3 - 0.0557*x1*x2
        dx3 = 0.0977*x1*x2 - 0.0461*x3 + 0.0381*x0
