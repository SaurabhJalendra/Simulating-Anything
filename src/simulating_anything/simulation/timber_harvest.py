...
class TimberHarvestSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0748*x1 - 0.0207*x0 + 0.1128*np.sin(0.0550*self._t)
        dx1 = -0.0786*x0*x1 + 0.0886*x2 - 0.0701*x1
        dx2 = 0.1188*x0 - 0.0253*x2 + 0.0290*x3 - 0.0476*x1*x2
        dx3 = 0.0454*x1*x2 - 0.0209*x3 + 0.0887*x0
