...
class IceCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0782*x1 - 0.0312*x0 + 0.1032*np.sin(0.0710*self._t)
        dx1 = -0.1123*x0*x1 + 0.0273*x2 - 0.0230*x1
        dx2 = 0.0813*x0 - 0.1154*x2 + 0.0583*x3 - 0.1133*x1*x2
        dx3 = 0.0915*x1*x2 - 0.0651*x3 + 0.0380*x0
