...
class LakeBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0278*x1 - 0.1151*x0 + 0.0740*np.sin(0.1128*self._t)
        dx1 = -0.0886*x0*x1 + 0.0767*x2 - 0.0272*x1
        dx2 = 0.0334*x0 - 0.1032*x2 + 0.0425*x3 - 0.0587*x1*x2
        dx3 = 0.1000*x1*x2 - 0.0235*x3 + 0.0283*x0
