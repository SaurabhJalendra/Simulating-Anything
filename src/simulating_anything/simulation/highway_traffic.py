...
class HighwayTrafficSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0744*x1 - 0.0923*x0 + 0.1165*np.sin(0.0766*self._t)
        dx1 = -0.0573*x0*x1 + 0.0411*x2 - 0.1190*x1
        dx2 = 0.0442*x0 - 0.0743*x2 + 0.0342*x3 - 0.0329*x1*x2
        dx3 = 0.0775*x1*x2 - 0.1175*x3 + 0.0712*x0
