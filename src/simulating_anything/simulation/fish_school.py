...
class FishSchoolSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0515*x1 - 0.0410*x0 + 0.0949*np.sin(0.0226*self._t)
        dx1 = -0.0953*x0*x1 + 0.1034*x2 - 0.0395*x1
        dx2 = 0.0446*x0 - 0.0263*x2 + 0.0416*x3 - 0.0822*x1*x2
        dx3 = 0.0642*x1*x2 - 0.0417*x3 + 0.0239*x0
