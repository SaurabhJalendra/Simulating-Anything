...
class MucusTransportSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0603*x1 - 0.0856*x0 + 0.0604*np.sin(0.0867*self._t)
        dx1 = -0.1118*x0*x1 + 0.0431*x2 - 0.0760*x1
        dx2 = 0.0915*x0 - 0.1145*x2 + 0.0322*x3 - 0.0356*x1*x2
        dx3 = 0.0321*x1*x2 - 0.0385*x3 + 0.0546*x0
