...
class IceCreamMeltingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0688*x1 - 0.0721*x0 + 0.0877*np.sin(0.0206*self._t)
        dx1 = -0.0394*x0*x1 + 0.0699*x2 - 0.0684*x1
        dx2 = 0.0274*x0 - 0.0663*x2 + 0.0673*x3 - 0.1166*x1*x2
        dx3 = 0.0837*x1*x2 - 0.0404*x3 + 0.1105*x0
