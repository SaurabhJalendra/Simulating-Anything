...
class DrinkingWaterQualitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0330*x1 - 0.0626*x0 + 0.0816*np.sin(0.1147*self._t)
        dx1 = -0.0954*x0*x1 + 0.0379*x2 - 0.0956*x1
        dx2 = 0.0329*x0 - 0.0954*x2 + 0.1098*x3 - 0.0364*x1*x2
        dx3 = 0.1049*x1*x2 - 0.0795*x3 + 0.0563*x0
