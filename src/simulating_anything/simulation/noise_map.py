...
class NoiseMapSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1099*x1 - 0.0463*x0 + 0.0354*np.sin(0.0686*self._t)
        dx1 = -0.0783*x0*x1 + 0.0361*x2 - 0.0392*x1
        dx2 = 0.1079*x0 - 0.1116*x2 + 0.0732*x3 - 0.0775*x1*x2
        dx3 = 0.0891*x1*x2 - 0.0415*x3 + 0.0843*x0
