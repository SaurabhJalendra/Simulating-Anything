...
class SunspotCycleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0574*x1 - 0.0634*x0 + 0.0659*np.sin(0.0888*self._t)
        dx1 = -0.0455*x0*x1 + 0.0856*x2 - 0.0383*x1
        dx2 = 0.0259*x0 - 0.0460*x2 + 0.0805*x3 - 0.1054*x1*x2
        dx3 = 0.0576*x1*x2 - 0.0644*x3 + 0.0910*x0
