...
class CoffeeExtractionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0243*x1 - 0.0392*x0 + 0.0908*np.sin(0.1617*self._t)
        dx1 = -0.1288*x0*x1 + 0.0702*x2 - 0.1535*x1
        dx2 = 0.0211*x0 - 0.1657*x2 + 0.0540*x3 - 0.1471*x1*x2
        dx3 = 0.1184*x1*x2 - 0.1591*x3 + 0.1055*x0
