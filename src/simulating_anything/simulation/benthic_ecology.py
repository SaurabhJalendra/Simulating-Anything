...
class BenthicEcologySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0252*x1 - 0.1027*x0 + 0.0657*np.sin(0.1019*self._t)
        dx1 = -0.0960*x0*x1 + 0.0262*x2 - 0.0286*x1
        dx2 = 0.0817*x0 - 0.0633*x2 + 0.1143*x3 - 0.0275*x1*x2
        dx3 = 0.0616*x1*x2 - 0.0384*x3 + 0.1104*x0
