...
class UrbanGardenSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0973*x1 - 0.0375*x0 + 0.0802*np.sin(0.0752*self._t)
        dx1 = -0.0666*x0*x1 + 0.1157*x2 - 0.0882*x1
        dx2 = 0.0651*x0 - 0.0573*x2 + 0.0331*x3 - 0.0706*x1*x2
        dx3 = 0.1165*x1*x2 - 0.0849*x3 + 0.0823*x0
