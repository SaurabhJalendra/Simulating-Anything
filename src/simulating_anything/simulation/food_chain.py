...
class FoodChainSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0616*x1 - 0.0616*x0 + 0.0648*np.sin(0.1024*self._t)
        dx1 = -0.0557*x0*x1 + 0.0561*x2 - 0.0757*x1
        dx2 = 0.0991*x0 - 0.0555*x2 + 0.0241*x3 - 0.0343*x1*x2
        dx3 = 0.0723*x1*x2 - 0.1167*x3 + 0.1059*x0
