...
class SaltmarshErosionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0802*x1 - 0.1165*x0 + 0.0519*np.sin(0.0787*self._t)
        dx1 = -0.0613*x0*x1 + 0.0254*x2 - 0.0333*x1
        dx2 = 0.0727*x0 - 0.0893*x2 + 0.1169*x3 - 0.0350*x1*x2
        dx3 = 0.0650*x1*x2 - 0.0793*x3 + 0.0984*x0
