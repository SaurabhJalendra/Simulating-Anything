...
class DigestiveSystemSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0340*x1 - 0.0762*x0 + 0.0815*np.sin(0.0969*self._t)
        dx1 = -0.0482*x0*x1 + 0.0861*x2 - 0.1011*x1
        dx2 = 0.0836*x0 - 0.0641*x2 + 0.1025*x3 - 0.0902*x1*x2
        dx3 = 0.0562*x1*x2 - 0.0567*x3 + 0.1008*x0
