...
class RapidTransitSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0838*x1 - 0.0576*x0 + 0.1147*np.sin(0.1183*self._t)
        dx1 = -0.0839*x0*x1 + 0.0586*x2 - 0.0419*x1
        dx2 = 0.0737*x0 - 0.1148*x2 + 0.0544*x3 - 0.0702*x1*x2
        dx3 = 0.0550*x1*x2 - 0.0959*x3 + 0.0571*x0
