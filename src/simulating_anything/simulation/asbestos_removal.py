...
class AsbestosRemovalSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0269*x1 - 0.0340*x0 + 0.0830*np.sin(0.0371*self._t)
        dx1 = -0.0871*x0*x1 + 0.1021*x2 - 0.0924*x1
        dx2 = 0.1009*x0 - 0.0320*x2 + 0.0329*x3 - 0.0761*x1*x2
        dx3 = 0.0939*x1*x2 - 0.0218*x3 + 0.0893*x0
