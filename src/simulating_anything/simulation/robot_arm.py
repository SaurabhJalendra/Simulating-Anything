...
class RobotArmSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0754*x1 - 0.0977*x0 + 0.0944*np.sin(0.1194*self._t)
        dx1 = -0.0523*x0*x1 + 0.0371*x2 - 0.0896*x1
        dx2 = 0.0711*x0 - 0.0959*x2 + 0.0642*x3 - 0.1150*x1*x2
        dx3 = 0.0910*x1*x2 - 0.0847*x3 + 0.1187*x0
