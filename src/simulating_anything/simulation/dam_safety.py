...
class DamSafetySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1196*x1 - 0.1188*x0 + 0.1186*np.sin(0.0415*self._t)
        dx1 = -0.0540*x0*x1 + 0.0306*x2 - 0.0739*x1
        dx2 = 0.0572*x0 - 0.0850*x2 + 0.0967*x3 - 0.0856*x1*x2
        dx3 = 0.0952*x1*x2 - 0.0320*x3 + 0.0466*x0
