...
class GreenRoofSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0395*x1 - 0.0859*x0 + 0.1171*np.sin(0.0238*self._t)
        dx1 = -0.1166*x0*x1 + 0.0541*x2 - 0.0261*x1
        dx2 = 0.0376*x0 - 0.1016*x2 + 0.0340*x3 - 0.1116*x1*x2
        dx3 = 0.0355*x1*x2 - 0.0732*x3 + 0.1011*x0
