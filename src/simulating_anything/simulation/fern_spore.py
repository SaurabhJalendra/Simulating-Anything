...
class FernSporeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0658*x1 - 0.1164*x0 + 0.0896*np.sin(0.1540*self._t)
        dx1 = -0.0587*x0*x1 + 0.1223*x2 - 0.0712*x1
        dx2 = 0.1460*x0 - 0.0299*x2 + 0.0323*x3 - 0.1355*x1*x2
        dx3 = 0.0990*x1*x2 - 0.0616*x3 + 0.0682*x0
