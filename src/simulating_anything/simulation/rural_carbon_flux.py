...
class RuralCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0704*x1 - 0.0753*x0 + 0.0535*np.sin(0.1109*self._t)
        dx1 = -0.0946*x0*x1 + 0.1170*x2 - 0.1180*x1
        dx2 = 0.0720*x0 - 0.0967*x2 + 0.1173*x3 - 0.1042*x1*x2
        dx3 = 0.1126*x1*x2 - 0.1168*x3 + 0.0374*x0
