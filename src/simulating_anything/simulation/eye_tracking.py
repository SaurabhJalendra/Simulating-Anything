...
class EyeTrackingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0879*x1 - 0.0626*x0 + 0.0425*np.sin(0.0387*self._t)
        dx1 = -0.0212*x0*x1 + 0.1006*x2 - 0.1196*x1
        dx2 = 0.0527*x0 - 0.0601*x2 + 0.0613*x3 - 0.0658*x1*x2
        dx3 = 0.0503*x1*x2 - 0.0929*x3 + 0.0981*x0
