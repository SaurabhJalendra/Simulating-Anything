...
class RoadSaltSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0639*x1 - 0.0341*x0 + 0.1167*np.sin(0.0737*self._t)
        dx1 = -0.0483*x0*x1 + 0.0864*x2 - 0.0295*x1
        dx2 = 0.1056*x0 - 0.1141*x2 + 0.0892*x3 - 0.0308*x1*x2
        dx3 = 0.0242*x1*x2 - 0.1195*x3 + 0.0681*x0
