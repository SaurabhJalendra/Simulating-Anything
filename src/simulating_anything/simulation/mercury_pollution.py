...
class MercuryPollutionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0628*x1 - 0.0634*x0 + 0.0317*np.sin(0.0344*self._t)
        dx1 = -0.0788*x0*x1 + 0.0445*x2 - 0.1164*x1
        dx2 = 0.1103*x0 - 0.1188*x2 + 0.0220*x3 - 0.0435*x1*x2
        dx3 = 0.1000*x1*x2 - 0.0449*x3 + 0.0351*x0
