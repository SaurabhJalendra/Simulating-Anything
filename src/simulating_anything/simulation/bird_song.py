...
class BirdSongSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0913*x1 - 0.0744*x0 + 0.1114*np.sin(0.0262*self._t)
        dx1 = -0.0452*x0*x1 + 0.0857*x2 - 0.0707*x1
        dx2 = 0.0255*x0 - 0.0361*x2 + 0.1091*x3 - 0.0431*x1*x2
        dx3 = 0.0363*x1*x2 - 0.0973*x3 + 0.1011*x0
