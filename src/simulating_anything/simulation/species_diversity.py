...
class SpeciesDiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0499*x1 - 0.0819*x0 + 0.0515*np.sin(0.0262*self._t)
        dx1 = -0.0982*x0*x1 + 0.1115*x2 - 0.0523*x1
        dx2 = 0.0742*x0 - 0.0605*x2 + 0.0460*x3 - 0.0986*x1*x2
        dx3 = 0.1199*x1*x2 - 0.0734*x3 + 0.1112*x0
