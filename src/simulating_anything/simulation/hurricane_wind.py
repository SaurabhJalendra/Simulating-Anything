...
class HurricaneWindSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0971*x1 - 0.0365*x0 + 0.0338*np.sin(0.0627*self._t)
        dx1 = -0.0894*x0*x1 + 0.0607*x2 - 0.1075*x1
        dx2 = 0.0917*x0 - 0.0619*x2 + 0.0814*x3 - 0.0682*x1*x2
        dx3 = 0.0203*x1*x2 - 0.1059*x3 + 0.0406*x0
