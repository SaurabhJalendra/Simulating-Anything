...
class OzoneRecoverySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0767*x1 - 0.0908*x0 + 0.1145*np.sin(0.0650*self._t)
        dx1 = -0.0714*x0*x1 + 0.0978*x2 - 0.0764*x1
        dx2 = 0.1092*x0 - 0.0314*x2 + 0.1125*x3 - 0.0827*x1*x2
        dx3 = 0.0559*x1*x2 - 0.0745*x3 + 0.0725*x0
