...
class OceanBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0341*x1 - 0.0705*x0 + 0.0835*np.sin(0.0462*self._t)
        dx1 = -0.0453*x0*x1 + 0.0555*x2 - 0.1020*x1
        dx2 = 0.0748*x0 - 0.0617*x2 + 0.0706*x3 - 0.0397*x1*x2
        dx3 = 0.0794*x1*x2 - 0.0611*x3 + 0.0838*x0
