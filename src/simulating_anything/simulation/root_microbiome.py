...
class RootMicrobiomeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0239*x1 - 0.0739*x0 + 0.0670*np.sin(0.0896*self._t)
        dx1 = -0.0227*x0*x1 + 0.0704*x2 - 0.1180*x1
        dx2 = 0.0480*x0 - 0.0216*x2 + 0.1117*x3 - 0.1194*x1*x2
        dx3 = 0.0884*x1*x2 - 0.0252*x3 + 0.0565*x0
