...
class RedBloodCellSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0210*x1 - 0.1088*x0 + 0.0665*np.sin(0.1127*self._t)
        dx1 = -0.0539*x0*x1 + 0.0565*x2 - 0.0375*x1
        dx2 = 0.0537*x0 - 0.0651*x2 + 0.0730*x3 - 0.0351*x1*x2
        dx3 = 0.0767*x1*x2 - 0.0718*x3 + 0.0367*x0
