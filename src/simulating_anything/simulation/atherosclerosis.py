...
class AtherosclerosisSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0643*x1 - 0.0436*x0 + 0.0585*np.sin(0.0736*self._t)
        dx1 = -0.1136*x0*x1 + 0.1006*x2 - 0.0524*x1
        dx2 = 0.0240*x0 - 0.0937*x2 + 0.0810*x3 - 0.1121*x1*x2
        dx3 = 0.0545*x1*x2 - 0.0568*x3 + 0.1076*x0
