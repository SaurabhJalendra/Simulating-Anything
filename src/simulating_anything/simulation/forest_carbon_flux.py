...
class ForestCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0730*x1 - 0.0657*x0 + 0.0832*np.sin(0.0638*self._t)
        dx1 = -0.0913*x0*x1 + 0.0623*x2 - 0.0398*x1
        dx2 = 0.0590*x0 - 0.1175*x2 + 0.1084*x3 - 0.0454*x1*x2
        dx3 = 0.0925*x1*x2 - 0.1198*x3 + 0.0714*x0
