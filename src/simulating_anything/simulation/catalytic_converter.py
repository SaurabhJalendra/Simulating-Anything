...
class CatalyticConverterSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0302*x1 - 0.1147*x0 + 0.0413*np.sin(0.0892*self._t)
        dx1 = -0.0612*x0*x1 + 0.0650*x2 - 0.0859*x1
        dx2 = 0.0878*x0 - 0.0922*x2 + 0.0818*x3 - 0.0280*x1*x2
        dx3 = 0.1084*x1*x2 - 0.1021*x3 + 0.0466*x0
