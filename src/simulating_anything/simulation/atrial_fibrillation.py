...
class AtrialFibrillationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0669*x1 - 0.0750*x0 + 0.0805*np.sin(0.0923*self._t)
        dx1 = -0.0596*x0*x1 + 0.0886*x2 - 0.0312*x1
        dx2 = 0.0969*x0 - 0.0955*x2 + 0.1091*x3 - 0.0654*x1*x2
        dx3 = 0.1108*x1*x2 - 0.0523*x3 + 0.1163*x0
