...
class EbolaOutbreakSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0903*x1 - 0.0469*x0 + 0.0437*np.sin(0.0958*self._t)
        dx1 = -0.1070*x0*x1 + 0.0322*x2 - 0.0975*x1
        dx2 = 0.0524*x0 - 0.0228*x2 + 0.0563*x3 - 0.0569*x1*x2
        dx3 = 0.0237*x1*x2 - 0.0782*x3 + 0.0431*x0
