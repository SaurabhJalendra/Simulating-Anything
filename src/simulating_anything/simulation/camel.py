...
class CamelSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0804*x1 - 0.0880*x0 + 0.0437*np.sin(0.0826*self._t)
        dx1 = -0.0865*x0*x1 + 0.0267*x2 - 0.0291*x1
        dx2 = 0.0781*x0 - 0.0217*x2 + 0.0845*x3 - 0.1015*x1*x2
        dx3 = 0.0853*x1*x2 - 0.0850*x3 + 0.0989*x0
