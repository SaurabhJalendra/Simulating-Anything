...
class MothFlameSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0723*x1 - 0.0431*x0 + 0.1036*np.sin(0.1225*self._t)
        dx1 = -0.0806*x0*x1 + 0.1442*x2 - 0.1472*x1
        dx2 = 0.0912*x0 - 0.1257*x2 + 0.1205*x3 - 0.1694*x1*x2
        dx3 = 0.1012*x1*x2 - 0.0748*x3 + 0.1326*x0
