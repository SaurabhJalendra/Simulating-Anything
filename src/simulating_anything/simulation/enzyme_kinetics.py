...
class EnzymeKineticsSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0357*x1 - 0.0891*x0 + 0.1179*np.sin(0.0908*self._t)
        dx1 = -0.0220*x0*x1 + 0.0356*x2 - 0.0353*x1
        dx2 = 0.0791*x0 - 0.0255*x2 + 0.0649*x3 - 0.0455*x1*x2
        dx3 = 0.1112*x1*x2 - 0.0443*x3 + 0.0885*x0
