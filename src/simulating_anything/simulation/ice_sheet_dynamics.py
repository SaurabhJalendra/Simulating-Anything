...
class IceSheetDynamicsSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0546*x1 - 0.1015*x0 + 0.1156*np.sin(0.0633*self._t)
        dx1 = -0.0309*x0*x1 + 0.0736*x2 - 0.0540*x1
        dx2 = 0.0273*x0 - 0.0377*x2 + 0.0558*x3 - 0.0991*x1*x2
        dx3 = 0.0512*x1*x2 - 0.0524*x3 + 0.1089*x0
