...
class ColdChainSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0642*x1 - 0.0810*x0 + 0.0417*np.sin(0.0350*self._t)
        dx1 = -0.0725*x0*x1 + 0.1155*x2 - 0.0421*x1
        dx2 = 0.0421*x0 - 0.0225*x2 + 0.0397*x3 - 0.0616*x1*x2
        dx3 = 0.0300*x1*x2 - 0.0214*x3 + 0.0870*x0
