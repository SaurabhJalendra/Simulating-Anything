...
class CoolingTowerSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0225*x1 - 0.0977*x0 + 0.1003*np.sin(0.0270*self._t)
        dx1 = -0.0353*x0*x1 + 0.0753*x2 - 0.0458*x1
        dx2 = 0.0824*x0 - 0.0607*x2 + 0.0340*x3 - 0.0220*x1*x2
        dx3 = 0.1072*x1*x2 - 0.0782*x3 + 0.0695*x0
