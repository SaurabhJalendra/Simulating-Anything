...
class BatteryRecyclingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0933*x1 - 0.0581*x0 + 0.0562*np.sin(0.0453*self._t)
        dx1 = -0.0557*x0*x1 + 0.0553*x2 - 0.0591*x1
        dx2 = 0.1133*x0 - 0.0223*x2 + 0.0276*x3 - 0.1145*x1*x2
        dx3 = 0.0794*x1*x2 - 0.1132*x3 + 0.0756*x0
