...
class RenewableGridSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1107*x1 - 0.0359*x0 + 0.0320*np.sin(0.0317*self._t)
        dx1 = -0.0793*x0*x1 + 0.0264*x2 - 0.1181*x1
        dx2 = 0.1167*x0 - 0.0622*x2 + 0.1131*x3 - 0.0227*x1*x2
        dx3 = 0.1156*x1*x2 - 0.0640*x3 + 0.1006*x0
