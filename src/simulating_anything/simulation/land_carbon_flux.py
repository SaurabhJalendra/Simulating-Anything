...
class LandCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0644*x1 - 0.0996*x0 + 0.0800*np.sin(0.0297*self._t)
        dx1 = -0.0783*x0*x1 + 0.1081*x2 - 0.1197*x1
        dx2 = 0.0300*x0 - 0.0490*x2 + 0.0281*x3 - 0.0650*x1*x2
        dx3 = 0.0272*x1*x2 - 0.0849*x3 + 0.0301*x0
