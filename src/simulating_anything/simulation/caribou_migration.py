...
class CaribouMigrationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0385*x1 - 0.1002*x0 + 0.0400*np.sin(0.1048*self._t)
        dx1 = -0.0992*x0*x1 + 0.0392*x2 - 0.0444*x1
        dx2 = 0.0478*x0 - 0.0463*x2 + 0.0667*x3 - 0.1056*x1*x2
        dx3 = 0.1192*x1*x2 - 0.0745*x3 + 0.0617*x0
