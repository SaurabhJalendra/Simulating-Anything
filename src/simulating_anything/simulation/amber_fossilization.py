...
class AmberFossilizationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1120*x1 - 0.0251*x0 + 0.1553*np.sin(0.0629*self._t)
        dx1 = -0.1146*x0*x1 + 0.0429*x2 - 0.1591*x1
        dx2 = 0.1143*x0 - 0.1509*x2 + 0.0233*x3 - 0.0989*x1*x2
        dx3 = 0.0650*x1*x2 - 0.1689*x3 + 0.0510*x0
