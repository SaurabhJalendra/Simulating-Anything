...
class BoundaryLayerSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0945*x1 - 0.0594*x0 + 0.0962*np.sin(0.0509*self._t)
        dx1 = -0.0227*x0*x1 + 0.0821*x2 - 0.1108*x1
        dx2 = 0.0856*x0 - 0.0278*x2 + 0.0954*x3 - 0.1067*x1*x2
        dx3 = 0.0224*x1*x2 - 0.0747*x3 + 0.1070*x0
