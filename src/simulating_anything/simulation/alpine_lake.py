...
class AlpineLakeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1151*x1 - 0.0631*x0 + 0.0677*np.sin(0.0921*self._t)
        dx1 = -0.0994*x0*x1 + 0.0896*x2 - 0.0970*x1
        dx2 = 0.1067*x0 - 0.0372*x2 + 0.0989*x3 - 0.0402*x1*x2
        dx3 = 0.0491*x1*x2 - 0.0290*x3 + 0.0247*x0
