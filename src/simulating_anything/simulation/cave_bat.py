...
class CaveBatSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0346*x1 - 0.0449*x0 + 0.1156*np.sin(0.0633*self._t)
        dx1 = -0.0938*x0*x1 + 0.0659*x2 - 0.0725*x1
        dx2 = 0.0694*x0 - 0.0332*x2 + 0.0495*x3 - 0.1025*x1*x2
        dx3 = 0.1008*x1*x2 - 0.0662*x3 + 0.1108*x0
