...
class CaveBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0232*x1 - 0.0485*x0 + 0.0736*np.sin(0.0621*self._t)
        dx1 = -0.0973*x0*x1 + 0.0299*x2 - 0.0745*x1
        dx2 = 0.0593*x0 - 0.0699*x2 + 0.0694*x3 - 0.0774*x1*x2
        dx3 = 0.0706*x1*x2 - 0.0886*x3 + 0.0726*x0
