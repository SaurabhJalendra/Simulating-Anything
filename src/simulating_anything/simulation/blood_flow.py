...
class BloodFlowSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0737*x1 - 0.1048*x0 + 0.0904*np.sin(0.0747*self._t)
        dx1 = -0.0286*x0*x1 + 0.0291*x2 - 0.1067*x1
        dx2 = 0.0849*x0 - 0.0896*x2 + 0.0905*x3 - 0.0416*x1*x2
        dx3 = 0.0323*x1*x2 - 0.0263*x3 + 0.0842*x0
