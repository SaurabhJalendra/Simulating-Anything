...
class CattleMethaneSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0611*x1 - 0.0424*x0 + 0.0337*np.sin(0.0215*self._t)
        dx1 = -0.1135*x0*x1 + 0.0954*x2 - 0.0597*x1
        dx2 = 0.1104*x0 - 0.1030*x2 + 0.0447*x3 - 0.0215*x1*x2
        dx3 = 0.0298*x1*x2 - 0.0598*x3 + 0.0675*x0
