...
class ThermalStratificationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0995*x1 - 0.0507*x0 + 0.0454*np.sin(0.0463*self._t)
        dx1 = -0.0510*x0*x1 + 0.0258*x2 - 0.0784*x1
        dx2 = 0.0280*x0 - 0.1011*x2 + 0.0648*x3 - 0.0783*x1*x2
        dx3 = 0.0941*x1*x2 - 0.0611*x3 + 0.0299*x0
