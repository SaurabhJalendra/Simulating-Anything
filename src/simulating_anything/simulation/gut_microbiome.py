...
class GutMicrobiomeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0777*x1 - 0.1182*x0 + 0.0458*np.sin(0.0907*self._t)
        dx1 = -0.0394*x0*x1 + 0.0727*x2 - 0.0452*x1
        dx2 = 0.0941*x0 - 0.0576*x2 + 0.0982*x3 - 0.1196*x1*x2
        dx3 = 0.0524*x1*x2 - 0.0503*x3 + 0.0833*x0
