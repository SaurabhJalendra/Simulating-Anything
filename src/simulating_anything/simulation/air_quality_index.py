...
class AirQualityIndexSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0358*x1 - 0.0455*x0 + 0.0911*np.sin(0.0560*self._t)
        dx1 = -0.0242*x0*x1 + 0.0419*x2 - 0.0491*x1
        dx2 = 0.0739*x0 - 0.1032*x2 + 0.0329*x3 - 0.0998*x1*x2
        dx3 = 0.0574*x1*x2 - 0.0814*x3 + 0.0585*x0
