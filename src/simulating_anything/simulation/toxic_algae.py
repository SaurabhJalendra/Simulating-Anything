...
class ToxicAlgaeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0605*x1 - 0.0424*x0 + 0.0434*np.sin(0.0609*self._t)
        dx1 = -0.0916*x0*x1 + 0.1089*x2 - 0.0647*x1
        dx2 = 0.0587*x0 - 0.0358*x2 + 0.0403*x3 - 0.0440*x1*x2
        dx3 = 0.0377*x1*x2 - 0.1051*x3 + 0.0787*x0
