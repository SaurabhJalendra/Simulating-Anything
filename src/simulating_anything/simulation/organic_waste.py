...
class OrganicWasteSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0711*x1 - 0.0645*x0 + 0.1161*np.sin(0.0527*self._t)
        dx1 = -0.0285*x0*x1 + 0.0944*x2 - 0.0579*x1
        dx2 = 0.0785*x0 - 0.0681*x2 + 0.0898*x3 - 0.0719*x1*x2
        dx3 = 0.0399*x1*x2 - 0.0236*x3 + 0.1067*x0
