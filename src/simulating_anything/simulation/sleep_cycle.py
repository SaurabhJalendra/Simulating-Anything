...
class SleepCycleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0749*x1 - 0.0931*x0 + 0.0300*np.sin(0.1127*self._t)
        dx1 = -0.0738*x0*x1 + 0.0976*x2 - 0.0728*x1
        dx2 = 0.0893*x0 - 0.1037*x2 + 0.0327*x3 - 0.0706*x1*x2
        dx3 = 0.0652*x1*x2 - 0.0732*x3 + 0.0229*x0
