...
class RubberDegradationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0956*x1 - 0.0736*x0 + 0.0627*np.sin(0.1133*self._t)
        dx1 = -0.0262*x0*x1 + 0.1108*x2 - 0.0536*x1
        dx2 = 0.1066*x0 - 0.0617*x2 + 0.0634*x3 - 0.0615*x1*x2
        dx3 = 0.0282*x1*x2 - 0.0696*x3 + 0.0356*x0
