...
class BambooForestSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1175*x1 - 0.0909*x0 + 0.0296*np.sin(0.0992*self._t)
        dx1 = -0.0912*x0*x1 + 0.0314*x2 - 0.1147*x1
        dx2 = 0.0652*x0 - 0.0381*x2 + 0.0279*x3 - 0.1126*x1*x2
        dx3 = 0.0455*x1*x2 - 0.0518*x3 + 0.0658*x0
