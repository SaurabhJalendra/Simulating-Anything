...
class NitrogenDepositionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0724*x1 - 0.1012*x0 + 0.1057*np.sin(0.0360*self._t)
        dx1 = -0.0422*x0*x1 + 0.0430*x2 - 0.1169*x1
        dx2 = 0.0304*x0 - 0.1003*x2 + 0.0305*x3 - 0.0664*x1*x2
        dx3 = 0.1041*x1*x2 - 0.0423*x3 + 0.0399*x0
