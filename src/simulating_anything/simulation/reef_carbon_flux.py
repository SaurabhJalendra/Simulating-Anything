...
class ReefCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0700*x1 - 0.0759*x0 + 0.1143*np.sin(0.0267*self._t)
        dx1 = -0.0353*x0*x1 + 0.0262*x2 - 0.0220*x1
        dx2 = 0.0569*x0 - 0.1103*x2 + 0.0810*x3 - 0.0953*x1*x2
        dx3 = 0.0830*x1*x2 - 0.0744*x3 + 0.0464*x0
