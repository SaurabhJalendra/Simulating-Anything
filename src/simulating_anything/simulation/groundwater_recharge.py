...
class GroundwaterRechargeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0367*x1 - 0.0577*x0 + 0.0960*np.sin(0.0424*self._t)
        dx1 = -0.0374*x0*x1 + 0.0589*x2 - 0.0827*x1
        dx2 = 0.0405*x0 - 0.1185*x2 + 0.0920*x3 - 0.0551*x1*x2
        dx3 = 0.0672*x1*x2 - 0.0291*x3 + 0.0883*x0
