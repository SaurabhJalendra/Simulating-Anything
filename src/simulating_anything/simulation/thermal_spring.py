...
class ThermalSpringSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0435*x1 - 0.0643*x0 + 0.1538*np.sin(0.1172*self._t)
        dx1 = -0.077*x0*x1 + 0.1352*x2 - 0.1515*x1
        dx2 = 0.0628*x0 - 0.022*x2 + 0.0218*x3 - 0.0759*x1*x2
        dx3 = 0.1299*x1*x2 - 0.0403*x3 + 0.1609*x0
