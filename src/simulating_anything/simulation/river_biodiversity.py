...
class RiverBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0940*x1 - 0.0644*x0 + 0.0983*np.sin(0.0925*self._t)
        dx1 = -0.0306*x0*x1 + 0.1033*x2 - 0.0965*x1
        dx2 = 0.1066*x0 - 0.1029*x2 + 0.0910*x3 - 0.0740*x1*x2
        dx3 = 0.0595*x1*x2 - 0.0807*x3 + 0.0583*x0
