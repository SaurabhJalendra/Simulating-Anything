...
class ThermalBatterySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0282*x1 - 0.0524*x0 + 0.0744*np.sin(0.1052*self._t)
        dx1 = -0.1012*x0*x1 + 0.0874*x2 - 0.1055*x1
        dx2 = 0.0526*x0 - 0.0891*x2 + 0.0416*x3 - 0.0663*x1*x2
        dx3 = 0.0331*x1*x2 - 0.0391*x3 + 0.0256*x0
