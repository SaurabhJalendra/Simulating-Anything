...
class WetlandSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0742*x1 - 0.0925*x0 + 0.0852*np.sin(0.0895*self._t)
        dx1 = -0.0867*x0*x1 + 0.0451*x2 - 0.0232*x1
        dx2 = 0.0439*x0 - 0.0686*x2 + 0.0709*x3 - 0.0683*x1*x2
        dx3 = 0.1137*x1*x2 - 0.0914*x3 + 0.0675*x0
