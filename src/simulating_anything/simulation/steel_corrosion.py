...
class SteelCorrosionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0679*x1 - 0.1181*x0 + 0.0767*np.sin(0.0554*self._t)
        dx1 = -0.1072*x0*x1 + 0.0684*x2 - 0.0598*x1
        dx2 = 0.1094*x0 - 0.0601*x2 + 0.1012*x3 - 0.0738*x1*x2
        dx3 = 0.1053*x1*x2 - 0.0829*x3 + 0.0759*x0
