...
class PacemakerSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1172*x1 - 0.0872*x0 + 0.0528*np.sin(0.0667*self._t)
        dx1 = -0.0848*x0*x1 + 0.0853*x2 - 0.0455*x1
        dx2 = 0.0558*x0 - 0.1031*x2 + 0.1103*x3 - 0.0486*x1*x2
        dx3 = 0.1050*x1*x2 - 0.1144*x3 + 0.0586*x0
