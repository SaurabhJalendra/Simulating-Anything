...
class GeneticDriftSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0895*x1 - 0.0807*x0 + 0.0662*np.sin(0.0346*self._t)
        dx1 = -0.1151*x0*x1 + 0.0859*x2 - 0.0980*x1
        dx2 = 0.0297*x0 - 0.0613*x2 + 0.0322*x3 - 0.0790*x1*x2
        dx3 = 0.0845*x1*x2 - 0.0489*x3 + 0.0676*x0
