...
class BioacousticsSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0608*x1 - 0.0748*x0 + 0.1197*np.sin(0.0920*self._t)
        dx1 = -0.0438*x0*x1 + 0.0781*x2 - 0.0607*x1
        dx2 = 0.0479*x0 - 0.0654*x2 + 0.0593*x3 - 0.0392*x1*x2
        dx3 = 0.0568*x1*x2 - 0.0807*x3 + 0.0971*x0
