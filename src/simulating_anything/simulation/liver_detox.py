...
class LiverDetoxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0881*x1 - 0.0762*x0 + 0.1127*np.sin(0.0541*self._t)
        dx1 = -0.0201*x0*x1 + 0.0844*x2 - 0.0979*x1
        dx2 = 0.0873*x0 - 0.0395*x2 + 0.0949*x3 - 0.0879*x1*x2
        dx3 = 0.1170*x1*x2 - 0.0334*x3 + 0.0525*x0
