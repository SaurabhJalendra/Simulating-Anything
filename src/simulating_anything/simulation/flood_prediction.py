...
class FloodPredictionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0772*x1 - 0.0672*x0 + 0.0892*np.sin(0.0623*self._t)
        dx1 = -0.0366*x0*x1 + 0.1120*x2 - 0.0604*x1
        dx2 = 0.0645*x0 - 0.0440*x2 + 0.0874*x3 - 0.0585*x1*x2
        dx3 = 0.0835*x1*x2 - 0.0779*x3 + 0.0685*x0
