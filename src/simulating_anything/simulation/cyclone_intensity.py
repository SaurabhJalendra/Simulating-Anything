...
class CycloneIntensitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0306*x1 - 0.0250*x0 + 0.1032*np.sin(0.1003*self._t)
        dx1 = -0.0908*x0*x1 + 0.1050*x2 - 0.0357*x1
        dx2 = 0.0233*x0 - 0.0824*x2 + 0.0813*x3 - 0.0255*x1*x2
        dx3 = 0.0442*x1*x2 - 0.0606*x3 + 0.0920*x0
