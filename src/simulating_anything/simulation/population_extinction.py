...
class PopulationExtinctionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0747*x1 - 0.0274*x0 + 0.0499*np.sin(0.0508*self._t)
        dx1 = -0.0675*x0*x1 + 0.0453*x2 - 0.0557*x1
        dx2 = 0.1003*x0 - 0.1075*x2 + 0.0979*x3 - 0.1168*x1*x2
        dx3 = 0.0667*x1*x2 - 0.1120*x3 + 0.0903*x0
