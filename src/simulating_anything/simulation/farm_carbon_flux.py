...
class FarmCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0474*x1 - 0.0431*x0 + 0.1145*np.sin(0.0965*self._t)
        dx1 = -0.0924*x0*x1 + 0.0358*x2 - 0.0820*x1
        dx2 = 0.1141*x0 - 0.0480*x2 + 0.0763*x3 - 0.0480*x1*x2
        dx3 = 0.0855*x1*x2 - 0.0712*x3 + 0.0734*x0
