...
class LagoonEcologySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0688*x1 - 0.1076*x0 + 0.0239*np.sin(0.0935*self._t)
        dx1 = -0.0636*x0*x1 + 0.0733*x2 - 0.0297*x1
        dx2 = 0.0635*x0 - 0.1094*x2 + 0.0777*x3 - 0.0820*x1*x2
        dx3 = 0.0581*x1*x2 - 0.1061*x3 + 0.0499*x0
