...
class ArsenicGroundwaterSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0676*x1 - 0.0692*x0 + 0.0706*np.sin(0.1081*self._t)
        dx1 = -0.0472*x0*x1 + 0.0933*x2 - 0.1060*x1
        dx2 = 0.0633*x0 - 0.0754*x2 + 0.0630*x3 - 0.0362*x1*x2
        dx3 = 0.1139*x1*x2 - 0.0746*x3 + 0.1101*x0
