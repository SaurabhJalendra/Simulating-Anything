...
class PregnancyNutritionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1067*x1 - 0.1051*x0 + 0.0876*np.sin(0.0449*self._t)
        dx1 = -0.1012*x0*x1 + 0.0974*x2 - 0.0986*x1
        dx2 = 0.0617*x0 - 0.0718*x2 + 0.0755*x3 - 0.1145*x1*x2
        dx3 = 0.1093*x1*x2 - 0.0735*x3 + 0.0503*x0
