...
class MeadowBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0755*x1 - 0.0437*x0 + 0.0381*np.sin(0.0460*self._t)
        dx1 = -0.0508*x0*x1 + 0.0812*x2 - 0.0261*x1
        dx2 = 0.0949*x0 - 0.1063*x2 + 0.0812*x3 - 0.0470*x1*x2
        dx3 = 0.0877*x1*x2 - 0.0745*x3 + 0.1003*x0
