...
class BiomassEnergySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0787*x1 - 0.1145*x0 + 0.0362*np.sin(0.1129*self._t)
        dx1 = -0.0840*x0*x1 + 0.0556*x2 - 0.1065*x1
        dx2 = 0.0797*x0 - 0.1235*x2 + 0.0666*x3 - 0.0347*x1*x2
        dx3 = 0.0876*x1*x2 - 0.0758*x3 + 0.1268*x0
