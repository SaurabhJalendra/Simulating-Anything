...
class WildfireSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0720*x1 - 0.0746*x0 + 0.0333*np.sin(0.0706*self._t)
        dx1 = -0.0247*x0*x1 + 0.0901*x2 - 0.1120*x1
        dx2 = 0.1034*x0 - 0.0473*x2 + 0.0639*x3 - 0.0901*x1*x2
        dx3 = 0.0668*x1*x2 - 0.0677*x3 + 0.0500*x0
