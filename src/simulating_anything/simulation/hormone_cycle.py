...
class HormoneCycleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0837*x1 - 0.1092*x0 + 0.0683*np.sin(0.1001*self._t)
        dx1 = -0.0238*x0*x1 + 0.1171*x2 - 0.0774*x1
        dx2 = 0.0738*x0 - 0.0965*x2 + 0.0926*x3 - 0.0800*x1*x2
        dx3 = 0.0751*x1*x2 - 0.1011*x3 + 0.0963*x0
