...
class RiverFloodingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1163*x1 - 0.1544*x0 + 0.0343*np.sin(0.0595*self._t)
        dx1 = -0.1658*x0*x1 + 0.0472*x2 - 0.1243*x1
        dx2 = 0.1499*x0 - 0.1661*x2 + 0.0327*x3 - 0.1283*x1*x2
        dx3 = 0.1634*x1*x2 - 0.1666*x3 + 0.1002*x0
