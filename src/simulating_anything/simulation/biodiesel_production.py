...
class BiodieselProductionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0315*x1 - 0.0790*x0 + 0.0547*np.sin(0.0884*self._t)
        dx1 = -0.0555*x0*x1 + 0.0849*x2 - 0.0311*x1
        dx2 = 0.0307*x0 - 0.0427*x2 + 0.0435*x3 - 0.0252*x1*x2
        dx3 = 0.1118*x1*x2 - 0.0838*x3 + 0.0619*x0
