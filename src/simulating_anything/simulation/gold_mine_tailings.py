...
class GoldMineTailingsSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1031*x1 - 0.0593*x0 + 0.0226*np.sin(0.0423*self._t)
        dx1 = -0.0476*x0*x1 + 0.0662*x2 - 0.0708*x1
        dx2 = 0.1075*x0 - 0.0663*x2 + 0.0952*x3 - 0.0561*x1*x2
        dx3 = 0.0998*x1*x2 - 0.0900*x3 + 0.0709*x0
