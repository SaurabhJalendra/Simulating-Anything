...
class DroughtSeveritySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1112*x1 - 0.0931*x0 + 0.1198*np.sin(0.0531*self._t)
        dx1 = -0.0351*x0*x1 + 0.1151*x2 - 0.0405*x1
        dx2 = 0.0441*x0 - 0.0713*x2 + 0.0550*x3 - 0.0598*x1*x2
        dx3 = 0.1028*x1*x2 - 0.0370*x3 + 0.1169*x0
