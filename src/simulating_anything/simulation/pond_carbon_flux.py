...
class PondCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1049*x1 - 0.0443*x0 + 0.0368*np.sin(0.0999*self._t)
        dx1 = -0.0622*x0*x1 + 0.0494*x2 - 0.0871*x1
        dx2 = 0.0758*x0 - 0.0546*x2 + 0.0667*x3 - 0.1141*x1*x2
        dx3 = 0.0620*x1*x2 - 0.0788*x3 + 0.0718*x0
