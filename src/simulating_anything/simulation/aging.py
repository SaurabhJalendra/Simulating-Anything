...
class AgingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0436*x1 - 0.0429*x0 + 0.0651*np.sin(0.0768*self._t)
        dx1 = -0.0910*x0*x1 + 0.1186*x2 - 0.0685*x1
        dx2 = 0.0465*x0 - 0.0506*x2 + 0.0743*x3 - 0.0800*x1*x2
        dx3 = 0.0345*x1*x2 - 0.0591*x3 + 0.0276*x0
