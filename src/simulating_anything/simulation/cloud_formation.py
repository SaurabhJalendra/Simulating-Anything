...
class CloudFormationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0603*x1 - 0.0387*x0 + 0.0458*np.sin(0.0207*self._t)
        dx1 = -0.0246*x0*x1 + 0.0454*x2 - 0.0455*x1
        dx2 = 0.0278*x0 - 0.1062*x2 + 0.1090*x3 - 0.0960*x1*x2
        dx3 = 0.1094*x1*x2 - 0.0506*x3 + 0.1324*x0
