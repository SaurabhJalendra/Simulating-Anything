...
class OysterReefSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1164*x1 - 0.1173*x0 + 0.1394*np.sin(0.0997*self._t)
        dx1 = -0.0804*x0*x1 + 0.0656*x2 - 0.0856*x1
        dx2 = 0.1194*x0 - 0.1371*x2 + 0.1435*x3 - 0.0319*x1*x2
        dx3 = 0.1151*x1*x2 - 0.0294*x3 + 0.1304*x0
