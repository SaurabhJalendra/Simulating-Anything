...
class AllergySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0830*x1 - 0.0835*x0 + 0.0926*np.sin(0.1193*self._t)
        dx1 = -0.0713*x0*x1 + 0.1031*x2 - 0.0805*x1
        dx2 = 0.0797*x0 - 0.0698*x2 + 0.0331*x3 - 0.0349*x1*x2
        dx3 = 0.0353*x1*x2 - 0.0949*x3 + 0.1165*x0
