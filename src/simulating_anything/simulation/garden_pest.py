...
class GardenPestSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0395*x1 - 0.0718*x0 + 0.1009*np.sin(0.0271*self._t)
        dx1 = -0.0419*x0*x1 + 0.0965*x2 - 0.0350*x1
        dx2 = 0.0812*x0 - 0.1187*x2 + 0.0705*x3 - 0.0302*x1*x2
        dx3 = 0.0464*x1*x2 - 0.1116*x3 + 0.0219*x0
