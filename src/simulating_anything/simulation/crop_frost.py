...
class CropFrostSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1134*x1 - 0.0687*x0 + 0.0611*np.sin(0.0489*self._t)
        dx1 = -0.0923*x0*x1 + 0.0761*x2 - 0.0929*x1
        dx2 = 0.0620*x0 - 0.0724*x2 + 0.0320*x3 - 0.0972*x1*x2
        dx3 = 0.0966*x1*x2 - 0.0850*x3 + 0.0692*x0
