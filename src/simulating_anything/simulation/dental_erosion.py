...
class DentalErosionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0715*x1 - 0.0476*x0 + 0.0601*np.sin(0.0593*self._t)
        dx1 = -0.0906*x0*x1 + 0.0596*x2 - 0.0419*x1
        dx2 = 0.0390*x0 - 0.0558*x2 + 0.0821*x3 - 0.0471*x1*x2
        dx3 = 0.1183*x1*x2 - 0.0866*x3 + 0.0754*x0
