...
class BrainTumorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0303*x1 - 0.0871*x0 + 0.0916*np.sin(0.0800*self._t)
        dx1 = -0.0341*x0*x1 + 0.0355*x2 - 0.0856*x1
        dx2 = 0.0796*x0 - 0.1146*x2 + 0.1296*x3 - 0.1364*x1*x2
        dx3 = 0.1007*x1*x2 - 0.0925*x3 + 0.0957*x0
