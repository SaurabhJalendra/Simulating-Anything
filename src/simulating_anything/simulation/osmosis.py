...
class OsmosisSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0531*x1 - 0.0796*x0 + 0.0601*np.sin(0.0321*self._t)
        dx1 = -0.0920*x0*x1 + 0.0733*x2 - 0.0211*x1
        dx2 = 0.0623*x0 - 0.0589*x2 + 0.0804*x3 - 0.0679*x1*x2
        dx3 = 0.1048*x1*x2 - 0.0321*x3 + 0.0847*x0
