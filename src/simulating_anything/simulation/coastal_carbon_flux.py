...
class CoastalCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0319*x1 - 0.0664*x0 + 0.0403*np.sin(0.1191*self._t)
        dx1 = -0.0898*x0*x1 + 0.0504*x2 - 0.0449*x1
        dx2 = 0.0705*x0 - 0.0729*x2 + 0.0681*x3 - 0.0535*x1*x2
        dx3 = 0.0823*x1*x2 - 0.0381*x3 + 0.0994*x0
