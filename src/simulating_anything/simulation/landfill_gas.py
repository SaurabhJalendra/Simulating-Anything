...
class LandfillGasSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0518*x1 - 0.1112*x0 + 0.0746*np.sin(0.0469*self._t)
        dx1 = -0.0924*x0*x1 + 0.0586*x2 - 0.0998*x1
        dx2 = 0.0505*x0 - 0.0856*x2 + 0.0908*x3 - 0.0842*x1*x2
        dx3 = 0.0570*x1*x2 - 0.0910*x3 + 0.0963*x0
