...
class ContinentalDriftSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0862*x1 - 0.1075*x0 + 0.1128*np.sin(0.0441*self._t)
        dx1 = -0.0686*x0*x1 + 0.0664*x2 - 0.1134*x1
        dx2 = 0.0430*x0 - 0.0525*x2 + 0.0310*x3 - 0.0392*x1*x2
        dx3 = 0.0530*x1*x2 - 0.0483*x3 + 0.0881*x0
