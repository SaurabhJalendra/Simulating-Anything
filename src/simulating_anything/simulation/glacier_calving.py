...
class GlacierCalvingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1541*x1 - 0.0891*x0 + 0.1658*np.sin(0.1388*self._t)
        dx1 = -0.1145*x0*x1 + 0.032*x2 - 0.1605*x1
        dx2 = 0.1479*x0 - 0.056*x2 + 0.1261*x3 - 0.0762*x1*x2
        dx3 = 0.1211*x1*x2 - 0.0763*x3 + 0.1281*x0
