...
class CocoaFarmingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0475*x1 - 0.0390*x0 + 0.0893*np.sin(0.0567*self._t)
        dx1 = -0.0533*x0*x1 + 0.1161*x2 - 0.1025*x1
        dx2 = 0.0915*x0 - 0.0753*x2 + 0.0208*x3 - 0.0937*x1*x2
        dx3 = 0.0417*x1*x2 - 0.1114*x3 + 0.0465*x0
