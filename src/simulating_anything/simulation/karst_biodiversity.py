...
class KarstBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0571*x1 - 0.0692*x0 + 0.0477*np.sin(0.0558*self._t)
        dx1 = -0.0928*x0*x1 + 0.0889*x2 - 0.1139*x1
        dx2 = 0.0691*x0 - 0.1170*x2 + 0.0316*x3 - 0.1061*x1*x2
        dx3 = 0.0894*x1*x2 - 0.0612*x3 + 0.0961*x0
