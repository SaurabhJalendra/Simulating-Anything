...
class AcuteKidneySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1196*x1 - 0.0478*x0 + 0.1166*np.sin(0.0307*self._t)
        dx1 = -0.0982*x0*x1 + 0.0454*x2 - 0.0458*x1
        dx2 = 0.1073*x0 - 0.0914*x2 + 0.0812*x3 - 0.0914*x1*x2
        dx3 = 0.0297*x1*x2 - 0.0521*x3 + 0.0678*x0
