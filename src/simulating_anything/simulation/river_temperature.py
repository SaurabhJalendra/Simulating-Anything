...
class RiverTemperatureSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1059*x1 - 0.0524*x0 + 0.0524*np.sin(0.0246*self._t)
        dx1 = -0.0773*x0*x1 + 0.1123*x2 - 0.0290*x1
        dx2 = 0.1063*x0 - 0.0818*x2 + 0.0800*x3 - 0.0719*x1*x2
        dx3 = 0.0473*x1*x2 - 0.0773*x3 + 0.0558*x0
