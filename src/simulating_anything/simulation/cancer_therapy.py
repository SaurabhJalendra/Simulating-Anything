...
class CancerTherapySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0482*x1 - 0.0702*x0 + 0.1089*np.sin(0.0989*self._t)
        dx1 = -0.0974*x0*x1 + 0.0269*x2 - 0.1037*x1
        dx2 = 0.0342*x0 - 0.0965*x2 + 0.0341*x3 - 0.0507*x1*x2
        dx3 = 0.0939*x1*x2 - 0.0719*x3 + 0.0409*x0
