...
class InfluenzaMutationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0353*x1 - 0.0536*x0 + 0.1180*np.sin(0.0395*self._t)
        dx1 = -0.0712*x0*x1 + 0.0450*x2 - 0.1070*x1
        dx2 = 0.0412*x0 - 0.0545*x2 + 0.0755*x3 - 0.0363*x1*x2
        dx3 = 0.0288*x1*x2 - 0.0895*x3 + 0.1121*x0
