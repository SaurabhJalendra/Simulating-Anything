...
class MaizeGrowthSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0686*x1 - 0.1013*x0 + 0.1078*np.sin(0.0544*self._t)
        dx1 = -0.1012*x0*x1 + 0.0841*x2 - 0.0911*x1
        dx2 = 0.0342*x0 - 0.1036*x2 + 0.1050*x3 - 0.0866*x1*x2
        dx3 = 0.1050*x1*x2 - 0.0501*x3 + 0.0455*x0
