...
class TransplantRejectionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0453*x1 - 0.0938*x0 + 0.0972*np.sin(0.0291*self._t)
        dx1 = -0.0337*x0*x1 + 0.0419*x2 - 0.1174*x1
        dx2 = 0.0950*x0 - 0.0496*x2 + 0.0949*x3 - 0.0384*x1*x2
        dx3 = 0.0368*x1*x2 - 0.0453*x3 + 0.0645*x0
