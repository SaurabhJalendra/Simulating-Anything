...
class SaltCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0519*x1 - 0.1054*x0 + 0.0850*np.sin(0.0217*self._t)
        dx1 = -0.0209*x0*x1 + 0.0308*x2 - 0.0721*x1
        dx2 = 0.0423*x0 - 0.0539*x2 + 0.1009*x3 - 0.0976*x1*x2
        dx3 = 0.0229*x1*x2 - 0.0424*x3 + 0.0737*x0
