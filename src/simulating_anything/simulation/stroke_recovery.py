...
class StrokeRecoverySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0275*x1 - 0.0210*x0 + 0.0854*np.sin(0.0375*self._t)
        dx1 = -0.0626*x0*x1 + 0.0590*x2 - 0.0572*x1
        dx2 = 0.0671*x0 - 0.0981*x2 + 0.1082*x3 - 0.0909*x1*x2
        dx3 = 0.0838*x1*x2 - 0.0214*x3 + 0.0786*x0
