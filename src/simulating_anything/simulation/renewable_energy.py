...
class RenewableEnergySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0624*x1 - 0.0770*x0 + 0.0536*np.sin(0.1109*self._t)
        dx1 = -0.0234*x0*x1 + 0.0538*x2 - 0.0852*x1
        dx2 = 0.1199*x0 - 0.0457*x2 + 0.0293*x3 - 0.0699*x1*x2
        dx3 = 0.0397*x1*x2 - 0.0476*x3 + 0.1032*x0
