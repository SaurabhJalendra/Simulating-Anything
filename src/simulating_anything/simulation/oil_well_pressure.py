...
class OilWellPressureSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0687*x1 - 0.1225*x0 + 0.0925*np.sin(0.0272*self._t)
        dx1 = -0.1127*x0*x1 + 0.1330*x2 - 0.0269*x1
        dx2 = 0.0624*x0 - 0.0698*x2 + 0.0488*x3 - 0.1178*x1*x2
        dx3 = 0.0838*x1*x2 - 0.1052*x3 + 0.1503*x0
