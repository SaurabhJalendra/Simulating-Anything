...
class TidalBarrageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0591*x1 - 0.0479*x0 + 0.0222*np.sin(0.0514*self._t)
        dx1 = -0.1066*x0*x1 + 0.0976*x2 - 0.0762*x1
        dx2 = 0.1176*x0 - 0.0802*x2 + 0.0424*x3 - 0.0448*x1*x2
        dx3 = 0.0723*x1*x2 - 0.0716*x3 + 0.0553*x0
