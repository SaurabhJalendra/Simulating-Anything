...
class BenthicInvertebrateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0559*x1 - 0.0683*x0 + 0.0309*np.sin(0.0543*self._t)
        dx1 = -0.0397*x0*x1 + 0.0662*x2 - 0.0987*x1
        dx2 = 0.1169*x0 - 0.0280*x2 + 0.1178*x3 - 0.0492*x1*x2
        dx3 = 0.0806*x1*x2 - 0.0963*x3 + 0.0698*x0
