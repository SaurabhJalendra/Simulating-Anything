...
class HabitatFragmentationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1305*x1 - 0.1231*x0 + 0.1207*np.sin(0.1070*self._t)
        dx1 = -0.1590*x0*x1 + 0.0292*x2 - 0.0530*x1
        dx2 = 0.0545*x0 - 0.0492*x2 + 0.0883*x3 - 0.0574*x1*x2
        dx3 = 0.0698*x1*x2 - 0.0871*x3 + 0.1093*x0
