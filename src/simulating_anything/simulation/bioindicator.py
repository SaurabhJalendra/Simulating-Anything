...
class BioindicatorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0880*x1 - 0.1129*x0 + 0.0966*np.sin(0.0623*self._t)
        dx1 = -0.0752*x0*x1 + 0.0522*x2 - 0.0987*x1
        dx2 = 0.0518*x0 - 0.0695*x2 + 0.0482*x3 - 0.0486*x1*x2
        dx3 = 0.0397*x1*x2 - 0.0272*x3 + 0.0318*x0
