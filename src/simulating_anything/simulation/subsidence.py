...
class SubsidenceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0923*x1 - 0.0544*x0 + 0.0411*np.sin(0.0696*self._t)
        dx1 = -0.1141*x0*x1 + 0.0662*x2 - 0.0878*x1
        dx2 = 0.0728*x0 - 0.0598*x2 + 0.0226*x3 - 0.0360*x1*x2
        dx3 = 0.1163*x1*x2 - 0.0709*x3 + 0.0446*x0
