...
class SandCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0675*x1 - 0.0728*x0 + 0.0853*np.sin(0.1054*self._t)
        dx1 = -0.0685*x0*x1 + 0.0638*x2 - 0.0216*x1
        dx2 = 0.0537*x0 - 0.0531*x2 + 0.0603*x3 - 0.1171*x1*x2
        dx3 = 0.0413*x1*x2 - 0.0451*x3 + 0.0720*x0
