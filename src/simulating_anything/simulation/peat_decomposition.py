...
class PeatDecompositionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1361*x1 - 0.1525*x0 + 0.1565*np.sin(0.0363*self._t)
        dx1 = -0.0930*x0*x1 + 0.1236*x2 - 0.1021*x1
        dx2 = 0.0972*x0 - 0.0893*x2 + 0.1115*x3 - 0.1563*x1*x2
        dx3 = 0.0230*x1*x2 - 0.1567*x3 + 0.1120*x0
