...
class DiamondGrowthSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1095*x1 - 0.0379*x0 + 0.0557*np.sin(0.1620*self._t)
        dx1 = -0.1636*x0*x1 + 0.0595*x2 - 0.0516*x1
        dx2 = 0.0226*x0 - 0.1031*x2 + 0.0917*x3 - 0.0967*x1*x2
        dx3 = 0.0721*x1*x2 - 0.0418*x3 + 0.1406*x0
