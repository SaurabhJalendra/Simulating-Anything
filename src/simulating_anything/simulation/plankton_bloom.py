...
class PlanktonBloomSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0659*x1 - 0.0788*x0 + 0.0524*np.sin(0.1133*self._t)
        dx1 = -0.0332*x0*x1 + 0.0623*x2 - 0.1126*x1
        dx2 = 0.0347*x0 - 0.0874*x2 + 0.0834*x3 - 0.0397*x1*x2
        dx3 = 0.0264*x1*x2 - 0.0946*x3 + 0.1171*x0
