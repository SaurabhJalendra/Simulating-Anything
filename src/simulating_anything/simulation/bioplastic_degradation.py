...
class BioplasticDegradationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1121*x1 - 0.1086*x0 + 0.0208*np.sin(0.0724*self._t)
        dx1 = -0.0913*x0*x1 + 0.0358*x2 - 0.1032*x1
        dx2 = 0.0537*x0 - 0.0758*x2 + 0.0532*x3 - 0.0867*x1*x2
        dx3 = 0.1137*x1*x2 - 0.0422*x3 + 0.0924*x0
