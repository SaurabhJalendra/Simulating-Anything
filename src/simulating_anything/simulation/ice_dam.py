...
class IceDamSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0420*x1 - 0.0775*x0 + 0.0873*np.sin(0.0892*self._t)
        dx1 = -0.0530*x0*x1 + 0.0961*x2 - 0.0748*x1
        dx2 = 0.0564*x0 - 0.0267*x2 + 0.0405*x3 - 0.1186*x1*x2
        dx3 = 0.1170*x1*x2 - 0.0495*x3 + 0.0788*x0
