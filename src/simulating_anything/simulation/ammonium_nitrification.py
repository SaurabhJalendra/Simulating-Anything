...
class AmmoniumNitrificationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0201*x1 - 0.0859*x0 + 0.0331*np.sin(0.0792*self._t)
        dx1 = -0.0372*x0*x1 + 0.0901*x2 - 0.0956*x1
        dx2 = 0.0608*x0 - 0.1012*x2 + 0.0680*x3 - 0.1030*x1*x2
        dx3 = 0.1077*x1*x2 - 0.0485*x3 + 0.0720*x0
