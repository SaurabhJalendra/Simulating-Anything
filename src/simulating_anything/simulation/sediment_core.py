...
class SedimentCoreSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1172*x1 - 0.0905*x0 + 0.0898*np.sin(0.0290*self._t)
        dx1 = -0.0357*x0*x1 + 0.1095*x2 - 0.1118*x1
        dx2 = 0.0453*x0 - 0.0756*x2 + 0.0317*x3 - 0.0767*x1*x2
        dx3 = 0.1192*x1*x2 - 0.0281*x3 + 0.0409*x0
