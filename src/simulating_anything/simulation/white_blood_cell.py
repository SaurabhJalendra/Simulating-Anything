...
class WhiteBloodCellSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0917*x1 - 0.1020*x0 + 0.0890*np.sin(0.0990*self._t)
        dx1 = -0.1122*x0*x1 + 0.0952*x2 - 0.0412*x1
        dx2 = 0.0614*x0 - 0.1176*x2 + 0.1153*x3 - 0.0603*x1*x2
        dx3 = 0.0213*x1*x2 - 0.0801*x3 + 0.0925*x0
