...
class FireSuppressionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0840*x1 - 0.0761*x0 + 0.0550*np.sin(0.0910*self._t)
        dx1 = -0.0711*x0*x1 + 0.0561*x2 - 0.0279*x1
        dx2 = 0.0563*x0 - 0.0255*x2 + 0.0881*x3 - 0.0672*x1*x2
        dx3 = 0.0855*x1*x2 - 0.1225*x3 + 0.0776*x0
