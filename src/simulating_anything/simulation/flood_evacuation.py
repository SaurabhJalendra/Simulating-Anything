...
class FloodEvacuationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1381*x1 - 0.1389*x0 + 0.0554*np.sin(0.0266*self._t)
        dx1 = -0.1467*x0*x1 + 0.1699*x2 - 0.1379*x1
        dx2 = 0.1627*x0 - 0.0318*x2 + 0.022*x3 - 0.0266*x1*x2
        dx3 = 0.0586*x1*x2 - 0.1087*x3 + 0.0479*x0
