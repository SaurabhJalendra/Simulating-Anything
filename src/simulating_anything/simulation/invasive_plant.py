...
class InvasivePlantSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0270*x1 - 0.0360*x0 + 0.1039*np.sin(0.0555*self._t)
        dx1 = -0.0485*x0*x1 + 0.0421*x2 - 0.0995*x1
        dx2 = 0.0551*x0 - 0.0685*x2 + 0.0361*x3 - 0.0836*x1*x2
        dx3 = 0.0950*x1*x2 - 0.0735*x3 + 0.0365*x0
