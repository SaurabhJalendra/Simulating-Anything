...
class SpongeReefSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1069*x1 - 0.1103*x0 + 0.0514*np.sin(0.0886*self._t)
        dx1 = -0.0264*x0*x1 + 0.0703*x2 - 0.0398*x1
        dx2 = 0.0952*x0 - 0.0560*x2 + 0.0654*x3 - 0.0857*x1*x2
        dx3 = 0.0738*x1*x2 - 0.1079*x3 + 0.0893*x0
