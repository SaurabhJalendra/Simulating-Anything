...
class SandBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0690*x1 - 0.0994*x0 + 0.0319*np.sin(0.0589*self._t)
        dx1 = -0.0826*x0*x1 + 0.1028*x2 - 0.0648*x1
        dx2 = 0.0993*x0 - 0.0794*x2 + 0.0386*x3 - 0.0451*x1*x2
        dx3 = 0.0925*x1*x2 - 0.0261*x3 + 0.0705*x0
