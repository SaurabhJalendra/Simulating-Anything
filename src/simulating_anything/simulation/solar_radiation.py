...
class SolarRadiationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0357*x1 - 0.0857*x0 + 0.0543*np.sin(0.1117*self._t)
        dx1 = -0.0555*x0*x1 + 0.0613*x2 - 0.0845*x1
        dx2 = 0.0343*x0 - 0.0986*x2 + 0.0777*x3 - 0.0512*x1*x2
        dx3 = 0.0604*x1*x2 - 0.0286*x3 + 0.1124*x0
