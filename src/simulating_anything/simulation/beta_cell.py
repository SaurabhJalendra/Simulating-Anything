...
class BetaCellSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0416*x1 - 0.0817*x0 + 0.0528*np.sin(0.1178*self._t)
        dx1 = -0.1016*x0*x1 + 0.0598*x2 - 0.0623*x1
        dx2 = 0.1028*x0 - 0.0320*x2 + 0.0981*x3 - 0.0344*x1*x2
        dx3 = 0.0413*x1*x2 - 0.1101*x3 + 0.0692*x0
