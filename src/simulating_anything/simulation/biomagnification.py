...
class BiomagnificationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0778*x1 - 0.1163*x0 + 0.0311*np.sin(0.0312*self._t)
        dx1 = -0.0914*x0*x1 + 0.1129*x2 - 0.0924*x1
        dx2 = 0.0466*x0 - 0.0549*x2 + 0.0348*x3 - 0.0895*x1*x2
        dx3 = 0.0747*x1*x2 - 0.1176*x3 + 0.0515*x0
