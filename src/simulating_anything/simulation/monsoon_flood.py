...
class MonsoonFloodSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0383*x1 - 0.1177*x0 + 0.0820*np.sin(0.0892*self._t)
        dx1 = -0.0449*x0*x1 + 0.0644*x2 - 0.0227*x1
        dx2 = 0.0255*x0 - 0.0816*x2 + 0.1131*x3 - 0.0463*x1*x2
        dx3 = 0.0843*x1*x2 - 0.0682*x3 + 0.0432*x0
