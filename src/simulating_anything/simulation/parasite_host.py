...
class ParasiteHostSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0397*x1 - 0.0527*x0 + 0.1085*np.sin(0.0808*self._t)
        dx1 = -0.0687*x0*x1 + 0.0411*x2 - 0.0720*x1
        dx2 = 0.0289*x0 - 0.0586*x2 + 0.0984*x3 - 0.0614*x1*x2
        dx3 = 0.0510*x1*x2 - 0.1070*x3 + 0.0367*x0
