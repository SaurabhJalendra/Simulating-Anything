...
class CircadianLightSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0326*x1 - 0.0279*x0 + 0.0493*np.sin(0.0597*self._t)
        dx1 = -0.0324*x0*x1 + 0.1099*x2 - 0.0529*x1
        dx2 = 0.0768*x0 - 0.0569*x2 + 0.0399*x3 - 0.0592*x1*x2
        dx3 = 0.1058*x1*x2 - 0.1081*x3 + 0.0528*x0
