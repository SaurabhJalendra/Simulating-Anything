...
class BananaDiseaseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0897*x1 - 0.1151*x0 + 0.0244*np.sin(0.0693*self._t)
        dx1 = -0.0497*x0*x1 + 0.0826*x2 - 0.1107*x1
        dx2 = 0.0464*x0 - 0.0684*x2 + 0.0567*x3 - 0.0419*x1*x2
        dx3 = 0.0256*x1*x2 - 0.0874*x3 + 0.0965*x0
