...
class EcologicalFootprintSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0240*x1 - 0.0961*x0 + 0.0608*np.sin(0.0471*self._t)
        dx1 = -0.0855*x0*x1 + 0.1100*x2 - 0.0213*x1
        dx2 = 0.1098*x0 - 0.1149*x2 + 0.1029*x3 - 0.0628*x1*x2
        dx3 = 0.1039*x1*x2 - 0.1038*x3 + 0.0508*x0
