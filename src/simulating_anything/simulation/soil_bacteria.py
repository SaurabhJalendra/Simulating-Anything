...
class SoilBacteriaSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1191*x1 - 0.0460*x0 + 0.1004*np.sin(0.0276*self._t)
        dx1 = -0.0224*x0*x1 + 0.0756*x2 - 0.0298*x1
        dx2 = 0.0391*x0 - 0.0775*x2 + 0.0400*x3 - 0.0647*x1*x2
        dx3 = 0.0825*x1*x2 - 0.0919*x3 + 0.0632*x0
