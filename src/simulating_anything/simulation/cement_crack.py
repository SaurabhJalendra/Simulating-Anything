...
class CementCrackSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0819*x1 - 0.0270*x0 + 0.1114*np.sin(0.0342*self._t)
        dx1 = -0.0927*x0*x1 + 0.1027*x2 - 0.0767*x1
        dx2 = 0.0705*x0 - 0.0277*x2 + 0.0945*x3 - 0.0296*x1*x2
        dx3 = 0.0862*x1*x2 - 0.0218*x3 + 0.1189*x0
