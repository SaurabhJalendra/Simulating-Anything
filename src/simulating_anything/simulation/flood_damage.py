...
class FloodDamageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1259*x1 - 0.0423*x0 + 0.1005*np.sin(0.0320*self._t)
        dx1 = -0.0638*x0*x1 + 0.0291*x2 - 0.0281*x1
        dx2 = 0.1189*x0 - 0.0848*x2 + 0.0455*x3 - 0.0649*x1*x2
        dx3 = 0.0970*x1*x2 - 0.0552*x3 + 0.0469*x0
