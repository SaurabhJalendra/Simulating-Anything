...
class AerobicDigestionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0736*x1 - 0.0520*x0 + 0.0491*np.sin(0.0557*self._t)
        dx1 = -0.1049*x0*x1 + 0.0418*x2 - 0.0910*x1
        dx2 = 0.1092*x0 - 0.0394*x2 + 0.0726*x3 - 0.0516*x1*x2
        dx3 = 0.0852*x1*x2 - 0.0715*x3 + 0.0381*x0
