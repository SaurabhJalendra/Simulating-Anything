...
class DolphinPodSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0743*x1 - 0.0256*x0 + 0.1102*np.sin(0.0252*self._t)
        dx1 = -0.0733*x0*x1 + 0.0951*x2 - 0.0204*x1
        dx2 = 0.0798*x0 - 0.1135*x2 + 0.0955*x3 - 0.0402*x1*x2
        dx3 = 0.1141*x1*x2 - 0.0729*x3 + 0.0412*x0
