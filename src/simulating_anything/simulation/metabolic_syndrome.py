...
class MetabolicSyndromeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1068*x1 - 0.0607*x0 + 0.0510*np.sin(0.0231*self._t)
        dx1 = -0.0303*x0*x1 + 0.1059*x2 - 0.0880*x1
        dx2 = 0.0249*x0 - 0.0831*x2 + 0.0785*x3 - 0.0828*x1*x2
        dx3 = 0.0908*x1*x2 - 0.0276*x3 + 0.0734*x0
