...
class HazardousWasteSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0419*x1 - 0.0772*x0 + 0.0280*np.sin(0.1068*self._t)
        dx1 = -0.0557*x0*x1 + 0.0714*x2 - 0.1181*x1
        dx2 = 0.1089*x0 - 0.0668*x2 + 0.0710*x3 - 0.0480*x1*x2
        dx3 = 0.0855*x1*x2 - 0.0520*x3 + 0.0612*x0
