...
class FreshwaterMusselSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0719*x1 - 0.0836*x0 + 0.0214*np.sin(0.1285*self._t)
        dx1 = -0.0364*x0*x1 + 0.0802*x2 - 0.0661*x1
        dx2 = 0.1289*x0 - 0.1012*x2 + 0.1084*x3 - 0.0997*x1*x2
        dx3 = 0.0715*x1*x2 - 0.0315*x3 + 0.1162*x0
