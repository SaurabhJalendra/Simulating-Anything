...
class GeothermalReservoirSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1261*x1 - 0.0715*x0 + 0.0739*np.sin(0.1387*self._t)
        dx1 = -0.0713*x0*x1 + 0.0753*x2 - 0.0869*x1
        dx2 = 0.1227*x0 - 0.0340*x2 + 0.0552*x3 - 0.1226*x1*x2
        dx3 = 0.0410*x1*x2 - 0.1368*x3 + 0.0401*x0
