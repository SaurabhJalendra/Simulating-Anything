...
class FisheryQuotaSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0537*x1 - 0.0866*x0 + 0.0473*np.sin(0.0345*self._t)
        dx1 = -0.0964*x0*x1 + 0.0531*x2 - 0.1191*x1
        dx2 = 0.0657*x0 - 0.0380*x2 + 0.0542*x3 - 0.0647*x1*x2
        dx3 = 0.0531*x1*x2 - 0.0725*x3 + 0.1048*x0
