...
class StripMiningSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0203*x1 - 0.0942*x0 + 0.0482*np.sin(0.0445*self._t)
        dx1 = -0.0901*x0*x1 + 0.0482*x2 - 0.0473*x1
        dx2 = 0.0548*x0 - 0.0719*x2 + 0.0978*x3 - 0.0463*x1*x2
        dx3 = 0.0292*x1*x2 - 0.0968*x3 + 0.0406*x0
