...
class FuelSpillSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0943*x1 - 0.0534*x0 + 0.1152*np.sin(0.0751*self._t)
        dx1 = -0.0671*x0*x1 + 0.0533*x2 - 0.0462*x1
        dx2 = 0.0983*x0 - 0.0813*x2 + 0.0704*x3 - 0.1171*x1*x2
        dx3 = 0.1124*x1*x2 - 0.0986*x3 + 0.0281*x0
