...
class ApeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0809*x1 - 0.0556*x0 + 0.0989*np.sin(0.0496*self._t)
        dx1 = -0.1091*x0*x1 + 0.1125*x2 - 0.0561*x1
        dx2 = 0.1189*x0 - 0.1047*x2 + 0.0898*x3 - 0.0939*x1*x2
        dx3 = 0.0378*x1*x2 - 0.1077*x3 + 0.0469*x0
