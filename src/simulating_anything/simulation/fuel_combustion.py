...
class FuelCombustionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0680*x1 - 0.0497*x0 + 0.0313*np.sin(0.0240*self._t)
        dx1 = -0.0731*x0*x1 + 0.0479*x2 - 0.0237*x1
        dx2 = 0.0923*x0 - 0.0490*x2 + 0.0913*x3 - 0.0996*x1*x2
        dx3 = 0.0720*x1*x2 - 0.0406*x3 + 0.0707*x0
