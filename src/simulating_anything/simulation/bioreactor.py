...
class BioreactorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0598*x1 - 0.0473*x0 + 0.1042*np.sin(0.0855*self._t)
        dx1 = -0.0633*x0*x1 + 0.0481*x2 - 0.0637*x1
        dx2 = 0.0646*x0 - 0.0604*x2 + 0.0968*x3 - 0.0931*x1*x2
        dx3 = 0.1180*x1*x2 - 0.0442*x3 + 0.0951*x0
