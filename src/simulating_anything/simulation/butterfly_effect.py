...
class ButterflyEffectSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0436*x1 - 0.0838*x0 + 0.0967*np.sin(0.0722*self._t)
        dx1 = -0.0484*x0*x1 + 0.1110*x2 - 0.1078*x1
        dx2 = 0.0780*x0 - 0.1150*x2 + 0.0287*x3 - 0.1071*x1*x2
        dx3 = 0.0449*x1*x2 - 0.1167*x3 + 0.0558*x0
