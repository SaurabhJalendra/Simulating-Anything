...
class NoiseCancellationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0613*x1 - 0.0262*x0 + 0.0892*np.sin(0.0608*self._t)
        dx1 = -0.0828*x0*x1 + 0.1009*x2 - 0.0220*x1
        dx2 = 0.0472*x0 - 0.0636*x2 + 0.0488*x3 - 0.0965*x1*x2
        dx3 = 0.1093*x1*x2 - 0.0220*x3 + 0.0411*x0
