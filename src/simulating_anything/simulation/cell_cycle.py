...
class CellCycleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0506*x1 - 0.0584*x0 + 0.1074*np.sin(0.1080*self._t)
        dx1 = -0.1100*x0*x1 + 0.0649*x2 - 0.0665*x1
        dx2 = 0.0527*x0 - 0.0222*x2 + 0.1127*x3 - 0.0266*x1*x2
        dx3 = 0.0551*x1*x2 - 0.0939*x3 + 0.0901*x0
