...
class DesertPavementSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1174*x1 - 0.1060*x0 + 0.0668*np.sin(0.0946*self._t)
        dx1 = -0.1192*x0*x1 + 0.1054*x2 - 0.1162*x1
        dx2 = 0.0591*x0 - 0.1158*x2 + 0.0622*x3 - 0.0347*x1*x2
        dx3 = 0.0965*x1*x2 - 0.0337*x3 + 0.1051*x0
