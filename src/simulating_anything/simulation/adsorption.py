...
class AdsorptionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0735*x1 - 0.0710*x0 + 0.1066*np.sin(0.0340*self._t)
        dx1 = -0.0332*x0*x1 + 0.0617*x2 - 0.0923*x1
        dx2 = 0.1174*x0 - 0.1136*x2 + 0.0979*x3 - 0.0574*x1*x2
        dx3 = 0.1100*x1*x2 - 0.0529*x3 + 0.1194*x0
