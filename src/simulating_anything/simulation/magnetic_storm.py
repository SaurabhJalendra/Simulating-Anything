...
class MagneticStormSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0783*x1 - 0.0236*x0 + 0.0399*np.sin(0.0543*self._t)
        dx1 = -0.0527*x0*x1 + 0.0712*x2 - 0.0361*x1
        dx2 = 0.0988*x0 - 0.0693*x2 + 0.1168*x3 - 0.0562*x1*x2
        dx3 = 0.0950*x1*x2 - 0.0542*x3 + 0.0536*x0
