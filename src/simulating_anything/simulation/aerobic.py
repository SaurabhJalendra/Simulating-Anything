...
class AerobicSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1031*x1 - 0.1118*x0 + 0.0917*np.sin(0.0306*self._t)
        dx1 = -0.0855*x0*x1 + 0.1066*x2 - 0.0943*x1
        dx2 = 0.0900*x0 - 0.0735*x2 + 0.1103*x3 - 0.0992*x1*x2
        dx3 = 0.0282*x1*x2 - 0.0530*x3 + 0.0739*x0
