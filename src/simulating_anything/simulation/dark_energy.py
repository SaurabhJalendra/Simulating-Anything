...
class DarkEnergySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1155*x1 - 0.0520*x0 + 0.1173*np.sin(0.1083*self._t)
        dx1 = -0.0722*x0*x1 + 0.0394*x2 - 0.0855*x1
        dx2 = 0.0409*x0 - 0.0806*x2 + 0.0427*x3 - 0.0854*x1*x2
        dx3 = 0.1173*x1*x2 - 0.0899*x3 + 0.0854*x0
