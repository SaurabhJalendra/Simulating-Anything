...
class LightningRodSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0771*x1 - 0.0596*x0 + 0.0932*np.sin(0.0304*self._t)
        dx1 = -0.0610*x0*x1 + 0.1176*x2 - 0.0379*x1
        dx2 = 0.0467*x0 - 0.0442*x2 + 0.1132*x3 - 0.0300*x1*x2
        dx3 = 0.0682*x1*x2 - 0.0600*x3 + 0.0393*x0
