...
class PollutionCleanupSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0308*x1 - 0.0626*x0 + 0.0987*np.sin(0.0713*self._t)
        dx1 = -0.1150*x0*x1 + 0.1088*x2 - 0.0258*x1
        dx2 = 0.0257*x0 - 0.0788*x2 + 0.0407*x3 - 0.0368*x1*x2
        dx3 = 0.0883*x1*x2 - 0.0357*x3 + 0.0359*x0
