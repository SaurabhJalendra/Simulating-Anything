...
class StomachAcidSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1044*x1 - 0.0251*x0 + 0.0991*np.sin(0.0934*self._t)
        dx1 = -0.0300*x0*x1 + 0.0232*x2 - 0.0827*x1
        dx2 = 0.0400*x0 - 0.0898*x2 + 0.1110*x3 - 0.0969*x1*x2
        dx3 = 0.1059*x1*x2 - 0.0387*x3 + 0.0724*x0
