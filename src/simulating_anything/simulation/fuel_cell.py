...
class FuelCellSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0478*x1 - 0.0672*x0 + 0.0821*np.sin(0.0817*self._t)
        dx1 = -0.0310*x0*x1 + 0.0999*x2 - 0.0826*x1
        dx2 = 0.0796*x0 - 0.0415*x2 + 0.0314*x3 - 0.0258*x1*x2
        dx3 = 0.0638*x1*x2 - 0.0921*x3 + 0.0616*x0
