...
class OsteocyteSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0862*x1 - 0.0672*x0 + 0.0668*np.sin(0.0839*self._t)
        dx1 = -0.1033*x0*x1 + 0.0537*x2 - 0.0728*x1
        dx2 = 0.0669*x0 - 0.0820*x2 + 0.1077*x3 - 0.0463*x1*x2
        dx3 = 0.0399*x1*x2 - 0.1163*x3 + 0.0905*x0
