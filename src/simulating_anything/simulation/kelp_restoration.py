...
class KelpRestorationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0213*x1 - 0.1128*x0 + 0.0863*np.sin(0.0899*self._t)
        dx1 = -0.0453*x0*x1 + 0.0570*x2 - 0.0301*x1
        dx2 = 0.0859*x0 - 0.0913*x2 + 0.0585*x3 - 0.0905*x1*x2
        dx3 = 0.0846*x1*x2 - 0.0788*x3 + 0.1123*x0
