...
class ViralLoadSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0548*x1 - 0.0999*x0 + 0.0382*np.sin(0.0990*self._t)
        dx1 = -0.1051*x0*x1 + 0.0411*x2 - 0.0595*x1
        dx2 = 0.0389*x0 - 0.0656*x2 + 0.0731*x3 - 0.0558*x1*x2
        dx3 = 0.0603*x1*x2 - 0.1091*x3 + 0.0267*x0
