...
class AsteroidImpactSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0986*x1 - 0.1153*x0 + 0.1192*np.sin(0.1189*self._t)
        dx1 = -0.0557*x0*x1 + 0.0420*x2 - 0.0997*x1
        dx2 = 0.0305*x0 - 0.0332*x2 + 0.0531*x3 - 0.1156*x1*x2
        dx3 = 0.0478*x1*x2 - 0.0710*x3 + 0.0473*x0
