...
class PineBeetleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1159*x1 - 0.1257*x0 + 0.105*np.sin(0.1113*self._t)
        dx1 = -0.0838*x0*x1 + 0.041*x2 - 0.128*x1
        dx2 = 0.0795*x0 - 0.1496*x2 + 0.1012*x3 - 0.0586*x1*x2
        dx3 = 0.0831*x1*x2 - 0.0266*x3 + 0.0923*x0
