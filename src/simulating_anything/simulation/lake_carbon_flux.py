...
class LakeCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1047*x1 - 0.0376*x0 + 0.0269*np.sin(0.0474*self._t)
        dx1 = -0.0766*x0*x1 + 0.0307*x2 - 0.0797*x1
        dx2 = 0.0496*x0 - 0.0944*x2 + 0.1067*x3 - 0.0206*x1*x2
        dx3 = 0.0749*x1*x2 - 0.0287*x3 + 0.0584*x0
