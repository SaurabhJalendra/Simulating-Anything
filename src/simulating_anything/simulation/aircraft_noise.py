...
class AircraftNoiseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0699*x1 - 0.0749*x0 + 0.0641*np.sin(0.0893*self._t)
        dx1 = -0.0962*x0*x1 + 0.1160*x2 - 0.0676*x1
        dx2 = 0.0546*x0 - 0.0855*x2 + 0.1172*x3 - 0.1043*x1*x2
        dx3 = 0.1114*x1*x2 - 0.0948*x3 + 0.0909*x0
