...
class FrictionHeatSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1227*x1 - 0.0965*x0 + 0.0709*np.sin(0.1418*self._t)
        dx1 = -0.0299*x0*x1 + 0.0316*x2 - 0.1163*x1
        dx2 = 0.1361*x0 - 0.0594*x2 + 0.1121*x3 - 0.1673*x1*x2
        dx3 = 0.1323*x1*x2 - 0.0927*x3 + 0.0904*x0
