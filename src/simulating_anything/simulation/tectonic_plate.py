...
class TectonicPlateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0431*x1 - 0.0480*x0 + 0.1105*np.sin(0.0881*self._t)
        dx1 = -0.0892*x0*x1 + 0.0653*x2 - 0.0732*x1
        dx2 = 0.0742*x0 - 0.0406*x2 + 0.0590*x3 - 0.1195*x1*x2
        dx3 = 0.1199*x1*x2 - 0.0404*x3 + 0.1147*x0
