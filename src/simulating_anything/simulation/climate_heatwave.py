...
class ClimateHeatwaveSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0240*x1 - 0.0403*x0 + 0.0559*np.sin(0.0546*self._t)
        dx1 = -0.0219*x0*x1 + 0.0567*x2 - 0.0855*x1
        dx2 = 0.0265*x0 - 0.0487*x2 + 0.0405*x3 - 0.0717*x1*x2
        dx3 = 0.1118*x1*x2 - 0.1027*x3 + 0.1087*x0
