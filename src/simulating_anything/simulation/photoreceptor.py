...
class PhotoreceptorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1120*x1 - 0.0918*x0 + 0.0754*np.sin(0.0388*self._t)
        dx1 = -0.0946*x0*x1 + 0.0776*x2 - 0.0541*x1
        dx2 = 0.0535*x0 - 0.1144*x2 + 0.0314*x3 - 0.0397*x1*x2
        dx3 = 0.1038*x1*x2 - 0.0643*x3 + 0.0205*x0
