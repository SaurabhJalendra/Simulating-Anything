...
class AridCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0305*x1 - 0.0838*x0 + 0.0286*np.sin(0.0345*self._t)
        dx1 = -0.0633*x0*x1 + 0.0769*x2 - 0.0214*x1
        dx2 = 0.0480*x0 - 0.0378*x2 + 0.0835*x3 - 0.0271*x1*x2
        dx3 = 0.1183*x1*x2 - 0.0479*x3 + 0.0916*x0
