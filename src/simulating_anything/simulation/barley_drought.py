...
class BarleyDroughtSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1184*x1 - 0.0723*x0 + 0.0326*np.sin(0.0609*self._t)
        dx1 = -0.0994*x0*x1 + 0.1109*x2 - 0.1165*x1
        dx2 = 0.0877*x0 - 0.0517*x2 + 0.0563*x3 - 0.0308*x1*x2
        dx3 = 0.0429*x1*x2 - 0.0392*x3 + 0.0590*x0
