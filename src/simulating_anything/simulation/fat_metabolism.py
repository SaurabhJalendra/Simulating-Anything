...
class FatMetabolismSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0683*x1 - 0.0912*x0 + 0.1163*np.sin(0.0551*self._t)
        dx1 = -0.0232*x0*x1 + 0.0273*x2 - 0.1121*x1
        dx2 = 0.0439*x0 - 0.0998*x2 + 0.0807*x3 - 0.1031*x1*x2
        dx3 = 0.0640*x1*x2 - 0.1111*x3 + 0.0823*x0
