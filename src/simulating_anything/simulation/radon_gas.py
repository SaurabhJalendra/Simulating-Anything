...
class RadonGasSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1052*x1 - 0.0950*x0 + 0.0873*np.sin(0.0509*self._t)
        dx1 = -0.1174*x0*x1 + 0.1180*x2 - 0.0609*x1
        dx2 = 0.0383*x0 - 0.1088*x2 + 0.0213*x3 - 0.1200*x1*x2
        dx3 = 0.1050*x1*x2 - 0.0939*x3 + 0.1021*x0
