...
class GlacierDebrisSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0344*x1 - 0.0223*x0 + 0.0331*np.sin(0.1223*self._t)
        dx1 = -0.1106*x0*x1 + 0.0474*x2 - 0.0303*x1
        dx2 = 0.0662*x0 - 0.0779*x2 + 0.0685*x3 - 0.0211*x1*x2
        dx3 = 0.0333*x1*x2 - 0.0683*x3 + 0.0521*x0
