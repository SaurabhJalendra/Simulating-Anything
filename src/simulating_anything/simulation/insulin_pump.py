...
class InsulinPumpSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0219*x1 - 0.0962*x0 + 0.0607*np.sin(0.1012*self._t)
        dx1 = -0.0963*x0*x1 + 0.0700*x2 - 0.1091*x1
        dx2 = 0.0960*x0 - 0.0785*x2 + 0.1180*x3 - 0.0512*x1*x2
        dx3 = 0.0443*x1*x2 - 0.0274*x3 + 0.0962*x0
