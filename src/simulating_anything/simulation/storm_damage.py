...
class StormDamageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0804*x1 - 0.0565*x0 + 0.0535*np.sin(0.1032*self._t)
        dx1 = -0.0976*x0*x1 + 0.0291*x2 - 0.0939*x1
        dx2 = 0.0702*x0 - 0.0947*x2 + 0.0561*x3 - 0.1074*x1*x2
        dx3 = 0.1099*x1*x2 - 0.0265*x3 + 0.0875*x0
