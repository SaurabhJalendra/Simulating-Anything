...
class BatteryChemistrySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1117*x1 - 0.0752*x0 + 0.0645*np.sin(0.0297*self._t)
        dx1 = -0.1126*x0*x1 + 0.0885*x2 - 0.0500*x1
        dx2 = 0.1092*x0 - 0.0676*x2 + 0.0690*x3 - 0.1198*x1*x2
        dx3 = 0.0885*x1*x2 - 0.0952*x3 + 0.0304*x0
