...
class NuclearStorageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0561*x1 - 0.0990*x0 + 0.0750*np.sin(0.0830*self._t)
        dx1 = -0.0740*x0*x1 + 0.1164*x2 - 0.1101*x1
        dx2 = 0.0748*x0 - 0.0466*x2 + 0.1100*x3 - 0.1022*x1*x2
        dx3 = 0.0549*x1*x2 - 0.0331*x3 + 0.0237*x0
