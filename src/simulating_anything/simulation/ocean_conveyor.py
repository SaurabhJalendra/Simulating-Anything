...
class OceanConveyorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1036*x1 - 0.1180*x0 + 0.1042*np.sin(0.1030*self._t)
        dx1 = -0.0951*x0*x1 + 0.0311*x2 - 0.0896*x1
        dx2 = 0.0420*x0 - 0.0906*x2 + 0.0204*x3 - 0.0429*x1*x2
        dx3 = 0.0511*x1*x2 - 0.0401*x3 + 0.0559*x0
