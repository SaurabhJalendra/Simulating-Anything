...
class CopperCorrosionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1104*x1 - 0.0707*x0 + 0.1038*np.sin(0.0298*self._t)
        dx1 = -0.0224*x0*x1 + 0.1129*x2 - 0.0595*x1
        dx2 = 0.0744*x0 - 0.0981*x2 + 0.0814*x3 - 0.0217*x1*x2
        dx3 = 0.0900*x1*x2 - 0.0211*x3 + 0.0341*x0
