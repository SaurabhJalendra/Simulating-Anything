...
class LocustSwarmSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0877*x1 - 0.1126*x0 + 0.0684*np.sin(0.1343*self._t)
        dx1 = -0.0763*x0*x1 + 0.1115*x2 - 0.1142*x1
        dx2 = 0.1319*x0 - 0.0391*x2 + 0.1282*x3 - 0.1392*x1*x2
        dx3 = 0.1557*x1*x2 - 0.049*x3 + 0.1563*x0
