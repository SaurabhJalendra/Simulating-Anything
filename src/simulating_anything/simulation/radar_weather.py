...
class RadarWeatherSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0229*x1 - 0.0305*x0 + 0.0344*np.sin(0.0786*self._t)
        dx1 = -0.0240*x0*x1 + 0.0565*x2 - 0.0386*x1
        dx2 = 0.1077*x0 - 0.0414*x2 + 0.0548*x3 - 0.0946*x1*x2
        dx3 = 0.0203*x1*x2 - 0.0207*x3 + 0.0544*x0
