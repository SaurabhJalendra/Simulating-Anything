...
class GlassManufacturingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0436*x1 - 0.0832*x0 + 0.0529*np.sin(0.0480*self._t)
        dx1 = -0.0906*x0*x1 + 0.0576*x2 - 0.0772*x1
        dx2 = 0.0259*x0 - 0.0627*x2 + 0.0590*x3 - 0.0515*x1*x2
        dx3 = 0.0364*x1*x2 - 0.0359*x3 + 0.0268*x0
