...
class MineCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0901*x1 - 0.0360*x0 + 0.0721*np.sin(0.0299*self._t)
        dx1 = -0.0229*x0*x1 + 0.0731*x2 - 0.0762*x1
        dx2 = 0.0361*x0 - 0.0802*x2 + 0.0982*x3 - 0.1045*x1*x2
        dx3 = 0.0873*x1*x2 - 0.0390*x3 + 0.0532*x0
