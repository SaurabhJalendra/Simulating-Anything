...
class MountainWeatherSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0242*x1 - 0.0522*x0 + 0.0429*np.sin(0.0399*self._t)
        dx1 = -0.0295*x0*x1 + 0.0955*x2 - 0.0692*x1
        dx2 = 0.0976*x0 - 0.0442*x2 + 0.0228*x3 - 0.0608*x1*x2
        dx3 = 0.0500*x1*x2 - 0.0492*x3 + 0.0642*x0
