...
class BiomimeticMaterialSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0947*x1 - 0.1066*x0 + 0.0370*np.sin(0.1069*self._t)
        dx1 = -0.0543*x0*x1 + 0.1093*x2 - 0.1060*x1
        dx2 = 0.1074*x0 - 0.1117*x2 + 0.0749*x3 - 0.0508*x1*x2
        dx3 = 0.0610*x1*x2 - 0.0933*x3 + 0.0615*x0
