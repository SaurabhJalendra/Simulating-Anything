...
class BodyTemperatureSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1039*x1 - 0.0486*x0 + 0.0715*np.sin(0.0622*self._t)
        dx1 = -0.0867*x0*x1 + 0.1007*x2 - 0.0847*x1
        dx2 = 0.1059*x0 - 0.1016*x2 + 0.0234*x3 - 0.0409*x1*x2
        dx3 = 0.1127*x1*x2 - 0.0812*x3 + 0.0830*x0
