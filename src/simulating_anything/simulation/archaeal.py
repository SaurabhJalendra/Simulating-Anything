...
class ArchaealSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0647*x1 - 0.0693*x0 + 0.1093*np.sin(0.0863*self._t)
        dx1 = -0.0244*x0*x1 + 0.0797*x2 - 0.0818*x1
        dx2 = 0.0514*x0 - 0.0452*x2 + 0.0318*x3 - 0.0896*x1*x2
        dx3 = 0.0570*x1*x2 - 0.0829*x3 + 0.1019*x0
