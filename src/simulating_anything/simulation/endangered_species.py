...
class EndangeredSpeciesSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1376*x1 - 0.0695*x0 + 0.0491*np.sin(0.1003*self._t)
        dx1 = -0.1139*x0*x1 + 0.1378*x2 - 0.0816*x1
        dx2 = 0.1364*x0 - 0.1123*x2 + 0.0459*x3 - 0.0286*x1*x2
        dx3 = 0.0695*x1*x2 - 0.1226*x3 + 0.0770*x0
