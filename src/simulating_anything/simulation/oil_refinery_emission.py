...
class OilRefineryEmissionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0502*x1 - 0.0405*x0 + 0.1043*np.sin(0.1183*self._t)
        dx1 = -0.0690*x0*x1 + 0.0689*x2 - 0.0290*x1
        dx2 = 0.0539*x0 - 0.0947*x2 + 0.0751*x3 - 0.0938*x1*x2
        dx3 = 0.0895*x1*x2 - 0.0384*x3 + 0.0296*x0
