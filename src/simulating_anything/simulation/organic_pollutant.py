...
class OrganicPollutantSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0733*x1 - 0.1110*x0 + 0.0649*np.sin(0.1029*self._t)
        dx1 = -0.0214*x0*x1 + 0.0486*x2 - 0.0723*x1
        dx2 = 0.0273*x0 - 0.0419*x2 + 0.0423*x3 - 0.0771*x1*x2
        dx3 = 0.1124*x1*x2 - 0.1161*x3 + 0.0281*x0
