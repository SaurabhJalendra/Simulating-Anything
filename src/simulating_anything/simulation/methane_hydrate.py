...
class MethaneHydrateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1436*x1 - 0.0372*x0 + 0.1656*np.sin(0.1660*self._t)
        dx1 = -0.0649*x0*x1 + 0.0356*x2 - 0.0976*x1
        dx2 = 0.0749*x0 - 0.0569*x2 + 0.0996*x3 - 0.1427*x1*x2
        dx3 = 0.1573*x1*x2 - 0.1550*x3 + 0.1002*x0
