...
class BarkBeetleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0618*x1 - 0.0728*x0 + 0.0892*np.sin(0.0508*self._t)
        dx1 = -0.0405*x0*x1 + 0.0813*x2 - 0.0944*x1
        dx2 = 0.0482*x0 - 0.0386*x2 + 0.0777*x3 - 0.0268*x1*x2
        dx3 = 0.0235*x1*x2 - 0.0750*x3 + 0.1053*x0
