...
class FermentationControlSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1028*x1 - 0.1188*x0 + 0.0910*np.sin(0.0917*self._t)
        dx1 = -0.0264*x0*x1 + 0.0775*x2 - 0.0479*x1
        dx2 = 0.0974*x0 - 0.0264*x2 + 0.0859*x3 - 0.0542*x1*x2
        dx3 = 0.1141*x1*x2 - 0.0382*x3 + 0.0698*x0
