...
class DioxinBioaccumulationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0969*x1 - 0.0650*x0 + 0.0450*np.sin(0.0990*self._t)
        dx1 = -0.0887*x0*x1 + 0.1066*x2 - 0.0785*x1
        dx2 = 0.0958*x0 - 0.0962*x2 + 0.0783*x3 - 0.1143*x1*x2
        dx3 = 0.0592*x1*x2 - 0.0480*x3 + 0.0496*x0
