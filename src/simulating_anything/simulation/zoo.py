...
class ZooSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0500*x1 - 0.0817*x0 + 0.1014*np.sin(0.0445*self._t)
        dx1 = -0.1097*x0*x1 + 0.0709*x2 - 0.0370*x1
        dx2 = 0.0322*x0 - 0.0862*x2 + 0.0591*x3 - 0.0722*x1*x2
        dx3 = 0.0470*x1*x2 - 0.0730*x3 + 0.0516*x0
