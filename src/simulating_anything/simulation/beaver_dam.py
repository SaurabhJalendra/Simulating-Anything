...
class BeaverDamSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0677*x1 - 0.1414*x0 + 0.1645*np.sin(0.0867*self._t)
        dx1 = -0.0257*x0*x1 + 0.1318*x2 - 0.0529*x1
        dx2 = 0.0226*x0 - 0.1460*x2 + 0.1673*x3 - 0.1229*x1*x2
        dx3 = 0.0691*x1*x2 - 0.1548*x3 + 0.0851*x0
