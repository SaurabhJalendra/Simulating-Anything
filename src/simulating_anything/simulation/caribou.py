...
class CaribouSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1081*x1 - 0.0711*x0 + 0.0481*np.sin(0.0751*self._t)
        dx1 = -0.1150*x0*x1 + 0.0625*x2 - 0.0565*x1
        dx2 = 0.0549*x0 - 0.0742*x2 + 0.0665*x3 - 0.0517*x1*x2
        dx3 = 0.0554*x1*x2 - 0.0893*x3 + 0.0209*x0
