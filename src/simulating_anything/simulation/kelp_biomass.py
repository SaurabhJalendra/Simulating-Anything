...
class KelpBiomassSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0414*x1 - 0.0875*x0 + 0.0563*np.sin(0.0914*self._t)
        dx1 = -0.0576*x0*x1 + 0.1052*x2 - 0.0684*x1
        dx2 = 0.0503*x0 - 0.0678*x2 + 0.0426*x3 - 0.0632*x1*x2
        dx3 = 0.0825*x1*x2 - 0.0871*x3 + 0.0860*x0
