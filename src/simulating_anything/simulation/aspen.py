...
class AspenSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0645*x1 - 0.0781*x0 + 0.0832*np.sin(0.0654*self._t)
        dx1 = -0.1105*x0*x1 + 0.0506*x2 - 0.0903*x1
        dx2 = 0.0211*x0 - 0.0780*x2 + 0.0294*x3 - 0.0859*x1*x2
        dx3 = 0.0745*x1*x2 - 0.0939*x3 + 0.0367*x0
