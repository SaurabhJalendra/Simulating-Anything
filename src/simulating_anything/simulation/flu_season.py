...
class FluSeasonSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0258*x1 - 0.0893*x0 + 0.1188*np.sin(0.0499*self._t)
        dx1 = -0.0896*x0*x1 + 0.0252*x2 - 0.0331*x1
        dx2 = 0.0399*x0 - 0.0632*x2 + 0.0742*x3 - 0.0643*x1*x2
        dx3 = 0.0636*x1*x2 - 0.0687*x3 + 0.0537*x0
