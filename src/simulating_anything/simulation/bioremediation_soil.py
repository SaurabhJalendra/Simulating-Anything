...
class BioremediationSoilSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0860*x1 - 0.1089*x0 + 0.0712*np.sin(0.0357*self._t)
        dx1 = -0.0227*x0*x1 + 0.1141*x2 - 0.0626*x1
        dx2 = 0.1159*x0 - 0.0989*x2 + 0.0439*x3 - 0.0678*x1*x2
        dx3 = 0.0416*x1*x2 - 0.0937*x3 + 0.0764*x0
