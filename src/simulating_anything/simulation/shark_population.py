...
class SharkPopulationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0423*x1 - 0.0728*x0 + 0.0898*np.sin(0.0504*self._t)
        dx1 = -0.0423*x0*x1 + 0.0893*x2 - 0.0324*x1
        dx2 = 0.0422*x0 - 0.0923*x2 + 0.0603*x3 - 0.0677*x1*x2
        dx3 = 0.0992*x1*x2 - 0.0492*x3 + 0.1104*x0
