...
class KelpCarbonSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0342*x1 - 0.0303*x0 + 0.0652*np.sin(0.0386*self._t)
        dx1 = -0.1142*x0*x1 + 0.0641*x2 - 0.0708*x1
        dx2 = 0.0387*x0 - 0.1076*x2 + 0.0769*x3 - 0.0882*x1*x2
        dx3 = 0.1048*x1*x2 - 0.0545*x3 + 0.0467*x0
