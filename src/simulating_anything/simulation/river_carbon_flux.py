...
class RiverCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1129*x1 - 0.0850*x0 + 0.0969*np.sin(0.0737*self._t)
        dx1 = -0.1038*x0*x1 + 0.1110*x2 - 0.0785*x1
        dx2 = 0.1110*x0 - 0.1121*x2 + 0.0266*x3 - 0.0388*x1*x2
        dx3 = 0.1170*x1*x2 - 0.1009*x3 + 0.0598*x0
