...
class ZebraMusselSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1114*x1 - 0.0276*x0 + 0.0558*np.sin(0.1049*self._t)
        dx1 = -0.0245*x0*x1 + 0.0872*x2 - 0.0819*x1
        dx2 = 0.0622*x0 - 0.0557*x2 + 0.0872*x3 - 0.0868*x1*x2
        dx3 = 0.0486*x1*x2 - 0.0737*x3 + 0.0906*x0
