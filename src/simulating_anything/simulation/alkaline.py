...
class AlkalineSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0273*x1 - 0.0623*x0 + 0.0930*np.sin(0.0395*self._t)
        dx1 = -0.0242*x0*x1 + 0.1125*x2 - 0.0926*x1
        dx2 = 0.0426*x0 - 0.0427*x2 + 0.0645*x3 - 0.0452*x1*x2
        dx3 = 0.0868*x1*x2 - 0.0627*x3 + 0.0713*x0
