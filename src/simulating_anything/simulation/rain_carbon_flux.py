...
class RainCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1100*x1 - 0.0272*x0 + 0.0786*np.sin(0.0389*self._t)
        dx1 = -0.0264*x0*x1 + 0.0808*x2 - 0.0887*x1
        dx2 = 0.0841*x0 - 0.0383*x2 + 0.0223*x3 - 0.1046*x1*x2
        dx3 = 0.0803*x1*x2 - 0.0784*x3 + 0.0958*x0
