...
class PlateletAggregationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0907*x1 - 0.0865*x0 + 0.0735*np.sin(0.0683*self._t)
        dx1 = -0.0746*x0*x1 + 0.0588*x2 - 0.1198*x1
        dx2 = 0.0632*x0 - 0.0606*x2 + 0.0617*x3 - 0.0386*x1*x2
        dx3 = 0.0473*x1*x2 - 0.0306*x3 + 0.0536*x0
