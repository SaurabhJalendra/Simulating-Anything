...
class BiosecuritySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0925*x1 - 0.0941*x0 + 0.0210*np.sin(0.0799*self._t)
        dx1 = -0.0365*x0*x1 + 0.1129*x2 - 0.0205*x1
        dx2 = 0.0651*x0 - 0.1136*x2 + 0.1067*x3 - 0.0540*x1*x2
        dx3 = 0.0221*x1*x2 - 0.0633*x3 + 0.0902*x0
