...
class DiseaseVectorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0513*x1 - 0.0473*x0 + 0.1132*np.sin(0.0601*self._t)
        dx1 = -0.0861*x0*x1 + 0.0478*x2 - 0.0451*x1
        dx2 = 0.1027*x0 - 0.0234*x2 + 0.0881*x3 - 0.0435*x1*x2
        dx3 = 0.0674*x1*x2 - 0.0335*x3 + 0.1036*x0
