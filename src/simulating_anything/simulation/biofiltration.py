...
class BiofiltrationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0326*x1 - 0.0405*x0 + 0.0593*np.sin(0.0648*self._t)
        dx1 = -0.0462*x0*x1 + 0.0815*x2 - 0.0759*x1
        dx2 = 0.0591*x0 - 0.0981*x2 + 0.1171*x3 - 0.0414*x1*x2
        dx3 = 0.1133*x1*x2 - 0.1144*x3 + 0.1046*x0
