...
class FishStockRecoverySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0417*x1 - 0.0647*x0 + 0.0511*np.sin(0.0755*self._t)
        dx1 = -0.1281*x0*x1 + 0.1171*x2 - 0.1313*x1
        dx2 = 0.0950*x0 - 0.0531*x2 + 0.0404*x3 - 0.0259*x1*x2
        dx3 = 0.1242*x1*x2 - 0.0936*x3 + 0.0690*x0
