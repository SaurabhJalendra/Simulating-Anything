...
class RootGrowthSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1112*x1 - 0.0769*x0 + 0.1218*np.sin(0.1307*self._t)
        dx1 = -0.1061*x0*x1 + 0.1554*x2 - 0.0741*x1
        dx2 = 0.0929*x0 - 0.1254*x2 + 0.0794*x3 - 0.0269*x1*x2
        dx3 = 0.0947*x1*x2 - 0.0822*x3 + 0.0987*x0
