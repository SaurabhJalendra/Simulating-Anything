...
class OspreyFishingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0816*x1 - 0.0815*x0 + 0.1275*np.sin(0.0529*self._t)
        dx1 = -0.0566*x0*x1 + 0.0856*x2 - 0.0997*x1
        dx2 = 0.1655*x0 - 0.1468*x2 + 0.1276*x3 - 0.0803*x1*x2
        dx3 = 0.0485*x1*x2 - 0.0588*x3 + 0.0216*x0
