...
class DiamondAnvilSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0727*x1 - 0.0558*x0 + 0.0672*np.sin(0.0354*self._t)
        dx1 = -0.0813*x0*x1 + 0.1053*x2 - 0.0551*x1
        dx2 = 0.0253*x0 - 0.0431*x2 + 0.0302*x3 - 0.1063*x1*x2
        dx3 = 0.0536*x1*x2 - 0.0339*x3 + 0.0358*x0
