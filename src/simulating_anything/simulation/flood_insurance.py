...
class FloodInsuranceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0750*x1 - 0.0458*x0 + 0.0868*np.sin(0.0380*self._t)
        dx1 = -0.1028*x0*x1 + 0.0849*x2 - 0.0786*x1
        dx2 = 0.0445*x0 - 0.0444*x2 + 0.0403*x3 - 0.0903*x1*x2
        dx3 = 0.0372*x1*x2 - 0.1179*x3 + 0.0999*x0
