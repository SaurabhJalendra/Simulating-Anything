...
class BananaSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0584*x1 - 0.0792*x0 + 0.1061*np.sin(0.0780*self._t)
        dx1 = -0.0645*x0*x1 + 0.0743*x2 - 0.0326*x1
        dx2 = 0.0927*x0 - 0.0471*x2 + 0.0543*x3 - 0.1059*x1*x2
        dx3 = 0.0922*x1*x2 - 0.0352*x3 + 0.0414*x0
