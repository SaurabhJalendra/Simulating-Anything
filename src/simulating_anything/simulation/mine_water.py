...
class MineWaterSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0509*x1 - 0.0370*x0 + 0.0282*np.sin(0.0541*self._t)
        dx1 = -0.1059*x0*x1 + 0.1038*x2 - 0.0817*x1
        dx2 = 0.0480*x0 - 0.0238*x2 + 0.0590*x3 - 0.0942*x1*x2
        dx3 = 0.0479*x1*x2 - 0.0788*x3 + 0.0554*x0
