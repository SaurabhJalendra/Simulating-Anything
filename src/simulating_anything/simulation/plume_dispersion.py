...
class PlumeDispersionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1162*x1 - 0.0761*x0 + 0.0260*np.sin(0.1035*self._t)
        dx1 = -0.1067*x0*x1 + 0.0254*x2 - 0.0724*x1
        dx2 = 0.1128*x0 - 0.1114*x2 + 0.0864*x3 - 0.0709*x1*x2
        dx3 = 0.0220*x1*x2 - 0.0582*x3 + 0.1197*x0
