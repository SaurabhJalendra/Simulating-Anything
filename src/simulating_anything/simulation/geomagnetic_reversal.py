...
class GeomagneticReversalSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0309*x1 - 0.0623*x0 + 0.0310*np.sin(0.1006*self._t)
        dx1 = -0.0216*x0*x1 + 0.0670*x2 - 0.0790*x1
        dx2 = 0.0947*x0 - 0.0603*x2 + 0.0823*x3 - 0.0852*x1*x2
        dx3 = 0.0301*x1*x2 - 0.0543*x3 + 0.0576*x0
