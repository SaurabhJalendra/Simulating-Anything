...
class BioelectricitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0921*x1 - 0.0917*x0 + 0.0958*np.sin(0.1148*self._t)
        dx1 = -0.1046*x0*x1 + 0.0216*x2 - 0.0211*x1
        dx2 = 0.1050*x0 - 0.0514*x2 + 0.0260*x3 - 0.0575*x1*x2
        dx3 = 0.0785*x1*x2 - 0.0533*x3 + 0.0657*x0
