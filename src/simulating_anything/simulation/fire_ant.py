...
class FireAntSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1274*x1 - 0.1589*x0 + 0.0342*np.sin(0.0216*self._t)
        dx1 = -0.0569*x0*x1 + 0.0397*x2 - 0.0863*x1
        dx2 = 0.0867*x0 - 0.1586*x2 + 0.0227*x3 - 0.0691*x1*x2
        dx3 = 0.0742*x1*x2 - 0.1339*x3 + 0.0592*x0
