...
class PainSignalSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0227*x1 - 0.0703*x0 + 0.1198*np.sin(0.1154*self._t)
        dx1 = -0.0285*x0*x1 + 0.0244*x2 - 0.0680*x1
        dx2 = 0.1126*x0 - 0.1142*x2 + 0.0800*x3 - 0.0509*x1*x2
        dx3 = 0.1187*x1*x2 - 0.1087*x3 + 0.0704*x0
