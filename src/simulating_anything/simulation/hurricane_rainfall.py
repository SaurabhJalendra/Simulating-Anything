...
class HurricaneRainfallSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1306*x1 - 0.0436*x0 + 0.1329*np.sin(0.1112*self._t)
        dx1 = -0.0786*x0*x1 + 0.0212*x2 - 0.0908*x1
        dx2 = 0.1030*x0 - 0.0313*x2 + 0.0584*x3 - 0.0546*x1*x2
        dx3 = 0.1018*x1*x2 - 0.0639*x3 + 0.0492*x0
