...
class EpidemicNetworkSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0448*x1 - 0.0936*x0 + 0.0203*np.sin(0.1043*self._t)
        dx1 = -0.0435*x0*x1 + 0.0239*x2 - 0.0488*x1
        dx2 = 0.1016*x0 - 0.0724*x2 + 0.1118*x3 - 0.0662*x1*x2
        dx3 = 0.0611*x1*x2 - 0.0476*x3 + 0.0308*x0
