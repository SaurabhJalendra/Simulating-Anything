...
class AppleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0866*x1 - 0.0307*x0 + 0.0730*np.sin(0.0602*self._t)
        dx1 = -0.0311*x0*x1 + 0.1109*x2 - 0.0548*x1
        dx2 = 0.1105*x0 - 0.0888*x2 + 0.0205*x3 - 0.0691*x1*x2
        dx3 = 0.1008*x1*x2 - 0.0702*x3 + 0.0320*x0
