...
class DroughtMonitoringSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0279*x1 - 0.0958*x0 + 0.1053*np.sin(0.0507*self._t)
        dx1 = -0.0247*x0*x1 + 0.0265*x2 - 0.0213*x1
        dx2 = 0.1110*x0 - 0.0411*x2 + 0.0573*x3 - 0.0543*x1*x2
        dx3 = 0.1016*x1*x2 - 0.0307*x3 + 0.0308*x0
