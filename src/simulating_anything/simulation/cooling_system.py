...
class CoolingSystemSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0438*x1 - 0.0437*x0 + 0.0804*np.sin(0.0212*self._t)
        dx1 = -0.0371*x0*x1 + 0.1173*x2 - 0.0939*x1
        dx2 = 0.0739*x0 - 0.1195*x2 + 0.0787*x3 - 0.1144*x1*x2
        dx3 = 0.0944*x1*x2 - 0.1034*x3 + 0.1076*x0
