...
class GoldLeachingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0930*x1 - 0.0605*x0 + 0.0697*np.sin(0.0784*self._t)
        dx1 = -0.1119*x0*x1 + 0.0971*x2 - 0.0305*x1
        dx2 = 0.0650*x0 - 0.1471*x2 + 0.0575*x3 - 0.0472*x1*x2
        dx3 = 0.0548*x1*x2 - 0.0874*x3 + 0.1393*x0
