...
class CanopyGapSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1191*x1 - 0.1075*x0 + 0.0404*np.sin(0.0877*self._t)
        dx1 = -0.0587*x0*x1 + 0.0894*x2 - 0.1196*x1
        dx2 = 0.0704*x0 - 0.0852*x2 + 0.1104*x3 - 0.0316*x1*x2
        dx3 = 0.0991*x1*x2 - 0.0685*x3 + 0.0497*x0
