...
class DieselExhaustSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0353*x1 - 0.0671*x0 + 0.1121*np.sin(0.0250*self._t)
        dx1 = -0.1142*x0*x1 + 0.0802*x2 - 0.0460*x1
        dx2 = 0.0850*x0 - 0.0379*x2 + 0.0305*x3 - 0.0205*x1*x2
        dx3 = 0.0384*x1*x2 - 0.0520*x3 + 0.0322*x0
