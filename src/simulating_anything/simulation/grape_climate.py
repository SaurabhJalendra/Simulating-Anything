...
class GrapeClimateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0947*x1 - 0.0221*x0 + 0.0689*np.sin(0.0371*self._t)
        dx1 = -0.1118*x0*x1 + 0.1084*x2 - 0.0440*x1
        dx2 = 0.0848*x0 - 0.1131*x2 + 0.0963*x3 - 0.0787*x1*x2
        dx3 = 0.0396*x1*x2 - 0.1108*x3 + 0.0676*x0
