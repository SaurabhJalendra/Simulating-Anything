...
class PopulationGrowthSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1029*x1 - 0.1119*x0 + 0.0813*np.sin(0.0639*self._t)
        dx1 = -0.0460*x0*x1 + 0.0765*x2 - 0.0987*x1
        dx2 = 0.0244*x0 - 0.0467*x2 + 0.0247*x3 - 0.0431*x1*x2
        dx3 = 0.0808*x1*x2 - 0.0212*x3 + 0.0980*x0
