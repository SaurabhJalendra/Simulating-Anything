...
class BiocharSoilSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0337*x1 - 0.0321*x0 + 0.0414*np.sin(0.0794*self._t)
        dx1 = -0.0315*x0*x1 + 0.0500*x2 - 0.1113*x1
        dx2 = 0.0421*x0 - 0.0480*x2 + 0.1184*x3 - 0.0808*x1*x2
        dx3 = 0.1154*x1*x2 - 0.0477*x3 + 0.0906*x0
