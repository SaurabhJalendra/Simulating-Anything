...
class PlacentaSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1157*x1 - 0.0808*x0 + 0.0860*np.sin(0.0774*self._t)
        dx1 = -0.0752*x0*x1 + 0.0756*x2 - 0.0279*x1
        dx2 = 0.0271*x0 - 0.0556*x2 + 0.0795*x3 - 0.0326*x1*x2
        dx3 = 0.1170*x1*x2 - 0.0677*x3 + 0.0288*x0
