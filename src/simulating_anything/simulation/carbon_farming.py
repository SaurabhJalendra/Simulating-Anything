...
class CarbonFarmingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0732*x1 - 0.1117*x0 + 0.1151*np.sin(0.1208*self._t)
        dx1 = -0.1472*x0*x1 + 0.0783*x2 - 0.0437*x1
        dx2 = 0.0853*x0 - 0.1627*x2 + 0.1584*x3 - 0.1454*x1*x2
        dx3 = 0.0364*x1*x2 - 0.0816*x3 + 0.0589*x0
