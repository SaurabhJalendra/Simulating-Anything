...
class ClamHarvestSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0241*x1 - 0.0401*x0 + 0.0253*np.sin(0.0810*self._t)
        dx1 = -0.0829*x0*x1 + 0.1155*x2 - 0.1124*x1
        dx2 = 0.0375*x0 - 0.0442*x2 + 0.0757*x3 - 0.0878*x1*x2
        dx3 = 0.0765*x1*x2 - 0.0293*x3 + 0.0397*x0
