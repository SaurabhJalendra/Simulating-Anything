...
class PermafrostCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0310*x1 - 0.0716*x0 + 0.0348*np.sin(0.0545*self._t)
        dx1 = -0.1129*x0*x1 + 0.0329*x2 - 0.1020*x1
        dx2 = 0.0673*x0 - 0.1089*x2 + 0.1009*x3 - 0.1052*x1*x2
        dx3 = 0.0783*x1*x2 - 0.0987*x3 + 0.1051*x0
