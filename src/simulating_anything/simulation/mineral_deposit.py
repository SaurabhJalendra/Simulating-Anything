...
class MineralDepositSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0924*x1 - 0.0397*x0 + 0.0444*np.sin(0.1147*self._t)
        dx1 = -0.1038*x0*x1 + 0.0587*x2 - 0.0277*x1
        dx2 = 0.0478*x0 - 0.0792*x2 + 0.0704*x3 - 0.0494*x1*x2
        dx3 = 0.0607*x1*x2 - 0.1078*x3 + 0.0387*x0
