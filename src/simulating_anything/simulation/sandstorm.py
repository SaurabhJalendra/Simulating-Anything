...
class SandstormSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0232*x1 - 0.1430*x0 + 0.0240*np.sin(0.0552*self._t)
        dx1 = -0.1641*x0*x1 + 0.1684*x2 - 0.0869*x1
        dx2 = 0.0841*x0 - 0.1577*x2 + 0.0923*x3 - 0.0855*x1*x2
        dx3 = 0.1694*x1*x2 - 0.0495*x3 + 0.0827*x0
