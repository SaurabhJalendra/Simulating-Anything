...
class MyceliumNetworkSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1003*x1 - 0.0564*x0 + 0.0910*np.sin(0.0662*self._t)
        dx1 = -0.0922*x0*x1 + 0.0334*x2 - 0.0267*x1
        dx2 = 0.1157*x0 - 0.0633*x2 + 0.0517*x3 - 0.0571*x1*x2
        dx3 = 0.0372*x1*x2 - 0.0599*x3 + 0.0672*x0
