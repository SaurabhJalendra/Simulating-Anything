...
class ZincSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0826*x1 - 0.0658*x0 + 0.0704*np.sin(0.0211*self._t)
        dx1 = -0.1042*x0*x1 + 0.0292*x2 - 0.0314*x1
        dx2 = 0.1039*x0 - 0.0334*x2 + 0.0693*x3 - 0.0439*x1*x2
        dx3 = 0.0398*x1*x2 - 0.0655*x3 + 0.0531*x0
