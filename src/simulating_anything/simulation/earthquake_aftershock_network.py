...
class EarthquakeAftershockNetworkSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0984*x1 - 0.0667*x0 + 0.0268*np.sin(0.0313*self._t)
        dx1 = -0.0807*x0*x1 + 0.0791*x2 - 0.0697*x1
        dx2 = 0.1052*x0 - 0.0508*x2 + 0.0741*x3 - 0.0301*x1*x2
        dx3 = 0.0658*x1*x2 - 0.1051*x3 + 0.0246*x0
