...
class AmmoniaEmissionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0420*x1 - 0.0991*x0 + 0.0269*np.sin(0.0996*self._t)
        dx1 = -0.1003*x0*x1 + 0.0703*x2 - 0.0924*x1
        dx2 = 0.0600*x0 - 0.0659*x2 + 0.0649*x3 - 0.1182*x1*x2
        dx3 = 0.0227*x1*x2 - 0.0993*x3 + 0.0550*x0
