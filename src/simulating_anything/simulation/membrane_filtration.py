...
class MembraneFiltrationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0217*x1 - 0.1152*x0 + 0.0608*np.sin(0.0965*self._t)
        dx1 = -0.1082*x0*x1 + 0.0786*x2 - 0.0740*x1
        dx2 = 0.0984*x0 - 0.0912*x2 + 0.0292*x3 - 0.0814*x1*x2
        dx3 = 0.0787*x1*x2 - 0.1153*x3 + 0.0846*x0
