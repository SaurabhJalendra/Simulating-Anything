...
class NeutronStarSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1006*x1 - 0.0441*x0 + 0.0775*np.sin(0.0346*self._t)
        dx1 = -0.0882*x0*x1 + 0.0867*x2 - 0.0263*x1
        dx2 = 0.1187*x0 - 0.1052*x2 + 0.0683*x3 - 0.0544*x1*x2
        dx3 = 0.0360*x1*x2 - 0.0533*x3 + 0.1122*x0
