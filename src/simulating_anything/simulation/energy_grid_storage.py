...
class EnergyGridStorageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1107*x1 - 0.0581*x0 + 0.1189*np.sin(0.0824*self._t)
        dx1 = -0.0933*x0*x1 + 0.0976*x2 - 0.0519*x1
        dx2 = 0.1092*x0 - 0.0863*x2 + 0.0365*x3 - 0.0993*x1*x2
        dx3 = 0.0237*x1*x2 - 0.0980*x3 + 0.1065*x0
