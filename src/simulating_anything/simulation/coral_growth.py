...
class CoralGrowthSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0358*x1 - 0.0448*x0 + 0.0208*np.sin(0.0774*self._t)
        dx1 = -0.0231*x0*x1 + 0.0681*x2 - 0.0296*x1
        dx2 = 0.0849*x0 - 0.0875*x2 + 0.0909*x3 - 0.0472*x1*x2
        dx3 = 0.0464*x1*x2 - 0.0461*x3 + 0.0395*x0
