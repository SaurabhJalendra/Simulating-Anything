...
class AgriculturalRunoffSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0977*x1 - 0.0809*x0 + 0.0251*np.sin(0.0695*self._t)
        dx1 = -0.1113*x0*x1 + 0.1131*x2 - 0.0878*x1
        dx2 = 0.0291*x0 - 0.0394*x2 + 0.0365*x3 - 0.0573*x1*x2
        dx3 = 0.1052*x1*x2 - 0.1029*x3 + 0.1197*x0
