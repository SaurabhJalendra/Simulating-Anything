...
class SoilAggregateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0646*x1 - 0.1110*x0 + 0.0262*np.sin(0.0752*self._t)
        dx1 = -0.0924*x0*x1 + 0.0296*x2 - 0.0212*x1
        dx2 = 0.0313*x0 - 0.0251*x2 + 0.0722*x3 - 0.1136*x1*x2
        dx3 = 0.1133*x1*x2 - 0.0463*x3 + 0.0756*x0
