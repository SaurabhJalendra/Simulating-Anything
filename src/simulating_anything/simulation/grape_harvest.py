...
class GrapeHarvestSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0650*x1 - 0.0234*x0 + 0.0360*np.sin(0.0547*self._t)
        dx1 = -0.0498*x0*x1 + 0.0441*x2 - 0.1170*x1
        dx2 = 0.0462*x0 - 0.0714*x2 + 0.1190*x3 - 0.0662*x1*x2
        dx3 = 0.0240*x1*x2 - 0.0792*x3 + 0.1137*x0
