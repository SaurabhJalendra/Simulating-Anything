...
class UraniumDecaySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0480*x1 - 0.1028*x0 + 0.1113*np.sin(0.0883*self._t)
        dx1 = -0.0818*x0*x1 + 0.0495*x2 - 0.0508*x1
        dx2 = 0.0867*x0 - 0.1091*x2 + 0.1035*x3 - 0.0831*x1*x2
        dx3 = 0.0673*x1*x2 - 0.0534*x3 + 0.1159*x0
