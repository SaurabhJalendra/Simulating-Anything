...
class SalmonLifecycleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1678*x1 - 0.1245*x0 + 0.1385*np.sin(0.1038*self._t)
        dx1 = -0.0378*x0*x1 + 0.0531*x2 - 0.0849*x1
        dx2 = 0.1165*x0 - 0.0929*x2 + 0.0929*x3 - 0.1217*x1*x2
        dx3 = 0.0567*x1*x2 - 0.1556*x3 + 0.0259*x0
