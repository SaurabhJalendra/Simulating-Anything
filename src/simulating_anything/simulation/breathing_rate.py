...
class BreathingRateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0315*x1 - 0.0683*x0 + 0.0443*np.sin(0.0910*self._t)
        dx1 = -0.0972*x0*x1 + 0.0863*x2 - 0.0652*x1
        dx2 = 0.0704*x0 - 0.0794*x2 + 0.0620*x3 - 0.0888*x1*x2
        dx3 = 0.0382*x1*x2 - 0.0879*x3 + 0.0859*x0
