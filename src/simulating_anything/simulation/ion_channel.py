...
class IonChannelSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0827*x1 - 0.0964*x0 + 0.1157*np.sin(0.0871*self._t)
        dx1 = -0.0308*x0*x1 + 0.0531*x2 - 0.0397*x1
        dx2 = 0.0314*x0 - 0.0681*x2 + 0.0667*x3 - 0.0558*x1*x2
        dx3 = 0.1069*x1*x2 - 0.1037*x3 + 0.1185*x0
