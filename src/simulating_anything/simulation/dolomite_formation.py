...
class DolomiteFormationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0829*x1 - 0.0405*x0 + 0.0987*np.sin(0.0863*self._t)
        dx1 = -0.1161*x0*x1 + 0.0948*x2 - 0.0614*x1
        dx2 = 0.0925*x0 - 0.0636*x2 + 0.0202*x3 - 0.0761*x1*x2
        dx3 = 0.1148*x1*x2 - 0.1171*x3 + 0.0398*x0
