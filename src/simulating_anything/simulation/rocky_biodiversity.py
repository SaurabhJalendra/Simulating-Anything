...
class RockyBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0980*x1 - 0.0844*x0 + 0.0696*np.sin(0.0451*self._t)
        dx1 = -0.0472*x0*x1 + 0.0745*x2 - 0.0492*x1
        dx2 = 0.0352*x0 - 0.0310*x2 + 0.0677*x3 - 0.0616*x1*x2
        dx3 = 0.0588*x1*x2 - 0.0324*x3 + 0.0332*x0
