...
class QuantumDotSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0561*x1 - 0.0550*x0 + 0.0260*np.sin(0.0443*self._t)
        dx1 = -0.1043*x0*x1 + 0.0520*x2 - 0.1072*x1
        dx2 = 0.0939*x0 - 0.0974*x2 + 0.0626*x3 - 0.1024*x1*x2
        dx3 = 0.0235*x1*x2 - 0.0248*x3 + 0.1084*x0
