...
class ElectricGridSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0323*x1 - 0.1034*x0 + 0.0703*np.sin(0.1040*self._t)
        dx1 = -0.1187*x0*x1 + 0.0730*x2 - 0.0328*x1
        dx2 = 0.0452*x0 - 0.1173*x2 + 0.0209*x3 - 0.1064*x1*x2
        dx3 = 0.0310*x1*x2 - 0.0422*x3 + 0.0829*x0
