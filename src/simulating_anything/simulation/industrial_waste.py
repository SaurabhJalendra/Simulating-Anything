...
class IndustrialWasteSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1304*x1 - 0.0554*x0 + 0.0543*np.sin(0.0441*self._t)
        dx1 = -0.1160*x0*x1 + 0.0561*x2 - 0.0802*x1
        dx2 = 0.0346*x0 - 0.0608*x2 + 0.0486*x3 - 0.1145*x1*x2
        dx3 = 0.0254*x1*x2 - 0.0607*x3 + 0.0713*x0
