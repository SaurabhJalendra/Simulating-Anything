...
class IndustrialBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0512*x1 - 0.1037*x0 + 0.1103*np.sin(0.0719*self._t)
        dx1 = -0.0662*x0*x1 + 0.1130*x2 - 0.0815*x1
        dx2 = 0.0613*x0 - 0.0250*x2 + 0.0316*x3 - 0.0356*x1*x2
        dx3 = 0.0784*x1*x2 - 0.1153*x3 + 0.0318*x0
