...
class LiverMetabolismSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1475*x1 - 0.1139*x0 + 0.1459*np.sin(0.0666*self._t)
        dx1 = -0.0527*x0*x1 + 0.1626*x2 - 0.0757*x1
        dx2 = 0.1137*x0 - 0.1156*x2 + 0.1631*x3 - 0.1417*x1*x2
        dx3 = 0.0937*x1*x2 - 0.0336*x3 + 0.1386*x0
