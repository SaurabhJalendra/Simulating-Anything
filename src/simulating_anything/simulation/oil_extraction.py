...
class OilExtractionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0696*x1 - 0.0452*x0 + 0.0985*np.sin(0.1197*self._t)
        dx1 = -0.0659*x0*x1 + 0.0647*x2 - 0.1113*x1
        dx2 = 0.0923*x0 - 0.0890*x2 + 0.0200*x3 - 0.1087*x1*x2
        dx3 = 0.0899*x1*x2 - 0.0426*x3 + 0.0618*x0
