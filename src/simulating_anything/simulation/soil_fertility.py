...
class SoilFertilitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1085*x1 - 0.0954*x0 + 0.0331*np.sin(0.0325*self._t)
        dx1 = -0.1141*x0*x1 + 0.0400*x2 - 0.0746*x1
        dx2 = 0.0921*x0 - 0.0371*x2 + 0.0944*x3 - 0.0422*x1*x2
        dx3 = 0.0597*x1*x2 - 0.1162*x3 + 0.0648*x0
