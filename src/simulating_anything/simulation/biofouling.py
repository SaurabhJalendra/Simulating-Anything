...
class BiofoulingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0954*x1 - 0.0354*x0 + 0.1169*np.sin(0.0937*self._t)
        dx1 = -0.0850*x0*x1 + 0.0373*x2 - 0.0221*x1
        dx2 = 0.0460*x0 - 0.0693*x2 + 0.1054*x3 - 0.0923*x1*x2
        dx3 = 0.0800*x1*x2 - 0.0763*x3 + 0.0876*x0
