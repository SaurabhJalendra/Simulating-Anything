...
class AvalancheDebrisSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0841*x1 - 0.1135*x0 + 0.0867*np.sin(0.0376*self._t)
        dx1 = -0.0977*x0*x1 + 0.0398*x2 - 0.1069*x1
        dx2 = 0.1017*x0 - 0.0270*x2 + 0.1013*x3 - 0.0238*x1*x2
        dx3 = 0.0506*x1*x2 - 0.0855*x3 + 0.0467*x0
