...
class NitrogenCycleSoilSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0237*x1 - 0.0650*x0 + 0.0560*np.sin(0.0749*self._t)
        dx1 = -0.1068*x0*x1 + 0.0449*x2 - 0.0250*x1
        dx2 = 0.0266*x0 - 0.0672*x2 + 0.0463*x3 - 0.0996*x1*x2
        dx3 = 0.0378*x1*x2 - 0.0917*x3 + 0.0253*x0
