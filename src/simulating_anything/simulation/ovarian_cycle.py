...
class OvarianCycleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0266*x1 - 0.0565*x0 + 0.0737*np.sin(0.0688*self._t)
        dx1 = -0.0560*x0*x1 + 0.0271*x2 - 0.0227*x1
        dx2 = 0.1072*x0 - 0.0482*x2 + 0.1158*x3 - 0.1186*x1*x2
        dx3 = 0.0634*x1*x2 - 0.0787*x3 + 0.0275*x0
