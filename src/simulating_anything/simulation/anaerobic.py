...
class AnaerobicSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0882*x1 - 0.0886*x0 + 0.0987*np.sin(0.0354*self._t)
        dx1 = -0.0631*x0*x1 + 0.1083*x2 - 0.0544*x1
        dx2 = 0.0622*x0 - 0.0693*x2 + 0.0333*x3 - 0.1019*x1*x2
        dx3 = 0.0318*x1*x2 - 0.0562*x3 + 0.1109*x0
