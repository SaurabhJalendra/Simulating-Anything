...
class RiverDeltaSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0894*x1 - 0.1154*x0 + 0.0917*np.sin(0.0945*self._t)
        dx1 = -0.0793*x0*x1 + 0.1119*x2 - 0.1464*x1
        dx2 = 0.1426*x0 - 0.0546*x2 + 0.1225*x3 - 0.1458*x1*x2
        dx3 = 0.1654*x1*x2 - 0.1342*x3 + 0.1638*x0
