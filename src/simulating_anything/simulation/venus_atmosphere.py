...
class VenusAtmosphereSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1079*x1 - 0.0269*x0 + 0.0664*np.sin(0.1133*self._t)
        dx1 = -0.0271*x0*x1 + 0.0824*x2 - 0.0966*x1
        dx2 = 0.0604*x0 - 0.0829*x2 + 0.1156*x3 - 0.0616*x1*x2
        dx3 = 0.0982*x1*x2 - 0.0787*x3 + 0.0823*x0
