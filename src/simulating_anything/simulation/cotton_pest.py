...
class CottonPestSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0565*x1 - 0.1057*x0 + 0.0870*np.sin(0.0706*self._t)
        dx1 = -0.1049*x0*x1 + 0.0812*x2 - 0.0270*x1
        dx2 = 0.0968*x0 - 0.0633*x2 + 0.0346*x3 - 0.1054*x1*x2
        dx3 = 0.0749*x1*x2 - 0.1049*x3 + 0.0502*x0
