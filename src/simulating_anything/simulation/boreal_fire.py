...
class BorealFireSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0242*x1 - 0.0294*x0 + 0.0395*np.sin(0.0793*self._t)
        dx1 = -0.0276*x0*x1 + 0.0732*x2 - 0.0346*x1
        dx2 = 0.0232*x0 - 0.0943*x2 + 0.1134*x3 - 0.1017*x1*x2
        dx3 = 0.1157*x1*x2 - 0.0613*x3 + 0.0508*x0
