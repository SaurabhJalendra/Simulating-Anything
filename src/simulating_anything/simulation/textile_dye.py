...
class TextileDyeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0389*x1 - 0.0284*x0 + 0.0443*np.sin(0.0257*self._t)
        dx1 = -0.1174*x0*x1 + 0.0577*x2 - 0.1047*x1
        dx2 = 0.1029*x0 - 0.0711*x2 + 0.0549*x3 - 0.0848*x1*x2
        dx3 = 0.0418*x1*x2 - 0.0645*x3 + 0.1052*x0
