...
class CarbonCycleOceanSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1078*x1 - 0.0543*x0 + 0.0931*np.sin(0.1046*self._t)
        dx1 = -0.0423*x0*x1 + 0.1160*x2 - 0.1043*x1
        dx2 = 0.1089*x0 - 0.0415*x2 + 0.0695*x3 - 0.0986*x1*x2
        dx3 = 0.0779*x1*x2 - 0.1022*x3 + 0.0611*x0
