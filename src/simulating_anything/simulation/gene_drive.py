...
class GeneDriveSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0407*x1 - 0.0419*x0 + 0.0535*np.sin(0.0333*self._t)
        dx1 = -0.0868*x0*x1 + 0.0659*x2 - 0.0730*x1
        dx2 = 0.0284*x0 - 0.0715*x2 + 0.0693*x3 - 0.0924*x1*x2
        dx3 = 0.0335*x1*x2 - 0.0647*x3 + 0.0429*x0
