...
class AntibodyProductionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1178*x1 - 0.0839*x0 + 0.1198*np.sin(0.0609*self._t)
        dx1 = -0.0366*x0*x1 + 0.0206*x2 - 0.0279*x1
        dx2 = 0.0361*x0 - 0.0591*x2 + 0.0892*x3 - 0.0829*x1*x2
        dx3 = 0.1046*x1*x2 - 0.0412*x3 + 0.0502*x0
