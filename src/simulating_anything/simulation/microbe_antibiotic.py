...
class MicrobeAntibioticSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0487*x1 - 0.0285*x0 + 0.0926*np.sin(0.0565*self._t)
        dx1 = -0.0804*x0*x1 + 0.1052*x2 - 0.1047*x1
        dx2 = 0.0421*x0 - 0.0761*x2 + 0.0285*x3 - 0.1198*x1*x2
        dx3 = 0.0979*x1*x2 - 0.1030*x3 + 0.0393*x0
