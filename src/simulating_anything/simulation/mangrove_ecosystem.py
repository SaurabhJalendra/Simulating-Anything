...
class MangroveEcosystemSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0303*x1 - 0.0210*x0 + 0.1125*np.sin(0.0245*self._t)
        dx1 = -0.0207*x0*x1 + 0.1102*x2 - 0.0217*x1
        dx2 = 0.0596*x0 - 0.0540*x2 + 0.1161*x3 - 0.0447*x1*x2
        dx3 = 0.1034*x1*x2 - 0.1009*x3 + 0.1129*x0
