...
class DrainageBasinSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0796*x1 - 0.0532*x0 + 0.1194*np.sin(0.0742*self._t)
        dx1 = -0.0821*x0*x1 + 0.0910*x2 - 0.0579*x1
        dx2 = 0.0397*x0 - 0.0313*x2 + 0.0928*x3 - 0.0842*x1*x2
        dx3 = 0.1174*x1*x2 - 0.0796*x3 + 0.0470*x0
