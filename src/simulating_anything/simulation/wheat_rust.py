...
class WheatRustSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0392*x1 - 0.1002*x0 + 0.1036*np.sin(0.0979*self._t)
        dx1 = -0.0954*x0*x1 + 0.0345*x2 - 0.1184*x1
        dx2 = 0.0223*x0 - 0.0786*x2 + 0.0823*x3 - 0.1102*x1*x2
        dx3 = 0.0256*x1*x2 - 0.0376*x3 + 0.0729*x0
