...
class LakeOxygenSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0677*x1 - 0.0319*x0 + 0.0249*np.sin(0.0246*self._t)
        dx1 = -0.1164*x0*x1 + 0.0438*x2 - 0.1072*x1
        dx2 = 0.0335*x0 - 0.1064*x2 + 0.0272*x3 - 0.1106*x1*x2
        dx3 = 0.0637*x1*x2 - 0.1091*x3 + 0.1042*x0
