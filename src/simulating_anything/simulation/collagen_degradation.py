...
class CollagenDegradationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0711*x1 - 0.1003*x0 + 0.0489*np.sin(0.0252*self._t)
        dx1 = -0.1122*x0*x1 + 0.1062*x2 - 0.0910*x1
        dx2 = 0.0510*x0 - 0.0936*x2 + 0.0789*x3 - 0.1109*x1*x2
        dx3 = 0.0973*x1*x2 - 0.1050*x3 + 0.0625*x0
