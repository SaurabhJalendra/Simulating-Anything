...
class PlasticProductionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1150*x1 - 0.0252*x0 + 0.0227*np.sin(0.0626*self._t)
        dx1 = -0.1029*x0*x1 + 0.0602*x2 - 0.0980*x1
        dx2 = 0.1193*x0 - 0.0980*x2 + 0.0346*x3 - 0.0299*x1*x2
        dx3 = 0.1153*x1*x2 - 0.0540*x3 + 0.0499*x0
