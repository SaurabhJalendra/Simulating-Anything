...
class FishBehaviorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0238*x1 - 0.0700*x0 + 0.0354*np.sin(0.1182*self._t)
        dx1 = -0.0672*x0*x1 + 0.0351*x2 - 0.0433*x1
        dx2 = 0.1194*x0 - 0.0733*x2 + 0.1000*x3 - 0.1090*x1*x2
        dx3 = 0.0906*x1*x2 - 0.1078*x3 + 0.0495*x0
