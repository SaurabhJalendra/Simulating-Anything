...
class OceanCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0925*x1 - 0.0380*x0 + 0.0617*np.sin(0.0582*self._t)
        dx1 = -0.0672*x0*x1 + 0.0856*x2 - 0.0370*x1
        dx2 = 0.0715*x0 - 0.0414*x2 + 0.0557*x3 - 0.0514*x1*x2
        dx3 = 0.1134*x1*x2 - 0.0893*x3 + 0.0363*x0
