...
class ErosionControlSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1041*x1 - 0.0530*x0 + 0.0533*np.sin(0.0500*self._t)
        dx1 = -0.0594*x0*x1 + 0.0769*x2 - 0.0727*x1
        dx2 = 0.0283*x0 - 0.1164*x2 + 0.0659*x3 - 0.0618*x1*x2
        dx3 = 0.0796*x1*x2 - 0.0448*x3 + 0.0406*x0
