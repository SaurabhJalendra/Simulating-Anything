...
class IndustrialCoolingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0634*x1 - 0.0202*x0 + 0.0455*np.sin(0.0983*self._t)
        dx1 = -0.0709*x0*x1 + 0.0698*x2 - 0.0899*x1
        dx2 = 0.0409*x0 - 0.0905*x2 + 0.1006*x3 - 0.0647*x1*x2
        dx3 = 0.0405*x1*x2 - 0.0577*x3 + 0.0538*x0
