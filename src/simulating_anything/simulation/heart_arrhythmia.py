...
class HeartArrhythmiaSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1346*x1 - 0.1599*x0 + 0.1622*np.sin(0.0290*self._t)
        dx1 = -0.0509*x0*x1 + 0.0356*x2 - 0.0539*x1
        dx2 = 0.1524*x0 - 0.1010*x2 + 0.0483*x3 - 0.0891*x1*x2
        dx3 = 0.0215*x1*x2 - 0.0201*x3 + 0.0314*x0
