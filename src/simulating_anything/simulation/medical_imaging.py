...
class MedicalImagingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0958*x1 - 0.0291*x0 + 0.0300*np.sin(0.0868*self._t)
        dx1 = -0.1071*x0*x1 + 0.0423*x2 - 0.1195*x1
        dx2 = 0.1017*x0 - 0.0272*x2 + 0.0487*x3 - 0.0669*x1*x2
        dx3 = 0.1141*x1*x2 - 0.0832*x3 + 0.0204*x0
