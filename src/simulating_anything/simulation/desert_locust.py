...
class DesertLocustSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0527*x1 - 0.0409*x0 + 0.0280*np.sin(0.0797*self._t)
        dx1 = -0.0468*x0*x1 + 0.0724*x2 - 0.0906*x1
        dx2 = 0.0204*x0 - 0.1234*x2 + 0.0606*x3 - 0.0919*x1*x2
        dx3 = 0.1088*x1*x2 - 0.0441*x3 + 0.0517*x0
