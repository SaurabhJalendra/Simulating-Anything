...
class BeachSandSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0504*x1 - 0.0420*x0 + 0.1045*np.sin(0.0403*self._t)
        dx1 = -0.1105*x0*x1 + 0.1030*x2 - 0.1041*x1
        dx2 = 0.0703*x0 - 0.0624*x2 + 0.1185*x3 - 0.0778*x1*x2
        dx3 = 0.0263*x1*x2 - 0.0292*x3 + 0.1012*x0
