...
class RotaryEngineSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1046*x1 - 0.1198*x0 + 0.0220*np.sin(0.0961*self._t)
        dx1 = -0.0732*x0*x1 + 0.0254*x2 - 0.0475*x1
        dx2 = 0.0217*x0 - 0.0448*x2 + 0.0326*x3 - 0.0891*x1*x2
        dx3 = 0.1055*x1*x2 - 0.0386*x3 + 0.0521*x0
