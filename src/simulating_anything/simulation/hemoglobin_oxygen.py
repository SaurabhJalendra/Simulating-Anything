...
class HemoglobinOxygenSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1173*x1 - 0.0430*x0 + 0.0214*np.sin(0.0968*self._t)
        dx1 = -0.0786*x0*x1 + 0.1192*x2 - 0.0658*x1
        dx2 = 0.1083*x0 - 0.0997*x2 + 0.0925*x3 - 0.1155*x1*x2
        dx3 = 0.0578*x1*x2 - 0.0763*x3 + 0.0237*x0
