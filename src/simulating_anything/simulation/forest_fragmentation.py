...
class ForestFragmentationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0975*x1 - 0.0583*x0 + 0.1020*np.sin(0.0786*self._t)
        dx1 = -0.0559*x0*x1 + 0.0882*x2 - 0.0909*x1
        dx2 = 0.0248*x0 - 0.0626*x2 + 0.0449*x3 - 0.0311*x1*x2
        dx3 = 0.0545*x1*x2 - 0.0739*x3 + 0.0968*x0
