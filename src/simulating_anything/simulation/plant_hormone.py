...
class PlantHormoneSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0726*x1 - 0.1089*x0 + 0.1186*np.sin(0.0935*self._t)
        dx1 = -0.0565*x0*x1 + 0.0401*x2 - 0.0317*x1
        dx2 = 0.0759*x0 - 0.0419*x2 + 0.0761*x3 - 0.0697*x1*x2
        dx3 = 0.0351*x1*x2 - 0.0439*x3 + 0.0299*x0
