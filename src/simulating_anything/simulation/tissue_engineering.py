...
class TissueEngineeringSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0549*x1 - 0.0479*x0 + 0.0652*np.sin(0.1015*self._t)
        dx1 = -0.0672*x0*x1 + 0.1172*x2 - 0.0688*x1
        dx2 = 0.0645*x0 - 0.0291*x2 + 0.0556*x3 - 0.0561*x1*x2
        dx3 = 0.0425*x1*x2 - 0.0963*x3 + 0.0489*x0
