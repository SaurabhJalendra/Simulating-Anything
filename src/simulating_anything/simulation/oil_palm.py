...
class OilPalmSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0675*x1 - 0.0686*x0 + 0.0700*np.sin(0.0360*self._t)
        dx1 = -0.0719*x0*x1 + 0.0824*x2 - 0.0509*x1
        dx2 = 0.0647*x0 - 0.0219*x2 + 0.0928*x3 - 0.0554*x1*x2
        dx3 = 0.0820*x1*x2 - 0.0672*x3 + 0.1011*x0
