...
class MarshGasSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0701*x1 - 0.1486*x0 + 0.1283*np.sin(0.1286*self._t)
        dx1 = -0.0883*x0*x1 + 0.0800*x2 - 0.0586*x1
        dx2 = 0.0724*x0 - 0.1575*x2 + 0.1021*x3 - 0.0434*x1*x2
        dx3 = 0.0610*x1*x2 - 0.1416*x3 + 0.0767*x0
