...
class UrbanEcologySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0874*x1 - 0.0919*x0 + 0.0916*np.sin(0.0468*self._t)
        dx1 = -0.1015*x0*x1 + 0.0546*x2 - 0.0344*x1
        dx2 = 0.0427*x0 - 0.1200*x2 + 0.1181*x3 - 0.0868*x1*x2
        dx3 = 0.0255*x1*x2 - 0.0767*x3 + 0.0796*x0
