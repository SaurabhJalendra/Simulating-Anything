...
class FrostHeaveSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0539*x1 - 0.0390*x0 + 0.0588*np.sin(0.0341*self._t)
        dx1 = -0.1315*x0*x1 + 0.0683*x2 - 0.1586*x1
        dx2 = 0.0381*x0 - 0.1449*x2 + 0.0850*x3 - 0.1511*x1*x2
        dx3 = 0.1608*x1*x2 - 0.0531*x3 + 0.0632*x0
