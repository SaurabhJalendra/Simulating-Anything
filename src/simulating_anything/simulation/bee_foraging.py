...
class BeeForagingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0605*x1 - 0.0674*x0 + 0.0479*np.sin(0.0756*self._t)
        dx1 = -0.0402*x0*x1 + 0.0224*x2 - 0.0880*x1
        dx2 = 0.0916*x0 - 0.0691*x2 + 0.0741*x3 - 0.0502*x1*x2
        dx3 = 0.1061*x1*x2 - 0.0896*x3 + 0.0910*x0
