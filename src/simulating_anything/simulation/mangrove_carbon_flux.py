...
class MangroveCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0812*x1 - 0.0839*x0 + 0.1053*np.sin(0.0921*self._t)
        dx1 = -0.1087*x0*x1 + 0.1027*x2 - 0.0548*x1
        dx2 = 0.0242*x0 - 0.1029*x2 + 0.0595*x3 - 0.1059*x1*x2
        dx3 = 0.0320*x1*x2 - 0.1101*x3 + 0.0244*x0
