...
class AlgaeNutrientSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1317*x1 - 0.0626*x0 + 0.0954*np.sin(0.0524*self._t)
        dx1 = -0.1260*x0*x1 + 0.0942*x2 - 0.0315*x1
        dx2 = 0.0420*x0 - 0.0765*x2 + 0.1015*x3 - 0.0338*x1*x2
        dx3 = 0.0203*x1*x2 - 0.0770*x3 + 0.1269*x0
