...
class SoilOrganicSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0246*x1 - 0.0309*x0 + 0.0489*np.sin(0.0718*self._t)
        dx1 = -0.1138*x0*x1 + 0.0954*x2 - 0.0274*x1
        dx2 = 0.1125*x0 - 0.0550*x2 + 0.0241*x3 - 0.0295*x1*x2
        dx3 = 0.1027*x1*x2 - 0.0961*x3 + 0.0730*x0
