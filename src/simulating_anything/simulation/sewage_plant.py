...
class SewagePlantSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0318*x1 - 0.0378*x0 + 0.0656*np.sin(0.0333*self._t)
        dx1 = -0.0446*x0*x1 + 0.0898*x2 - 0.1101*x1
        dx2 = 0.0373*x0 - 0.0574*x2 + 0.0453*x3 - 0.1106*x1*x2
        dx3 = 0.1054*x1*x2 - 0.0955*x3 + 0.0715*x0
