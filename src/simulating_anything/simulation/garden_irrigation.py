...
class GardenIrrigationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0339*x1 - 0.0509*x0 + 0.1012*np.sin(0.1492*self._t)
        dx1 = -0.0745*x0*x1 + 0.0639*x2 - 0.1053*x1
        dx2 = 0.0793*x0 - 0.0496*x2 + 0.0583*x3 - 0.0576*x1*x2
        dx3 = 0.0704*x1*x2 - 0.0868*x3 + 0.0796*x0
