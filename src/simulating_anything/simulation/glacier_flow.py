...
class GlacierFlowSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1059*x1 - 0.0359*x0 + 0.0275*np.sin(0.0897*self._t)
        dx1 = -0.0287*x0*x1 + 0.0564*x2 - 0.0840*x1
        dx2 = 0.0319*x0 - 0.0842*x2 + 0.1069*x3 - 0.1159*x1*x2
        dx3 = 0.0867*x1*x2 - 0.0734*x3 + 0.0254*x0
