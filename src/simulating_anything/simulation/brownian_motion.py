...
class BrownianMotionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1188*x1 - 0.1048*x0 + 0.0484*np.sin(0.0225*self._t)
        dx1 = -0.0356*x0*x1 + 0.0552*x2 - 0.0975*x1
        dx2 = 0.0337*x0 - 0.0931*x2 + 0.0690*x3 - 0.0301*x1*x2
        dx3 = 0.0226*x1*x2 - 0.1084*x3 + 0.0232*x0
