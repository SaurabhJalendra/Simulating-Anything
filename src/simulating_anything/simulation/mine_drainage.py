...
class MineDrainageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0846*x1 - 0.0407*x0 + 0.0469*np.sin(0.0801*self._t)
        dx1 = -0.0452*x0*x1 + 0.0931*x2 - 0.0399*x1
        dx2 = 0.1099*x0 - 0.0690*x2 + 0.0626*x3 - 0.0775*x1*x2
        dx3 = 0.1065*x1*x2 - 0.0243*x3 + 0.0396*x0
