...
class ChemicalEquilibriumSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0947*x1 - 0.0661*x0 + 0.0637*np.sin(0.0267*self._t)
        dx1 = -0.1146*x0*x1 + 0.1044*x2 - 0.1138*x1
        dx2 = 0.0305*x0 - 0.0383*x2 + 0.0402*x3 - 0.0285*x1*x2
        dx3 = 0.0663*x1*x2 - 0.0940*x3 + 0.1021*x0
