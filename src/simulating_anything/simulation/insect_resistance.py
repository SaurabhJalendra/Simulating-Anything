...
class InsectResistanceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0497*x1 - 0.1060*x0 + 0.0432*np.sin(0.1150*self._t)
        dx1 = -0.1118*x0*x1 + 0.0497*x2 - 0.0447*x1
        dx2 = 0.0319*x0 - 0.1090*x2 + 0.0601*x3 - 0.0371*x1*x2
        dx3 = 0.0654*x1*x2 - 0.1087*x3 + 0.0661*x0
