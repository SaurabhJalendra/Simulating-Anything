...
class AlkaloidSynthesisSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0434*x1 - 0.0546*x0 + 0.0445*np.sin(0.0829*self._t)
        dx1 = -0.0356*x0*x1 + 0.0741*x2 - 0.0435*x1
        dx2 = 0.0439*x0 - 0.0758*x2 + 0.0506*x3 - 0.0263*x1*x2
        dx3 = 0.0475*x1*x2 - 0.0227*x3 + 0.1197*x0
