...
class FruitRipeningSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0590*x1 - 0.0575*x0 + 0.0592*np.sin(0.0617*self._t)
        dx1 = -0.0240*x0*x1 + 0.1004*x2 - 0.1171*x1
        dx2 = 0.0450*x0 - 0.0785*x2 + 0.0965*x3 - 0.1008*x1*x2
        dx3 = 0.1062*x1*x2 - 0.0868*x3 + 0.0638*x0
