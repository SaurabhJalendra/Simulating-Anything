...
class OceanGarbageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0476*x1 - 0.0719*x0 + 0.0215*np.sin(0.0214*self._t)
        dx1 = -0.0470*x0*x1 + 0.0604*x2 - 0.0906*x1
        dx2 = 0.0211*x0 - 0.0833*x2 + 0.1123*x3 - 0.0799*x1*x2
        dx3 = 0.0249*x1*x2 - 0.0418*x3 + 0.1099*x0
