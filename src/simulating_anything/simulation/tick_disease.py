...
class TickDiseaseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0583*x1 - 0.1153*x0 + 0.0271*np.sin(0.1033*self._t)
        dx1 = -0.0884*x0*x1 + 0.0425*x2 - 0.1010*x1
        dx2 = 0.0563*x0 - 0.0486*x2 + 0.0215*x3 - 0.0870*x1*x2
        dx3 = 0.0439*x1*x2 - 0.0909*x3 + 0.0602*x0
