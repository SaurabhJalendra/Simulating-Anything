...
class JadeMiningSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0462*x1 - 0.0697*x0 + 0.0710*np.sin(0.0688*self._t)
        dx1 = -0.0393*x0*x1 + 0.0488*x2 - 0.1038*x1
        dx2 = 0.1136*x0 - 0.1196*x2 + 0.0519*x3 - 0.0865*x1*x2
        dx3 = 0.1012*x1*x2 - 0.0333*x3 + 0.1020*x0
