...
class BiomassCombustionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0755*x1 - 0.0826*x0 + 0.0479*np.sin(0.0202*self._t)
        dx1 = -0.0890*x0*x1 + 0.0870*x2 - 0.0380*x1
        dx2 = 0.0959*x0 - 0.0912*x2 + 0.0219*x3 - 0.0549*x1*x2
        dx3 = 0.0548*x1*x2 - 0.0659*x3 + 0.0367*x0
