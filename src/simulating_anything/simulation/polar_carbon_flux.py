...
class PolarCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1066*x1 - 0.1199*x0 + 0.0721*np.sin(0.0983*self._t)
        dx1 = -0.0914*x0*x1 + 0.1144*x2 - 0.0539*x1
        dx2 = 0.0570*x0 - 0.0359*x2 + 0.0435*x3 - 0.0829*x1*x2
        dx3 = 0.0658*x1*x2 - 0.0471*x3 + 0.1060*x0
