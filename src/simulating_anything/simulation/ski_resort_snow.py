...
class SkiResortSnowSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1062*x1 - 0.0716*x0 + 0.0852*np.sin(0.1097*self._t)
        dx1 = -0.0570*x0*x1 + 0.0524*x2 - 0.0740*x1
        dx2 = 0.0613*x0 - 0.0397*x2 + 0.0457*x3 - 0.0997*x1*x2
        dx3 = 0.0513*x1*x2 - 0.1056*x3 + 0.0768*x0
