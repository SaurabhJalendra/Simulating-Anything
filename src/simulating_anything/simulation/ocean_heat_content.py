...
class OceanHeatContentSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1297*x1 - 0.0380*x0 + 0.0956*np.sin(0.1195*self._t)
        dx1 = -0.0682*x0*x1 + 0.0610*x2 - 0.1372*x1
        dx2 = 0.0846*x0 - 0.0927*x2 + 0.0307*x3 - 0.0943*x1*x2
        dx3 = 0.0898*x1*x2 - 0.1281*x3 + 0.0642*x0
