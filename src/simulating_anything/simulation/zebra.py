...
class ZebraSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0750*x1 - 0.1031*x0 + 0.1053*np.sin(0.1146*self._t)
        dx1 = -0.1040*x0*x1 + 0.0549*x2 - 0.0681*x1
        dx2 = 0.0682*x0 - 0.0569*x2 + 0.0590*x3 - 0.1198*x1*x2
        dx3 = 0.1115*x1*x2 - 0.0614*x3 + 0.0698*x0
