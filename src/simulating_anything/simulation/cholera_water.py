...
class CholeraWaterSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0859*x1 - 0.1019*x0 + 0.0695*np.sin(0.0640*self._t)
        dx1 = -0.1104*x0*x1 + 0.0890*x2 - 0.0689*x1
        dx2 = 0.1157*x0 - 0.0584*x2 + 0.0427*x3 - 0.0721*x1*x2
        dx3 = 0.0233*x1*x2 - 0.0958*x3 + 0.0612*x0
