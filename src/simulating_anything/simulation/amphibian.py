...
class AmphibianSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1071*x1 - 0.0945*x0 + 0.0470*np.sin(0.0223*self._t)
        dx1 = -0.0907*x0*x1 + 0.0723*x2 - 0.0549*x1
        dx2 = 0.1126*x0 - 0.1181*x2 + 0.0325*x3 - 0.0719*x1*x2
        dx3 = 0.0415*x1*x2 - 0.0718*x3 + 0.0642*x0
