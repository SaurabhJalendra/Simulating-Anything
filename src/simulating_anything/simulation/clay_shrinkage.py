...
class ClayShrinkageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0264*x1 - 0.0644*x0 + 0.0752*np.sin(0.0820*self._t)
        dx1 = -0.0244*x0*x1 + 0.0451*x2 - 0.0267*x1
        dx2 = 0.0475*x0 - 0.0432*x2 + 0.0661*x3 - 0.0901*x1*x2
        dx3 = 0.0404*x1*x2 - 0.0341*x3 + 0.0215*x0
