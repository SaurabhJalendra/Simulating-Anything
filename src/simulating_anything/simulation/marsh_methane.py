...
class MarshMethaneSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0823*x1 - 0.0904*x0 + 0.0228*np.sin(0.1176*self._t)
        dx1 = -0.0266*x0*x1 + 0.0899*x2 - 0.0782*x1
        dx2 = 0.0578*x0 - 0.0308*x2 + 0.0694*x3 - 0.0835*x1*x2
        dx3 = 0.0709*x1*x2 - 0.0311*x3 + 0.0935*x0
