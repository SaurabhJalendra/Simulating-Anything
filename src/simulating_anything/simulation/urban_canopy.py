...
class UrbanCanopySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0201*x1 - 0.0482*x0 + 0.0764*np.sin(0.0981*self._t)
        dx1 = -0.0345*x0*x1 + 0.0347*x2 - 0.1058*x1
        dx2 = 0.0643*x0 - 0.0718*x2 + 0.1111*x3 - 0.0734*x1*x2
        dx3 = 0.0580*x1*x2 - 0.0369*x3 + 0.0421*x0
