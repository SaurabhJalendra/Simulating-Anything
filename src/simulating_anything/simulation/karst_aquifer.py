...
class KarstAquiferSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0875*x1 - 0.0959*x0 + 0.0891*np.sin(0.1102*self._t)
        dx1 = -0.0925*x0*x1 + 0.1051*x2 - 0.0240*x1
        dx2 = 0.0767*x0 - 0.1168*x2 + 0.0218*x3 - 0.0439*x1*x2
        dx3 = 0.1172*x1*x2 - 0.0555*x3 + 0.1089*x0
