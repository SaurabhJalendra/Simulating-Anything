...
class CropPollinationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0281*x1 - 0.0283*x0 + 0.0612*np.sin(0.1111*self._t)
        dx1 = -0.0566*x0*x1 + 0.0699*x2 - 0.1025*x1
        dx2 = 0.1088*x0 - 0.0552*x2 + 0.0659*x3 - 0.0377*x1*x2
        dx3 = 0.0549*x1*x2 - 0.0955*x3 + 0.0564*x0
