...
class BiologicalClockSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0474*x1 - 0.0312*x0 + 0.1036*np.sin(0.1060*self._t)
        dx1 = -0.0437*x0*x1 + 0.0752*x2 - 0.1015*x1
        dx2 = 0.0837*x0 - 0.0370*x2 + 0.0790*x3 - 0.0401*x1*x2
        dx3 = 0.1010*x1*x2 - 0.0232*x3 + 0.1069*x0
