...
class FermentationWineSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0202*x1 - 0.0736*x0 + 0.0617*np.sin(0.0689*self._t)
        dx1 = -0.0239*x0*x1 + 0.0786*x2 - 0.0395*x1
        dx2 = 0.1150*x0 - 0.0487*x2 + 0.0590*x3 - 0.0458*x1*x2
        dx3 = 0.0357*x1*x2 - 0.0793*x3 + 0.0904*x0
