...
class MarineDebrisSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0833*x1 - 0.0904*x0 + 0.0562*np.sin(0.0385*self._t)
        dx1 = -0.0702*x0*x1 + 0.0374*x2 - 0.0817*x1
        dx2 = 0.0750*x0 - 0.0634*x2 + 0.0469*x3 - 0.1129*x1*x2
        dx3 = 0.1018*x1*x2 - 0.0826*x3 + 0.0322*x0
