...
class KarstSinkholeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0846*x1 - 0.0952*x0 + 0.0389*np.sin(0.0579*self._t)
        dx1 = -0.0701*x0*x1 + 0.0626*x2 - 0.0578*x1
        dx2 = 0.1087*x0 - 0.0387*x2 + 0.0394*x3 - 0.0782*x1*x2
        dx3 = 0.0964*x1*x2 - 0.0791*x3 + 0.0738*x0
