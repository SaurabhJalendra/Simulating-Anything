...
class BarrierReefSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0447*x1 - 0.0225*x0 + 0.0698*np.sin(0.0971*self._t)
        dx1 = -0.0806*x0*x1 + 0.0224*x2 - 0.0581*x1
        dx2 = 0.0512*x0 - 0.0581*x2 + 0.0676*x3 - 0.0990*x1*x2
        dx3 = 0.0871*x1*x2 - 0.1035*x3 + 0.0302*x0
