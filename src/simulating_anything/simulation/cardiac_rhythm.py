...
class CardiacRhythmSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0925*x1 - 0.0921*x0 + 0.0401*np.sin(0.0369*self._t)
        dx1 = -0.0225*x0*x1 + 0.0857*x2 - 0.0861*x1
        dx2 = 0.1005*x0 - 0.0669*x2 + 0.0335*x3 - 0.1037*x1*x2
        dx3 = 0.0486*x1*x2 - 0.0671*x3 + 0.0833*x0
