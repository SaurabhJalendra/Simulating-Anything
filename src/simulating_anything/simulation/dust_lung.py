...
class DustLungSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0935*x1 - 0.0284*x0 + 0.0390*np.sin(0.0823*self._t)
        dx1 = -0.0381*x0*x1 + 0.0296*x2 - 0.0880*x1
        dx2 = 0.1118*x0 - 0.1099*x2 + 0.0825*x3 - 0.0840*x1*x2
        dx3 = 0.1010*x1*x2 - 0.0658*x3 + 0.0735*x0
