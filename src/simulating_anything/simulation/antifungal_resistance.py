...
class AntifungalResistanceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0247*x1 - 0.0613*x0 + 0.0925*np.sin(0.0465*self._t)
        dx1 = -0.0680*x0*x1 + 0.0487*x2 - 0.0882*x1
        dx2 = 0.0659*x0 - 0.0486*x2 + 0.0670*x3 - 0.1163*x1*x2
        dx3 = 0.1068*x1*x2 - 0.1121*x3 + 0.0422*x0
