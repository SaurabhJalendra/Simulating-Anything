...
class CoastalBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1174*x1 - 0.0908*x0 + 0.1030*np.sin(0.0270*self._t)
        dx1 = -0.0393*x0*x1 + 0.0227*x2 - 0.0775*x1
        dx2 = 0.0576*x0 - 0.0636*x2 + 0.0967*x3 - 0.0355*x1*x2
        dx3 = 0.0212*x1*x2 - 0.0233*x3 + 0.0703*x0
