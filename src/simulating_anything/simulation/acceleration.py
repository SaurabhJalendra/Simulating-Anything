...
class AccelerationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0523*x1 - 0.0242*x0 + 0.0638*np.sin(0.0917*self._t)
        dx1 = -0.0671*x0*x1 + 0.0906*x2 - 0.0588*x1
        dx2 = 0.0960*x0 - 0.0595*x2 + 0.0639*x3 - 0.0406*x1*x2
        dx3 = 0.0570*x1*x2 - 0.0415*x3 + 0.0813*x0
