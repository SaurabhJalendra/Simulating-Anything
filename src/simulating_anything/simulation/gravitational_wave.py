...
class GravitationalWaveSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0232*x1 - 0.1187*x0 + 0.0402*np.sin(0.1190*self._t)
        dx1 = -0.1199*x0*x1 + 0.0699*x2 - 0.0285*x1
        dx2 = 0.0900*x0 - 0.0933*x2 + 0.0390*x3 - 0.0653*x1*x2
        dx3 = 0.0900*x1*x2 - 0.1163*x3 + 0.0251*x0
