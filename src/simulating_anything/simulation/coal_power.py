...
class CoalPowerSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0343*x1 - 0.0849*x0 + 0.0993*np.sin(0.0821*self._t)
        dx1 = -0.0833*x0*x1 + 0.0491*x2 - 0.0823*x1
        dx2 = 0.1179*x0 - 0.0782*x2 + 0.0281*x3 - 0.0707*x1*x2
        dx3 = 0.0808*x1*x2 - 0.0818*x3 + 0.0700*x0
