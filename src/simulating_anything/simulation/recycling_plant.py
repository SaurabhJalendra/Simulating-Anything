...
class RecyclingPlantSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0778*x1 - 0.0486*x0 + 0.0871*np.sin(0.0580*self._t)
        dx1 = -0.0918*x0*x1 + 0.0937*x2 - 0.0797*x1
        dx2 = 0.1068*x0 - 0.0241*x2 + 0.1064*x3 - 0.1045*x1*x2
        dx3 = 0.1139*x1*x2 - 0.0609*x3 + 0.1169*x0
