...
class MangroveBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0574*x1 - 0.0917*x0 + 0.0617*np.sin(0.1068*self._t)
        dx1 = -0.1082*x0*x1 + 0.1127*x2 - 0.0926*x1
        dx2 = 0.0410*x0 - 0.0930*x2 + 0.0845*x3 - 0.0232*x1*x2
        dx3 = 0.0901*x1*x2 - 0.1174*x3 + 0.0786*x0
