...
class DinosaurExtinctionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1036*x1 - 0.0433*x0 + 0.1002*np.sin(0.0605*self._t)
        dx1 = -0.1179*x0*x1 + 0.0617*x2 - 0.0747*x1
        dx2 = 0.1400*x0 - 0.0614*x2 + 0.1523*x3 - 0.0794*x1*x2
        dx3 = 0.0413*x1*x2 - 0.1050*x3 + 0.1604*x0
