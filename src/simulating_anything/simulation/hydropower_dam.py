...
class HydropowerDamSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0447*x1 - 0.0905*x0 + 0.0911*np.sin(0.0576*self._t)
        dx1 = -0.0680*x0*x1 + 0.0733*x2 - 0.0577*x1
        dx2 = 0.0855*x0 - 0.0567*x2 + 0.0502*x3 - 0.0412*x1*x2
        dx3 = 0.0320*x1*x2 - 0.1172*x3 + 0.0693*x0
