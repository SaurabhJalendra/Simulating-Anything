...
class CornBlightSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0385*x1 - 0.0880*x0 + 0.1082*np.sin(0.0961*self._t)
        dx1 = -0.0949*x0*x1 + 0.0720*x2 - 0.0565*x1
        dx2 = 0.0484*x0 - 0.0557*x2 + 0.0623*x3 - 0.0222*x1*x2
        dx3 = 0.0698*x1*x2 - 0.0714*x3 + 0.0833*x0
