...
class MarineReserveSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1127*x1 - 0.0755*x0 + 0.1075*np.sin(0.0439*self._t)
        dx1 = -0.0204*x0*x1 + 0.0298*x2 - 0.0408*x1
        dx2 = 0.0947*x0 - 0.0631*x2 + 0.0951*x3 - 0.0927*x1*x2
        dx3 = 0.0842*x1*x2 - 0.0247*x3 + 0.0942*x0
