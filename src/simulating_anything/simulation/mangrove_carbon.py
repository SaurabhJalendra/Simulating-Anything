...
class MangroveCarbonSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0939*x1 - 0.1238*x0 + 0.1222*np.sin(0.0985*self._t)
        dx1 = -0.0658*x0*x1 + 0.0787*x2 - 0.1265*x1
        dx2 = 0.0324*x0 - 0.0451*x2 + 0.0394*x3 - 0.1531*x1*x2
        dx3 = 0.1657*x1*x2 - 0.0645*x3 + 0.1659*x0
