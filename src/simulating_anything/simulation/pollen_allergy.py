...
class PollenAllergySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0903*x1 - 0.0469*x0 + 0.1049*np.sin(0.0842*self._t)
        dx1 = -0.1112*x0*x1 + 0.0625*x2 - 0.0322*x1
        dx2 = 0.1154*x0 - 0.0781*x2 + 0.1021*x3 - 0.0355*x1*x2
        dx3 = 0.0882*x1*x2 - 0.0348*x3 + 0.0914*x0
