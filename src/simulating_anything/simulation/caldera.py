...
class CalderaSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1007*x1 - 0.0735*x0 + 0.1138*np.sin(0.0874*self._t)
        dx1 = -0.0411*x0*x1 + 0.0826*x2 - 0.0232*x1
        dx2 = 0.0756*x0 - 0.1066*x2 + 0.0561*x3 - 0.0374*x1*x2
        dx3 = 0.0347*x1*x2 - 0.0435*x3 + 0.0674*x0
