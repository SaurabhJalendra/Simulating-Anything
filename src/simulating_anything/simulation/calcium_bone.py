...
class CalciumBoneSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0367*x1 - 0.0772*x0 + 0.0390*np.sin(0.0629*self._t)
        dx1 = -0.1166*x0*x1 + 0.0994*x2 - 0.0233*x1
        dx2 = 0.0329*x0 - 0.0739*x2 + 0.0993*x3 - 0.1159*x1*x2
        dx3 = 0.0834*x1*x2 - 0.0321*x3 + 0.0984*x0
