...
class GroundwaterCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0467*x1 - 0.1160*x0 + 0.0695*np.sin(0.0276*self._t)
        dx1 = -0.0622*x0*x1 + 0.0546*x2 - 0.0602*x1
        dx2 = 0.0581*x0 - 0.0717*x2 + 0.1080*x3 - 0.0407*x1*x2
        dx3 = 0.0389*x1*x2 - 0.0851*x3 + 0.0929*x0
