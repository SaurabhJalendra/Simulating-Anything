...
class AtmosphericCo2Simulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0661*x1 - 0.0901*x0 + 0.0297*np.sin(0.0505*self._t)
        dx1 = -0.1060*x0*x1 + 0.0606*x2 - 0.0643*x1
        dx2 = 0.0262*x0 - 0.0458*x2 + 0.0980*x3 - 0.1187*x1*x2
        dx3 = 0.0931*x1*x2 - 0.0418*x3 + 0.1027*x0
