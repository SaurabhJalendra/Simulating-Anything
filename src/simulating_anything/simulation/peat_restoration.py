...
class PeatRestorationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0925*x1 - 0.0836*x0 + 0.0963*np.sin(0.0781*self._t)
        dx1 = -0.0662*x0*x1 + 0.1134*x2 - 0.0368*x1
        dx2 = 0.1186*x0 - 0.0275*x2 + 0.0454*x3 - 0.0234*x1*x2
        dx3 = 0.0796*x1*x2 - 0.0298*x3 + 0.0252*x0
