...
class RheumatoidArthritisSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0286*x1 - 0.1087*x0 + 0.0249*np.sin(0.0646*self._t)
        dx1 = -0.0802*x0*x1 + 0.1073*x2 - 0.0298*x1
        dx2 = 0.0967*x0 - 0.0904*x2 + 0.0685*x3 - 0.1089*x1*x2
        dx3 = 0.0754*x1*x2 - 0.0602*x3 + 0.1058*x0
