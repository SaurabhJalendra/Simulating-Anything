...
class CropBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1039*x1 - 0.0769*x0 + 0.1191*np.sin(0.1098*self._t)
        dx1 = -0.0223*x0*x1 + 0.0685*x2 - 0.0447*x1
        dx2 = 0.0931*x0 - 0.1031*x2 + 0.1050*x3 - 0.0590*x1*x2
        dx3 = 0.0378*x1*x2 - 0.0666*x3 + 0.0386*x0
