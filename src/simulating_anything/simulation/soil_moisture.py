...
class SoilMoistureSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0652*x1 - 0.1099*x0 + 0.0582*np.sin(0.1447*self._t)
        dx1 = -0.0738*x0*x1 + 0.0299*x2 - 0.0443*x1
        dx2 = 0.036*x0 - 0.1371*x2 + 0.0613*x3 - 0.0621*x1*x2
        dx3 = 0.1663*x1*x2 - 0.0443*x3 + 0.1283*x0
