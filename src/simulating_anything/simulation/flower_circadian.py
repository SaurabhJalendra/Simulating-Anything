...
class FlowerCircadianSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0836*x1 - 0.0270*x0 + 0.0338*np.sin(0.0669*self._t)
        dx1 = -0.0354*x0*x1 + 0.0571*x2 - 0.0721*x1
        dx2 = 0.0359*x0 - 0.0308*x2 + 0.0297*x3 - 0.0316*x1*x2
        dx3 = 0.1003*x1*x2 - 0.0679*x3 + 0.0515*x0
