...
class DrugResistanceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0225*x1 - 0.0700*x0 + 0.0442*np.sin(0.0957*self._t)
        dx1 = -0.0378*x0*x1 + 0.0853*x2 - 0.0219*x1
        dx2 = 0.0445*x0 - 0.0793*x2 + 0.0587*x3 - 0.1095*x1*x2
        dx3 = 0.0584*x1*x2 - 0.0933*x3 + 0.0201*x0
