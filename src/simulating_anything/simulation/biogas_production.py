...
class BiogasProductionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0465*x1 - 0.0562*x0 + 0.0592*np.sin(0.0221*self._t)
        dx1 = -0.0709*x0*x1 + 0.1051*x2 - 0.0250*x1
        dx2 = 0.1117*x0 - 0.0313*x2 + 0.0907*x3 - 0.0636*x1*x2
        dx3 = 0.1047*x1*x2 - 0.1133*x3 + 0.0781*x0
