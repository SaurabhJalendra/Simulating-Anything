...
class BisonGrazingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1037*x1 - 0.1074*x0 + 0.0414*np.sin(0.0729*self._t)
        dx1 = -0.1083*x0*x1 + 0.1116*x2 - 0.0641*x1
        dx2 = 0.0887*x0 - 0.1037*x2 + 0.0564*x3 - 0.0745*x1*x2
        dx3 = 0.0540*x1*x2 - 0.1005*x3 + 0.0979*x0
