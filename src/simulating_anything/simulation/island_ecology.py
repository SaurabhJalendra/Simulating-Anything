...
class IslandEcologySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0633*x1 - 0.1118*x0 + 0.1040*np.sin(0.0613*self._t)
        dx1 = -0.0399*x0*x1 + 0.1022*x2 - 0.0493*x1
        dx2 = 0.0542*x0 - 0.1020*x2 + 0.0715*x3 - 0.0966*x1*x2
        dx3 = 0.0651*x1*x2 - 0.0499*x3 + 0.0316*x0
