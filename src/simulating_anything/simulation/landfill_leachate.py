...
class LandfillLeachateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0462*x1 - 0.0577*x0 + 0.1163*np.sin(0.0784*self._t)
        dx1 = -0.0357*x0*x1 + 0.0665*x2 - 0.1253*x1
        dx2 = 0.0617*x0 - 0.0438*x2 + 0.0542*x3 - 0.0571*x1*x2
        dx3 = 0.1294*x1*x2 - 0.0500*x3 + 0.0461*x0
