...
class BoneMarrowSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0253*x1 - 0.0655*x0 + 0.1006*np.sin(0.1066*self._t)
        dx1 = -0.0337*x0*x1 + 0.0364*x2 - 0.0283*x1
        dx2 = 0.0588*x0 - 0.1112*x2 + 0.1130*x3 - 0.0219*x1*x2
        dx3 = 0.0653*x1*x2 - 0.0882*x3 + 0.0539*x0
