...
class EarthMagneticFieldSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0283*x1 - 0.0249*x0 + 0.0582*np.sin(0.1157*self._t)
        dx1 = -0.0754*x0*x1 + 0.0244*x2 - 0.0358*x1
        dx2 = 0.0865*x0 - 0.0491*x2 + 0.1189*x3 - 0.1042*x1*x2
        dx3 = 0.0322*x1*x2 - 0.0502*x3 + 0.0336*x0
