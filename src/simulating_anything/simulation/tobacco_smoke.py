...
class TobaccoSmokeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0681*x1 - 0.0508*x0 + 0.0985*np.sin(0.0228*self._t)
        dx1 = -0.0910*x0*x1 + 0.0785*x2 - 0.1138*x1
        dx2 = 0.0241*x0 - 0.1105*x2 + 0.0545*x3 - 0.0753*x1*x2
        dx3 = 0.0774*x1*x2 - 0.0322*x3 + 0.0224*x0
