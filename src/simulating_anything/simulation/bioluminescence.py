...
class BioluminescenceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0968*x1 - 0.1113*x0 + 0.0354*np.sin(0.0352*self._t)
        dx1 = -0.1547*x0*x1 + 0.1634*x2 - 0.0672*x1
        dx2 = 0.0779*x0 - 0.0833*x2 + 0.0315*x3 - 0.0380*x1*x2
        dx3 = 0.1618*x1*x2 - 0.0563*x3 + 0.1683*x0
