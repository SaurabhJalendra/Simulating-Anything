...
class HeatExchangerSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0634*x1 - 0.0633*x0 + 0.0440*np.sin(0.0433*self._t)
        dx1 = -0.0713*x0*x1 + 0.0761*x2 - 0.0705*x1
        dx2 = 0.0793*x0 - 0.0268*x2 + 0.0213*x3 - 0.1036*x1*x2
        dx3 = 0.0571*x1*x2 - 0.0800*x3 + 0.0905*x0
