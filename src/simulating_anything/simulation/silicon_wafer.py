...
class SiliconWaferSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0950*x1 - 0.0832*x0 + 0.0687*np.sin(0.0698*self._t)
        dx1 = -0.0696*x0*x1 + 0.0551*x2 - 0.0260*x1
        dx2 = 0.0436*x0 - 0.0525*x2 + 0.0653*x3 - 0.0563*x1*x2
        dx3 = 0.0205*x1*x2 - 0.0750*x3 + 0.1000*x0
