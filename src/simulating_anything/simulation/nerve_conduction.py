...
class NerveConductionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0462*x1 - 0.0691*x0 + 0.0597*np.sin(0.0520*self._t)
        dx1 = -0.0981*x0*x1 + 0.1173*x2 - 0.1105*x1
        dx2 = 0.1099*x0 - 0.1013*x2 + 0.0990*x3 - 0.0799*x1*x2
        dx3 = 0.0978*x1*x2 - 0.0580*x3 + 0.0625*x0
