...
class LavaTubeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0819*x1 - 0.0875*x0 + 0.1379*np.sin(0.1391*self._t)
        dx1 = -0.1026*x0*x1 + 0.0864*x2 - 0.1260*x1
        dx2 = 0.0565*x0 - 0.0410*x2 + 0.0541*x3 - 0.0423*x1*x2
        dx3 = 0.1394*x1*x2 - 0.1251*x3 + 0.0790*x0
