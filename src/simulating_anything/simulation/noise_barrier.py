...
class NoiseBarrierSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0556*x1 - 0.1170*x0 + 0.0957*np.sin(0.0499*self._t)
        dx1 = -0.0968*x0*x1 + 0.1056*x2 - 0.0711*x1
        dx2 = 0.1092*x0 - 0.0963*x2 + 0.1200*x3 - 0.0203*x1*x2
        dx3 = 0.0692*x1*x2 - 0.0637*x3 + 0.0221*x0
