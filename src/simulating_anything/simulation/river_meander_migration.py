...
class RiverMeanderMigrationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1055*x1 - 0.0212*x0 + 0.0347*np.sin(0.0353*self._t)
        dx1 = -0.0385*x0*x1 + 0.1449*x2 - 0.057*x1
        dx2 = 0.1483*x0 - 0.1183*x2 + 0.1231*x3 - 0.0473*x1*x2
        dx3 = 0.1602*x1*x2 - 0.0616*x3 + 0.1552*x0
