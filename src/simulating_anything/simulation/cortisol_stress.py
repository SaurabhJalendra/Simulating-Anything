...
class CortisolStressSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0454*x1 - 0.0206*x0 + 0.0229*np.sin(0.0755*self._t)
        dx1 = -0.0634*x0*x1 + 0.0375*x2 - 0.0444*x1
        dx2 = 0.0598*x0 - 0.0593*x2 + 0.0363*x3 - 0.1090*x1*x2
        dx3 = 0.1076*x1*x2 - 0.0828*x3 + 0.0396*x0
