...
class AcidRainSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0308*x1 - 0.1296*x0 + 0.1222*np.sin(0.0389*self._t)
        dx1 = -0.0205*x0*x1 + 0.0541*x2 - 0.0735*x1
        dx2 = 0.0562*x0 - 0.0449*x2 + 0.1162*x3 - 0.1351*x1*x2
        dx3 = 0.1283*x1*x2 - 0.1375*x3 + 0.1027*x0
