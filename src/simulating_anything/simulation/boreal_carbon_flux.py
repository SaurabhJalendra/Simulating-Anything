...
class BorealCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0735*x1 - 0.0409*x0 + 0.0690*np.sin(0.0888*self._t)
        dx1 = -0.1188*x0*x1 + 0.0565*x2 - 0.0808*x1
        dx2 = 0.0637*x0 - 0.1038*x2 + 0.1097*x3 - 0.0801*x1*x2
        dx3 = 0.0434*x1*x2 - 0.0733*x3 + 0.1134*x0
