...
class MosquitoControlSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0293*x1 - 0.1178*x0 + 0.0629*np.sin(0.0444*self._t)
        dx1 = -0.0776*x0*x1 + 0.0850*x2 - 0.1034*x1
        dx2 = 0.0326*x0 - 0.0796*x2 + 0.1123*x3 - 0.0548*x1*x2
        dx3 = 0.0953*x1*x2 - 0.0348*x3 + 0.1021*x0
