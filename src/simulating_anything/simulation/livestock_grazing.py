...
class LivestockGrazingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0413*x1 - 0.0941*x0 + 0.1101*np.sin(0.0726*self._t)
        dx1 = -0.1029*x0*x1 + 0.0223*x2 - 0.1127*x1
        dx2 = 0.0666*x0 - 0.0218*x2 + 0.0665*x3 - 0.0254*x1*x2
        dx3 = 0.0488*x1*x2 - 0.0634*x3 + 0.0274*x0
