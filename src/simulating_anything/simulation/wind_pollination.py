...
class WindPollinationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0883*x1 - 0.0648*x0 + 0.0574*np.sin(0.1109*self._t)
        dx1 = -0.0704*x0*x1 + 0.0308*x2 - 0.0475*x1
        dx2 = 0.0598*x0 - 0.0714*x2 + 0.0677*x3 - 0.0408*x1*x2
        dx3 = 0.0870*x1*x2 - 0.0953*x3 + 0.0275*x0
