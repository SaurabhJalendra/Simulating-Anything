...
class FarmBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0550*x1 - 0.1129*x0 + 0.0937*np.sin(0.0712*self._t)
        dx1 = -0.0738*x0*x1 + 0.1197*x2 - 0.1062*x1
        dx2 = 0.0532*x0 - 0.0354*x2 + 0.0789*x3 - 0.0531*x1*x2
        dx3 = 0.0905*x1*x2 - 0.0402*x3 + 0.0274*x0
