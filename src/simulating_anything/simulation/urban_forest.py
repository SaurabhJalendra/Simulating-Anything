...
class UrbanForestSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0357*x1 - 0.0660*x0 + 0.0688*np.sin(0.0534*self._t)
        dx1 = -0.0441*x0*x1 + 0.0353*x2 - 0.0842*x1
        dx2 = 0.0382*x0 - 0.1078*x2 + 0.1111*x3 - 0.1137*x1*x2
        dx3 = 0.1124*x1*x2 - 0.0429*x3 + 0.1135*x0
