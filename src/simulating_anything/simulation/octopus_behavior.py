...
class OctopusBehaviorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0876*x1 - 0.0588*x0 + 0.1073*np.sin(0.0595*self._t)
        dx1 = -0.0728*x0*x1 + 0.0334*x2 - 0.1078*x1
        dx2 = 0.0994*x0 - 0.0768*x2 + 0.0500*x3 - 0.0767*x1*x2
        dx3 = 0.0300*x1*x2 - 0.0653*x3 + 0.0795*x0
