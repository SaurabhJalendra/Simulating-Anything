...
class CellDivisionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0975*x1 - 0.0295*x0 + 0.1115*np.sin(0.0664*self._t)
        dx1 = -0.0528*x0*x1 + 0.0277*x2 - 0.0460*x1
        dx2 = 0.0252*x0 - 0.1151*x2 + 0.0462*x3 - 0.0958*x1*x2
        dx3 = 0.1146*x1*x2 - 0.1169*x3 + 0.0998*x0
