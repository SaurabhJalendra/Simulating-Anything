...
class CompostWormSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1485*x1 - 0.1266*x0 + 0.1645*np.sin(0.1122*self._t)
        dx1 = -0.1235*x0*x1 + 0.0429*x2 - 0.0686*x1
        dx2 = 0.1220*x0 - 0.1020*x2 + 0.0716*x3 - 0.1293*x1*x2
        dx3 = 0.0515*x1*x2 - 0.0204*x3 + 0.0204*x0
