...
class ColonyCollapseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0630*x1 - 0.0644*x0 + 0.0997*np.sin(0.0287*self._t)
        dx1 = -0.0349*x0*x1 + 0.0915*x2 - 0.0585*x1
        dx2 = 0.0710*x0 - 0.0600*x2 + 0.0803*x3 - 0.0467*x1*x2
        dx3 = 0.0387*x1*x2 - 0.1151*x3 + 0.1082*x0
