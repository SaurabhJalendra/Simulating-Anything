...
class MotorNeuronSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0653*x1 - 0.0982*x0 + 0.0460*np.sin(0.0296*self._t)
        dx1 = -0.0769*x0*x1 + 0.1021*x2 - 0.1127*x1
        dx2 = 0.0701*x0 - 0.0884*x2 + 0.0320*x3 - 0.0875*x1*x2
        dx3 = 0.0867*x1*x2 - 0.0655*x3 + 0.1061*x0
