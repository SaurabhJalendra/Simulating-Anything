...
class NaturalGasLeakSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1025*x1 - 0.0537*x0 + 0.0952*np.sin(0.1185*self._t)
        dx1 = -0.0823*x0*x1 + 0.0239*x2 - 0.0971*x1
        dx2 = 0.1084*x0 - 0.1172*x2 + 0.1142*x3 - 0.0727*x1*x2
        dx3 = 0.0673*x1*x2 - 0.0961*x3 + 0.1179*x0
