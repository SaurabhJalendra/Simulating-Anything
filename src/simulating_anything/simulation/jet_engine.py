...
class JetEngineSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1103*x1 - 0.0819*x0 + 0.0632*np.sin(0.0316*self._t)
        dx1 = -0.0906*x0*x1 + 0.0641*x2 - 0.1172*x1
        dx2 = 0.0467*x0 - 0.0350*x2 + 0.0570*x3 - 0.0508*x1*x2
        dx3 = 0.0278*x1*x2 - 0.0423*x3 + 0.0877*x0
