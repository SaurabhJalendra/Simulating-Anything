...
class ClimateDroughtSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0992*x1 - 0.0584*x0 + 0.0950*np.sin(0.0465*self._t)
        dx1 = -0.1175*x0*x1 + 0.1144*x2 - 0.0665*x1
        dx2 = 0.0738*x0 - 0.0778*x2 + 0.0769*x3 - 0.0344*x1*x2
        dx3 = 0.0646*x1*x2 - 0.0408*x3 + 0.1002*x0
