...
class AllergenExposureSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1185*x1 - 0.1021*x0 + 0.0824*np.sin(0.0997*self._t)
        dx1 = -0.1137*x0*x1 + 0.0218*x2 - 0.0770*x1
        dx2 = 0.0652*x0 - 0.0708*x2 + 0.1170*x3 - 0.0741*x1*x2
        dx3 = 0.0552*x1*x2 - 0.0250*x3 + 0.0685*x0
