...
class GreenhouseHeatingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1197*x1 - 0.0637*x0 + 0.0783*np.sin(0.0343*self._t)
        dx1 = -0.0929*x0*x1 + 0.1034*x2 - 0.0900*x1
        dx2 = 0.0701*x0 - 0.0624*x2 + 0.0998*x3 - 0.0389*x1*x2
        dx3 = 0.0439*x1*x2 - 0.0436*x3 + 0.1197*x0
