...
class IrrigationDrainageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0666*x1 - 0.1153*x0 + 0.0856*np.sin(0.0571*self._t)
        dx1 = -0.0365*x0*x1 + 0.0673*x2 - 0.0373*x1
        dx2 = 0.1180*x0 - 0.1171*x2 + 0.0399*x3 - 0.0270*x1*x2
        dx3 = 0.0549*x1*x2 - 0.0942*x3 + 0.0493*x0
