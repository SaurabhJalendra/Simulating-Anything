...
class HeatStrokeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1637*x1 - 0.1493*x0 + 0.1014*np.sin(0.0934*self._t)
        dx1 = -0.1616*x0*x1 + 0.1235*x2 - 0.1431*x1
        dx2 = 0.0313*x0 - 0.042*x2 + 0.1694*x3 - 0.1299*x1*x2
        dx3 = 0.1029*x1*x2 - 0.0384*x3 + 0.1161*x0
