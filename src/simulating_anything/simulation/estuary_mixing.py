...
class EstuaryMixingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0528*x1 - 0.0666*x0 + 0.1453*np.sin(0.1041*self._t)
        dx1 = -0.1595*x0*x1 + 0.1004*x2 - 0.0678*x1
        dx2 = 0.1187*x0 - 0.1411*x2 + 0.0208*x3 - 0.0619*x1*x2
        dx3 = 0.0287*x1*x2 - 0.1192*x3 + 0.1468*x0
