...
class AbyssalEcosystemSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0297*x1 - 0.0404*x0 + 0.0884*np.sin(0.0784*self._t)
        dx1 = -0.1114*x0*x1 + 0.0244*x2 - 0.0554*x1
        dx2 = 0.0488*x0 - 0.0529*x2 + 0.0719*x3 - 0.0855*x1*x2
        dx3 = 0.0758*x1*x2 - 0.0334*x3 + 0.0538*x0
