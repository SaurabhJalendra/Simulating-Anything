...
class OceanDeoxygenationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0403*x1 - 0.0618*x0 + 0.0423*np.sin(0.0340*self._t)
        dx1 = -0.0471*x0*x1 + 0.0596*x2 - 0.1109*x1
        dx2 = 0.0980*x0 - 0.0857*x2 + 0.0652*x3 - 0.0643*x1*x2
        dx3 = 0.0813*x1*x2 - 0.0410*x3 + 0.1108*x0
