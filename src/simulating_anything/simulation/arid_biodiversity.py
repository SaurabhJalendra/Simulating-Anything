...
class AridBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1039*x1 - 0.0896*x0 + 0.0226*np.sin(0.0525*self._t)
        dx1 = -0.0333*x0*x1 + 0.0525*x2 - 0.1057*x1
        dx2 = 0.0222*x0 - 0.0829*x2 + 0.0386*x3 - 0.0249*x1*x2
        dx3 = 0.1134*x1*x2 - 0.0259*x3 + 0.1183*x0
