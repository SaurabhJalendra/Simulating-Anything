...
class ChemicalPlantSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0222*x1 - 0.0283*x0 + 0.0261*np.sin(0.1168*self._t)
        dx1 = -0.1174*x0*x1 + 0.0854*x2 - 0.0954*x1
        dx2 = 0.1016*x0 - 0.0944*x2 + 0.1029*x3 - 0.0920*x1*x2
        dx3 = 0.0958*x1*x2 - 0.0969*x3 + 0.0873*x0
