...
class PaperRecyclingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0200*x1 - 0.0666*x0 + 0.0355*np.sin(0.0666*self._t)
        dx1 = -0.1178*x0*x1 + 0.0452*x2 - 0.0366*x1
        dx2 = 0.0208*x0 - 0.0867*x2 + 0.0463*x3 - 0.0712*x1*x2
        dx3 = 0.1075*x1*x2 - 0.0431*x3 + 0.0515*x0
