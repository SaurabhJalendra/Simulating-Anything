...
class CityHeatSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1136*x1 - 0.0794*x0 + 0.0565*np.sin(0.1050*self._t)
        dx1 = -0.1184*x0*x1 + 0.0382*x2 - 0.0862*x1
        dx2 = 0.0408*x0 - 0.0589*x2 + 0.0908*x3 - 0.0302*x1*x2
        dx3 = 0.0418*x1*x2 - 0.0805*x3 + 0.0483*x0
