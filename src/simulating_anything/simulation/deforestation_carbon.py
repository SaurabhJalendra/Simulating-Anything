...
class DeforestationCarbonSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0669*x1 - 0.0900*x0 + 0.0308*np.sin(0.1066*self._t)
        dx1 = -0.1090*x0*x1 + 0.0660*x2 - 0.0381*x1
        dx2 = 0.0503*x0 - 0.0475*x2 + 0.0213*x3 - 0.1197*x1*x2
        dx3 = 0.1152*x1*x2 - 0.0272*x3 + 0.0329*x0
