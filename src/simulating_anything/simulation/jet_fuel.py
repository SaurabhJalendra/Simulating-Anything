...
class JetFuelSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0832*x1 - 0.0952*x0 + 0.1051*np.sin(0.1163*self._t)
        dx1 = -0.0421*x0*x1 + 0.1175*x2 - 0.0511*x1
        dx2 = 0.1192*x0 - 0.0767*x2 + 0.0656*x3 - 0.1008*x1*x2
        dx3 = 0.0802*x1*x2 - 0.0656*x3 + 0.0863*x0
