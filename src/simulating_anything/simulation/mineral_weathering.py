...
class MineralWeatheringSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1027*x1 - 0.0482*x0 + 0.1454*np.sin(0.1122*self._t)
        dx1 = -0.1500*x0*x1 + 0.1645*x2 - 0.0519*x1
        dx2 = 0.1089*x0 - 0.0962*x2 + 0.0244*x3 - 0.0923*x1*x2
        dx3 = 0.0696*x1*x2 - 0.1083*x3 + 0.1354*x0
