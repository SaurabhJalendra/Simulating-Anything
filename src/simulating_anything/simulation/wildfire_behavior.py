...
class WildfireBehaviorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0394*x1 - 0.0747*x0 + 0.0263*np.sin(0.0374*self._t)
        dx1 = -0.0612*x0*x1 + 0.0412*x2 - 0.0965*x1
        dx2 = 0.0288*x0 - 0.0315*x2 + 0.0634*x3 - 0.0327*x1*x2
        dx3 = 0.0752*x1*x2 - 0.1044*x3 + 0.0695*x0
