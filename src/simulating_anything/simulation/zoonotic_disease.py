...
class ZoonoticDiseaseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1064*x1 - 0.0732*x0 + 0.0204*np.sin(0.0840*self._t)
        dx1 = -0.0943*x0*x1 + 0.0463*x2 - 0.0366*x1
        dx2 = 0.0279*x0 - 0.0918*x2 + 0.1089*x3 - 0.0267*x1*x2
        dx3 = 0.0991*x1*x2 - 0.0822*x3 + 0.0616*x0
