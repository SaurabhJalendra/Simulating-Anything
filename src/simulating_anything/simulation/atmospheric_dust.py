...
class AtmosphericDustSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1163*x1 - 0.0680*x0 + 0.0742*np.sin(0.1096*self._t)
        dx1 = -0.0320*x0*x1 + 0.0789*x2 - 0.0902*x1
        dx2 = 0.0337*x0 - 0.0544*x2 + 0.0792*x3 - 0.0561*x1*x2
        dx3 = 0.0588*x1*x2 - 0.0886*x3 + 0.1160*x0
