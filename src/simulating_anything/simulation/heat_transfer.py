...
class HeatTransferSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0636*x1 - 0.1024*x0 + 0.0682*np.sin(0.0264*self._t)
        dx1 = -0.0473*x0*x1 + 0.0759*x2 - 0.0638*x1
        dx2 = 0.0673*x0 - 0.0409*x2 + 0.0216*x3 - 0.0756*x1*x2
        dx3 = 0.1132*x1*x2 - 0.0640*x3 + 0.0908*x0
