...
class CoalCombustionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1334*x1 - 0.0461*x0 + 0.0420*np.sin(0.1696*self._t)
        dx1 = -0.0909*x0*x1 + 0.0452*x2 - 0.0913*x1
        dx2 = 0.0409*x0 - 0.0550*x2 + 0.0621*x3 - 0.0610*x1*x2
        dx3 = 0.1369*x1*x2 - 0.0392*x3 + 0.1391*x0
