...
class OceanCurrentSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1105*x1 - 0.0349*x0 + 0.0534*np.sin(0.0537*self._t)
        dx1 = -0.0648*x0*x1 + 0.1611*x2 - 0.0838*x1
        dx2 = 0.0345*x0 - 0.0237*x2 + 0.0702*x3 - 0.0263*x1*x2
        dx3 = 0.1106*x1*x2 - 0.0369*x3 + 0.0575*x0
