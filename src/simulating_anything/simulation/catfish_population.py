...
class CatfishPopulationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1097*x1 - 0.0513*x0 + 0.0750*np.sin(0.0915*self._t)
        dx1 = -0.0514*x0*x1 + 0.0230*x2 - 0.1002*x1
        dx2 = 0.0316*x0 - 0.0771*x2 + 0.1102*x3 - 0.0372*x1*x2
        dx3 = 0.0465*x1*x2 - 0.0837*x3 + 0.0303*x0
