...
class BloodBrainSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0242*x1 - 0.0780*x0 + 0.1122*np.sin(0.0935*self._t)
        dx1 = -0.1077*x0*x1 + 0.0703*x2 - 0.0304*x1
        dx2 = 0.0955*x0 - 0.1071*x2 + 0.0511*x3 - 0.0655*x1*x2
        dx3 = 0.1074*x1*x2 - 0.1137*x3 + 0.0472*x0
