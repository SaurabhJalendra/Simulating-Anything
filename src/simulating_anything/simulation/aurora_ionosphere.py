...
class AuroraIonosphereSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0550*x1 - 0.1137*x0 + 0.0589*np.sin(0.1056*self._t)
        dx1 = -0.0336*x0*x1 + 0.0898*x2 - 0.0661*x1
        dx2 = 0.0300*x0 - 0.0408*x2 + 0.0240*x3 - 0.0983*x1*x2
        dx3 = 0.0671*x1*x2 - 0.0642*x3 + 0.0594*x0
