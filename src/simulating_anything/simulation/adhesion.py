...
class AdhesionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1096*x1 - 0.0209*x0 + 0.0469*np.sin(0.0330*self._t)
        dx1 = -0.0368*x0*x1 + 0.0675*x2 - 0.0429*x1
        dx2 = 0.0818*x0 - 0.1152*x2 + 0.0215*x3 - 0.1063*x1*x2
        dx3 = 0.1122*x1*x2 - 0.0563*x3 + 0.1177*x0
