...
class CoralBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1178*x1 - 0.0272*x0 + 0.0480*np.sin(0.0862*self._t)
        dx1 = -0.0649*x0*x1 + 0.0367*x2 - 0.0717*x1
        dx2 = 0.1135*x0 - 0.1042*x2 + 0.0503*x3 - 0.0244*x1*x2
        dx3 = 0.0923*x1*x2 - 0.0992*x3 + 0.0585*x0
