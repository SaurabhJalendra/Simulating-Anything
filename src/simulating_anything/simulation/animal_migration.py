...
class AnimalMigrationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1154*x1 - 0.1155*x0 + 0.0951*np.sin(0.1028*self._t)
        dx1 = -0.0560*x0*x1 + 0.0752*x2 - 0.0692*x1
        dx2 = 0.0275*x0 - 0.0891*x2 + 0.0429*x3 - 0.1047*x1*x2
        dx3 = 0.0215*x1*x2 - 0.1079*x3 + 0.0987*x0
