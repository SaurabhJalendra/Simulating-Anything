...
class AnaerobicDigestionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0495*x1 - 0.0889*x0 + 0.0495*np.sin(0.0389*self._t)
        dx1 = -0.0543*x0*x1 + 0.0798*x2 - 0.0204*x1
        dx2 = 0.0982*x0 - 0.0958*x2 + 0.1191*x3 - 0.0515*x1*x2
        dx3 = 0.0518*x1*x2 - 0.0448*x3 + 0.0767*x0
