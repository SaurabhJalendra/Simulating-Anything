...
class WaterPurificationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0669*x1 - 0.0508*x0 + 0.0308*np.sin(0.0854*self._t)
        dx1 = -0.0662*x0*x1 + 0.0381*x2 - 0.1196*x1
        dx2 = 0.0357*x0 - 0.0987*x2 + 0.0690*x3 - 0.1005*x1*x2
        dx3 = 0.0618*x1*x2 - 0.1147*x3 + 0.0426*x0
