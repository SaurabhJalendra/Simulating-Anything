...
class AlgalCultivationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0768*x1 - 0.0937*x0 + 0.1113*np.sin(0.0257*self._t)
        dx1 = -0.1117*x0*x1 + 0.0977*x2 - 0.1026*x1
        dx2 = 0.0562*x0 - 0.0389*x2 + 0.1143*x3 - 0.0630*x1*x2
        dx3 = 0.0744*x1*x2 - 0.0475*x3 + 0.0580*x0
