...
class AlbedoChangeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1158*x1 - 0.0297*x0 + 0.0414*np.sin(0.1133*self._t)
        dx1 = -0.0983*x0*x1 + 0.0666*x2 - 0.0515*x1
        dx2 = 0.0731*x0 - 0.0716*x2 + 0.0894*x3 - 0.0889*x1*x2
        dx3 = 0.1142*x1*x2 - 0.0424*x3 + 0.0550*x0
