...
class MountainGlacierSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0443*x1 - 0.0448*x0 + 0.0251*np.sin(0.0669*self._t)
        dx1 = -0.0993*x0*x1 + 0.0860*x2 - 0.0680*x1
        dx2 = 0.0451*x0 - 0.1147*x2 + 0.0670*x3 - 0.0503*x1*x2
        dx3 = 0.0239*x1*x2 - 0.1058*x3 + 0.0369*x0
