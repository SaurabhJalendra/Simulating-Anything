...
class SemiconductorFabSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0944*x1 - 0.0992*x0 + 0.0634*np.sin(0.0236*self._t)
        dx1 = -0.0894*x0*x1 + 0.0347*x2 - 0.0403*x1
        dx2 = 0.1191*x0 - 0.0664*x2 + 0.0274*x3 - 0.1061*x1*x2
        dx3 = 0.1012*x1*x2 - 0.0542*x3 + 0.1059*x0
