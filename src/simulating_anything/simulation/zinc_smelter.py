...
class ZincSmelterSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1502*x1 - 0.0236*x0 + 0.1436*np.sin(0.0555*self._t)
        dx1 = -0.0508*x0*x1 + 0.0864*x2 - 0.0956*x1
        dx2 = 0.1665*x0 - 0.0203*x2 + 0.1652*x3 - 0.086*x1*x2
        dx3 = 0.0729*x1*x2 - 0.0351*x3 + 0.1656*x0
