...
class BambooGrowthSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0831*x1 - 0.0218*x0 + 0.1137*np.sin(0.0932*self._t)
        dx1 = -0.0201*x0*x1 + 0.0601*x2 - 0.0330*x1
        dx2 = 0.0475*x0 - 0.1125*x2 + 0.0386*x3 - 0.1044*x1*x2
        dx3 = 0.0551*x1*x2 - 0.0464*x3 + 0.1092*x0
