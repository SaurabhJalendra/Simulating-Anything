...
class BloodClotSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0688*x1 - 0.0494*x0 + 0.1144*np.sin(0.0305*self._t)
        dx1 = -0.0487*x0*x1 + 0.0288*x2 - 0.0867*x1
        dx2 = 0.1037*x0 - 0.0332*x2 + 0.0639*x3 - 0.0419*x1*x2
        dx3 = 0.0334*x1*x2 - 0.0423*x3 + 0.0900*x0
