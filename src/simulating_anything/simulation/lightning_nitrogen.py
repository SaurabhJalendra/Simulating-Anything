...
class LightningNitrogenSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0327*x1 - 0.0520*x0 + 0.0693*np.sin(0.0667*self._t)
        dx1 = -0.1251*x0*x1 + 0.0477*x2 - 0.0345*x1
        dx2 = 0.0892*x0 - 0.1041*x2 + 0.1092*x3 - 0.0978*x1*x2
        dx3 = 0.0388*x1*x2 - 0.0341*x3 + 0.1304*x0
