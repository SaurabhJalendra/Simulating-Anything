...
class ElectricVehicleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1292*x1 - 0.0368*x0 + 0.1389*np.sin(0.0909*self._t)
        dx1 = -0.1112*x0*x1 + 0.1232*x2 - 0.1273*x1
        dx2 = 0.0470*x0 - 0.0767*x2 + 0.0870*x3 - 0.0926*x1*x2
        dx3 = 0.1262*x1*x2 - 0.0874*x3 + 0.0908*x0
