...
class AlgaeToxinFishSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0766*x1 - 0.0343*x0 + 0.0426*np.sin(0.1034*self._t)
        dx1 = -0.0650*x0*x1 + 0.0796*x2 - 0.0446*x1
        dx2 = 0.0564*x0 - 0.0850*x2 + 0.0230*x3 - 0.0773*x1*x2
        dx3 = 0.0289*x1*x2 - 0.0660*x3 + 0.0593*x0
