...
class StreamEcologySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0643*x1 - 0.0499*x0 + 0.0737*np.sin(0.0595*self._t)
        dx1 = -0.0503*x0*x1 + 0.0357*x2 - 0.0318*x1
        dx2 = 0.0327*x0 - 0.0813*x2 + 0.0552*x3 - 0.0534*x1*x2
        dx3 = 0.0289*x1*x2 - 0.0620*x3 + 0.0822*x0
