...
class LandSubsidenceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0301*x1 - 0.0920*x0 + 0.0403*np.sin(0.0345*self._t)
        dx1 = -0.0369*x0*x1 + 0.0819*x2 - 0.1057*x1
        dx2 = 0.0222*x0 - 0.1033*x2 + 0.0723*x3 - 0.0984*x1*x2
        dx3 = 0.0335*x1*x2 - 0.0867*x3 + 0.0483*x0
