...
class ParasiteEcologySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0852*x1 - 0.0545*x0 + 0.0991*np.sin(0.1176*self._t)
        dx1 = -0.0611*x0*x1 + 0.0986*x2 - 0.0234*x1
        dx2 = 0.0318*x0 - 0.0375*x2 + 0.0938*x3 - 0.0880*x1*x2
        dx3 = 0.0563*x1*x2 - 0.0625*x3 + 0.0427*x0
