...
class RetinalCellSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1193*x1 - 0.0503*x0 + 0.0795*np.sin(0.0797*self._t)
        dx1 = -0.0961*x0*x1 + 0.1183*x2 - 0.0958*x1
        dx2 = 0.0592*x0 - 0.1181*x2 + 0.0473*x3 - 0.0397*x1*x2
        dx3 = 0.0701*x1*x2 - 0.0826*x3 + 0.0673*x0
