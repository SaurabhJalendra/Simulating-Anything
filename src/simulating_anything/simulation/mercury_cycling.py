...
class MercuryCyclingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1159*x1 - 0.0925*x0 + 0.1199*np.sin(0.0684*self._t)
        dx1 = -0.0744*x0*x1 + 0.0222*x2 - 0.0502*x1
        dx2 = 0.0930*x0 - 0.0375*x2 + 0.1173*x3 - 0.0410*x1*x2
        dx3 = 0.0268*x1*x2 - 0.0556*x3 + 0.0869*x0
