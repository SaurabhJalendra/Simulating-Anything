...
class SolarThermalSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0866*x1 - 0.0629*x0 + 0.0589*np.sin(0.1052*self._t)
        dx1 = -0.0907*x0*x1 + 0.0236*x2 - 0.0800*x1
        dx2 = 0.0913*x0 - 0.0272*x2 + 0.0757*x3 - 0.0991*x1*x2
        dx3 = 0.0373*x1*x2 - 0.1129*x3 + 0.0959*x0
