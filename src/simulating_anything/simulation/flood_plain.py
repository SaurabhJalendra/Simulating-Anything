...
class FloodPlainSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1121*x1 - 0.0370*x0 + 0.1198*np.sin(0.0848*self._t)
        dx1 = -0.0206*x0*x1 + 0.0681*x2 - 0.1160*x1
        dx2 = 0.0849*x0 - 0.0788*x2 + 0.1117*x3 - 0.0361*x1*x2
        dx3 = 0.0582*x1*x2 - 0.0317*x3 + 0.0344*x0
