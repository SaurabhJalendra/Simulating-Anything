...
class AquiferSalinitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0739*x1 - 0.0372*x0 + 0.0570*np.sin(0.0968*self._t)
        dx1 = -0.1138*x0*x1 + 0.0328*x2 - 0.0463*x1
        dx2 = 0.0223*x0 - 0.0322*x2 + 0.0835*x3 - 0.0984*x1*x2
        dx3 = 0.0941*x1*x2 - 0.0992*x3 + 0.0648*x0
