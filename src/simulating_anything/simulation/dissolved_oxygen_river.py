...
class DissolvedOxygenRiverSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0244*x1 - 0.1098*x0 + 0.0643*np.sin(0.0597*self._t)
        dx1 = -0.1011*x0*x1 + 0.0863*x2 - 0.0678*x1
        dx2 = 0.0820*x0 - 0.0257*x2 + 0.0417*x3 - 0.0691*x1*x2
        dx3 = 0.0557*x1*x2 - 0.0342*x3 + 0.0691*x0
