...
class MarshCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0398*x1 - 0.0564*x0 + 0.0459*np.sin(0.0492*self._t)
        dx1 = -0.0261*x0*x1 + 0.0333*x2 - 0.0860*x1
        dx2 = 0.0999*x0 - 0.0377*x2 + 0.0341*x3 - 0.0576*x1*x2
        dx3 = 0.0666*x1*x2 - 0.0929*x3 + 0.0619*x0
