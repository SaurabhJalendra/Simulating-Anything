...
class WeatherFrontSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0288*x1 - 0.0449*x0 + 0.0999*np.sin(0.0910*self._t)
        dx1 = -0.0622*x0*x1 + 0.0729*x2 - 0.0224*x1
        dx2 = 0.0578*x0 - 0.0770*x2 + 0.0920*x3 - 0.1108*x1*x2
        dx3 = 0.0653*x1*x2 - 0.0797*x3 + 0.0685*x0
