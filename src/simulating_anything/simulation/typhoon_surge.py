...
class TyphoonSurgeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1029*x1 - 0.0626*x0 + 0.0534*np.sin(0.1077*self._t)
        dx1 = -0.0669*x0*x1 + 0.0973*x2 - 0.0542*x1
        dx2 = 0.0668*x0 - 0.0938*x2 + 0.0407*x3 - 0.0759*x1*x2
        dx3 = 0.0940*x1*x2 - 0.0412*x3 + 0.0683*x0
