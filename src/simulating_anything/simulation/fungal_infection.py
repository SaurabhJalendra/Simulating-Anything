...
class FungalInfectionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0206*x1 - 0.0657*x0 + 0.0574*np.sin(0.0269*self._t)
        dx1 = -0.0802*x0*x1 + 0.0878*x2 - 0.0523*x1
        dx2 = 0.1081*x0 - 0.0944*x2 + 0.0843*x3 - 0.1048*x1*x2
        dx3 = 0.0653*x1*x2 - 0.0770*x3 + 0.0471*x0
