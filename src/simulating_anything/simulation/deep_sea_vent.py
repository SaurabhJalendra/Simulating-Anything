...
class DeepSeaVentSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1206*x1 - 0.0582*x0 + 0.1405*np.sin(0.1264*self._t)
        dx1 = -0.1386*x0*x1 + 0.0402*x2 - 0.1425*x1
        dx2 = 0.0373*x0 - 0.1625*x2 + 0.1604*x3 - 0.0352*x1*x2
        dx3 = 0.0451*x1*x2 - 0.1065*x3 + 0.0896*x0
