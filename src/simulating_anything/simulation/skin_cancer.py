...
class SkinCancerSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0578*x1 - 0.0861*x0 + 0.0669*np.sin(0.0588*self._t)
        dx1 = -0.0756*x0*x1 + 0.0363*x2 - 0.0639*x1
        dx2 = 0.1096*x0 - 0.1074*x2 + 0.0645*x3 - 0.0382*x1*x2
        dx3 = 0.1168*x1*x2 - 0.0732*x3 + 0.0642*x0
