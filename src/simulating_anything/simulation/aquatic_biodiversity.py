...
class AquaticBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0837*x1 - 0.1176*x0 + 0.0327*np.sin(0.1021*self._t)
        dx1 = -0.0835*x0*x1 + 0.0715*x2 - 0.0706*x1
        dx2 = 0.0327*x0 - 0.1075*x2 + 0.0417*x3 - 0.0426*x1*x2
        dx3 = 0.0288*x1*x2 - 0.0529*x3 + 0.0294*x0
