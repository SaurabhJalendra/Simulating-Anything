...
class OysterDiseaseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0985*x1 - 0.0601*x0 + 0.0279*np.sin(0.0683*self._t)
        dx1 = -0.0607*x0*x1 + 0.1127*x2 - 0.0866*x1
        dx2 = 0.0455*x0 - 0.0372*x2 + 0.0820*x3 - 0.0511*x1*x2
        dx3 = 0.0619*x1*x2 - 0.1162*x3 + 0.0753*x0
