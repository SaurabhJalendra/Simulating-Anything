...
class PeatBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1004*x1 - 0.0276*x0 + 0.0975*np.sin(0.1157*self._t)
        dx1 = -0.0492*x0*x1 + 0.0751*x2 - 0.0216*x1
        dx2 = 0.0717*x0 - 0.0808*x2 + 0.0667*x3 - 0.0474*x1*x2
        dx3 = 0.0448*x1*x2 - 0.0489*x3 + 0.1198*x0
