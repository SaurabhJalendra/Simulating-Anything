...
class AcousticSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0520*x1 - 0.0609*x0 + 0.0631*np.sin(0.0336*self._t)
        dx1 = -0.0765*x0*x1 + 0.1030*x2 - 0.0794*x1
        dx2 = 0.0784*x0 - 0.1019*x2 + 0.0937*x3 - 0.1019*x1*x2
        dx3 = 0.0207*x1*x2 - 0.0494*x3 + 0.0381*x0
