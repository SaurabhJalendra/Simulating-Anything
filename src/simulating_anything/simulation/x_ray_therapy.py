...
class XRayTherapySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0854*x1 - 0.1178*x0 + 0.0587*np.sin(0.0424*self._t)
        dx1 = -0.0846*x0*x1 + 0.0826*x2 - 0.0354*x1
        dx2 = 0.0685*x0 - 0.0993*x2 + 0.1028*x3 - 0.0579*x1*x2
        dx3 = 0.0480*x1*x2 - 0.0670*x3 + 0.0267*x0
