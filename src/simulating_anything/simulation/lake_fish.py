...
class LakeFishSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0307*x1 - 0.0309*x0 + 0.0749*np.sin(0.0243*self._t)
        dx1 = -0.0225*x0*x1 + 0.0776*x2 - 0.0882*x1
        dx2 = 0.1065*x0 - 0.0341*x2 + 0.0799*x3 - 0.0601*x1*x2
        dx3 = 0.0871*x1*x2 - 0.0928*x3 + 0.0349*x0
