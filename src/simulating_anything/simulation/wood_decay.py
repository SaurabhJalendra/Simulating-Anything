...
class WoodDecaySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0587*x1 - 0.1182*x0 + 0.1170*np.sin(0.1187*self._t)
        dx1 = -0.0771*x0*x1 + 0.1085*x2 - 0.0649*x1
        dx2 = 0.0436*x0 - 0.1013*x2 + 0.0502*x3 - 0.1159*x1*x2
        dx3 = 0.0534*x1*x2 - 0.1021*x3 + 0.0572*x0
