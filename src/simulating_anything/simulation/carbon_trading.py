...
class CarbonTradingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1136*x1 - 0.0370*x0 + 0.0434*np.sin(0.0509*self._t)
        dx1 = -0.1176*x0*x1 + 0.1010*x2 - 0.0469*x1
        dx2 = 0.0845*x0 - 0.1118*x2 + 0.0859*x3 - 0.0289*x1*x2
        dx3 = 0.0718*x1*x2 - 0.0721*x3 + 0.0728*x0
