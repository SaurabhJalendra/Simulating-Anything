...
class BirdCollisionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0668*x1 - 0.0441*x0 + 0.0255*np.sin(0.0808*self._t)
        dx1 = -0.1123*x0*x1 + 0.0726*x2 - 0.0526*x1
        dx2 = 0.0408*x0 - 0.0823*x2 + 0.0402*x3 - 0.1101*x1*x2
        dx3 = 0.0820*x1*x2 - 0.0393*x3 + 0.0630*x0
