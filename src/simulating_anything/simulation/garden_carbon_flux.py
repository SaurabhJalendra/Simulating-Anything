...
class GardenCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0887*x1 - 0.0502*x0 + 0.0466*np.sin(0.0566*self._t)
        dx1 = -0.0862*x0*x1 + 0.0914*x2 - 0.0943*x1
        dx2 = 0.0946*x0 - 0.0997*x2 + 0.0688*x3 - 0.0939*x1*x2
        dx3 = 0.0424*x1*x2 - 0.0609*x3 + 0.0635*x0
