...
class UltrasoundTherapySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1052*x1 - 0.0307*x0 + 0.1170*np.sin(0.0682*self._t)
        dx1 = -0.0217*x0*x1 + 0.1099*x2 - 0.0299*x1
        dx2 = 0.0790*x0 - 0.0565*x2 + 0.0623*x3 - 0.1196*x1*x2
        dx3 = 0.0209*x1*x2 - 0.0314*x3 + 0.1159*x0
