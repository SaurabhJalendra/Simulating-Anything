...
class SoilCarbonStorageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0665*x1 - 0.0798*x0 + 0.0218*np.sin(0.0700*self._t)
        dx1 = -0.0290*x0*x1 + 0.0418*x2 - 0.1051*x1
        dx2 = 0.0826*x0 - 0.0541*x2 + 0.0946*x3 - 0.0967*x1*x2
        dx3 = 0.0889*x1*x2 - 0.0909*x3 + 0.0816*x0
