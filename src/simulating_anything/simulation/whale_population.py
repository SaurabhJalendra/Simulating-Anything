...
class WhalePopulationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1593*x1 - 0.0816*x0 + 0.1502*np.sin(0.0514*self._t)
        dx1 = -0.049*x0*x1 + 0.1147*x2 - 0.0634*x1
        dx2 = 0.1616*x0 - 0.0894*x2 + 0.0302*x3 - 0.0223*x1*x2
        dx3 = 0.0333*x1*x2 - 0.1424*x3 + 0.0841*x0
