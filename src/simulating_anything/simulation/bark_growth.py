...
class BarkGrowthSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0959*x1 - 0.0688*x0 + 0.1170*np.sin(0.0795*self._t)
        dx1 = -0.0796*x0*x1 + 0.0338*x2 - 0.1125*x1
        dx2 = 0.0644*x0 - 0.1054*x2 + 0.0951*x3 - 0.0720*x1*x2
        dx3 = 0.0375*x1*x2 - 0.1085*x3 + 0.0256*x0
