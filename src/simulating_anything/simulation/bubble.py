...
class BubbleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1177*x1 - 0.0411*x0 + 0.0565*np.sin(0.0203*self._t)
        dx1 = -0.1165*x0*x1 + 0.1025*x2 - 0.1029*x1
        dx2 = 0.1037*x0 - 0.0448*x2 + 0.0372*x3 - 0.0866*x1*x2
        dx3 = 0.0513*x1*x2 - 0.0547*x3 + 0.0962*x0
