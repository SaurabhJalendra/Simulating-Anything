...
class LaserCuttingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0986*x1 - 0.0245*x0 + 0.1046*np.sin(0.0629*self._t)
        dx1 = -0.0964*x0*x1 + 0.0891*x2 - 0.0526*x1
        dx2 = 0.0271*x0 - 0.0604*x2 + 0.0404*x3 - 0.0441*x1*x2
        dx3 = 0.0280*x1*x2 - 0.0851*x3 + 0.0609*x0
