...
class DolphinPopulationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0326*x1 - 0.0365*x0 + 0.0913*np.sin(0.0648*self._t)
        dx1 = -0.0888*x0*x1 + 0.0685*x2 - 0.0357*x1
        dx2 = 0.0289*x0 - 0.0337*x2 + 0.0807*x3 - 0.0388*x1*x2
        dx3 = 0.0592*x1*x2 - 0.0612*x3 + 0.1070*x0
