...
class PrionDiseaseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1002*x1 - 0.0327*x0 + 0.0636*np.sin(0.0530*self._t)
        dx1 = -0.0367*x0*x1 + 0.0349*x2 - 0.1192*x1
        dx2 = 0.0682*x0 - 0.0443*x2 + 0.1088*x3 - 0.0732*x1*x2
        dx3 = 0.1051*x1*x2 - 0.0829*x3 + 0.1186*x0
