...
class SeaLevelRiseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0763*x1 - 0.0261*x0 + 0.0572*np.sin(0.1105*self._t)
        dx1 = -0.1046*x0*x1 + 0.0455*x2 - 0.0513*x1
        dx2 = 0.0384*x0 - 0.0943*x2 + 0.0378*x3 - 0.0752*x1*x2
        dx3 = 0.1055*x1*x2 - 0.0653*x3 + 0.0241*x0
