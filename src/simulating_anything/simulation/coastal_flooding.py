...
class CoastalFloodingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1116*x1 - 0.0373*x0 + 0.0582*np.sin(0.1262*self._t)
        dx1 = -0.1316*x0*x1 + 0.1270*x2 - 0.1042*x1
        dx2 = 0.0641*x0 - 0.0900*x2 + 0.0224*x3 - 0.1286*x1*x2
        dx3 = 0.0736*x1*x2 - 0.0815*x3 + 0.1058*x0
