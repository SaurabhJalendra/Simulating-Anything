...
class SlimeMoldSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0906*x1 - 0.0853*x0 + 0.1197*np.sin(0.0816*self._t)
        dx1 = -0.1054*x0*x1 + 0.0269*x2 - 0.0276*x1
        dx2 = 0.0992*x0 - 0.0461*x2 + 0.0998*x3 - 0.0676*x1*x2
        dx3 = 0.0546*x1*x2 - 0.1037*x3 + 0.0360*x0
