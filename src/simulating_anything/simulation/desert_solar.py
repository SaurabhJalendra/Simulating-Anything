...
class DesertSolarSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1119*x1 - 0.0574*x0 + 0.0457*np.sin(0.0602*self._t)
        dx1 = -0.1144*x0*x1 + 0.0784*x2 - 0.0917*x1
        dx2 = 0.0619*x0 - 0.0485*x2 + 0.0218*x3 - 0.0797*x1*x2
        dx3 = 0.1115*x1*x2 - 0.0370*x3 + 0.0384*x0
