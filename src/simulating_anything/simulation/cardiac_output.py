...
class CardiacOutputSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0836*x1 - 0.0494*x0 + 0.0932*np.sin(0.0488*self._t)
        dx1 = -0.0642*x0*x1 + 0.0561*x2 - 0.0580*x1
        dx2 = 0.0577*x0 - 0.0961*x2 + 0.0498*x3 - 0.1001*x1*x2
        dx3 = 0.0367*x1*x2 - 0.1061*x3 + 0.0441*x0
