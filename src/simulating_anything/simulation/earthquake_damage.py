...
class EarthquakeDamageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0543*x1 - 0.0855*x0 + 0.031*np.sin(0.1367*self._t)
        dx1 = -0.1648*x0*x1 + 0.1106*x2 - 0.1429*x1
        dx2 = 0.1095*x0 - 0.1604*x2 + 0.1695*x3 - 0.0254*x1*x2
        dx3 = 0.0672*x1*x2 - 0.1112*x3 + 0.1061*x0
