...
class FlashFloodSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0982*x1 - 0.1644*x0 + 0.1481*np.sin(0.0502*self._t)
        dx1 = -0.1177*x0*x1 + 0.0462*x2 - 0.1391*x1
        dx2 = 0.0919*x0 - 0.1457*x2 + 0.1233*x3 - 0.1597*x1*x2
        dx3 = 0.1194*x1*x2 - 0.1220*x3 + 0.1502*x0
