...
class IronOreSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0581*x1 - 0.0595*x0 + 0.0232*np.sin(0.0824*self._t)
        dx1 = -0.0872*x0*x1 + 0.0337*x2 - 0.0457*x1
        dx2 = 0.0661*x0 - 0.0574*x2 + 0.0866*x3 - 0.0534*x1*x2
        dx3 = 0.0479*x1*x2 - 0.0304*x3 + 0.0464*x0
