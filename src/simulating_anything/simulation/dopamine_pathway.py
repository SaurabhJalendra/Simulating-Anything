...
class DopaminePathwaySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0560*x1 - 0.1081*x0 + 0.0401*np.sin(0.0725*self._t)
        dx1 = -0.0572*x0*x1 + 0.0837*x2 - 0.0407*x1
        dx2 = 0.0761*x0 - 0.0381*x2 + 0.0517*x3 - 0.0647*x1*x2
        dx3 = 0.0925*x1*x2 - 0.1198*x3 + 0.0244*x0
