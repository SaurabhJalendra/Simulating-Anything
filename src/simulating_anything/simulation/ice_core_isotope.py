...
class IceCoreIsotopeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1640*x1 - 0.0869*x0 + 0.1082*np.sin(0.0215*self._t)
        dx1 = -0.1154*x0*x1 + 0.1028*x2 - 0.0762*x1
        dx2 = 0.0868*x0 - 0.1059*x2 + 0.0343*x3 - 0.1458*x1*x2
        dx3 = 0.0256*x1*x2 - 0.0402*x3 + 0.0878*x0
