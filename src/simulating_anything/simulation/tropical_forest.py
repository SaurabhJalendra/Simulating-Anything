...
class TropicalForestSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0527*x1 - 0.0853*x0 + 0.0688*np.sin(0.0476*self._t)
        dx1 = -0.0460*x0*x1 + 0.0246*x2 - 0.0399*x1
        dx2 = 0.1172*x0 - 0.0489*x2 + 0.0963*x3 - 0.1159*x1*x2
        dx3 = 0.0459*x1*x2 - 0.1011*x3 + 0.0318*x0
