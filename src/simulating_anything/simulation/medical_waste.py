...
class MedicalWasteSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1057*x1 - 0.0859*x0 + 0.1068*np.sin(0.0827*self._t)
        dx1 = -0.0449*x0*x1 + 0.1073*x2 - 0.0946*x1
        dx2 = 0.0444*x0 - 0.1101*x2 + 0.0905*x3 - 0.0405*x1*x2
        dx3 = 0.0983*x1*x2 - 0.0714*x3 + 0.0531*x0
