...
class OrganicFarmingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0493*x1 - 0.1176*x0 + 0.0380*np.sin(0.0931*self._t)
        dx1 = -0.0666*x0*x1 + 0.1052*x2 - 0.1198*x1
        dx2 = 0.0968*x0 - 0.0371*x2 + 0.0676*x3 - 0.1087*x1*x2
        dx3 = 0.0269*x1*x2 - 0.0257*x3 + 0.0366*x0
