...
class EarthquakePrecursorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0769*x1 - 0.0310*x0 + 0.0225*np.sin(0.0657*self._t)
        dx1 = -0.1134*x0*x1 + 0.0224*x2 - 0.0735*x1
        dx2 = 0.1095*x0 - 0.0999*x2 + 0.0316*x3 - 0.0670*x1*x2
        dx3 = 0.0203*x1*x2 - 0.0745*x3 + 0.0304*x0
