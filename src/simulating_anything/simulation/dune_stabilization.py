...
class DuneStabilizationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0619*x1 - 0.0299*x0 + 0.0402*np.sin(0.0474*self._t)
        dx1 = -0.0817*x0*x1 + 0.0334*x2 - 0.0523*x1
        dx2 = 0.0251*x0 - 0.0762*x2 + 0.0585*x3 - 0.0585*x1*x2
        dx3 = 0.1054*x1*x2 - 0.1069*x3 + 0.0739*x0
