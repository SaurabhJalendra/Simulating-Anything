...
class JungleFireSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1191*x1 - 0.0939*x0 + 0.0604*np.sin(0.1091*self._t)
        dx1 = -0.0294*x0*x1 + 0.0939*x2 - 0.0319*x1
        dx2 = 0.0545*x0 - 0.1195*x2 + 0.0622*x3 - 0.0539*x1*x2
        dx3 = 0.0561*x1*x2 - 0.0441*x3 + 0.0463*x0
