...
class KelpUrchinSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1588*x1 - 0.1429*x0 + 0.1503*np.sin(0.0988*self._t)
        dx1 = -0.0747*x0*x1 + 0.1235*x2 - 0.063*x1
        dx2 = 0.0337*x0 - 0.0886*x2 + 0.1124*x3 - 0.1239*x1*x2
        dx3 = 0.1195*x1*x2 - 0.0646*x3 + 0.1242*x0
