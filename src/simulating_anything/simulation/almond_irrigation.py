...
class AlmondIrrigationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0889*x1 - 0.1089*x0 + 0.1016*np.sin(0.0532*self._t)
        dx1 = -0.0279*x0*x1 + 0.0287*x2 - 0.0844*x1
        dx2 = 0.0984*x0 - 0.0655*x2 + 0.0494*x3 - 0.1148*x1*x2
        dx3 = 0.0696*x1*x2 - 0.0385*x3 + 0.1007*x0
