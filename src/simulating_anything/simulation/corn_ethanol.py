...
class CornEthanolSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1082*x1 - 0.1065*x0 + 0.0362*np.sin(0.0753*self._t)
        dx1 = -0.0266*x0*x1 + 0.1035*x2 - 0.0827*x1
        dx2 = 0.0929*x0 - 0.0692*x2 + 0.0220*x3 - 0.1198*x1*x2
        dx3 = 0.1160*x1*x2 - 0.1071*x3 + 0.0961*x0
