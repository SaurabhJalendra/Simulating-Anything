...
class CementEmissionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1080*x1 - 0.0961*x0 + 0.0974*np.sin(0.0423*self._t)
        dx1 = -0.0916*x0*x1 + 0.0604*x2 - 0.0436*x1
        dx2 = 0.0221*x0 - 0.0471*x2 + 0.0263*x3 - 0.0479*x1*x2
        dx3 = 0.0429*x1*x2 - 0.0385*x3 + 0.1122*x0
