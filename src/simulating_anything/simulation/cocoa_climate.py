...
class CocoaClimateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1057*x1 - 0.0397*x0 + 0.0409*np.sin(0.0743*self._t)
        dx1 = -0.0766*x0*x1 + 0.0894*x2 - 0.0734*x1
        dx2 = 0.0477*x0 - 0.0917*x2 + 0.0781*x3 - 0.1149*x1*x2
        dx3 = 0.0735*x1*x2 - 0.0364*x3 + 0.0700*x0
