...
class BarnacleCompetitionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0951*x1 - 0.0431*x0 + 0.0656*np.sin(0.1088*self._t)
        dx1 = -0.0653*x0*x1 + 0.0914*x2 - 0.0340*x1
        dx2 = 0.1137*x0 - 0.0423*x2 + 0.1015*x3 - 0.0254*x1*x2
        dx3 = 0.0352*x1*x2 - 0.0206*x3 + 0.0240*x0
