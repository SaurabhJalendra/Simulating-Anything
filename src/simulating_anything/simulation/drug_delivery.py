...
class DrugDeliverySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0316*x1 - 0.0782*x0 + 0.0339*np.sin(0.0650*self._t)
        dx1 = -0.0203*x0*x1 + 0.0913*x2 - 0.0551*x1
        dx2 = 0.1151*x0 - 0.0966*x2 + 0.1133*x3 - 0.0927*x1*x2
        dx3 = 0.0792*x1*x2 - 0.0247*x3 + 0.0438*x0
