...
class CropCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0817*x1 - 0.1017*x0 + 0.0716*np.sin(0.1074*self._t)
        dx1 = -0.0618*x0*x1 + 0.1133*x2 - 0.0672*x1
        dx2 = 0.0681*x0 - 0.0937*x2 + 0.0255*x3 - 0.1020*x1*x2
        dx3 = 0.0435*x1*x2 - 0.0497*x3 + 0.0944*x0
