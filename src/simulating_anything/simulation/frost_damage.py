...
class FrostDamageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0214*x1 - 0.0410*x0 + 0.0480*np.sin(0.0263*self._t)
        dx1 = -0.1195*x0*x1 + 0.0590*x2 - 0.0205*x1
        dx2 = 0.0510*x0 - 0.0585*x2 + 0.0453*x3 - 0.0737*x1*x2
        dx3 = 0.1198*x1*x2 - 0.0547*x3 + 0.0638*x0
