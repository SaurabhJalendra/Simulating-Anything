...
class SaharaDustSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0238*x1 - 0.068*x0 + 0.1628*np.sin(0.077*self._t)
        dx1 = -0.1528*x0*x1 + 0.09*x2 - 0.0481*x1
        dx2 = 0.0742*x0 - 0.0684*x2 + 0.0651*x3 - 0.1166*x1*x2
        dx3 = 0.0224*x1*x2 - 0.1497*x3 + 0.0762*x0
