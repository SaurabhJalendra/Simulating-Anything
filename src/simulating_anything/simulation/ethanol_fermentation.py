...
class EthanolFermentationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1114*x1 - 0.1268*x0 + 0.0315*np.sin(0.1400*self._t)
        dx1 = -0.0424*x0*x1 + 0.1500*x2 - 0.1277*x1
        dx2 = 0.0643*x0 - 0.0606*x2 + 0.1243*x3 - 0.0547*x1*x2
        dx3 = 0.0707*x1*x2 - 0.0300*x3 + 0.0827*x0
