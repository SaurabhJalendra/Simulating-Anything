...
class WaspColonySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0320*x1 - 0.1075*x0 + 0.0324*np.sin(0.0780*self._t)
        dx1 = -0.0699*x0*x1 + 0.1011*x2 - 0.0465*x1
        dx2 = 0.0207*x0 - 0.0743*x2 + 0.0536*x3 - 0.0587*x1*x2
        dx3 = 0.0552*x1*x2 - 0.0863*x3 + 0.1008*x0
