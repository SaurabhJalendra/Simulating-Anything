...
class SurfaceTensionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0246*x1 - 0.0766*x0 + 0.0981*np.sin(0.0690*self._t)
        dx1 = -0.0280*x0*x1 + 0.0253*x2 - 0.0505*x1
        dx2 = 0.0377*x0 - 0.0267*x2 + 0.1113*x3 - 0.0575*x1*x2
        dx3 = 0.0983*x1*x2 - 0.0754*x3 + 0.0924*x0
