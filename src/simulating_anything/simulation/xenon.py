...
class XenonSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1124*x1 - 0.1139*x0 + 0.1048*np.sin(0.0823*self._t)
        dx1 = -0.0325*x0*x1 + 0.0779*x2 - 0.0908*x1
        dx2 = 0.1179*x0 - 0.0362*x2 + 0.0551*x3 - 0.0928*x1*x2
        dx3 = 0.0787*x1*x2 - 0.0464*x3 + 0.0420*x0
