...
class BrainInjurySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1188*x1 - 0.1074*x0 + 0.0714*np.sin(0.0933*self._t)
        dx1 = -0.0433*x0*x1 + 0.1155*x2 - 0.0209*x1
        dx2 = 0.1047*x0 - 0.0313*x2 + 0.0833*x3 - 0.0200*x1*x2
        dx3 = 0.0635*x1*x2 - 0.0300*x3 + 0.0417*x0
