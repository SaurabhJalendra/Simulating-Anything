...
class WoodSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0443*x1 - 0.0259*x0 + 0.0496*np.sin(0.0965*self._t)
        dx1 = -0.0484*x0*x1 + 0.0776*x2 - 0.0392*x1
        dx2 = 0.0391*x0 - 0.0642*x2 + 0.0683*x3 - 0.0540*x1*x2
        dx3 = 0.0345*x1*x2 - 0.0701*x3 + 0.0220*x0
