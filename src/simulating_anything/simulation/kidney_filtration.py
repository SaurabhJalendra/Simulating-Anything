...
class KidneyFiltrationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1439*x1 - 0.1223*x0 + 0.0704*np.sin(0.0468*self._t)
        dx1 = -0.0716*x0*x1 + 0.0540*x2 - 0.0502*x1
        dx2 = 0.1150*x0 - 0.1006*x2 + 0.1121*x3 - 0.0539*x1*x2
        dx3 = 0.1289*x1*x2 - 0.0736*x3 + 0.1089*x0
