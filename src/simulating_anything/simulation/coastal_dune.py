...
class CoastalDuneSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1546*x1 - 0.0531*x0 + 0.0214*np.sin(0.0223*self._t)
        dx1 = -0.0922*x0*x1 + 0.1434*x2 - 0.0643*x1
        dx2 = 0.1071*x0 - 0.1601*x2 + 0.0696*x3 - 0.109*x1*x2
        dx3 = 0.0697*x1*x2 - 0.1547*x3 + 0.0429*x0
