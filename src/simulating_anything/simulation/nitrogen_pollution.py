...
class NitrogenPollutionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1063*x1 - 0.0723*x0 + 0.1033*np.sin(0.0525*self._t)
        dx1 = -0.0918*x0*x1 + 0.1114*x2 - 0.0342*x1
        dx2 = 0.1103*x0 - 0.0645*x2 + 0.1120*x3 - 0.0932*x1*x2
        dx3 = 0.0483*x1*x2 - 0.0965*x3 + 0.0990*x0
