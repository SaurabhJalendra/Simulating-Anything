...
class UrbanDrainageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0759*x1 - 0.136*x0 + 0.0427*np.sin(0.1384*self._t)
        dx1 = -0.15*x0*x1 + 0.0382*x2 - 0.1424*x1
        dx2 = 0.1285*x0 - 0.0575*x2 + 0.1236*x3 - 0.1654*x1*x2
        dx3 = 0.0631*x1*x2 - 0.0257*x3 + 0.1183*x0
