...
class ScarTissueSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0439*x1 - 0.0997*x0 + 0.0817*np.sin(0.0348*self._t)
        dx1 = -0.1172*x0*x1 + 0.0210*x2 - 0.0911*x1
        dx2 = 0.0271*x0 - 0.0976*x2 + 0.0642*x3 - 0.0326*x1*x2
        dx3 = 0.0257*x1*x2 - 0.0480*x3 + 0.0231*x0
