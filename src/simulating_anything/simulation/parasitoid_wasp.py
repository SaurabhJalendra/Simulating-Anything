...
class ParasitoidWaspSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0962*x1 - 0.0346*x0 + 0.0975*np.sin(0.0586*self._t)
        dx1 = -0.0445*x0*x1 + 0.1018*x2 - 0.1114*x1
        dx2 = 0.0653*x0 - 0.0395*x2 + 0.1021*x3 - 0.0567*x1*x2
        dx3 = 0.1025*x1*x2 - 0.1199*x3 + 0.0255*x0
