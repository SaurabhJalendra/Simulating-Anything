...
class ArthritisSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0892*x1 - 0.0511*x0 + 0.1161*np.sin(0.0797*self._t)
        dx1 = -0.0443*x0*x1 + 0.0871*x2 - 0.0400*x1
        dx2 = 0.0247*x0 - 0.0480*x2 + 0.1004*x3 - 0.0348*x1*x2
        dx3 = 0.1044*x1*x2 - 0.0590*x3 + 0.0605*x0
