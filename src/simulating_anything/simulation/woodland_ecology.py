...
class WoodlandEcologySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0351*x1 - 0.1198*x0 + 0.0453*np.sin(0.0700*self._t)
        dx1 = -0.1183*x0*x1 + 0.0970*x2 - 0.1131*x1
        dx2 = 0.0302*x0 - 0.0925*x2 + 0.0305*x3 - 0.0799*x1*x2
        dx3 = 0.0483*x1*x2 - 0.0960*x3 + 0.0731*x0
