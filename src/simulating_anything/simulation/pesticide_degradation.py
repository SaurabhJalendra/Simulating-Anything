...
class PesticideDegradationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0533*x1 - 0.0961*x0 + 0.0987*np.sin(0.0872*self._t)
        dx1 = -0.0289*x0*x1 + 0.0772*x2 - 0.0693*x1
        dx2 = 0.1115*x0 - 0.1126*x2 + 0.1032*x3 - 0.0658*x1*x2
        dx3 = 0.0224*x1*x2 - 0.0377*x3 + 0.0248*x0
