...
class MitochondriaSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1114*x1 - 0.0524*x0 + 0.0232*np.sin(0.0372*self._t)
        dx1 = -0.0754*x0*x1 + 0.1132*x2 - 0.0684*x1
        dx2 = 0.0609*x0 - 0.0720*x2 + 0.1036*x3 - 0.1062*x1*x2
        dx3 = 0.0459*x1*x2 - 0.0569*x3 + 0.1123*x0
