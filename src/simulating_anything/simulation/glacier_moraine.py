...
class GlacierMoraineSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0418*x1 - 0.0648*x0 + 0.1279*np.sin(0.0937*self._t)
        dx1 = -0.0624*x0*x1 + 0.0828*x2 - 0.0701*x1
        dx2 = 0.0843*x0 - 0.0788*x2 + 0.0485*x3 - 0.1183*x1*x2
        dx3 = 0.1530*x1*x2 - 0.1461*x3 + 0.1282*x0
