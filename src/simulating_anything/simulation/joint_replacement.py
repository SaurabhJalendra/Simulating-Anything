...
class JointReplacementSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0428*x1 - 0.0997*x0 + 0.0840*np.sin(0.0339*self._t)
        dx1 = -0.0887*x0*x1 + 0.0944*x2 - 0.0526*x1
        dx2 = 0.0310*x0 - 0.0625*x2 + 0.1091*x3 - 0.0620*x1*x2
        dx3 = 0.1143*x1*x2 - 0.0501*x3 + 0.1114*x0
