...
class AminoAcidMetabolismSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1180*x1 - 0.0283*x0 + 0.1106*np.sin(0.0479*self._t)
        dx1 = -0.0756*x0*x1 + 0.0622*x2 - 0.1003*x1
        dx2 = 0.0435*x0 - 0.1174*x2 + 0.0742*x3 - 0.1073*x1*x2
        dx3 = 0.0523*x1*x2 - 0.0635*x3 + 0.0402*x0
