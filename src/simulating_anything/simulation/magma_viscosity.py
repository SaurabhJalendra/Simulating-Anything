...
class MagmaViscositySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0861*x1 - 0.0644*x0 + 0.0236*np.sin(0.0825*self._t)
        dx1 = -0.0428*x0*x1 + 0.0580*x2 - 0.1375*x1
        dx2 = 0.0834*x0 - 0.0977*x2 + 0.0506*x3 - 0.0390*x1*x2
        dx3 = 0.1085*x1*x2 - 0.0628*x3 + 0.1695*x0
