...
class AuroraBorealisSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0351*x1 - 0.1123*x0 + 0.0272*np.sin(0.1568*self._t)
        dx1 = -0.0312*x0*x1 + 0.1440*x2 - 0.0344*x1
        dx2 = 0.1370*x0 - 0.0977*x2 + 0.0384*x3 - 0.1037*x1*x2
        dx3 = 0.1319*x1*x2 - 0.0537*x3 + 0.0237*x0
