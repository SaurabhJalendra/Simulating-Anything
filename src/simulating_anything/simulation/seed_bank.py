...
class SeedBankSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1057*x1 - 0.1006*x0 + 0.0499*np.sin(0.0325*self._t)
        dx1 = -0.0281*x0*x1 + 0.0801*x2 - 0.0761*x1
        dx2 = 0.0464*x0 - 0.0824*x2 + 0.0302*x3 - 0.0411*x1*x2
        dx3 = 0.0994*x1*x2 - 0.0561*x3 + 0.1099*x0
