...
class PlantDefenseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0904*x1 - 0.1129*x0 + 0.0497*np.sin(0.1125*self._t)
        dx1 = -0.0509*x0*x1 + 0.0499*x2 - 0.0356*x1
        dx2 = 0.1187*x0 - 0.0228*x2 + 0.1092*x3 - 0.0955*x1*x2
        dx3 = 0.0832*x1*x2 - 0.1074*x3 + 0.1120*x0
