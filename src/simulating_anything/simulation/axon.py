...
class AxonSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0361*x1 - 0.0713*x0 + 0.1022*np.sin(0.0941*self._t)
        dx1 = -0.0353*x0*x1 + 0.0392*x2 - 0.0450*x1
        dx2 = 0.1027*x0 - 0.0761*x2 + 0.0507*x3 - 0.0880*x1*x2
        dx3 = 0.0614*x1*x2 - 0.1188*x3 + 0.0656*x0
