...
class FreshwaterCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0594*x1 - 0.0308*x0 + 0.0640*np.sin(0.1142*self._t)
        dx1 = -0.0382*x0*x1 + 0.1029*x2 - 0.1008*x1
        dx2 = 0.0405*x0 - 0.0925*x2 + 0.0245*x3 - 0.0844*x1*x2
        dx3 = 0.0964*x1*x2 - 0.0541*x3 + 0.0911*x0
