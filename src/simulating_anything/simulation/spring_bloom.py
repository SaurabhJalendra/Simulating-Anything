...
class SpringBloomSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0565*x1 - 0.0266*x0 + 0.0282*np.sin(0.0870*self._t)
        dx1 = -0.0879*x0*x1 + 0.0394*x2 - 0.0424*x1
        dx2 = 0.1026*x0 - 0.1090*x2 + 0.0383*x3 - 0.1188*x1*x2
        dx3 = 0.1198*x1*x2 - 0.1109*x3 + 0.1134*x0
