...
class WheatSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0747*x1 - 0.1122*x0 + 0.0330*np.sin(0.0561*self._t)
        dx1 = -0.0533*x0*x1 + 0.0734*x2 - 0.1114*x1
        dx2 = 0.0211*x0 - 0.0772*x2 + 0.1188*x3 - 0.1076*x1*x2
        dx3 = 0.0440*x1*x2 - 0.1085*x3 + 0.0683*x0
