...
class ArcticFoxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1170*x1 - 0.0369*x0 + 0.0959*np.sin(0.0295*self._t)
        dx1 = -0.0909*x0*x1 + 0.0908*x2 - 0.0753*x1
        dx2 = 0.1027*x0 - 0.0867*x2 + 0.0874*x3 - 0.0278*x1*x2
        dx3 = 0.0309*x1*x2 - 0.1158*x3 + 0.1057*x0
