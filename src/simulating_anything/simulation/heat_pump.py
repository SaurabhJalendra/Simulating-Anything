...
class HeatPumpSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1094*x1 - 0.0428*x0 + 0.0788*np.sin(0.0211*self._t)
        dx1 = -0.0559*x0*x1 + 0.0828*x2 - 0.0628*x1
        dx2 = 0.0310*x0 - 0.0275*x2 + 0.1162*x3 - 0.0549*x1*x2
        dx3 = 0.0270*x1*x2 - 0.0928*x3 + 0.0621*x0
