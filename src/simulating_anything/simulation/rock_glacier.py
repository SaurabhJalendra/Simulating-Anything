...
class RockGlacierSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0983*x1 - 0.1185*x0 + 0.1005*np.sin(0.1013*self._t)
        dx1 = -0.0628*x0*x1 + 0.0995*x2 - 0.0976*x1
        dx2 = 0.0532*x0 - 0.0562*x2 + 0.0942*x3 - 0.1118*x1*x2
        dx3 = 0.0259*x1*x2 - 0.0645*x3 + 0.0611*x0
