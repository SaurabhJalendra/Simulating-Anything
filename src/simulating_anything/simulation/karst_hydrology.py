...
class KarstHydrologySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0829*x1 - 0.0244*x0 + 0.0852*np.sin(0.1093*self._t)
        dx1 = -0.1024*x0*x1 + 0.0474*x2 - 0.0418*x1
        dx2 = 0.1496*x0 - 0.0869*x2 + 0.1322*x3 - 0.0634*x1*x2
        dx3 = 0.1577*x1*x2 - 0.0533*x3 + 0.0995*x0
