...
class HeatMortalitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0720*x1 - 0.0210*x0 + 0.0393*np.sin(0.0420*self._t)
        dx1 = -0.0663*x0*x1 + 0.1168*x2 - 0.0227*x1
        dx2 = 0.0560*x0 - 0.0240*x2 + 0.0278*x3 - 0.0531*x1*x2
        dx3 = 0.0494*x1*x2 - 0.0935*x3 + 0.1168*x0
