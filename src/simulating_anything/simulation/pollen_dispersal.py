...
class PollenDispersalSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0460*x1 - 0.1274*x0 + 0.1058*np.sin(0.0327*self._t)
        dx1 = -0.1483*x0*x1 + 0.0792*x2 - 0.0819*x1
        dx2 = 0.1519*x0 - 0.1091*x2 + 0.1698*x3 - 0.1579*x1*x2
        dx3 = 0.0746*x1*x2 - 0.1045*x3 + 0.1448*x0
