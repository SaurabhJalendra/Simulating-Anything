...
class NaturalDisasterSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0807*x1 - 0.0221*x0 + 0.0899*np.sin(0.0306*self._t)
        dx1 = -0.0807*x0*x1 + 0.0769*x2 - 0.0288*x1
        dx2 = 0.0910*x0 - 0.0715*x2 + 0.0439*x3 - 0.1098*x1*x2
        dx3 = 0.0638*x1*x2 - 0.1102*x3 + 0.0862*x0
