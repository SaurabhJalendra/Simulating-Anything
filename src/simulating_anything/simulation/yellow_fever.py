...
class YellowFeverSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0457*x1 - 0.1003*x0 + 0.0364*np.sin(0.0486*self._t)
        dx1 = -0.0841*x0*x1 + 0.0541*x2 - 0.0307*x1
        dx2 = 0.0433*x0 - 0.0326*x2 + 0.0287*x3 - 0.0824*x1*x2
        dx3 = 0.0313*x1*x2 - 0.0437*x3 + 0.0747*x0
