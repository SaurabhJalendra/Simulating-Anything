...
class CoalGasificationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0788*x1 - 0.0406*x0 + 0.0755*np.sin(0.0431*self._t)
        dx1 = -0.0672*x0*x1 + 0.0904*x2 - 0.0511*x1
        dx2 = 0.1021*x0 - 0.1107*x2 + 0.0843*x3 - 0.0327*x1*x2
        dx3 = 0.0724*x1*x2 - 0.0500*x3 + 0.0825*x0
