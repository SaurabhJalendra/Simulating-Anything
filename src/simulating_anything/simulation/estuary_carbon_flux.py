...
class EstuaryCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1107*x1 - 0.0700*x0 + 0.0717*np.sin(0.1048*self._t)
        dx1 = -0.0589*x0*x1 + 0.0518*x2 - 0.0314*x1
        dx2 = 0.1161*x0 - 0.0835*x2 + 0.0546*x3 - 0.0250*x1*x2
        dx3 = 0.1185*x1*x2 - 0.0986*x3 + 0.0724*x0
