...
class AnemiaSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0274*x1 - 0.0939*x0 + 0.0735*np.sin(0.0541*self._t)
        dx1 = -0.1009*x0*x1 + 0.0394*x2 - 0.0789*x1
        dx2 = 0.1169*x0 - 0.0645*x2 + 0.0390*x3 - 0.0637*x1*x2
        dx3 = 0.1046*x1*x2 - 0.0279*x3 + 0.1130*x0
