...
class IrrigationCanalSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0549*x1 - 0.1035*x0 + 0.0420*np.sin(0.0688*self._t)
        dx1 = -0.0217*x0*x1 + 0.0757*x2 - 0.0478*x1
        dx2 = 0.0570*x0 - 0.0414*x2 + 0.1164*x3 - 0.0790*x1*x2
        dx3 = 0.0667*x1*x2 - 0.0799*x3 + 0.0613*x0
