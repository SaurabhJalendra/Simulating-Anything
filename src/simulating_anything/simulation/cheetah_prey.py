...
class CheetahPreySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0219*x1 - 0.0686*x0 + 0.1104*np.sin(0.0973*self._t)
        dx1 = -0.0375*x0*x1 + 0.1108*x2 - 0.1071*x1
        dx2 = 0.0577*x0 - 0.0539*x2 + 0.0492*x3 - 0.0300*x1*x2
        dx3 = 0.0346*x1*x2 - 0.0590*x3 + 0.0250*x0
