...
class AquiferModelSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0644*x1 - 0.0636*x0 + 0.0680*np.sin(0.1058*self._t)
        dx1 = -0.0223*x0*x1 + 0.0499*x2 - 0.0406*x1
        dx2 = 0.0272*x0 - 0.0561*x2 + 0.0841*x3 - 0.0806*x1*x2
        dx3 = 0.0664*x1*x2 - 0.0207*x3 + 0.0871*x0
