...
class MicrobeSoilSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1170*x1 - 0.0392*x0 + 0.0371*np.sin(0.1115*self._t)
        dx1 = -0.0362*x0*x1 + 0.1023*x2 - 0.0925*x1
        dx2 = 0.0840*x0 - 0.0901*x2 + 0.0853*x3 - 0.0364*x1*x2
        dx3 = 0.0504*x1*x2 - 0.1071*x3 + 0.0867*x0
