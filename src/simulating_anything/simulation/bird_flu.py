...
class BirdFluSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0402*x1 - 0.0874*x0 + 0.0726*np.sin(0.1047*self._t)
        dx1 = -0.1165*x0*x1 + 0.0658*x2 - 0.0728*x1
        dx2 = 0.0629*x0 - 0.0277*x2 + 0.0717*x3 - 0.0941*x1*x2
        dx3 = 0.0540*x1*x2 - 0.0602*x3 + 0.0363*x0
