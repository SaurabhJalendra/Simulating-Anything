...
class MountainCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1018*x1 - 0.0396*x0 + 0.0283*np.sin(0.0780*self._t)
        dx1 = -0.0957*x0*x1 + 0.0674*x2 - 0.0592*x1
        dx2 = 0.0461*x0 - 0.0462*x2 + 0.0870*x3 - 0.0236*x1*x2
        dx3 = 0.1067*x1*x2 - 0.0204*x3 + 0.0938*x0
