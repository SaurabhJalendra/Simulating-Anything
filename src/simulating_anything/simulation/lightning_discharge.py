...
class LightningDischargeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1189*x1 - 0.0754*x0 + 0.1552*np.sin(0.0642*self._t)
        dx1 = -0.0843*x0*x1 + 0.1270*x2 - 0.1620*x1
        dx2 = 0.1183*x0 - 0.1309*x2 + 0.0379*x3 - 0.0906*x1*x2
        dx3 = 0.0348*x1*x2 - 0.1328*x3 + 0.1510*x0
