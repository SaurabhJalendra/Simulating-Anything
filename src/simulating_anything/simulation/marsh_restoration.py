...
class MarshRestorationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0887*x1 - 0.0944*x0 + 0.1098*np.sin(0.1194*self._t)
        dx1 = -0.0278*x0*x1 + 0.0739*x2 - 0.0721*x1
        dx2 = 0.0311*x0 - 0.0746*x2 + 0.0272*x3 - 0.0549*x1*x2
        dx3 = 0.0558*x1*x2 - 0.0720*x3 + 0.0991*x0
