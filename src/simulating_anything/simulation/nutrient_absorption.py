...
class NutrientAbsorptionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1140*x1 - 0.1016*x0 + 0.1031*np.sin(0.0753*self._t)
        dx1 = -0.0993*x0*x1 + 0.0919*x2 - 0.0428*x1
        dx2 = 0.0964*x0 - 0.1118*x2 + 0.0241*x3 - 0.0556*x1*x2
        dx3 = 0.0415*x1*x2 - 0.0696*x3 + 0.0330*x0
