...
class HabitatCorridorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.09*x1 - 0.0336*x0 + 0.0952*np.sin(0.0719*self._t)
        dx1 = -0.0525*x0*x1 + 0.0538*x2 - 0.1405*x1
        dx2 = 0.0426*x0 - 0.1022*x2 + 0.0835*x3 - 0.0659*x1*x2
        dx3 = 0.109*x1*x2 - 0.164*x3 + 0.0357*x0
