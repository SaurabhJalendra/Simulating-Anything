...
class CoralCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0930*x1 - 0.0608*x0 + 0.0843*np.sin(0.0328*self._t)
        dx1 = -0.0957*x0*x1 + 0.1115*x2 - 0.0935*x1
        dx2 = 0.0681*x0 - 0.0240*x2 + 0.0657*x3 - 0.0936*x1*x2
        dx3 = 0.0344*x1*x2 - 0.1103*x3 + 0.0744*x0
