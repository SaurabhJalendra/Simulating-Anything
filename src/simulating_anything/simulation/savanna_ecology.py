...
class SavannaEcologySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0368*x1 - 0.0646*x0 + 0.0869*np.sin(0.1002*self._t)
        dx1 = -0.0549*x0*x1 + 0.0547*x2 - 0.0950*x1
        dx2 = 0.1169*x0 - 0.0505*x2 + 0.1001*x3 - 0.0959*x1*x2
        dx3 = 0.0729*x1*x2 - 0.0969*x3 + 0.1143*x0
