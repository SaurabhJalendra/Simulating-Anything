...
class DiseaseEvolutionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0830*x1 - 0.0859*x0 + 0.0207*np.sin(0.0829*self._t)
        dx1 = -0.1140*x0*x1 + 0.0588*x2 - 0.0309*x1
        dx2 = 0.0227*x0 - 0.0844*x2 + 0.1036*x3 - 0.1133*x1*x2
        dx3 = 0.0767*x1*x2 - 0.0283*x3 + 0.1109*x0
