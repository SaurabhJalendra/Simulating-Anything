...
class BridgeVibrationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0643*x1 - 0.1041*x0 + 0.0927*np.sin(0.1103*self._t)
        dx1 = -0.0633*x0*x1 + 0.0362*x2 - 0.0254*x1
        dx2 = 0.0471*x0 - 0.0468*x2 + 0.0462*x3 - 0.1038*x1*x2
        dx3 = 0.1162*x1*x2 - 0.1123*x3 + 0.0597*x0
