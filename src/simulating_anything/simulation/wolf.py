...
class WolfSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0621*x1 - 0.1068*x0 + 0.1079*np.sin(0.0362*self._t)
        dx1 = -0.0253*x0*x1 + 0.0753*x2 - 0.0279*x1
        dx2 = 0.0937*x0 - 0.0361*x2 + 0.1185*x3 - 0.0984*x1*x2
        dx3 = 0.0919*x1*x2 - 0.0810*x3 + 0.0316*x0
