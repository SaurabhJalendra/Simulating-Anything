...
class MountainBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0501*x1 - 0.1061*x0 + 0.1008*np.sin(0.0861*self._t)
        dx1 = -0.1081*x0*x1 + 0.1172*x2 - 0.0699*x1
        dx2 = 0.0486*x0 - 0.0758*x2 + 0.0753*x3 - 0.0750*x1*x2
        dx3 = 0.0649*x1*x2 - 0.0863*x3 + 0.0572*x0
