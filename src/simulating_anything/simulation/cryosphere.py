...
class CryosphereSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0761*x1 - 0.0784*x0 + 0.0888*np.sin(0.0921*self._t)
        dx1 = -0.0278*x0*x1 + 0.0896*x2 - 0.0805*x1
        dx2 = 0.0780*x0 - 0.0645*x2 + 0.1090*x3 - 0.0750*x1*x2
        dx3 = 0.0992*x1*x2 - 0.1050*x3 + 0.0472*x0
