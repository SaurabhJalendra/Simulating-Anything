...
class EarPressureSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0919*x1 - 0.0303*x0 + 0.0669*np.sin(0.1099*self._t)
        dx1 = -0.0454*x0*x1 + 0.0719*x2 - 0.0341*x1
        dx2 = 0.1034*x0 - 0.1196*x2 + 0.0206*x3 - 0.1198*x1*x2
        dx3 = 0.0255*x1*x2 - 0.0575*x3 + 0.0975*x0
