...
class EucalyptusFireSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0299*x1 - 0.1061*x0 + 0.0734*np.sin(0.0767*self._t)
        dx1 = -0.1132*x0*x1 + 0.0908*x2 - 0.0279*x1
        dx2 = 0.0235*x0 - 0.0691*x2 + 0.0830*x3 - 0.0939*x1*x2
        dx3 = 0.0744*x1*x2 - 0.0466*x3 + 0.0726*x0
