...
class OzoneHoleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0236*x1 - 0.0385*x0 + 0.1168*np.sin(0.0458*self._t)
        dx1 = -0.0816*x0*x1 + 0.0892*x2 - 0.0272*x1
        dx2 = 0.0809*x0 - 0.1122*x2 + 0.0400*x3 - 0.0682*x1*x2
        dx3 = 0.0740*x1*x2 - 0.1080*x3 + 0.0492*x0
