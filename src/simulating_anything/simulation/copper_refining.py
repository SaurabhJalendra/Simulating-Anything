...
class CopperRefiningSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1140*x1 - 0.0228*x0 + 0.0585*np.sin(0.0898*self._t)
        dx1 = -0.1084*x0*x1 + 0.1123*x2 - 0.0981*x1
        dx2 = 0.0329*x0 - 0.0562*x2 + 0.0935*x3 - 0.0900*x1*x2
        dx3 = 0.0384*x1*x2 - 0.0463*x3 + 0.0976*x0
