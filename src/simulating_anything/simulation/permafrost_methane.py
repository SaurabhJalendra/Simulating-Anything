...
class PermafrostMethaneSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0376*x1 - 0.0869*x0 + 0.0348*np.sin(0.1090*self._t)
        dx1 = -0.1117*x0*x1 + 0.0699*x2 - 0.0352*x1
        dx2 = 0.0641*x0 - 0.1148*x2 + 0.0700*x3 - 0.1117*x1*x2
        dx3 = 0.1097*x1*x2 - 0.0336*x3 + 0.0687*x0
