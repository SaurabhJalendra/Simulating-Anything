...
class SewerOverflowSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1013*x1 - 0.0357*x0 + 0.0388*np.sin(0.0770*self._t)
        dx1 = -0.1117*x0*x1 + 0.0554*x2 - 0.1117*x1
        dx2 = 0.1184*x0 - 0.0596*x2 + 0.0310*x3 - 0.0442*x1*x2
        dx3 = 0.0233*x1*x2 - 0.0423*x3 + 0.1018*x0
