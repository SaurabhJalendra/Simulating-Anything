...
class RockWeatheringSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0856*x1 - 0.0522*x0 + 0.0899*np.sin(0.1129*self._t)
        dx1 = -0.1482*x0*x1 + 0.0295*x2 - 0.0913*x1
        dx2 = 0.1645*x0 - 0.1353*x2 + 0.0631*x3 - 0.1196*x1*x2
        dx3 = 0.0875*x1*x2 - 0.0913*x3 + 0.1052*x0
