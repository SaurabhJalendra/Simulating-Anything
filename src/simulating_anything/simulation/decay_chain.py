...
class DecayChainSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0647*x1 - 0.1099*x0 + 0.1086*np.sin(0.0693*self._t)
        dx1 = -0.0838*x0*x1 + 0.0223*x2 - 0.1156*x1
        dx2 = 0.0366*x0 - 0.0930*x2 + 0.0311*x3 - 0.0609*x1*x2
        dx3 = 0.0710*x1*x2 - 0.0415*x3 + 0.0252*x0
