...
class ChromosomeDynamicsSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0697*x1 - 0.0844*x0 + 0.0356*np.sin(0.0848*self._t)
        dx1 = -0.0798*x0*x1 + 0.1018*x2 - 0.0281*x1
        dx2 = 0.0963*x0 - 0.1043*x2 + 0.0857*x3 - 0.0480*x1*x2
        dx3 = 0.0804*x1*x2 - 0.0259*x3 + 0.0960*x0
