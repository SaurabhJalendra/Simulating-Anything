...
class SolarIrradianceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0829*x1 - 0.0368*x0 + 0.0459*np.sin(0.1070*self._t)
        dx1 = -0.0877*x0*x1 + 0.0242*x2 - 0.0965*x1
        dx2 = 0.0204*x0 - 0.0980*x2 + 0.0762*x3 - 0.1175*x1*x2
        dx3 = 0.0907*x1*x2 - 0.0953*x3 + 0.0553*x0
