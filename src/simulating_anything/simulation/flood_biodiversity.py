...
class FloodBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0949*x1 - 0.0706*x0 + 0.0885*np.sin(0.0572*self._t)
        dx1 = -0.0515*x0*x1 + 0.0915*x2 - 0.0678*x1
        dx2 = 0.1017*x0 - 0.0994*x2 + 0.1145*x3 - 0.0644*x1*x2
        dx3 = 0.1156*x1*x2 - 0.0832*x3 + 0.1156*x0
