...
class WhaleSongSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1020*x1 - 0.0329*x0 + 0.0493*np.sin(0.0804*self._t)
        dx1 = -0.0951*x0*x1 + 0.0548*x2 - 0.0389*x1
        dx2 = 0.0248*x0 - 0.1111*x2 + 0.0468*x3 - 0.0370*x1*x2
        dx3 = 0.0832*x1*x2 - 0.0797*x3 + 0.0406*x0
