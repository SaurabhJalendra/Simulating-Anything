...
class BioaccumulationFoodSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0788*x1 - 0.0747*x0 + 0.0280*np.sin(0.1073*self._t)
        dx1 = -0.0900*x0*x1 + 0.0789*x2 - 0.1041*x1
        dx2 = 0.0834*x0 - 0.1057*x2 + 0.0466*x3 - 0.0456*x1*x2
        dx3 = 0.0632*x1*x2 - 0.0839*x3 + 0.0341*x0
