...
class SnowMeltFloodSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0302*x1 - 0.0546*x0 + 0.0408*np.sin(0.0495*self._t)
        dx1 = -0.1008*x0*x1 + 0.0436*x2 - 0.1146*x1
        dx2 = 0.0620*x0 - 0.0809*x2 + 0.0698*x3 - 0.0314*x1*x2
        dx3 = 0.0433*x1*x2 - 0.0777*x3 + 0.0496*x0
