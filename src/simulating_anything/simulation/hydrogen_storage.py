...
class HydrogenStorageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0725*x1 - 0.0266*x0 + 0.1121*np.sin(0.0440*self._t)
        dx1 = -0.0518*x0*x1 + 0.0234*x2 - 0.0258*x1
        dx2 = 0.0890*x0 - 0.0597*x2 + 0.0612*x3 - 0.0991*x1*x2
        dx3 = 0.1050*x1*x2 - 0.0581*x3 + 0.0429*x0
