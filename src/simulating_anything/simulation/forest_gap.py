...
class ForestGapSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1017*x1 - 0.0656*x0 + 0.1139*np.sin(0.0474*self._t)
        dx1 = -0.0655*x0*x1 + 0.1625*x2 - 0.1405*x1
        dx2 = 0.1677*x0 - 0.0459*x2 + 0.0622*x3 - 0.0563*x1*x2
        dx3 = 0.1624*x1*x2 - 0.027*x3 + 0.1456*x0
