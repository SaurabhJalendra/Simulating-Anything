...
class CropDiseaseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1263*x1 - 0.0792*x0 + 0.1344*np.sin(0.0783*self._t)
        dx1 = -0.0479*x0*x1 + 0.1663*x2 - 0.1648*x1
        dx2 = 0.0833*x0 - 0.1117*x2 + 0.0701*x3 - 0.0899*x1*x2
        dx3 = 0.0358*x1*x2 - 0.0734*x3 + 0.1345*x0
