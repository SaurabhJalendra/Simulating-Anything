...
class NightCoolingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0287*x1 - 0.0265*x0 + 0.1642*np.sin(0.0903*self._t)
        dx1 = -0.1680*x0*x1 + 0.1582*x2 - 0.1564*x1
        dx2 = 0.0372*x0 - 0.0600*x2 + 0.0561*x3 - 0.0713*x1*x2
        dx3 = 0.1453*x1*x2 - 0.0528*x3 + 0.0607*x0
