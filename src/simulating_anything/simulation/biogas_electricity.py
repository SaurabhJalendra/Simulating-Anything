...
class BiogasElectricitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0357*x1 - 0.0961*x0 + 0.1078*np.sin(0.0213*self._t)
        dx1 = -0.1153*x0*x1 + 0.0743*x2 - 0.1124*x1
        dx2 = 0.1054*x0 - 0.0390*x2 + 0.0330*x3 - 0.0459*x1*x2
        dx3 = 0.0798*x1*x2 - 0.0947*x3 + 0.0753*x0
