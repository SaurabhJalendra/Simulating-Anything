...
class FertilizerSoilSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1068*x1 - 0.1139*x0 + 0.0705*np.sin(0.0458*self._t)
        dx1 = -0.0667*x0*x1 + 0.0236*x2 - 0.0507*x1
        dx2 = 0.1102*x0 - 0.0852*x2 + 0.0852*x3 - 0.1089*x1*x2
        dx3 = 0.1126*x1*x2 - 0.0452*x3 + 0.0819*x0
