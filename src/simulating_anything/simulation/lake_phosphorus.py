...
class LakePhosphorusSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1330*x1 - 0.0410*x0 + 0.1307*np.sin(0.0737*self._t)
        dx1 = -0.0200*x0*x1 + 0.0345*x2 - 0.0689*x1
        dx2 = 0.0942*x0 - 0.0880*x2 + 0.0948*x3 - 0.0836*x1*x2
        dx3 = 0.0569*x1*x2 - 0.1185*x3 + 0.1343*x0
