...
class CognitiveLoadSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1067*x1 - 0.0930*x0 + 0.0973*np.sin(0.0856*self._t)
        dx1 = -0.1104*x0*x1 + 0.0858*x2 - 0.0942*x1
        dx2 = 0.0566*x0 - 0.0753*x2 + 0.0296*x3 - 0.0556*x1*x2
        dx3 = 0.1087*x1*x2 - 0.0418*x3 + 0.0623*x0
