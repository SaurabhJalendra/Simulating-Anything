...
class MicrogravitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0584*x1 - 0.0831*x0 + 0.0494*np.sin(0.0783*self._t)
        dx1 = -0.0387*x0*x1 + 0.0228*x2 - 0.0577*x1
        dx2 = 0.0464*x0 - 0.1049*x2 + 0.1023*x3 - 0.0671*x1*x2
        dx3 = 0.0378*x1*x2 - 0.1107*x3 + 0.0407*x0
