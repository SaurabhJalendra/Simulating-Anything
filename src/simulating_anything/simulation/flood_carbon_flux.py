...
class FloodCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1044*x1 - 0.0847*x0 + 0.0730*np.sin(0.0724*self._t)
        dx1 = -0.0908*x0*x1 + 0.0665*x2 - 0.0252*x1
        dx2 = 0.0963*x0 - 0.0423*x2 + 0.0463*x3 - 0.0751*x1*x2
        dx3 = 0.1149*x1*x2 - 0.1107*x3 + 0.0969*x0
