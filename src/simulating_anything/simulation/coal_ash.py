...
class CoalAshSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1166*x1 - 0.0380*x0 + 0.0354*np.sin(0.1125*self._t)
        dx1 = -0.0548*x0*x1 + 0.0238*x2 - 0.1119*x1
        dx2 = 0.0484*x0 - 0.0819*x2 + 0.1170*x3 - 0.0472*x1*x2
        dx3 = 0.0629*x1*x2 - 0.0527*x3 + 0.0947*x0
