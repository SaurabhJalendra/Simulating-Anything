...
class DustDevilSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0784*x1 - 0.0978*x0 + 0.1194*np.sin(0.1615*self._t)
        dx1 = -0.1234*x0*x1 + 0.0493*x2 - 0.0439*x1
        dx2 = 0.1440*x0 - 0.0290*x2 + 0.1390*x3 - 0.0751*x1*x2
        dx3 = 0.1619*x1*x2 - 0.1519*x3 + 0.0859*x0
