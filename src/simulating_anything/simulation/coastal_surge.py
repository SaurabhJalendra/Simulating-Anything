...
class CoastalSurgeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0963*x1 - 0.1003*x0 + 0.1042*np.sin(0.0912*self._t)
        dx1 = -0.0935*x0*x1 + 0.0365*x2 - 0.0369*x1
        dx2 = 0.0984*x0 - 0.0651*x2 + 0.0274*x3 - 0.0886*x1*x2
        dx3 = 0.1168*x1*x2 - 0.0292*x3 + 0.0947*x0
