...
class GeothermalCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0832*x1 - 0.1155*x0 + 0.1008*np.sin(0.0522*self._t)
        dx1 = -0.0346*x0*x1 + 0.0720*x2 - 0.0572*x1
        dx2 = 0.0654*x0 - 0.1187*x2 + 0.0490*x3 - 0.0508*x1*x2
        dx3 = 0.0529*x1*x2 - 0.0767*x3 + 0.0399*x0
