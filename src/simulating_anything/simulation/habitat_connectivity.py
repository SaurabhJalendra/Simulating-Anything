...
class HabitatConnectivitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0520*x1 - 0.0408*x0 + 0.0558*np.sin(0.0207*self._t)
        dx1 = -0.0876*x0*x1 + 0.1062*x2 - 0.0648*x1
        dx2 = 0.0394*x0 - 0.0810*x2 + 0.0385*x3 - 0.1062*x1*x2
        dx3 = 0.0356*x1*x2 - 0.0484*x3 + 0.0971*x0
