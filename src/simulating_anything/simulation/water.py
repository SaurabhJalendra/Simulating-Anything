...
class WaterSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1063*x1 - 0.0652*x0 + 0.0263*np.sin(0.0555*self._t)
        dx1 = -0.0773*x0*x1 + 0.0227*x2 - 0.0656*x1
        dx2 = 0.0451*x0 - 0.0902*x2 + 0.0523*x3 - 0.0660*x1*x2
        dx3 = 0.1180*x1*x2 - 0.0744*x3 + 0.1077*x0
