...
class SulfateAerosolSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0805*x1 - 0.0595*x0 + 0.0668*np.sin(0.0533*self._t)
        dx1 = -0.1026*x0*x1 + 0.1026*x2 - 0.1026*x1
        dx2 = 0.1009*x0 - 0.1188*x2 + 0.0923*x3 - 0.0913*x1*x2
        dx3 = 0.0250*x1*x2 - 0.0664*x3 + 0.0993*x0
