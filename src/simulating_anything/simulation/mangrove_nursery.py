...
class MangroveNurserySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0400*x1 - 0.0205*x0 + 0.1345*np.sin(0.0493*self._t)
        dx1 = -0.0405*x0*x1 + 0.0495*x2 - 0.0823*x1
        dx2 = 0.0743*x0 - 0.0436*x2 + 0.0766*x3 - 0.0836*x1*x2
        dx3 = 0.0483*x1*x2 - 0.0207*x3 + 0.1044*x0
