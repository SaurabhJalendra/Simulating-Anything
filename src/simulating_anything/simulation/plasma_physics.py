...
class PlasmaPhysicsSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0960*x1 - 0.0471*x0 + 0.0982*np.sin(0.0712*self._t)
        dx1 = -0.1089*x0*x1 + 0.0595*x2 - 0.0454*x1
        dx2 = 0.1085*x0 - 0.0450*x2 + 0.0597*x3 - 0.0753*x1*x2
        dx3 = 0.0993*x1*x2 - 0.1053*x3 + 0.0584*x0
