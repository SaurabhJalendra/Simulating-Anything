...
class SnowHydrologySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1163*x1 - 0.0456*x0 + 0.1124*np.sin(0.0968*self._t)
        dx1 = -0.0850*x0*x1 + 0.0697*x2 - 0.1186*x1
        dx2 = 0.0460*x0 - 0.0687*x2 + 0.0348*x3 - 0.0290*x1*x2
        dx3 = 0.0700*x1*x2 - 0.0650*x3 + 0.0209*x0
