...
class ClimateRefugeeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0268*x1 - 0.0215*x0 + 0.0324*np.sin(0.0281*self._t)
        dx1 = -0.0346*x0*x1 + 0.0735*x2 - 0.0831*x1
        dx2 = 0.1167*x0 - 0.1074*x2 + 0.0760*x3 - 0.1393*x1*x2
        dx3 = 0.1074*x1*x2 - 0.1002*x3 + 0.1347*x0
