...
class EvolutionCooperationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0423*x1 - 0.0448*x0 + 0.0201*np.sin(0.0496*self._t)
        dx1 = -0.0716*x0*x1 + 0.0812*x2 - 0.0818*x1
        dx2 = 0.0308*x0 - 0.0484*x2 + 0.0262*x3 - 0.0221*x1*x2
        dx3 = 0.1197*x1*x2 - 0.0983*x3 + 0.0796*x0
