...
class NutrientRunoffSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0318*x1 - 0.1563*x0 + 0.1473*np.sin(0.1354*self._t)
        dx1 = -0.0203*x0*x1 + 0.0989*x2 - 0.031*x1
        dx2 = 0.0418*x0 - 0.0863*x2 + 0.0987*x3 - 0.0637*x1*x2
        dx3 = 0.1139*x1*x2 - 0.0954*x3 + 0.0418*x0
