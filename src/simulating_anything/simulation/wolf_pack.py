...
class WolfPackSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0448*x1 - 0.0243*x0 + 0.0850*np.sin(0.1084*self._t)
        dx1 = -0.0989*x0*x1 + 0.0586*x2 - 0.0787*x1
        dx2 = 0.0867*x0 - 0.1051*x2 + 0.0238*x3 - 0.0220*x1*x2
        dx3 = 0.0728*x1*x2 - 0.0566*x3 + 0.1057*x0
