...
class AlbedoFeedbackSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0213*x1 - 0.0811*x0 + 0.0958*np.sin(0.0216*self._t)
        dx1 = -0.0920*x0*x1 + 0.0305*x2 - 0.0616*x1
        dx2 = 0.1053*x0 - 0.0821*x2 + 0.0498*x3 - 0.0254*x1*x2
        dx3 = 0.0881*x1*x2 - 0.0871*x3 + 0.1114*x0
