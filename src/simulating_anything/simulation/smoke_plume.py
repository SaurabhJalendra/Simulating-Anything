...
class SmokePlumeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0765*x1 - 0.1155*x0 + 0.0531*np.sin(0.0323*self._t)
        dx1 = -0.0467*x0*x1 + 0.0875*x2 - 0.1013*x1
        dx2 = 0.0927*x0 - 0.1182*x2 + 0.0216*x3 - 0.0242*x1*x2
        dx3 = 0.1020*x1*x2 - 0.0238*x3 + 0.0612*x0
