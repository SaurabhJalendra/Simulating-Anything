...
class MigrationBirdSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0969*x1 - 0.0738*x0 + 0.0690*np.sin(0.0429*self._t)
        dx1 = -0.0575*x0*x1 + 0.0291*x2 - 0.0234*x1
        dx2 = 0.0913*x0 - 0.0999*x2 + 0.1048*x3 - 0.1077*x1*x2
        dx3 = 0.0495*x1*x2 - 0.0958*x3 + 0.0707*x0
