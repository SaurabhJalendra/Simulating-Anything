...
class SugarMetabolismSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0997*x1 - 0.0715*x0 + 0.0410*np.sin(0.0511*self._t)
        dx1 = -0.0823*x0*x1 + 0.1060*x2 - 0.0669*x1
        dx2 = 0.0308*x0 - 0.0501*x2 + 0.0515*x3 - 0.0342*x1*x2
        dx3 = 0.1056*x1*x2 - 0.0591*x3 + 0.0419*x0
