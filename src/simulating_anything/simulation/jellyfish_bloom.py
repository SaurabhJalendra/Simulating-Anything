...
class JellyfishBloomSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0875*x1 - 0.1456*x0 + 0.0966*np.sin(0.0358*self._t)
        dx1 = -0.0765*x0*x1 + 0.0393*x2 - 0.1287*x1
        dx2 = 0.1607*x0 - 0.1694*x2 + 0.055*x3 - 0.0786*x1*x2
        dx3 = 0.1208*x1*x2 - 0.1297*x3 + 0.1036*x0
