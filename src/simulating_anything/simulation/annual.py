...
class AnnualSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0742*x1 - 0.1194*x0 + 0.1105*np.sin(0.0792*self._t)
        dx1 = -0.0574*x0*x1 + 0.0423*x2 - 0.0453*x1
        dx2 = 0.0832*x0 - 0.0264*x2 + 0.1144*x3 - 0.1199*x1*x2
        dx3 = 0.0904*x1*x2 - 0.0310*x3 + 0.0455*x0
