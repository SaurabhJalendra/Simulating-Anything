...
class SatelliteOrbitSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0744*x1 - 0.0707*x0 + 0.0925*np.sin(0.1077*self._t)
        dx1 = -0.0506*x0*x1 + 0.0567*x2 - 0.1062*x1
        dx2 = 0.0997*x0 - 0.0239*x2 + 0.0282*x3 - 0.0775*x1*x2
        dx3 = 0.1168*x1*x2 - 0.0545*x3 + 0.1116*x0
