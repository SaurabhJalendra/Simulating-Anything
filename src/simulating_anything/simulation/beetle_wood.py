...
class BeetleWoodSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0297*x1 - 0.0813*x0 + 0.0640*np.sin(0.0577*self._t)
        dx1 = -0.0476*x0*x1 + 0.0984*x2 - 0.0560*x1
        dx2 = 0.0640*x0 - 0.0682*x2 + 0.0931*x3 - 0.0958*x1*x2
        dx3 = 0.0642*x1*x2 - 0.0324*x3 + 0.0627*x0
