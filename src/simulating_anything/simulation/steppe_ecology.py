...
class SteppeEcologySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0703*x1 - 0.1079*x0 + 0.1007*np.sin(0.0347*self._t)
        dx1 = -0.1161*x0*x1 + 0.0573*x2 - 0.0314*x1
        dx2 = 0.0206*x0 - 0.1177*x2 + 0.0918*x3 - 0.1130*x1*x2
        dx3 = 0.0897*x1*x2 - 0.1109*x3 + 0.0937*x0
