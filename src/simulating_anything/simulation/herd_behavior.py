...
class HerdBehaviorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0894*x1 - 0.0741*x0 + 0.0874*np.sin(0.0545*self._t)
        dx1 = -0.0241*x0*x1 + 0.0300*x2 - 0.0918*x1
        dx2 = 0.0715*x0 - 0.0340*x2 + 0.0907*x3 - 0.0863*x1*x2
        dx3 = 0.0599*x1*x2 - 0.0533*x3 + 0.0818*x0
