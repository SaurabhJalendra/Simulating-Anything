...
class InsectDeclineSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1274*x1 - 0.0566*x0 + 0.0862*np.sin(0.0656*self._t)
        dx1 = -0.1086*x0*x1 + 0.1288*x2 - 0.1250*x1
        dx2 = 0.0840*x0 - 0.0896*x2 + 0.1120*x3 - 0.1149*x1*x2
        dx3 = 0.0385*x1*x2 - 0.1096*x3 + 0.0471*x0
