...
class StressHormoneSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0226*x1 - 0.0652*x0 + 0.0833*np.sin(0.0815*self._t)
        dx1 = -0.0484*x0*x1 + 0.0997*x2 - 0.0933*x1
        dx2 = 0.0333*x0 - 0.0377*x2 + 0.0647*x3 - 0.0463*x1*x2
        dx3 = 0.0842*x1*x2 - 0.0315*x3 + 0.0671*x0
