...
class AngiogenesisSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0514*x1 - 0.0998*x0 + 0.1002*np.sin(0.1065*self._t)
        dx1 = -0.0362*x0*x1 + 0.0704*x2 - 0.0491*x1
        dx2 = 0.0264*x0 - 0.0350*x2 + 0.0563*x3 - 0.0668*x1*x2
        dx3 = 0.1124*x1*x2 - 0.1163*x3 + 0.0264*x0
