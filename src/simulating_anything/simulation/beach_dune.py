...
class BeachDuneSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0414*x1 - 0.0786*x0 + 0.0821*np.sin(0.0497*self._t)
        dx1 = -0.0244*x0*x1 + 0.1117*x2 - 0.0248*x1
        dx2 = 0.0502*x0 - 0.0308*x2 + 0.1191*x3 - 0.1022*x1*x2
        dx3 = 0.1095*x1*x2 - 0.0942*x3 + 0.0429*x0
