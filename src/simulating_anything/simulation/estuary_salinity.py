...
class EstuarySalinitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1046*x1 - 0.1319*x0 + 0.0681*np.sin(0.0474*self._t)
        dx1 = -0.0629*x0*x1 + 0.0254*x2 - 0.1267*x1
        dx2 = 0.0900*x0 - 0.0600*x2 + 0.1056*x3 - 0.0872*x1*x2
        dx3 = 0.1317*x1*x2 - 0.0892*x3 + 0.1326*x0
