...
class FreshwaterBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1073*x1 - 0.1154*x0 + 0.0312*np.sin(0.0339*self._t)
        dx1 = -0.1171*x0*x1 + 0.0971*x2 - 0.0883*x1
        dx2 = 0.0368*x0 - 0.0839*x2 + 0.0838*x3 - 0.1044*x1*x2
        dx3 = 0.0308*x1*x2 - 0.0532*x3 + 0.1062*x0
