...
class DeepOceanMixingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1164*x1 - 0.0633*x0 + 0.0768*np.sin(0.0767*self._t)
        dx1 = -0.0392*x0*x1 + 0.0630*x2 - 0.0600*x1
        dx2 = 0.1116*x0 - 0.1049*x2 + 0.1042*x3 - 0.1287*x1*x2
        dx3 = 0.0447*x1*x2 - 0.0693*x3 + 0.1206*x0
