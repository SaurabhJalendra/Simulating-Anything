...
class CircadianJetLagSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1273*x1 - 0.0998*x0 + 0.1024*np.sin(0.1531*self._t)
        dx1 = -0.0520*x0*x1 + 0.0604*x2 - 0.1322*x1
        dx2 = 0.1646*x0 - 0.1614*x2 + 0.0772*x3 - 0.1697*x1*x2
        dx3 = 0.0820*x1*x2 - 0.0915*x3 + 0.0564*x0
