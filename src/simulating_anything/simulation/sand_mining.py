...
class SandMiningSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0444*x1 - 0.0606*x0 + 0.0771*np.sin(0.0333*self._t)
        dx1 = -0.1002*x0*x1 + 0.0848*x2 - 0.0484*x1
        dx2 = 0.1157*x0 - 0.1043*x2 + 0.1024*x3 - 0.0996*x1*x2
        dx3 = 0.0376*x1*x2 - 0.0986*x3 + 0.0332*x0
