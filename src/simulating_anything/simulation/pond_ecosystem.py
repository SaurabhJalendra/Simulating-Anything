...
class PondEcosystemSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0338*x1 - 0.0808*x0 + 0.1393*np.sin(0.0746*self._t)
        dx1 = -0.0389*x0*x1 + 0.1320*x2 - 0.0220*x1
        dx2 = 0.0505*x0 - 0.1654*x2 + 0.1066*x3 - 0.0976*x1*x2
        dx3 = 0.0713*x1*x2 - 0.0536*x3 + 0.0986*x0
