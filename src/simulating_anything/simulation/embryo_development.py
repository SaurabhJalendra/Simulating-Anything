...
class EmbryoDevelopmentSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0261*x1 - 0.0235*x0 + 0.0327*np.sin(0.1041*self._t)
        dx1 = -0.0573*x0*x1 + 0.0749*x2 - 0.1036*x1
        dx2 = 0.0876*x0 - 0.0934*x2 + 0.1033*x3 - 0.1050*x1*x2
        dx3 = 0.0650*x1*x2 - 0.0649*x3 + 0.0285*x0
