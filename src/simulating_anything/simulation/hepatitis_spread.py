...
class HepatitisSpreadSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0226*x1 - 0.1051*x0 + 0.0388*np.sin(0.0645*self._t)
        dx1 = -0.0497*x0*x1 + 0.0531*x2 - 0.0790*x1
        dx2 = 0.0451*x0 - 0.0247*x2 + 0.1003*x3 - 0.1035*x1*x2
        dx3 = 0.0946*x1*x2 - 0.0766*x3 + 0.0359*x0
