...
class HairGrowthSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1034*x1 - 0.1047*x0 + 0.0925*np.sin(0.0792*self._t)
        dx1 = -0.0598*x0*x1 + 0.0743*x2 - 0.0718*x1
        dx2 = 0.0908*x0 - 0.0329*x2 + 0.0437*x3 - 0.0749*x1*x2
        dx3 = 0.0878*x1*x2 - 0.0518*x3 + 0.0963*x0
