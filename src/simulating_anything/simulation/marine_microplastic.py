...
class MarineMicroplasticSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0824*x1 - 0.0765*x0 + 0.1019*np.sin(0.0231*self._t)
        dx1 = -0.0722*x0*x1 + 0.0591*x2 - 0.0534*x1
        dx2 = 0.0302*x0 - 0.0329*x2 + 0.0657*x3 - 0.0655*x1*x2
        dx3 = 0.0268*x1*x2 - 0.0325*x3 + 0.0378*x0
