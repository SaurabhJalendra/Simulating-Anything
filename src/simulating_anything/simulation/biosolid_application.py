...
class BiosolidApplicationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0630*x1 - 0.0539*x0 + 0.0840*np.sin(0.0865*self._t)
        dx1 = -0.0957*x0*x1 + 0.0874*x2 - 0.0965*x1
        dx2 = 0.0865*x0 - 0.0872*x2 + 0.0748*x3 - 0.1071*x1*x2
        dx3 = 0.0357*x1*x2 - 0.0784*x3 + 0.0867*x0
