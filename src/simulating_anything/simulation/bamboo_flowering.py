...
class BambooFloweringSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0628*x1 - 0.0717*x0 + 0.0877*np.sin(0.0982*self._t)
        dx1 = -0.0433*x0*x1 + 0.0635*x2 - 0.1109*x1
        dx2 = 0.0974*x0 - 0.0845*x2 + 0.0746*x3 - 0.0302*x1*x2
        dx3 = 0.0524*x1*x2 - 0.0921*x3 + 0.0814*x0
