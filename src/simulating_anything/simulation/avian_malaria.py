...
class AvianMalariaSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0448*x1 - 0.0669*x0 + 0.0308*np.sin(0.0250*self._t)
        dx1 = -0.1145*x0*x1 + 0.0606*x2 - 0.0468*x1
        dx2 = 0.1030*x0 - 0.0835*x2 + 0.0582*x3 - 0.0385*x1*x2
        dx3 = 0.0772*x1*x2 - 0.0618*x3 + 0.0296*x0
