...
class HoneybeeThermoregulationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1128*x1 - 0.0470*x0 + 0.0989*np.sin(0.0220*self._t)
        dx1 = -0.1370*x0*x1 + 0.1218*x2 - 0.0669*x1
        dx2 = 0.0879*x0 - 0.0789*x2 + 0.1541*x3 - 0.0239*x1*x2
        dx3 = 0.1105*x1*x2 - 0.1193*x3 + 0.0271*x0
