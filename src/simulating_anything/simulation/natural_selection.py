...
class NaturalSelectionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0830*x1 - 0.0750*x0 + 0.0373*np.sin(0.0358*self._t)
        dx1 = -0.0204*x0*x1 + 0.0819*x2 - 0.0513*x1
        dx2 = 0.0217*x0 - 0.0850*x2 + 0.0242*x3 - 0.0893*x1*x2
        dx3 = 0.1066*x1*x2 - 0.1065*x3 + 0.0610*x0
