...
class ElectricBatterySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0742*x1 - 0.1073*x0 + 0.1176*np.sin(0.0382*self._t)
        dx1 = -0.0564*x0*x1 + 0.0312*x2 - 0.0699*x1
        dx2 = 0.0525*x0 - 0.0607*x2 + 0.0511*x3 - 0.0827*x1*x2
        dx3 = 0.1020*x1*x2 - 0.1185*x3 + 0.0234*x0
