...
class PhotovoltaicCellSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0477*x1 - 0.0246*x0 + 0.1066*np.sin(0.0843*self._t)
        dx1 = -0.0460*x0*x1 + 0.0705*x2 - 0.0442*x1
        dx2 = 0.0715*x0 - 0.0520*x2 + 0.0907*x3 - 0.0308*x1*x2
        dx3 = 0.0685*x1*x2 - 0.0503*x3 + 0.0641*x0
