...
class SulfurDioxideSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0671*x1 - 0.0492*x0 + 0.0428*np.sin(0.0352*self._t)
        dx1 = -0.0938*x0*x1 + 0.0592*x2 - 0.0905*x1
        dx2 = 0.1043*x0 - 0.0658*x2 + 0.0915*x3 - 0.0590*x1*x2
        dx3 = 0.0339*x1*x2 - 0.0552*x3 + 0.0340*x0
