...
class ElNinoPredictionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0383*x1 - 0.0608*x0 + 0.0449*np.sin(0.0848*self._t)
        dx1 = -0.1190*x0*x1 + 0.0806*x2 - 0.1562*x1
        dx2 = 0.1404*x0 - 0.0762*x2 + 0.0386*x3 - 0.0239*x1*x2
        dx3 = 0.0774*x1*x2 - 0.0781*x3 + 0.1050*x0
