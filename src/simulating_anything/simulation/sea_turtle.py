...
class SeaTurtleSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0926*x1 - 0.0851*x0 + 0.1647*np.sin(0.1306*self._t)
        dx1 = -0.1197*x0*x1 + 0.0261*x2 - 0.1486*x1
        dx2 = 0.1517*x0 - 0.1055*x2 + 0.0377*x3 - 0.0912*x1*x2
        dx3 = 0.135*x1*x2 - 0.0595*x3 + 0.0309*x0
