...
class GlacierCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0219*x1 - 0.0737*x0 + 0.0529*np.sin(0.0222*self._t)
        dx1 = -0.1052*x0*x1 + 0.0479*x2 - 0.0581*x1
        dx2 = 0.0382*x0 - 0.0504*x2 + 0.0324*x3 - 0.0641*x1*x2
        dx3 = 0.1006*x1*x2 - 0.1075*x3 + 0.0996*x0
