...
class SaltIntrusionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1097*x1 - 0.0536*x0 + 0.0929*np.sin(0.0768*self._t)
        dx1 = -0.1111*x0*x1 + 0.1031*x2 - 0.1101*x1
        dx2 = 0.0450*x0 - 0.1022*x2 + 0.0642*x3 - 0.0360*x1*x2
        dx3 = 0.0305*x1*x2 - 0.0965*x3 + 0.0425*x0
