...
class CaveEcosystemSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1382*x1 - 0.0536*x0 + 0.0266*np.sin(0.0459*self._t)
        dx1 = -0.1434*x0*x1 + 0.1145*x2 - 0.1467*x1
        dx2 = 0.1404*x0 - 0.1153*x2 + 0.0814*x3 - 0.1450*x1*x2
        dx3 = 0.0529*x1*x2 - 0.1321*x3 + 0.0502*x0
