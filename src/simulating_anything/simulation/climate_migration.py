...
class ClimateMigrationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0676*x1 - 0.0796*x0 + 0.0336*np.sin(0.0969*self._t)
        dx1 = -0.0570*x0*x1 + 0.0768*x2 - 0.1123*x1
        dx2 = 0.0678*x0 - 0.1063*x2 + 0.0839*x3 - 0.1151*x1*x2
        dx3 = 0.0675*x1*x2 - 0.0786*x3 + 0.0801*x0
