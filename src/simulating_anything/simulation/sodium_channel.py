...
class SodiumChannelSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0490*x1 - 0.1157*x0 + 0.0627*np.sin(0.0797*self._t)
        dx1 = -0.0211*x0*x1 + 0.0752*x2 - 0.1063*x1
        dx2 = 0.0788*x0 - 0.0599*x2 + 0.0561*x3 - 0.0318*x1*x2
        dx3 = 0.0996*x1*x2 - 0.0927*x3 + 0.1083*x0
