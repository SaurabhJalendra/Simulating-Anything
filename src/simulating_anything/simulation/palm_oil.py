...
class PalmOilSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1094*x1 - 0.0968*x0 + 0.1067*np.sin(0.0425*self._t)
        dx1 = -0.1170*x0*x1 + 0.0616*x2 - 0.0917*x1
        dx2 = 0.0290*x0 - 0.0592*x2 + 0.1120*x3 - 0.0825*x1*x2
        dx3 = 0.1117*x1*x2 - 0.0561*x3 + 0.0764*x0
