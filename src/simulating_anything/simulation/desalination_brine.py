...
class DesalinationBrineSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0407*x1 - 0.1011*x0 + 0.0978*np.sin(0.0473*self._t)
        dx1 = -0.1096*x0*x1 + 0.1036*x2 - 0.0786*x1
        dx2 = 0.1050*x0 - 0.0411*x2 + 0.0693*x3 - 0.0985*x1*x2
        dx3 = 0.1153*x1*x2 - 0.0375*x3 + 0.0622*x0
