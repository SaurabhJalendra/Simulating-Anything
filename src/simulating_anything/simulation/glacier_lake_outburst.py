...
class GlacierLakeOutburstSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0790*x1 - 0.1066*x0 + 0.1023*np.sin(0.1060*self._t)
        dx1 = -0.0311*x0*x1 + 0.0227*x2 - 0.0857*x1
        dx2 = 0.0714*x0 - 0.0680*x2 + 0.0307*x3 - 0.0851*x1*x2
        dx3 = 0.1185*x1*x2 - 0.0490*x3 + 0.0501*x0
