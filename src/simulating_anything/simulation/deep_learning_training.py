...
class DeepLearningTrainingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0930*x1 - 0.0304*x0 + 0.0738*np.sin(0.0990*self._t)
        dx1 = -0.0612*x0*x1 + 0.0959*x2 - 0.0701*x1
        dx2 = 0.0458*x0 - 0.0696*x2 + 0.0791*x3 - 0.0798*x1*x2
        dx3 = 0.0588*x1*x2 - 0.0893*x3 + 0.0970*x0
