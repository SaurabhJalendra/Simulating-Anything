...
class PlantCompetitionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0795*x1 - 0.0692*x0 + 0.1585*np.sin(0.1411*self._t)
        dx1 = -0.116*x0*x1 + 0.0549*x2 - 0.1649*x1
        dx2 = 0.1191*x0 - 0.0994*x2 + 0.1533*x3 - 0.0973*x1*x2
        dx3 = 0.0951*x1*x2 - 0.0297*x3 + 0.1557*x0
