...
class WinterSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0560*x1 - 0.0659*x0 + 0.0317*np.sin(0.0324*self._t)
        dx1 = -0.0667*x0*x1 + 0.0791*x2 - 0.1050*x1
        dx2 = 0.0407*x0 - 0.0903*x2 + 0.0977*x3 - 0.0772*x1*x2
        dx3 = 0.0246*x1*x2 - 0.0893*x3 + 0.0846*x0
