...
class HospitalWasteSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1034*x1 - 0.0914*x0 + 0.0419*np.sin(0.0701*self._t)
        dx1 = -0.0256*x0*x1 + 0.0837*x2 - 0.0469*x1
        dx2 = 0.0662*x0 - 0.0950*x2 + 0.0475*x3 - 0.0975*x1*x2
        dx3 = 0.0830*x1*x2 - 0.0789*x3 + 0.0789*x0
