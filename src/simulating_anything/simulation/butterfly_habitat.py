...
class ButterflyHabitatSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0953*x1 - 0.0926*x0 + 0.0372*np.sin(0.0753*self._t)
        dx1 = -0.0601*x0*x1 + 0.0621*x2 - 0.1150*x1
        dx2 = 0.0638*x0 - 0.0247*x2 + 0.0448*x3 - 0.0919*x1*x2
        dx3 = 0.0499*x1*x2 - 0.0204*x3 + 0.0497*x0
