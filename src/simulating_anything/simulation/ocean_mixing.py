...
class OceanMixingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0326*x1 - 0.1180*x0 + 0.0845*np.sin(0.0709*self._t)
        dx1 = -0.0784*x0*x1 + 0.0371*x2 - 0.1138*x1
        dx2 = 0.0237*x0 - 0.0449*x2 + 0.1146*x3 - 0.0511*x1*x2
        dx3 = 0.0903*x1*x2 - 0.1197*x3 + 0.0579*x0
