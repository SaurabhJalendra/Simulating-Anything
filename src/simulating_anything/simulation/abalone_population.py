...
class AbalonePopulationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1179*x1 - 0.0519*x0 + 0.1128*np.sin(0.0418*self._t)
        dx1 = -0.0544*x0*x1 + 0.0201*x2 - 0.0438*x1
        dx2 = 0.0337*x0 - 0.1197*x2 + 0.0894*x3 - 0.0355*x1*x2
        dx3 = 0.0324*x1*x2 - 0.0214*x3 + 0.0871*x0
