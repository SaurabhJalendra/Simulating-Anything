...
class SpaceWeatherSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0630*x1 - 0.0949*x0 + 0.0366*np.sin(0.0994*self._t)
        dx1 = -0.0801*x0*x1 + 0.1108*x2 - 0.0255*x1
        dx2 = 0.0965*x0 - 0.0812*x2 + 0.0358*x3 - 0.0254*x1*x2
        dx3 = 0.0314*x1*x2 - 0.0897*x3 + 0.0846*x0
