...
class TurbineBladeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0239*x1 - 0.1004*x0 + 0.0604*np.sin(0.1178*self._t)
        dx1 = -0.0888*x0*x1 + 0.1026*x2 - 0.0459*x1
        dx2 = 0.0383*x0 - 0.0335*x2 + 0.1198*x3 - 0.0447*x1*x2
        dx3 = 0.1139*x1*x2 - 0.0905*x3 + 0.0797*x0
