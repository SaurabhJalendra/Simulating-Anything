...
class ParticlePhysicsSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0722*x1 - 0.1200*x0 + 0.0756*np.sin(0.0781*self._t)
        dx1 = -0.0993*x0*x1 + 0.0509*x2 - 0.0738*x1
        dx2 = 0.0760*x0 - 0.0927*x2 + 0.0982*x3 - 0.0367*x1*x2
        dx3 = 0.0233*x1*x2 - 0.0704*x3 + 0.1109*x0
