...
class BeeDanceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0748*x1 - 0.0681*x0 + 0.0406*np.sin(0.0797*self._t)
        dx1 = -0.0693*x0*x1 + 0.0941*x2 - 0.0942*x1
        dx2 = 0.0830*x0 - 0.0727*x2 + 0.0385*x3 - 0.0407*x1*x2
        dx3 = 0.0949*x1*x2 - 0.1083*x3 + 0.0332*x0
