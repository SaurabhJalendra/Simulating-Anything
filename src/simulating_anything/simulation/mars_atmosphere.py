...
class MarsAtmosphereSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0349*x1 - 0.1006*x0 + 0.0525*np.sin(0.1020*self._t)
        dx1 = -0.0429*x0*x1 + 0.0896*x2 - 0.0952*x1
        dx2 = 0.0991*x0 - 0.0478*x2 + 0.1155*x3 - 0.0616*x1*x2
        dx3 = 0.0204*x1*x2 - 0.0727*x3 + 0.0960*x0
