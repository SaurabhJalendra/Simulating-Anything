...
class YeastFermentationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0602*x1 - 0.0270*x0 + 0.1034*np.sin(0.0741*self._t)
        dx1 = -0.0407*x0*x1 + 0.0358*x2 - 0.0911*x1
        dx2 = 0.1127*x0 - 0.0388*x2 + 0.0612*x3 - 0.0588*x1*x2
        dx3 = 0.0673*x1*x2 - 0.1016*x3 + 0.0225*x0
