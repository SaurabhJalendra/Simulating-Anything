...
class DesertBloomSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0627*x1 - 0.0351*x0 + 0.1133*np.sin(0.0897*self._t)
        dx1 = -0.0781*x0*x1 + 0.1397*x2 - 0.0256*x1
        dx2 = 0.0943*x0 - 0.1121*x2 + 0.1488*x3 - 0.1164*x1*x2
        dx3 = 0.0418*x1*x2 - 0.1011*x3 + 0.1092*x0
