...
class GroundwaterBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0421*x1 - 0.0376*x0 + 0.0983*np.sin(0.0803*self._t)
        dx1 = -0.0285*x0*x1 + 0.0779*x2 - 0.0509*x1
        dx2 = 0.0985*x0 - 0.0455*x2 + 0.1090*x3 - 0.1169*x1*x2
        dx3 = 0.0369*x1*x2 - 0.1184*x3 + 0.0451*x0
