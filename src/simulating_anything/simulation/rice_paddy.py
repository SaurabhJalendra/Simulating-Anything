...
class RicePaddySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0694*x1 - 0.0948*x0 + 0.0884*np.sin(0.0642*self._t)
        dx1 = -0.0960*x0*x1 + 0.0613*x2 - 0.0888*x1
        dx2 = 0.1151*x0 - 0.0720*x2 + 0.0775*x3 - 0.1013*x1*x2
        dx3 = 0.0299*x1*x2 - 0.0805*x3 + 0.0702*x0
