...
class PhytoremediationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0459*x1 - 0.0353*x0 + 0.1136*np.sin(0.0699*self._t)
        dx1 = -0.0246*x0*x1 + 0.0477*x2 - 0.0831*x1
        dx2 = 0.0655*x0 - 0.0761*x2 + 0.1173*x3 - 0.0679*x1*x2
        dx3 = 0.0670*x1*x2 - 0.1174*x3 + 0.0606*x0
