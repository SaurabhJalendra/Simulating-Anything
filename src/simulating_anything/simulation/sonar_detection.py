...
class SonarDetectionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0927*x1 - 0.0824*x0 + 0.0827*np.sin(0.0702*self._t)
        dx1 = -0.1057*x0*x1 + 0.1197*x2 - 0.0447*x1
        dx2 = 0.0315*x0 - 0.1148*x2 + 0.0294*x3 - 0.0557*x1*x2
        dx3 = 0.1010*x1*x2 - 0.0641*x3 + 0.0948*x0
