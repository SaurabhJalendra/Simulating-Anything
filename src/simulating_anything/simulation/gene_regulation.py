...
class GeneRegulationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0684*x1 - 0.0614*x0 + 0.0731*np.sin(0.1062*self._t)
        dx1 = -0.0956*x0*x1 + 0.0396*x2 - 0.0265*x1
        dx2 = 0.0803*x0 - 0.0857*x2 + 0.0559*x3 - 0.0735*x1*x2
        dx3 = 0.0632*x1*x2 - 0.0626*x3 + 0.1078*x0
