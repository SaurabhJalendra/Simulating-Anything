...
class DeltaSubsidenceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0649*x1 - 0.0248*x0 + 0.1022*np.sin(0.0591*self._t)
        dx1 = -0.0825*x0*x1 + 0.0955*x2 - 0.1125*x1
        dx2 = 0.0576*x0 - 0.0704*x2 + 0.0329*x3 - 0.0342*x1*x2
        dx3 = 0.0310*x1*x2 - 0.1053*x3 + 0.0593*x0
