...
class GreenhouseGasSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0597*x1 - 0.1072*x0 + 0.1338*np.sin(0.0800*self._t)
        dx1 = -0.0341*x0*x1 + 0.0367*x2 - 0.1209*x1
        dx2 = 0.1380*x0 - 0.1239*x2 + 0.0588*x3 - 0.0971*x1*x2
        dx3 = 0.0864*x1*x2 - 0.0679*x3 + 0.1183*x0
