...
class EmbryonicStemSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0503*x1 - 0.0709*x0 + 0.1178*np.sin(0.0675*self._t)
        dx1 = -0.0396*x0*x1 + 0.1182*x2 - 0.0599*x1
        dx2 = 0.0725*x0 - 0.0813*x2 + 0.1173*x3 - 0.0506*x1*x2
        dx3 = 0.0581*x1*x2 - 0.0634*x3 + 0.0723*x0
