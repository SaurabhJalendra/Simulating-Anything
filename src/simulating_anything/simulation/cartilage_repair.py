...
class CartilageRepairSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1186*x1 - 0.0346*x0 + 0.0359*np.sin(0.0596*self._t)
        dx1 = -0.0683*x0*x1 + 0.0615*x2 - 0.0569*x1
        dx2 = 0.0847*x0 - 0.1120*x2 + 0.0370*x3 - 0.0390*x1*x2
        dx3 = 0.0873*x1*x2 - 0.0835*x3 + 0.0543*x0
