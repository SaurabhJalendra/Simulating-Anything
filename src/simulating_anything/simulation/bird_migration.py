...
class BirdMigrationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1303*x1 - 0.1147*x0 + 0.1615*np.sin(0.0457*self._t)
        dx1 = -0.1607*x0*x1 + 0.1103*x2 - 0.0657*x1
        dx2 = 0.1479*x0 - 0.1113*x2 + 0.0515*x3 - 0.0661*x1*x2
        dx3 = 0.0606*x1*x2 - 0.1124*x3 + 0.0612*x0
