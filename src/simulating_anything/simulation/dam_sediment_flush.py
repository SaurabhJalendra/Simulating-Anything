...
class DamSedimentFlushSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0410*x1 - 0.1103*x0 + 0.0969*np.sin(0.0347*self._t)
        dx1 = -0.0897*x0*x1 + 0.0747*x2 - 0.1142*x1
        dx2 = 0.1017*x0 - 0.0237*x2 + 0.0504*x3 - 0.0269*x1*x2
        dx3 = 0.0770*x1*x2 - 0.0450*x3 + 0.0810*x0
