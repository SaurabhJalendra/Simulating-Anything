...
class SepticSystemSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1120*x1 - 0.0201*x0 + 0.0626*np.sin(0.1193*self._t)
        dx1 = -0.0224*x0*x1 + 0.0341*x2 - 0.0201*x1
        dx2 = 0.1046*x0 - 0.1153*x2 + 0.0653*x3 - 0.1056*x1*x2
        dx3 = 0.1174*x1*x2 - 0.0697*x3 + 0.0647*x0
