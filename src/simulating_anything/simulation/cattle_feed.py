...
class CattleFeedSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0557*x1 - 0.1138*x0 + 0.0899*np.sin(0.0406*self._t)
        dx1 = -0.0673*x0*x1 + 0.0789*x2 - 0.0439*x1
        dx2 = 0.0752*x0 - 0.0845*x2 + 0.0502*x3 - 0.0507*x1*x2
        dx3 = 0.0674*x1*x2 - 0.1177*x3 + 0.0463*x0
