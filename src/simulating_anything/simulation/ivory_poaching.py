...
class IvoryPoachingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1123*x1 - 0.1435*x0 + 0.0333*np.sin(0.1337*self._t)
        dx1 = -0.0935*x0*x1 + 0.1195*x2 - 0.1320*x1
        dx2 = 0.1251*x0 - 0.0849*x2 + 0.1217*x3 - 0.1022*x1*x2
        dx3 = 0.1046*x1*x2 - 0.1696*x3 + 0.1672*x0
