...
class CarbonFiberSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1061*x1 - 0.0310*x0 + 0.0304*np.sin(0.0845*self._t)
        dx1 = -0.0319*x0*x1 + 0.0229*x2 - 0.0999*x1
        dx2 = 0.0994*x0 - 0.0374*x2 + 0.0839*x3 - 0.0906*x1*x2
        dx3 = 0.0866*x1*x2 - 0.0906*x3 + 0.1128*x0
