...
class TropicalDiseaseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1066*x1 - 0.0521*x0 + 0.0436*np.sin(0.0339*self._t)
        dx1 = -0.0539*x0*x1 + 0.1137*x2 - 0.1023*x1
        dx2 = 0.0358*x0 - 0.0364*x2 + 0.0415*x3 - 0.0948*x1*x2
        dx3 = 0.0348*x1*x2 - 0.0314*x3 + 0.0694*x0
