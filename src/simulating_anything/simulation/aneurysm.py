...
class AneurysmSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0568*x1 - 0.1051*x0 + 0.1099*np.sin(0.0314*self._t)
        dx1 = -0.0233*x0*x1 + 0.0593*x2 - 0.1002*x1
        dx2 = 0.0937*x0 - 0.0330*x2 + 0.0807*x3 - 0.0237*x1*x2
        dx3 = 0.0769*x1*x2 - 0.0915*x3 + 0.0819*x0
