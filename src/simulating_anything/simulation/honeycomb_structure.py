...
class HoneycombStructureSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0374*x1 - 0.0412*x0 + 0.1171*np.sin(0.0333*self._t)
        dx1 = -0.0540*x0*x1 + 0.1136*x2 - 0.0281*x1
        dx2 = 0.1118*x0 - 0.0708*x2 + 0.0802*x3 - 0.1010*x1*x2
        dx3 = 0.0503*x1*x2 - 0.0986*x3 + 0.0955*x0
