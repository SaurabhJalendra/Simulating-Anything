...
class CloudCondensationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0890*x1 - 0.0909*x0 + 0.0583*np.sin(0.0371*self._t)
        dx1 = -0.0570*x0*x1 + 0.0588*x2 - 0.1065*x1
        dx2 = 0.0752*x0 - 0.1069*x2 + 0.0455*x3 - 0.0726*x1*x2
        dx3 = 0.1147*x1*x2 - 0.0769*x3 + 0.1093*x0
