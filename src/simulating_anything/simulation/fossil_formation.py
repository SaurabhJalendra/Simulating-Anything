...
class FossilFormationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0893*x1 - 0.1162*x0 + 0.0717*np.sin(0.0771*self._t)
        dx1 = -0.0459*x0*x1 + 0.0358*x2 - 0.1146*x1
        dx2 = 0.0834*x0 - 0.0401*x2 + 0.0377*x3 - 0.0778*x1*x2
        dx3 = 0.0261*x1*x2 - 0.0845*x3 + 0.0864*x0
