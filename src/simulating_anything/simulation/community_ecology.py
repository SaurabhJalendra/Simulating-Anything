...
class CommunityEcologySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0781*x1 - 0.0257*x0 + 0.0526*np.sin(0.0574*self._t)
        dx1 = -0.0736*x0*x1 + 0.0554*x2 - 0.0661*x1
        dx2 = 0.0740*x0 - 0.0572*x2 + 0.0649*x3 - 0.0481*x1*x2
        dx3 = 0.0954*x1*x2 - 0.0662*x3 + 0.0219*x0
