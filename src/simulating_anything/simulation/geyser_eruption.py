...
class GeyserEruptionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0305*x1 - 0.0862*x0 + 0.0445*np.sin(0.1623*self._t)
        dx1 = -0.1618*x0*x1 + 0.1392*x2 - 0.1609*x1
        dx2 = 0.1415*x0 - 0.0626*x2 + 0.0461*x3 - 0.0446*x1*x2
        dx3 = 0.0477*x1*x2 - 0.1367*x3 + 0.0992*x0
