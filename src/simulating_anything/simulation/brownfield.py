...
class BrownfieldSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0590*x1 - 0.0859*x0 + 0.0452*np.sin(0.1037*self._t)
        dx1 = -0.0749*x0*x1 + 0.0901*x2 - 0.0770*x1
        dx2 = 0.0783*x0 - 0.0972*x2 + 0.1026*x3 - 0.0668*x1*x2
        dx3 = 0.0429*x1*x2 - 0.0968*x3 + 0.0697*x0
