...
class NeuralPlasticitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0599*x1 - 0.0768*x0 + 0.0561*np.sin(0.0878*self._t)
        dx1 = -0.1123*x0*x1 + 0.0484*x2 - 0.1013*x1
        dx2 = 0.0255*x0 - 0.0994*x2 + 0.1138*x3 - 0.0549*x1*x2
        dx3 = 0.0703*x1*x2 - 0.0458*x3 + 0.0910*x0
