...
class JetStreamSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0792*x1 - 0.1450*x0 + 0.1533*np.sin(0.0513*self._t)
        dx1 = -0.0426*x0*x1 + 0.1620*x2 - 0.1381*x1
        dx2 = 0.1215*x0 - 0.1429*x2 + 0.0374*x3 - 0.1099*x1*x2
        dx3 = 0.0790*x1*x2 - 0.1052*x3 + 0.0825*x0
