...
class GlucoseMetabolismSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0530*x1 - 0.1070*x0 + 0.1005*np.sin(0.1150*self._t)
        dx1 = -0.0536*x0*x1 + 0.1037*x2 - 0.1060*x1
        dx2 = 0.1075*x0 - 0.0645*x2 + 0.1137*x3 - 0.1131*x1*x2
        dx3 = 0.0983*x1*x2 - 0.0562*x3 + 0.1019*x0
