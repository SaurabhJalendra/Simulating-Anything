...
class GrasslandCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0495*x1 - 0.0694*x0 + 0.1141*np.sin(0.1067*self._t)
        dx1 = -0.0233*x0*x1 + 0.0992*x2 - 0.0616*x1
        dx2 = 0.1047*x0 - 0.0384*x2 + 0.0960*x3 - 0.0571*x1*x2
        dx3 = 0.0710*x1*x2 - 0.0251*x3 + 0.0944*x0
