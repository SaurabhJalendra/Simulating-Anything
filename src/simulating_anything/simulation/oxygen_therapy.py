...
class OxygenTherapySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0911*x1 - 0.0699*x0 + 0.1113*np.sin(0.0427*self._t)
        dx1 = -0.0908*x0*x1 + 0.0930*x2 - 0.1195*x1
        dx2 = 0.0567*x0 - 0.0346*x2 + 0.1051*x3 - 0.0402*x1*x2
        dx3 = 0.0618*x1*x2 - 0.1065*x3 + 0.1140*x0
