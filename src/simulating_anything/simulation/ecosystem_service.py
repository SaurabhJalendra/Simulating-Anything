...
class EcosystemServiceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1159*x1 - 0.0985*x0 + 0.1188*np.sin(0.0321*self._t)
        dx1 = -0.0549*x0*x1 + 0.0470*x2 - 0.0296*x1
        dx2 = 0.0211*x0 - 0.0355*x2 + 0.0222*x3 - 0.1049*x1*x2
        dx3 = 0.0597*x1*x2 - 0.0265*x3 + 0.1086*x0
