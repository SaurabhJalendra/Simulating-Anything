...
class HydrogenFuelSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0322*x1 - 0.0628*x0 + 0.0767*np.sin(0.0600*self._t)
        dx1 = -0.0759*x0*x1 + 0.1029*x2 - 0.0330*x1
        dx2 = 0.1025*x0 - 0.0658*x2 + 0.0437*x3 - 0.0451*x1*x2
        dx3 = 0.0617*x1*x2 - 0.1063*x3 + 0.0392*x0
