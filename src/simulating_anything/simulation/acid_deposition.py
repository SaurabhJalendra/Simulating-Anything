...
class AcidDepositionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0513*x1 - 0.0835*x0 + 0.0478*np.sin(0.0734*self._t)
        dx1 = -0.0517*x0*x1 + 0.0364*x2 - 0.0630*x1
        dx2 = 0.0417*x0 - 0.1157*x2 + 0.0939*x3 - 0.0457*x1*x2
        dx3 = 0.0275*x1*x2 - 0.0640*x3 + 0.0831*x0
