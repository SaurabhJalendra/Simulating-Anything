...
class FishLadderSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.168*x1 - 0.0292*x0 + 0.144*np.sin(0.0333*self._t)
        dx1 = -0.167*x0*x1 + 0.0957*x2 - 0.1078*x1
        dx2 = 0.1555*x0 - 0.0993*x2 + 0.0287*x3 - 0.0816*x1*x2
        dx3 = 0.1555*x1*x2 - 0.0889*x3 + 0.1481*x0
