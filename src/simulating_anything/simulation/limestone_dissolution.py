...
class LimestoneDissolutionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0363*x1 - 0.0876*x0 + 0.0865*np.sin(0.1050*self._t)
        dx1 = -0.1084*x0*x1 + 0.0918*x2 - 0.0576*x1
        dx2 = 0.1161*x0 - 0.0893*x2 + 0.0388*x3 - 0.0435*x1*x2
        dx3 = 0.0962*x1*x2 - 0.0457*x3 + 0.1063*x0
