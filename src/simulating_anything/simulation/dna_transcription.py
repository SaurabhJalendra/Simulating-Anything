...
class DnaTranscriptionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1109*x1 - 0.1074*x0 + 0.0414*np.sin(0.0503*self._t)
        dx1 = -0.1012*x0*x1 + 0.1020*x2 - 0.0395*x1
        dx2 = 0.0838*x0 - 0.0676*x2 + 0.1033*x3 - 0.0750*x1*x2
        dx3 = 0.0431*x1*x2 - 0.0467*x3 + 0.0533*x0
