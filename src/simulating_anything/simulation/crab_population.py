...
class CrabPopulationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0358*x1 - 0.0667*x0 + 0.0897*np.sin(0.0578*self._t)
        dx1 = -0.0576*x0*x1 + 0.0877*x2 - 0.0685*x1
        dx2 = 0.0223*x0 - 0.1129*x2 + 0.1156*x3 - 0.0763*x1*x2
        dx3 = 0.0254*x1*x2 - 0.0220*x3 + 0.0867*x0
