...
class BlackHoleAccretionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0430*x1 - 0.0245*x0 + 0.0784*np.sin(0.0474*self._t)
        dx1 = -0.0452*x0*x1 + 0.0740*x2 - 0.0380*x1
        dx2 = 0.1183*x0 - 0.0623*x2 + 0.0393*x3 - 0.0402*x1*x2
        dx3 = 0.0266*x1*x2 - 0.0523*x3 + 0.0932*x0
