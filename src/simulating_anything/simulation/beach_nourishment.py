...
class BeachNourishmentSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0524*x1 - 0.1397*x0 + 0.0285*np.sin(0.1254*self._t)
        dx1 = -0.0997*x0*x1 + 0.1253*x2 - 0.1257*x1
        dx2 = 0.0712*x0 - 0.0901*x2 + 0.0562*x3 - 0.0738*x1*x2
        dx3 = 0.1211*x1*x2 - 0.1389*x3 + 0.0769*x0
