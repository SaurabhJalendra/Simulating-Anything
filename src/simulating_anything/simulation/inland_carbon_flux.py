...
class InlandCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0717*x1 - 0.0904*x0 + 0.0990*np.sin(0.0741*self._t)
        dx1 = -0.0396*x0*x1 + 0.0212*x2 - 0.0348*x1
        dx2 = 0.1003*x0 - 0.0670*x2 + 0.0969*x3 - 0.0417*x1*x2
        dx3 = 0.0201*x1*x2 - 0.0606*x3 + 0.0756*x0
