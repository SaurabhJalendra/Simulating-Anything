...
class TireRecyclingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1166*x1 - 0.0867*x0 + 0.1066*np.sin(0.0894*self._t)
        dx1 = -0.0774*x0*x1 + 0.0203*x2 - 0.1078*x1
        dx2 = 0.0903*x0 - 0.0841*x2 + 0.0636*x3 - 0.1110*x1*x2
        dx3 = 0.0440*x1*x2 - 0.0600*x3 + 0.0362*x0
