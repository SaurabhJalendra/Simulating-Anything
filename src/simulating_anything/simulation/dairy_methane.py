...
class DairyMethaneSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0604*x1 - 0.0486*x0 + 0.0344*np.sin(0.0761*self._t)
        dx1 = -0.0592*x0*x1 + 0.0356*x2 - 0.1029*x1
        dx2 = 0.0437*x0 - 0.1039*x2 + 0.0464*x3 - 0.0772*x1*x2
        dx3 = 0.0232*x1*x2 - 0.0989*x3 + 0.1122*x0
