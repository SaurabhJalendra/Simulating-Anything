...
class AluminumSmeltingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0385*x1 - 0.1095*x0 + 0.0440*np.sin(0.0455*self._t)
        dx1 = -0.0355*x0*x1 + 0.0879*x2 - 0.0276*x1
        dx2 = 0.0205*x0 - 0.1095*x2 + 0.0620*x3 - 0.0558*x1*x2
        dx3 = 0.1112*x1*x2 - 0.0609*x3 + 0.0274*x0
