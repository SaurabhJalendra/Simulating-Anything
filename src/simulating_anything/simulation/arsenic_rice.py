...
class ArsenicRiceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0569*x1 - 0.0479*x0 + 0.0999*np.sin(0.0220*self._t)
        dx1 = -0.0777*x0*x1 + 0.0342*x2 - 0.0415*x1
        dx2 = 0.0566*x0 - 0.1197*x2 + 0.0354*x3 - 0.0944*x1*x2
        dx3 = 0.0792*x1*x2 - 0.0854*x3 + 0.1095*x0
