...
class StratosphereSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0691*x1 - 0.0360*x0 + 0.0514*np.sin(0.0977*self._t)
        dx1 = -0.0757*x0*x1 + 0.1136*x2 - 0.0318*x1
        dx2 = 0.1147*x0 - 0.0688*x2 + 0.0820*x3 - 0.0722*x1*x2
        dx3 = 0.1180*x1*x2 - 0.0529*x3 + 0.0458*x0
