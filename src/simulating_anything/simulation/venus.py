...
class VenusSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0628*x1 - 0.0598*x0 + 0.0353*np.sin(0.0474*self._t)
        dx1 = -0.0619*x0*x1 + 0.0976*x2 - 0.0458*x1
        dx2 = 0.0484*x0 - 0.0976*x2 + 0.0547*x3 - 0.0826*x1*x2
        dx3 = 0.0740*x1*x2 - 0.1088*x3 + 0.0482*x0
