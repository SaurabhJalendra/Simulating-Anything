...
class BioaccumulationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0532*x1 - 0.0348*x0 + 0.0990*np.sin(0.1094*self._t)
        dx1 = -0.1183*x0*x1 + 0.0498*x2 - 0.1138*x1
        dx2 = 0.1022*x0 - 0.0202*x2 + 0.1014*x3 - 0.0570*x1*x2
        dx3 = 0.0722*x1*x2 - 0.0649*x3 + 0.0956*x0
