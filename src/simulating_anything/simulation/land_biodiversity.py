...
class LandBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0623*x1 - 0.0578*x0 + 0.1011*np.sin(0.1019*self._t)
        dx1 = -0.0713*x0*x1 + 0.0338*x2 - 0.0867*x1
        dx2 = 0.0208*x0 - 0.1188*x2 + 0.0279*x3 - 0.0751*x1*x2
        dx3 = 0.0924*x1*x2 - 0.0212*x3 + 0.0755*x0
