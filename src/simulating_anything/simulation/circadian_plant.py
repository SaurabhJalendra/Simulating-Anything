...
class CircadianPlantSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0700*x1 - 0.0358*x0 + 0.0404*np.sin(0.0521*self._t)
        dx1 = -0.0450*x0*x1 + 0.0702*x2 - 0.0540*x1
        dx2 = 0.0704*x0 - 0.0212*x2 + 0.0437*x3 - 0.0919*x1*x2
        dx3 = 0.0241*x1*x2 - 0.1037*x3 + 0.1122*x0
