...
class ParkingHeatSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0216*x1 - 0.0487*x0 + 0.1020*np.sin(0.0863*self._t)
        dx1 = -0.0825*x0*x1 + 0.0768*x2 - 0.0695*x1
        dx2 = 0.0321*x0 - 0.0383*x2 + 0.0641*x3 - 0.0547*x1*x2
        dx3 = 0.0940*x1*x2 - 0.0904*x3 + 0.0463*x0
