...
class WoundHealingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0831*x1 - 0.0995*x0 + 0.1172*np.sin(0.0552*self._t)
        dx1 = -0.0742*x0*x1 + 0.1094*x2 - 0.1079*x1
        dx2 = 0.0507*x0 - 0.0700*x2 + 0.0606*x3 - 0.0455*x1*x2
        dx3 = 0.0735*x1*x2 - 0.1077*x3 + 0.1114*x0
