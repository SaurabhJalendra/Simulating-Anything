...
class ZooplanktonGrazingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1132*x1 - 0.1113*x0 + 0.0919*np.sin(0.0322*self._t)
        dx1 = -0.0608*x0*x1 + 0.1121*x2 - 0.1051*x1
        dx2 = 0.0909*x0 - 0.0489*x2 + 0.0375*x3 - 0.0812*x1*x2
        dx3 = 0.0443*x1*x2 - 0.0317*x3 + 0.1192*x0
