...
class FisheryCollapseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1165*x1 - 0.0898*x0 + 0.0359*np.sin(0.0276*self._t)
        dx1 = -0.0399*x0*x1 + 0.0692*x2 - 0.0394*x1
        dx2 = 0.0501*x0 - 0.0343*x2 + 0.0677*x3 - 0.0777*x1*x2
        dx3 = 0.0797*x1*x2 - 0.1067*x3 + 0.0908*x0
