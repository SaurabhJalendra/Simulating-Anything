...
class DieselEngineSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0965*x1 - 0.0570*x0 + 0.0400*np.sin(0.0515*self._t)
        dx1 = -0.0382*x0*x1 + 0.0390*x2 - 0.0830*x1
        dx2 = 0.0932*x0 - 0.0387*x2 + 0.0876*x3 - 0.0674*x1*x2
        dx3 = 0.0317*x1*x2 - 0.1100*x3 + 0.0419*x0
