...
class AlbatrossSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0240*x1 - 0.0757*x0 + 0.1036*np.sin(0.0830*self._t)
        dx1 = -0.0556*x0*x1 + 0.0985*x2 - 0.0592*x1
        dx2 = 0.0214*x0 - 0.0871*x2 + 0.0765*x3 - 0.0498*x1*x2
        dx3 = 0.0674*x1*x2 - 0.1092*x3 + 0.0360*x0
