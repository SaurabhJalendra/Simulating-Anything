...
class StemCellTherapySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0681*x1 - 0.0871*x0 + 0.0331*np.sin(0.1081*self._t)
        dx1 = -0.0547*x0*x1 + 0.0471*x2 - 0.0247*x1
        dx2 = 0.0984*x0 - 0.1085*x2 + 0.0340*x3 - 0.0253*x1*x2
        dx3 = 0.0435*x1*x2 - 0.1116*x3 + 0.1021*x0
