...
class CropIrrigationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1349*x1 - 0.1057*x0 + 0.1185*np.sin(0.0824*self._t)
        dx1 = -0.0908*x0*x1 + 0.0886*x2 - 0.0357*x1
        dx2 = 0.0416*x0 - 0.0457*x2 + 0.0894*x3 - 0.0600*x1*x2
        dx3 = 0.0503*x1*x2 - 0.0362*x3 + 0.0340*x0
