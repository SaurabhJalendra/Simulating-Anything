...
class BirdNestingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0509*x1 - 0.0459*x0 + 0.1077*np.sin(0.0733*self._t)
        dx1 = -0.0856*x0*x1 + 0.0922*x2 - 0.0839*x1
        dx2 = 0.0920*x0 - 0.0628*x2 + 0.0917*x3 - 0.0735*x1*x2
        dx3 = 0.0868*x1*x2 - 0.0901*x3 + 0.0306*x0
