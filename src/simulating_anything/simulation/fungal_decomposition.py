...
class FungalDecompositionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0771*x1 - 0.0588*x0 + 0.0542*np.sin(0.1181*self._t)
        dx1 = -0.0806*x0*x1 + 0.0914*x2 - 0.0924*x1
        dx2 = 0.1013*x0 - 0.0897*x2 + 0.0399*x3 - 0.0233*x1*x2
        dx3 = 0.0428*x1*x2 - 0.1044*x3 + 0.0573*x0
