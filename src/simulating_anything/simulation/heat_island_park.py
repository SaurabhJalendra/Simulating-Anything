...
class HeatIslandParkSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0622*x1 - 0.0285*x0 + 0.1130*np.sin(0.1396*self._t)
        dx1 = -0.0483*x0*x1 + 0.1070*x2 - 0.0821*x1
        dx2 = 0.1281*x0 - 0.0932*x2 + 0.0795*x3 - 0.0299*x1*x2
        dx3 = 0.0854*x1*x2 - 0.0224*x3 + 0.0954*x0
