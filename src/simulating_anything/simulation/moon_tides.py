...
class MoonTidesSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0476*x1 - 0.0270*x0 + 0.0871*np.sin(0.0905*self._t)
        dx1 = -0.1038*x0*x1 + 0.0798*x2 - 0.0767*x1
        dx2 = 0.1170*x0 - 0.1150*x2 + 0.0296*x3 - 0.0445*x1*x2
        dx3 = 0.1043*x1*x2 - 0.0420*x3 + 0.1088*x0
