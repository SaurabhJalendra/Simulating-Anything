...
class DiatomBloomSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0700*x1 - 0.0397*x0 + 0.0455*np.sin(0.0373*self._t)
        dx1 = -0.0886*x0*x1 + 0.0374*x2 - 0.1092*x1
        dx2 = 0.1041*x0 - 0.0568*x2 + 0.0379*x3 - 0.0848*x1*x2
        dx3 = 0.0761*x1*x2 - 0.0343*x3 + 0.0825*x0
