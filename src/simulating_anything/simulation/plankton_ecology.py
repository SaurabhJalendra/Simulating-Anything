...
class PlanktonEcologySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0506*x1 - 0.0403*x0 + 0.0850*np.sin(0.0720*self._t)
        dx1 = -0.0727*x0*x1 + 0.0632*x2 - 0.1186*x1
        dx2 = 0.0918*x0 - 0.0959*x2 + 0.0523*x3 - 0.0773*x1*x2
        dx3 = 0.0855*x1*x2 - 0.0923*x3 + 0.0662*x0
