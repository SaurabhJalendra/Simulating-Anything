...
class MutationRateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0532*x1 - 0.0827*x0 + 0.0359*np.sin(0.0429*self._t)
        dx1 = -0.0730*x0*x1 + 0.0576*x2 - 0.0222*x1
        dx2 = 0.0395*x0 - 0.0319*x2 + 0.0515*x3 - 0.0502*x1*x2
        dx3 = 0.0839*x1*x2 - 0.0362*x3 + 0.0884*x0
