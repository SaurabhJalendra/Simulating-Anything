...
class WineFermentationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0724*x1 - 0.0344*x0 + 0.0367*np.sin(0.1002*self._t)
        dx1 = -0.1110*x0*x1 + 0.0244*x2 - 0.0867*x1
        dx2 = 0.0932*x0 - 0.1038*x2 + 0.0258*x3 - 0.0394*x1*x2
        dx3 = 0.0327*x1*x2 - 0.0801*x3 + 0.0400*x0
