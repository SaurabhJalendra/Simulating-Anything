...
class ForestSuccessionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0775*x1 - 0.0871*x0 + 0.1113*np.sin(0.0841*self._t)
        dx1 = -0.0353*x0*x1 + 0.1011*x2 - 0.1430*x1
        dx2 = 0.0611*x0 - 0.0776*x2 + 0.1203*x3 - 0.1540*x1*x2
        dx3 = 0.0717*x1*x2 - 0.0643*x3 + 0.1029*x0
