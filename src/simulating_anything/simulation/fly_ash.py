...
class FlyAshSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0276*x1 - 0.0500*x0 + 0.1182*np.sin(0.0525*self._t)
        dx1 = -0.0725*x0*x1 + 0.0455*x2 - 0.0972*x1
        dx2 = 0.0285*x0 - 0.0659*x2 + 0.0891*x3 - 0.0277*x1*x2
        dx3 = 0.0338*x1*x2 - 0.0877*x3 + 0.0887*x0
