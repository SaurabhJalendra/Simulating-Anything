...
class FluidMixingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0720*x1 - 0.1125*x0 + 0.0269*np.sin(0.0660*self._t)
        dx1 = -0.0658*x0*x1 + 0.1080*x2 - 0.0575*x1
        dx2 = 0.0206*x0 - 0.0772*x2 + 0.1115*x3 - 0.0688*x1*x2
        dx3 = 0.0618*x1*x2 - 0.0387*x3 + 0.0852*x0
