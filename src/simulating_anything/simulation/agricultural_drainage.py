...
class AgriculturalDrainageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0546*x1 - 0.0520*x0 + 0.1007*np.sin(0.0891*self._t)
        dx1 = -0.0557*x0*x1 + 0.0245*x2 - 0.1149*x1
        dx2 = 0.0563*x0 - 0.0454*x2 + 0.0570*x3 - 0.0934*x1*x2
        dx3 = 0.0605*x1*x2 - 0.0813*x3 + 0.0672*x0
