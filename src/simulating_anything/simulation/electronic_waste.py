...
class ElectronicWasteSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0440*x1 - 0.0386*x0 + 0.0961*np.sin(0.0470*self._t)
        dx1 = -0.1012*x0*x1 + 0.0866*x2 - 0.0224*x1
        dx2 = 0.0912*x0 - 0.0367*x2 + 0.1025*x3 - 0.0443*x1*x2
        dx3 = 0.0296*x1*x2 - 0.0363*x3 + 0.1061*x0
