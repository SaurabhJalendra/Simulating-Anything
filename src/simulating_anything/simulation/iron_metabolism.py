...
class IronMetabolismSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0361*x1 - 0.0921*x0 + 0.1070*np.sin(0.1096*self._t)
        dx1 = -0.0227*x0*x1 + 0.0959*x2 - 0.0405*x1
        dx2 = 0.0756*x0 - 0.1079*x2 + 0.0430*x3 - 0.0780*x1*x2
        dx3 = 0.0637*x1*x2 - 0.0413*x3 + 0.1041*x0
