...
class PaperMillSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0936*x1 - 0.0424*x0 + 0.0232*np.sin(0.0703*self._t)
        dx1 = -0.1134*x0*x1 + 0.0406*x2 - 0.1187*x1
        dx2 = 0.1005*x0 - 0.0207*x2 + 0.0451*x3 - 0.0425*x1*x2
        dx3 = 0.1137*x1*x2 - 0.0524*x3 + 0.0912*x0
