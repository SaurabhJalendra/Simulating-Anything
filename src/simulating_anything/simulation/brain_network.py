...
class BrainNetworkSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0365*x1 - 0.0438*x0 + 0.0542*np.sin(0.1136*self._t)
        dx1 = -0.0872*x0*x1 + 0.1177*x2 - 0.1064*x1
        dx2 = 0.1135*x0 - 0.0880*x2 + 0.0566*x3 - 0.0725*x1*x2
        dx3 = 0.0745*x1*x2 - 0.0814*x3 + 0.0744*x0
