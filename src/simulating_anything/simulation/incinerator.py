...
class IncineratorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0666*x1 - 0.0745*x0 + 0.1163*np.sin(0.0611*self._t)
        dx1 = -0.0715*x0*x1 + 0.0741*x2 - 0.0498*x1
        dx2 = 0.0494*x0 - 0.0310*x2 + 0.0386*x3 - 0.0678*x1*x2
        dx3 = 0.0207*x1*x2 - 0.0491*x3 + 0.0341*x0
