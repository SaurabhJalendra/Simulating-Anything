...
class SwarmIntelligenceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0501*x1 - 0.0388*x0 + 0.0833*np.sin(0.0892*self._t)
        dx1 = -0.0814*x0*x1 + 0.1117*x2 - 0.0274*x1
        dx2 = 0.0910*x0 - 0.0289*x2 + 0.0382*x3 - 0.0211*x1*x2
        dx3 = 0.0358*x1*x2 - 0.1061*x3 + 0.0583*x0
