...
class MineralExtractionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0448*x1 - 0.0388*x0 + 0.0792*np.sin(0.0413*self._t)
        dx1 = -0.0258*x0*x1 + 0.0561*x2 - 0.1049*x1
        dx2 = 0.0869*x0 - 0.0840*x2 + 0.1083*x3 - 0.0749*x1*x2
        dx3 = 0.1092*x1*x2 - 0.0261*x3 + 0.0438*x0
