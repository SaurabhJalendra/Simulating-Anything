...
class OpticalFiberSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0866*x1 - 0.0888*x0 + 0.0802*np.sin(0.0720*self._t)
        dx1 = -0.0548*x0*x1 + 0.1066*x2 - 0.0983*x1
        dx2 = 0.0801*x0 - 0.0570*x2 + 0.0734*x3 - 0.0451*x1*x2
        dx3 = 0.0259*x1*x2 - 0.0880*x3 + 0.1111*x0
