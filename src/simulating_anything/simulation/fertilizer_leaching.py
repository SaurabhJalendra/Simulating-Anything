...
class FertilizerLeachingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1151*x1 - 0.0405*x0 + 0.0312*np.sin(0.1001*self._t)
        dx1 = -0.0287*x0*x1 + 0.1046*x2 - 0.0361*x1
        dx2 = 0.0398*x0 - 0.0894*x2 + 0.0555*x3 - 0.0435*x1*x2
        dx3 = 0.0259*x1*x2 - 0.0529*x3 + 0.1097*x0
