...
class BatColonySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0907*x1 - 0.0449*x0 + 0.0476*np.sin(0.0452*self._t)
        dx1 = -0.0603*x0*x1 + 0.0350*x2 - 0.0487*x1
        dx2 = 0.0405*x0 - 0.0924*x2 + 0.0758*x3 - 0.0288*x1*x2
        dx3 = 0.0825*x1*x2 - 0.0255*x3 + 0.0944*x0
