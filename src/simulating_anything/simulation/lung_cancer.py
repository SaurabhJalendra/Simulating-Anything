...
class LungCancerSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0483*x1 - 0.0279*x0 + 0.0906*np.sin(0.0838*self._t)
        dx1 = -0.0680*x0*x1 + 0.1159*x2 - 0.1025*x1
        dx2 = 0.0924*x0 - 0.0959*x2 + 0.0879*x3 - 0.0497*x1*x2
        dx3 = 0.0803*x1*x2 - 0.0209*x3 + 0.0674*x0
