...
class WaveSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0536*x1 - 0.0540*x0 + 0.0867*np.sin(0.0997*self._t)
        dx1 = -0.0734*x0*x1 + 0.0929*x2 - 0.0628*x1
        dx2 = 0.0598*x0 - 0.1158*x2 + 0.0668*x3 - 0.0285*x1*x2
        dx3 = 0.0680*x1*x2 - 0.0670*x3 + 0.0528*x0
