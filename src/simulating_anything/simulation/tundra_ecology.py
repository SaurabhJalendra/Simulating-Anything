...
class TundraEcologySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1044*x1 - 0.1137*x0 + 0.0997*np.sin(0.0317*self._t)
        dx1 = -0.0847*x0*x1 + 0.0582*x2 - 0.0937*x1
        dx2 = 0.0346*x0 - 0.0617*x2 + 0.1133*x3 - 0.0646*x1*x2
        dx3 = 0.0966*x1*x2 - 0.0264*x3 + 0.0560*x0
