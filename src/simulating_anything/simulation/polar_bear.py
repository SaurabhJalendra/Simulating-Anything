...
class PolarBearSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0559*x1 - 0.0705*x0 + 0.0969*np.sin(0.0675*self._t)
        dx1 = -0.0740*x0*x1 + 0.0294*x2 - 0.0943*x1
        dx2 = 0.0341*x0 - 0.1085*x2 + 0.0404*x3 - 0.1031*x1*x2
        dx3 = 0.0875*x1*x2 - 0.0661*x3 + 0.0378*x0
