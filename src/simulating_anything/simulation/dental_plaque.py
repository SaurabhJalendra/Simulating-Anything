...
class DentalPlaqueSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1153*x1 - 0.0398*x0 + 0.1188*np.sin(0.0939*self._t)
        dx1 = -0.0304*x0*x1 + 0.0350*x2 - 0.1150*x1
        dx2 = 0.1186*x0 - 0.0860*x2 + 0.0534*x3 - 0.0452*x1*x2
        dx3 = 0.0652*x1*x2 - 0.1013*x3 + 0.1102*x0
