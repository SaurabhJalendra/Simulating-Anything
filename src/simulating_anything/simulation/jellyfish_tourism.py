...
class JellyfishTourismSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0336*x1 - 0.0578*x0 + 0.1143*np.sin(0.0643*self._t)
        dx1 = -0.0394*x0*x1 + 0.1153*x2 - 0.0210*x1
        dx2 = 0.0964*x0 - 0.0314*x2 + 0.1008*x3 - 0.0937*x1*x2
        dx3 = 0.0604*x1*x2 - 0.0376*x3 + 0.1393*x0
