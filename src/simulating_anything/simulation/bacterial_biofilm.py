...
class BacterialBiofilmSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0903*x1 - 0.0524*x0 + 0.0803*np.sin(0.1026*self._t)
        dx1 = -0.0969*x0*x1 + 0.1113*x2 - 0.0301*x1
        dx2 = 0.0862*x0 - 0.0440*x2 + 0.1060*x3 - 0.0589*x1*x2
        dx3 = 0.0440*x1*x2 - 0.0930*x3 + 0.0200*x0
