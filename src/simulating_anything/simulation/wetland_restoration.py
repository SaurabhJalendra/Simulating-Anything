...
class WetlandRestorationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0975*x1 - 0.0321*x0 + 0.1067*np.sin(0.0837*self._t)
        dx1 = -0.0246*x0*x1 + 0.1148*x2 - 0.1095*x1
        dx2 = 0.0628*x0 - 0.0840*x2 + 0.0562*x3 - 0.0488*x1*x2
        dx3 = 0.0307*x1*x2 - 0.0644*x3 + 0.0648*x0
