...
class EnzymeCatalysisSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0349*x1 - 0.1096*x0 + 0.0644*np.sin(0.0721*self._t)
        dx1 = -0.0809*x0*x1 + 0.0780*x2 - 0.0807*x1
        dx2 = 0.0963*x0 - 0.0350*x2 + 0.0422*x3 - 0.1092*x1*x2
        dx3 = 0.0629*x1*x2 - 0.0930*x3 + 0.0342*x0
