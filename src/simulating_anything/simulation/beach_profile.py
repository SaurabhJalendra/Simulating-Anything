...
class BeachProfileSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1035*x1 - 0.0933*x0 + 0.0775*np.sin(0.0910*self._t)
        dx1 = -0.0456*x0*x1 + 0.0508*x2 - 0.0998*x1
        dx2 = 0.0256*x0 - 0.0949*x2 + 0.0328*x3 - 0.0573*x1*x2
        dx3 = 0.1138*x1*x2 - 0.0993*x3 + 0.0885*x0
