...
class IslandBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1137*x1 - 0.0956*x0 + 0.0576*np.sin(0.1134*self._t)
        dx1 = -0.0897*x0*x1 + 0.0284*x2 - 0.0903*x1
        dx2 = 0.1173*x0 - 0.0829*x2 + 0.1070*x3 - 0.0861*x1*x2
        dx3 = 0.1183*x1*x2 - 0.0959*x3 + 0.0399*x0
