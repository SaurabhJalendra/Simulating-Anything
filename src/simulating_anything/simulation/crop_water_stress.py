...
class CropWaterStressSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0570*x1 - 0.0242*x0 + 0.0309*np.sin(0.1090*self._t)
        dx1 = -0.0608*x0*x1 + 0.0525*x2 - 0.0417*x1
        dx2 = 0.0819*x0 - 0.1011*x2 + 0.0727*x3 - 0.0696*x1*x2
        dx3 = 0.0576*x1*x2 - 0.0500*x3 + 0.0937*x0
