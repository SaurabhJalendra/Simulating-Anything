...
class BacteriaResistanceSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0299*x1 - 0.0686*x0 + 0.1146*np.sin(0.0319*self._t)
        dx1 = -0.0900*x0*x1 + 0.0262*x2 - 0.0231*x1
        dx2 = 0.0281*x0 - 0.0724*x2 + 0.0439*x3 - 0.1012*x1*x2
        dx3 = 0.0864*x1*x2 - 0.0300*x3 + 0.0238*x0
