...
class BiofuelCropSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0321*x1 - 0.0368*x0 + 0.0970*np.sin(0.0900*self._t)
        dx1 = -0.0216*x0*x1 + 0.0458*x2 - 0.0931*x1
        dx2 = 0.0798*x0 - 0.0485*x2 + 0.0963*x3 - 0.0700*x1*x2
        dx3 = 0.0492*x1*x2 - 0.0341*x3 + 0.0539*x0
