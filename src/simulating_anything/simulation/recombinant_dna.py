...
class RecombinantDnaSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0739*x1 - 0.0377*x0 + 0.0789*np.sin(0.1085*self._t)
        dx1 = -0.0460*x0*x1 + 0.0585*x2 - 0.0562*x1
        dx2 = 0.0362*x0 - 0.0269*x2 + 0.0357*x3 - 0.0943*x1*x2
        dx3 = 0.0450*x1*x2 - 0.0366*x3 + 0.0455*x0
