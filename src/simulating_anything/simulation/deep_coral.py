...
class DeepCoralSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0236*x1 - 0.0625*x0 + 0.0778*np.sin(0.0328*self._t)
        dx1 = -0.0720*x0*x1 + 0.1078*x2 - 0.0877*x1
        dx2 = 0.0498*x0 - 0.1049*x2 + 0.1062*x3 - 0.1039*x1*x2
        dx3 = 0.1170*x1*x2 - 0.0724*x3 + 0.1175*x0
