...
class IceShelfCollapseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1012*x1 - 0.1351*x0 + 0.0904*np.sin(0.0423*self._t)
        dx1 = -0.0271*x0*x1 + 0.1050*x2 - 0.1169*x1
        dx2 = 0.1326*x0 - 0.1110*x2 + 0.0976*x3 - 0.0981*x1*x2
        dx3 = 0.0734*x1*x2 - 0.0605*x3 + 0.1056*x0
