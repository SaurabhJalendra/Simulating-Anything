...
class OrganicBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0637*x1 - 0.1159*x0 + 0.0292*np.sin(0.0712*self._t)
        dx1 = -0.1163*x0*x1 + 0.0643*x2 - 0.0253*x1
        dx2 = 0.0712*x0 - 0.0283*x2 + 0.0324*x3 - 0.0357*x1*x2
        dx3 = 0.0497*x1*x2 - 0.0373*x3 + 0.0807*x0
