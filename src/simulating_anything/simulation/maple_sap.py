...
class MapleSapSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0397*x1 - 0.0227*x0 + 0.0768*np.sin(0.0356*self._t)
        dx1 = -0.1350*x0*x1 + 0.0760*x2 - 0.1414*x1
        dx2 = 0.1466*x0 - 0.0962*x2 + 0.1472*x3 - 0.1455*x1*x2
        dx3 = 0.1588*x1*x2 - 0.0257*x3 + 0.0910*x0
