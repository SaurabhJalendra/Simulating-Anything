...
class TropicalCycloneSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0656*x1 - 0.0992*x0 + 0.1167*np.sin(0.0271*self._t)
        dx1 = -0.0888*x0*x1 + 0.0617*x2 - 0.0502*x1
        dx2 = 0.0560*x0 - 0.0331*x2 + 0.0625*x3 - 0.0218*x1*x2
        dx3 = 0.0448*x1*x2 - 0.0383*x3 + 0.0390*x0
