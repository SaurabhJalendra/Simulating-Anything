...
class PlasticRecyclingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1047*x1 - 0.0993*x0 + 0.0839*np.sin(0.1180*self._t)
        dx1 = -0.0982*x0*x1 + 0.0340*x2 - 0.0300*x1
        dx2 = 0.1007*x0 - 0.0512*x2 + 0.0696*x3 - 0.1058*x1*x2
        dx3 = 0.1063*x1*x2 - 0.0893*x3 + 0.0491*x0
