...
class RiverBankErosionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0745*x1 - 0.0616*x0 + 0.0366*np.sin(0.0488*self._t)
        dx1 = -0.1040*x0*x1 + 0.0398*x2 - 0.1189*x1
        dx2 = 0.0239*x0 - 0.1137*x2 + 0.0346*x3 - 0.0252*x1*x2
        dx3 = 0.0661*x1*x2 - 0.0435*x3 + 0.0803*x0
