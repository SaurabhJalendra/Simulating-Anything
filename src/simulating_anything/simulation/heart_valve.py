...
class HeartValveSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0210*x1 - 0.0277*x0 + 0.1054*np.sin(0.0754*self._t)
        dx1 = -0.1071*x0*x1 + 0.1187*x2 - 0.0563*x1
        dx2 = 0.0768*x0 - 0.0587*x2 + 0.1194*x3 - 0.0442*x1*x2
        dx3 = 0.1121*x1*x2 - 0.0863*x3 + 0.0748*x0
