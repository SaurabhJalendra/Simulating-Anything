...
class EarthquakeLiquefactionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1378*x1 - 0.1093*x0 + 0.0719*np.sin(0.1226*self._t)
        dx1 = -0.0264*x0*x1 + 0.1109*x2 - 0.0773*x1
        dx2 = 0.0473*x0 - 0.0310*x2 + 0.0451*x3 - 0.1352*x1*x2
        dx3 = 0.1302*x1*x2 - 0.0300*x3 + 0.0859*x0
