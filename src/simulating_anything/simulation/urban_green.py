...
class UrbanGreenSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0373*x1 - 0.0200*x0 + 0.1137*np.sin(0.0332*self._t)
        dx1 = -0.0276*x0*x1 + 0.0667*x2 - 0.0980*x1
        dx2 = 0.0851*x0 - 0.0352*x2 + 0.0401*x3 - 0.0736*x1*x2
        dx3 = 0.0610*x1*x2 - 0.0875*x3 + 0.0893*x0
