...
class CompostFacilitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0851*x1 - 0.0774*x0 + 0.0373*np.sin(0.0449*self._t)
        dx1 = -0.0990*x0*x1 + 0.0766*x2 - 0.0579*x1
        dx2 = 0.0835*x0 - 0.0653*x2 + 0.1017*x3 - 0.0762*x1*x2
        dx3 = 0.1077*x1*x2 - 0.0400*x3 + 0.0413*x0
