...
class StarFormationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1018*x1 - 0.0582*x0 + 0.1119*np.sin(0.1142*self._t)
        dx1 = -0.1103*x0*x1 + 0.0395*x2 - 0.0444*x1
        dx2 = 0.0359*x0 - 0.0231*x2 + 0.0386*x3 - 0.1184*x1*x2
        dx3 = 0.0897*x1*x2 - 0.0830*x3 + 0.0980*x0
