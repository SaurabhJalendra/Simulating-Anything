...
class DesertCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0367*x1 - 0.0209*x0 + 0.0354*np.sin(0.0544*self._t)
        dx1 = -0.1135*x0*x1 + 0.0648*x2 - 0.0249*x1
        dx2 = 0.1042*x0 - 0.0904*x2 + 0.0771*x3 - 0.0865*x1*x2
        dx3 = 0.0529*x1*x2 - 0.0466*x3 + 0.1126*x0
