...
class VolcanoMonitoringSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0932*x1 - 0.132*x0 + 0.1317*np.sin(0.137*self._t)
        dx1 = -0.0853*x0*x1 + 0.1352*x2 - 0.0514*x1
        dx2 = 0.0565*x0 - 0.1433*x2 + 0.1392*x3 - 0.1323*x1*x2
        dx3 = 0.0337*x1*x2 - 0.0869*x3 + 0.117*x0
