...
class OzoneGroundLevelSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0587*x1 - 0.0650*x0 + 0.0510*np.sin(0.0265*self._t)
        dx1 = -0.0626*x0*x1 + 0.0411*x2 - 0.1196*x1
        dx2 = 0.1063*x0 - 0.0344*x2 + 0.1193*x3 - 0.0635*x1*x2
        dx3 = 0.1068*x1*x2 - 0.0593*x3 + 0.0341*x0
