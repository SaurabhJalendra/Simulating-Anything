...
class PolymerDegradationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0985*x1 - 0.0863*x0 + 0.0490*np.sin(0.0330*self._t)
        dx1 = -0.0948*x0*x1 + 0.0964*x2 - 0.0613*x1
        dx2 = 0.0273*x0 - 0.0374*x2 + 0.0754*x3 - 0.0419*x1*x2
        dx3 = 0.0389*x1*x2 - 0.0674*x3 + 0.0320*x0
