...
class OilSpillCleanupSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0732*x1 - 0.0561*x0 + 0.0277*np.sin(0.0860*self._t)
        dx1 = -0.0841*x0*x1 + 0.0459*x2 - 0.0701*x1
        dx2 = 0.0886*x0 - 0.1070*x2 + 0.0831*x3 - 0.0363*x1*x2
        dx3 = 0.1029*x1*x2 - 0.0539*x3 + 0.0759*x0
