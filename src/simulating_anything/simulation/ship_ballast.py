...
class ShipBallastSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1576*x1 - 0.0891*x0 + 0.1178*np.sin(0.0611*self._t)
        dx1 = -0.0335*x0*x1 + 0.1155*x2 - 0.1446*x1
        dx2 = 0.1424*x0 - 0.124*x2 + 0.0363*x3 - 0.0225*x1*x2
        dx3 = 0.1532*x1*x2 - 0.1203*x3 + 0.1332*x0
