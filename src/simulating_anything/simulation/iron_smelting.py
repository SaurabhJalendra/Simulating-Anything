...
class IronSmeltingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0903*x1 - 0.0763*x0 + 0.0255*np.sin(0.0798*self._t)
        dx1 = -0.0931*x0*x1 + 0.1069*x2 - 0.0490*x1
        dx2 = 0.1101*x0 - 0.0441*x2 + 0.0574*x3 - 0.0503*x1*x2
        dx3 = 0.0372*x1*x2 - 0.0319*x3 + 0.0419*x0
