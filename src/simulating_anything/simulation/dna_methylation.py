...
class DnaMethylationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0846*x1 - 0.0490*x0 + 0.0998*np.sin(0.1199*self._t)
        dx1 = -0.0477*x0*x1 + 0.0257*x2 - 0.0726*x1
        dx2 = 0.0399*x0 - 0.0781*x2 + 0.1046*x3 - 0.0591*x1*x2
        dx3 = 0.0571*x1*x2 - 0.0531*x3 + 0.1017*x0
