...
class SlashBurnSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1268*x1 - 0.0314*x0 + 0.0748*np.sin(0.0375*self._t)
        dx1 = -0.1163*x0*x1 + 0.0982*x2 - 0.0230*x1
        dx2 = 0.0750*x0 - 0.0204*x2 + 0.1216*x3 - 0.0811*x1*x2
        dx3 = 0.0335*x1*x2 - 0.0480*x3 + 0.0516*x0
