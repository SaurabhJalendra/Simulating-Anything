...
class PrairieRestorationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0484*x1 - 0.0890*x0 + 0.0550*np.sin(0.1063*self._t)
        dx1 = -0.0869*x0*x1 + 0.0554*x2 - 0.0630*x1
        dx2 = 0.0368*x0 - 0.0993*x2 + 0.0434*x3 - 0.0427*x1*x2
        dx3 = 0.0708*x1*x2 - 0.1119*x3 + 0.0543*x0
