...
class CholesterolMetabolismSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0777*x1 - 0.1048*x0 + 0.0930*np.sin(0.0342*self._t)
        dx1 = -0.1184*x0*x1 + 0.0642*x2 - 0.0528*x1
        dx2 = 0.0367*x0 - 0.0873*x2 + 0.0488*x3 - 0.0820*x1*x2
        dx3 = 0.1154*x1*x2 - 0.0367*x3 + 0.1029*x0
