...
class LeadExposureSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0605*x1 - 0.0342*x0 + 0.1116*np.sin(0.1188*self._t)
        dx1 = -0.0811*x0*x1 + 0.0617*x2 - 0.0466*x1
        dx2 = 0.0926*x0 - 0.1173*x2 + 0.0742*x3 - 0.0242*x1*x2
        dx3 = 0.0420*x1*x2 - 0.0483*x3 + 0.0688*x0
