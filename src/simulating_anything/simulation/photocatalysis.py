...
class PhotocatalysisSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1015*x1 - 0.0203*x0 + 0.0637*np.sin(0.1187*self._t)
        dx1 = -0.0767*x0*x1 + 0.0569*x2 - 0.1084*x1
        dx2 = 0.1151*x0 - 0.0263*x2 + 0.0801*x3 - 0.0300*x1*x2
        dx3 = 0.0803*x1*x2 - 0.0599*x3 + 0.0564*x0
