...
class MolecularMotorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0216*x1 - 0.0619*x0 + 0.0533*np.sin(0.0885*self._t)
        dx1 = -0.0843*x0*x1 + 0.0968*x2 - 0.0393*x1
        dx2 = 0.0742*x0 - 0.0637*x2 + 0.0292*x3 - 0.0684*x1*x2
        dx3 = 0.1197*x1*x2 - 0.0392*x3 + 0.1018*x0
