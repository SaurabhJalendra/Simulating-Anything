...
class AsthmaPollutionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0438*x1 - 0.0533*x0 + 0.0862*np.sin(0.0810*self._t)
        dx1 = -0.1011*x0*x1 + 0.0743*x2 - 0.0658*x1
        dx2 = 0.0807*x0 - 0.1097*x2 + 0.0937*x3 - 0.0207*x1*x2
        dx3 = 0.0608*x1*x2 - 0.0998*x3 + 0.0399*x0
