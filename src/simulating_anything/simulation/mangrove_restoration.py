...
class MangroveRestorationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0704*x1 - 0.1098*x0 + 0.0716*np.sin(0.0484*self._t)
        dx1 = -0.0745*x0*x1 + 0.0767*x2 - 0.0358*x1
        dx2 = 0.0952*x0 - 0.0524*x2 + 0.0306*x3 - 0.0592*x1*x2
        dx3 = 0.0715*x1*x2 - 0.0220*x3 + 0.0321*x0
