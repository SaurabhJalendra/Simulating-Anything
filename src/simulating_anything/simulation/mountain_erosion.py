...
class MountainErosionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.03*x1 - 0.0946*x0 + 0.0239*np.sin(0.1287*self._t)
        dx1 = -0.0421*x0*x1 + 0.1635*x2 - 0.1179*x1
        dx2 = 0.0268*x0 - 0.0505*x2 + 0.0651*x3 - 0.094*x1*x2
        dx3 = 0.0535*x1*x2 - 0.1428*x3 + 0.1154*x0
