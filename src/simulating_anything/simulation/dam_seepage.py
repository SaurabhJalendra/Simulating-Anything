...
class DamSeepageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0901*x1 - 0.1060*x0 + 0.0683*np.sin(0.0830*self._t)
        dx1 = -0.0628*x0*x1 + 0.0338*x2 - 0.0598*x1
        dx2 = 0.0870*x0 - 0.1158*x2 + 0.0457*x3 - 0.1062*x1*x2
        dx3 = 0.1151*x1*x2 - 0.0887*x3 + 0.1087*x0
