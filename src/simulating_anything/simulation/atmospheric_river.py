...
class AtmosphericRiverSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0725*x1 - 0.0396*x0 + 0.0234*np.sin(0.0774*self._t)
        dx1 = -0.1529*x0*x1 + 0.0624*x2 - 0.1473*x1
        dx2 = 0.0963*x0 - 0.1016*x2 + 0.0367*x3 - 0.0631*x1*x2
        dx3 = 0.0431*x1*x2 - 0.1607*x3 + 0.1684*x0
