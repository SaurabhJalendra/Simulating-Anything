...
class FoodWebCollapseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0372*x1 - 0.1307*x0 + 0.1621*np.sin(0.0822*self._t)
        dx1 = -0.1271*x0*x1 + 0.1128*x2 - 0.1258*x1
        dx2 = 0.1618*x0 - 0.0313*x2 + 0.0905*x3 - 0.0438*x1*x2
        dx3 = 0.0284*x1*x2 - 0.0631*x3 + 0.0856*x0
