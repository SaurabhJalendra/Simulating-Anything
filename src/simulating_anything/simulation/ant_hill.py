...
class AntHillSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0429*x1 - 0.0788*x0 + 0.0432*np.sin(0.0950*self._t)
        dx1 = -0.0632*x0*x1 + 0.0259*x2 - 0.0210*x1
        dx2 = 0.1187*x0 - 0.0727*x2 + 0.0607*x3 - 0.0455*x1*x2
        dx3 = 0.0600*x1*x2 - 0.0208*x3 + 0.0671*x0
