...
class CondensationNucleiSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1192*x1 - 0.0726*x0 + 0.0258*np.sin(0.0211*self._t)
        dx1 = -0.0908*x0*x1 + 0.0977*x2 - 0.0213*x1
        dx2 = 0.0619*x0 - 0.0807*x2 + 0.0603*x3 - 0.0267*x1*x2
        dx3 = 0.0454*x1*x2 - 0.0460*x3 + 0.0448*x0
