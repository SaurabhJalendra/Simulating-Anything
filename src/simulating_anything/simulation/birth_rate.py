...
class BirthRateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0975*x1 - 0.0930*x0 + 0.0264*np.sin(0.0415*self._t)
        dx1 = -0.0202*x0*x1 + 0.0817*x2 - 0.0656*x1
        dx2 = 0.0491*x0 - 0.1155*x2 + 0.0668*x3 - 0.0946*x1*x2
        dx3 = 0.0525*x1*x2 - 0.0747*x3 + 0.0487*x0
