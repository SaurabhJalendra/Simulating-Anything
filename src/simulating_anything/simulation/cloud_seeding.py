...
class CloudSeedingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0984*x1 - 0.0698*x0 + 0.0339*np.sin(0.1085*self._t)
        dx1 = -0.1592*x0*x1 + 0.0523*x2 - 0.1499*x1
        dx2 = 0.1208*x0 - 0.1215*x2 + 0.1124*x3 - 0.0881*x1*x2
        dx3 = 0.1383*x1*x2 - 0.1642*x3 + 0.1157*x0
