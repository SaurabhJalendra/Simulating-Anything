...
class MangroveCarbonStorageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0993*x1 - 0.0480*x0 + 0.0690*np.sin(0.0546*self._t)
        dx1 = -0.0810*x0*x1 + 0.0236*x2 - 0.0635*x1
        dx2 = 0.0861*x0 - 0.0292*x2 + 0.1184*x3 - 0.0626*x1*x2
        dx3 = 0.0434*x1*x2 - 0.1050*x3 + 0.0325*x0
