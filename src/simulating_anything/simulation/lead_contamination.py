...
class LeadContaminationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1054*x1 - 0.0727*x0 + 0.0345*np.sin(0.0960*self._t)
        dx1 = -0.0403*x0*x1 + 0.0262*x2 - 0.0421*x1
        dx2 = 0.1005*x0 - 0.1090*x2 + 0.0919*x3 - 0.1066*x1*x2
        dx3 = 0.0815*x1*x2 - 0.0957*x3 + 0.0679*x0
