...
class DeerPopulationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0418*x1 - 0.0483*x0 + 0.0747*np.sin(0.0238*self._t)
        dx1 = -0.0615*x0*x1 + 0.0528*x2 - 0.0318*x1
        dx2 = 0.1029*x0 - 0.1073*x2 + 0.0898*x3 - 0.0266*x1*x2
        dx3 = 0.0491*x1*x2 - 0.0380*x3 + 0.0358*x0
