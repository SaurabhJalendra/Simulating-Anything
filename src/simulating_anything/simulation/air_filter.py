...
class AirFilterSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1000*x1 - 0.0869*x0 + 0.0920*np.sin(0.0437*self._t)
        dx1 = -0.0431*x0*x1 + 0.0753*x2 - 0.0948*x1
        dx2 = 0.0460*x0 - 0.0218*x2 + 0.0992*x3 - 0.0876*x1*x2
        dx3 = 0.1199*x1*x2 - 0.0878*x3 + 0.0967*x0
