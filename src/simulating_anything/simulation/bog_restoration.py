...
class BogRestorationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0553*x1 - 0.0435*x0 + 0.0805*np.sin(0.0282*self._t)
        dx1 = -0.0760*x0*x1 + 0.1026*x2 - 0.0750*x1
        dx2 = 0.0970*x0 - 0.1114*x2 + 0.0231*x3 - 0.0566*x1*x2
        dx3 = 0.0527*x1*x2 - 0.1027*x3 + 0.0432*x0
