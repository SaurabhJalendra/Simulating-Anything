...
class WetlandBirdSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0885*x1 - 0.0497*x0 + 0.0278*np.sin(0.1558*self._t)
        dx1 = -0.0753*x0*x1 + 0.057*x2 - 0.1151*x1
        dx2 = 0.0912*x0 - 0.1156*x2 + 0.0844*x3 - 0.1266*x1*x2
        dx3 = 0.0298*x1*x2 - 0.1472*x3 + 0.1268*x0
