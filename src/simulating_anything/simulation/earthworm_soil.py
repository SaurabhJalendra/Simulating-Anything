...
class EarthwormSoilSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0327*x1 - 0.1474*x0 + 0.1523*np.sin(0.0516*self._t)
        dx1 = -0.0275*x0*x1 + 0.0902*x2 - 0.1107*x1
        dx2 = 0.1268*x0 - 0.0537*x2 + 0.1601*x3 - 0.1498*x1*x2
        dx3 = 0.0299*x1*x2 - 0.0693*x3 + 0.0240*x0
