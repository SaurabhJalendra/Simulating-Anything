...
class CommensalBacteriaSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0328*x1 - 0.0619*x0 + 0.0930*np.sin(0.1015*self._t)
        dx1 = -0.0206*x0*x1 + 0.1095*x2 - 0.1097*x1
        dx2 = 0.0395*x0 - 0.0555*x2 + 0.0758*x3 - 0.0851*x1*x2
        dx3 = 0.0616*x1*x2 - 0.0688*x3 + 0.0948*x0
