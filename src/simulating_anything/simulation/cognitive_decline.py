...
class CognitiveDeclineSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0703*x1 - 0.0519*x0 + 0.1062*np.sin(0.0310*self._t)
        dx1 = -0.0282*x0*x1 + 0.0248*x2 - 0.1114*x1
        dx2 = 0.0371*x0 - 0.0669*x2 + 0.1075*x3 - 0.0542*x1*x2
        dx3 = 0.0901*x1*x2 - 0.0319*x3 + 0.1145*x0
