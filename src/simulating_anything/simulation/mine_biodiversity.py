...
class MineBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0890*x1 - 0.0203*x0 + 0.1100*np.sin(0.0663*self._t)
        dx1 = -0.0854*x0*x1 + 0.0353*x2 - 0.0276*x1
        dx2 = 0.0958*x0 - 0.1148*x2 + 0.1076*x3 - 0.0460*x1*x2
        dx3 = 0.0538*x1*x2 - 0.0688*x3 + 0.0650*x0
