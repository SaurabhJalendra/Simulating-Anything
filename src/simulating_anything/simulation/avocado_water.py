...
class AvocadoWaterSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1156*x1 - 0.0951*x0 + 0.0496*np.sin(0.0282*self._t)
        dx1 = -0.0563*x0*x1 + 0.1108*x2 - 0.0867*x1
        dx2 = 0.1093*x0 - 0.1124*x2 + 0.0498*x3 - 0.0457*x1*x2
        dx3 = 0.0410*x1*x2 - 0.0766*x3 + 0.0647*x0
