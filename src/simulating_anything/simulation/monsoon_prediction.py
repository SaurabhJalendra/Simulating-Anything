...
class MonsoonPredictionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1498*x1 - 0.0838*x0 + 0.0581*np.sin(0.1596*self._t)
        dx1 = -0.0531*x0*x1 + 0.0718*x2 - 0.0933*x1
        dx2 = 0.1252*x0 - 0.1194*x2 + 0.1491*x3 - 0.0757*x1*x2
        dx3 = 0.1353*x1*x2 - 0.1296*x3 + 0.0564*x0
