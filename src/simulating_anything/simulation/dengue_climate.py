...
class DengueClimateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0437*x1 - 0.0805*x0 + 0.0261*np.sin(0.0406*self._t)
        dx1 = -0.1074*x0*x1 + 0.0901*x2 - 0.0432*x1
        dx2 = 0.0828*x0 - 0.1035*x2 + 0.0321*x3 - 0.0962*x1*x2
        dx3 = 0.0724*x1*x2 - 0.0969*x3 + 0.0585*x0
