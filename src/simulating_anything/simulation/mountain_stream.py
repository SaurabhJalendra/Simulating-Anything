...
class MountainStreamSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0987*x1 - 0.1414*x0 + 0.0834*np.sin(0.0665*self._t)
        dx1 = -0.1614*x0*x1 + 0.0376*x2 - 0.0523*x1
        dx2 = 0.0390*x0 - 0.1093*x2 + 0.1480*x3 - 0.1071*x1*x2
        dx3 = 0.1455*x1*x2 - 0.0777*x3 + 0.0753*x0
