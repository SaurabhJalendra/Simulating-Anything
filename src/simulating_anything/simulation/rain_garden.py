...
class RainGardenSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1169*x1 - 0.0784*x0 + 0.0356*np.sin(0.0889*self._t)
        dx1 = -0.1057*x0*x1 + 0.1030*x2 - 0.1172*x1
        dx2 = 0.0331*x0 - 0.0751*x2 + 0.1015*x3 - 0.0908*x1*x2
        dx3 = 0.0897*x1*x2 - 0.0236*x3 + 0.0547*x0
