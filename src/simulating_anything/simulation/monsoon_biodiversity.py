...
class MonsoonBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0518*x1 - 0.0964*x0 + 0.0816*np.sin(0.0264*self._t)
        dx1 = -0.1036*x0*x1 + 0.1063*x2 - 0.0717*x1
        dx2 = 0.0696*x0 - 0.0577*x2 + 0.0432*x3 - 0.0742*x1*x2
        dx3 = 0.0507*x1*x2 - 0.0824*x3 + 0.0216*x0
