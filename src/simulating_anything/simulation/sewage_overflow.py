...
class SewageOverflowSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0359*x1 - 0.0547*x0 + 0.1053*np.sin(0.0795*self._t)
        dx1 = -0.0736*x0*x1 + 0.1108*x2 - 0.1078*x1
        dx2 = 0.0369*x0 - 0.0530*x2 + 0.0574*x3 - 0.1036*x1*x2
        dx3 = 0.1046*x1*x2 - 0.0595*x3 + 0.0948*x0
