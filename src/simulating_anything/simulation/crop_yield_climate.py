...
class CropYieldClimateSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1161*x1 - 0.1161*x0 + 0.0929*np.sin(0.0823*self._t)
        dx1 = -0.1061*x0*x1 + 0.0659*x2 - 0.0530*x1
        dx2 = 0.0959*x0 - 0.0592*x2 + 0.1084*x3 - 0.0425*x1*x2
        dx3 = 0.0260*x1*x2 - 0.0454*x3 + 0.0656*x0
