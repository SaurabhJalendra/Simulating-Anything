...
class RainwaterHarvestSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0914*x1 - 0.0804*x0 + 0.1055*np.sin(0.1002*self._t)
        dx1 = -0.0845*x0*x1 + 0.0627*x2 - 0.0513*x1
        dx2 = 0.0359*x0 - 0.0585*x2 + 0.0859*x3 - 0.0242*x1*x2
        dx3 = 0.0518*x1*x2 - 0.0838*x3 + 0.0793*x0
