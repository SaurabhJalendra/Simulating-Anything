...
class SootEmissionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0318*x1 - 0.0576*x0 + 0.1138*np.sin(0.0313*self._t)
        dx1 = -0.0357*x0*x1 + 0.1070*x2 - 0.0568*x1
        dx2 = 0.0772*x0 - 0.0983*x2 + 0.0912*x3 - 0.0716*x1*x2
        dx3 = 0.0478*x1*x2 - 0.1065*x3 + 0.0950*x0
