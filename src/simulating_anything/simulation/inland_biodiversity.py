...
class InlandBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1010*x1 - 0.0948*x0 + 0.0369*np.sin(0.0913*self._t)
        dx1 = -0.0606*x0*x1 + 0.0890*x2 - 0.0596*x1
        dx2 = 0.1089*x0 - 0.0733*x2 + 0.0389*x3 - 0.0231*x1*x2
        dx3 = 0.0470*x1*x2 - 0.0387*x3 + 0.0592*x0
