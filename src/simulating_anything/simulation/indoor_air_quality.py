...
class IndoorAirQualitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0378*x1 - 0.0544*x0 + 0.0615*np.sin(0.0556*self._t)
        dx1 = -0.0887*x0*x1 + 0.0322*x2 - 0.0939*x1
        dx2 = 0.0608*x0 - 0.1199*x2 + 0.0328*x3 - 0.0342*x1*x2
        dx3 = 0.0485*x1*x2 - 0.0560*x3 + 0.0613*x0
