...
class CassavaDiseaseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0464*x1 - 0.1037*x0 + 0.0245*np.sin(0.0768*self._t)
        dx1 = -0.0521*x0*x1 + 0.0983*x2 - 0.0924*x1
        dx2 = 0.0582*x0 - 0.0679*x2 + 0.0704*x3 - 0.1137*x1*x2
        dx3 = 0.1030*x1*x2 - 0.0852*x3 + 0.0491*x0
