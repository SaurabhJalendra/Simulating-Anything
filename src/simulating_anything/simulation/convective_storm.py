...
class ConvectiveStormSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0673*x1 - 0.0974*x0 + 0.0873*np.sin(0.0424*self._t)
        dx1 = -0.0962*x0*x1 + 0.0994*x2 - 0.1116*x1
        dx2 = 0.0264*x0 - 0.0630*x2 + 0.0807*x3 - 0.0765*x1*x2
        dx3 = 0.0916*x1*x2 - 0.1037*x3 + 0.0514*x0
