...
class RainfallErosionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1443*x1 - 0.0841*x0 + 0.1671*np.sin(0.1433*self._t)
        dx1 = -0.1413*x0*x1 + 0.0261*x2 - 0.1026*x1
        dx2 = 0.1020*x0 - 0.1064*x2 + 0.0927*x3 - 0.1089*x1*x2
        dx3 = 0.0324*x1*x2 - 0.0868*x3 + 0.0541*x0
