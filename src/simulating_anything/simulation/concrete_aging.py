...
class ConcreteAgingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1042*x1 - 0.0655*x0 + 0.0537*np.sin(0.1100*self._t)
        dx1 = -0.0742*x0*x1 + 0.0280*x2 - 0.1155*x1
        dx2 = 0.0871*x0 - 0.0556*x2 + 0.0438*x3 - 0.0287*x1*x2
        dx3 = 0.0930*x1*x2 - 0.0474*x3 + 0.0491*x0
