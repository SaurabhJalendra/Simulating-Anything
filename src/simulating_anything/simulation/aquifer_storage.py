...
class AquiferStorageSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0264*x1 - 0.1112*x0 + 0.0988*np.sin(0.0417*self._t)
        dx1 = -0.0843*x0*x1 + 0.0974*x2 - 0.1079*x1
        dx2 = 0.0762*x0 - 0.0484*x2 + 0.0232*x3 - 0.1098*x1*x2
        dx3 = 0.0393*x1*x2 - 0.0277*x3 + 0.0571*x0
