...
class BearHibernationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0872*x1 - 0.1043*x0 + 0.0208*np.sin(0.0973*self._t)
        dx1 = -0.0630*x0*x1 + 0.0749*x2 - 0.0387*x1
        dx2 = 0.0598*x0 - 0.0788*x2 + 0.0892*x3 - 0.1052*x1*x2
        dx3 = 0.0681*x1*x2 - 0.0957*x3 + 0.0887*x0
