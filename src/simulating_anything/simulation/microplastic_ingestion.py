...
class MicroplasticIngestionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1316*x1 - 0.1070*x0 + 0.1694*np.sin(0.1594*self._t)
        dx1 = -0.0733*x0*x1 + 0.0428*x2 - 0.0446*x1
        dx2 = 0.1085*x0 - 0.0722*x2 + 0.1664*x3 - 0.0895*x1*x2
        dx3 = 0.1348*x1*x2 - 0.1170*x3 + 0.1646*x0
