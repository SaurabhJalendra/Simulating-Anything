...
class RockyCarbonFluxSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0212*x1 - 0.0929*x0 + 0.0217*np.sin(0.0430*self._t)
        dx1 = -0.0842*x0*x1 + 0.0700*x2 - 0.0534*x1
        dx2 = 0.0683*x0 - 0.0608*x2 + 0.0708*x3 - 0.0939*x1*x2
        dx3 = 0.0950*x1*x2 - 0.0377*x3 + 0.0785*x0
