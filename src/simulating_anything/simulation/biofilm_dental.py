...
class BiofilmDentalSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0580*x1 - 0.0878*x0 + 0.0589*np.sin(0.0811*self._t)
        dx1 = -0.0966*x0*x1 + 0.1112*x2 - 0.0351*x1
        dx2 = 0.1177*x0 - 0.1088*x2 + 0.1132*x3 - 0.0324*x1*x2
        dx3 = 0.0955*x1*x2 - 0.0992*x3 + 0.0940*x0
