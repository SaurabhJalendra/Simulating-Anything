...
class ImmuneResponseSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0852*x1 - 0.0681*x0 + 0.0991*np.sin(0.0463*self._t)
        dx1 = -0.0497*x0*x1 + 0.0571*x2 - 0.0505*x1
        dx2 = 0.1146*x0 - 0.0273*x2 + 0.0401*x3 - 0.0795*x1*x2
        dx3 = 0.1000*x1*x2 - 0.0807*x3 + 0.0913*x0
