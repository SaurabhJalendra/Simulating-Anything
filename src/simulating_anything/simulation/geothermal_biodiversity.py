...
class GeothermalBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0625*x1 - 0.1156*x0 + 0.0642*np.sin(0.0891*self._t)
        dx1 = -0.0606*x0*x1 + 0.0247*x2 - 0.0329*x1
        dx2 = 0.0851*x0 - 0.0844*x2 + 0.0834*x3 - 0.0888*x1*x2
        dx3 = 0.0952*x1*x2 - 0.0891*x3 + 0.1032*x0
