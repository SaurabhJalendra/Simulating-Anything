...
class BivalveFiltrationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0983*x1 - 0.0860*x0 + 0.0452*np.sin(0.0998*self._t)
        dx1 = -0.1080*x0*x1 + 0.0650*x2 - 0.0499*x1
        dx2 = 0.0962*x0 - 0.0267*x2 + 0.0394*x3 - 0.0927*x1*x2
        dx3 = 0.0328*x1*x2 - 0.0396*x3 + 0.0402*x0
