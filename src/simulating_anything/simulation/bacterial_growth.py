...
class BacterialGrowthSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1306*x1 - 0.0998*x0 + 0.0953*np.sin(0.0729*self._t)
        dx1 = -0.0882*x0*x1 + 0.0760*x2 - 0.1087*x1
        dx2 = 0.0828*x0 - 0.0585*x2 + 0.0272*x3 - 0.0269*x1*x2
        dx3 = 0.0596*x1*x2 - 0.1078*x3 + 0.0947*x0
