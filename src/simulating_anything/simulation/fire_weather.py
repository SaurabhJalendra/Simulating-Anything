...
class FireWeatherSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0642*x1 - 0.0663*x0 + 0.0476*np.sin(0.0215*self._t)
        dx1 = -0.0279*x0*x1 + 0.0547*x2 - 0.0556*x1
        dx2 = 0.0929*x0 - 0.0938*x2 + 0.1198*x3 - 0.0337*x1*x2
        dx3 = 0.0593*x1*x2 - 0.0297*x3 + 0.0662*x0
