...
class KidneyStoneSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1068*x1 - 0.0745*x0 + 0.0230*np.sin(0.1150*self._t)
        dx1 = -0.0678*x0*x1 + 0.1183*x2 - 0.0273*x1
        dx2 = 0.1071*x0 - 0.0460*x2 + 0.0619*x3 - 0.0908*x1*x2
        dx3 = 0.0921*x1*x2 - 0.1057*x3 + 0.1099*x0
