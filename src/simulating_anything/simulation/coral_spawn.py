...
class CoralSpawnSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1122*x1 - 0.0970*x0 + 0.0276*np.sin(0.0223*self._t)
        dx1 = -0.1069*x0*x1 + 0.0469*x2 - 0.0300*x1
        dx2 = 0.0346*x0 - 0.0286*x2 + 0.0943*x3 - 0.0953*x1*x2
        dx3 = 0.0671*x1*x2 - 0.0517*x3 + 0.0619*x0
