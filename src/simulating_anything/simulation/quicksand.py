...
class QuicksandSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1404*x1 - 0.0413*x0 + 0.1283*np.sin(0.0314*self._t)
        dx1 = -0.0459*x0*x1 + 0.0802*x2 - 0.0782*x1
        dx2 = 0.0725*x0 - 0.0569*x2 + 0.0956*x3 - 0.1487*x1*x2
        dx3 = 0.1435*x1*x2 - 0.0930*x3 + 0.0401*x0
