...
class CoralRecruitmentSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0317*x1 - 0.0499*x0 + 0.071*np.sin(0.1621*self._t)
        dx1 = -0.1527*x0*x1 + 0.1424*x2 - 0.1014*x1
        dx2 = 0.0744*x0 - 0.1291*x2 + 0.085*x3 - 0.1675*x1*x2
        dx3 = 0.1219*x1*x2 - 0.1649*x3 + 0.1652*x0
