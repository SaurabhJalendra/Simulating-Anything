...
class AcornGerminationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0323*x1 - 0.0873*x0 + 0.0800*np.sin(0.0709*self._t)
        dx1 = -0.0294*x0*x1 + 0.1059*x2 - 0.0594*x1
        dx2 = 0.1181*x0 - 0.0596*x2 + 0.1126*x3 - 0.0623*x1*x2
        dx3 = 0.1146*x1*x2 - 0.0645*x3 + 0.0847*x0
