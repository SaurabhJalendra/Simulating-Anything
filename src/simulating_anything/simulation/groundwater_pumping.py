...
class GroundwaterPumpingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1169*x1 - 0.0845*x0 + 0.0237*np.sin(0.1484*self._t)
        dx1 = -0.0528*x0*x1 + 0.1054*x2 - 0.154*x1
        dx2 = 0.0577*x0 - 0.0899*x2 + 0.098*x3 - 0.0651*x1*x2
        dx3 = 0.0982*x1*x2 - 0.1222*x3 + 0.1139*x0
