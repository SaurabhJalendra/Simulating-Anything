...
class AntioxidantSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0913*x1 - 0.0378*x0 + 0.0566*np.sin(0.0426*self._t)
        dx1 = -0.0416*x0*x1 + 0.0608*x2 - 0.0237*x1
        dx2 = 0.1165*x0 - 0.1046*x2 + 0.0511*x3 - 0.1064*x1*x2
        dx3 = 0.0452*x1*x2 - 0.0382*x3 + 0.0420*x0
