...
class IrrigationEfficiencySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0929*x1 - 0.1188*x0 + 0.1200*np.sin(0.1119*self._t)
        dx1 = -0.0581*x0*x1 + 0.1252*x2 - 0.0654*x1
        dx2 = 0.1120*x0 - 0.1384*x2 + 0.0309*x3 - 0.0557*x1*x2
        dx3 = 0.0723*x1*x2 - 0.1040*x3 + 0.0816*x0
