...
class SpiderWebSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1010*x1 - 0.0632*x0 + 0.0347*np.sin(0.0320*self._t)
        dx1 = -0.1020*x0*x1 + 0.0525*x2 - 0.0313*x1
        dx2 = 0.0425*x0 - 0.0523*x2 + 0.0899*x3 - 0.0393*x1*x2
        dx3 = 0.0860*x1*x2 - 0.0812*x3 + 0.0788*x0
