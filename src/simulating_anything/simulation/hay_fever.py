...
class HayFeverSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0750*x1 - 0.1028*x0 + 0.0546*np.sin(0.0219*self._t)
        dx1 = -0.0315*x0*x1 + 0.0681*x2 - 0.1591*x1
        dx2 = 0.1335*x0 - 0.0238*x2 + 0.0680*x3 - 0.1010*x1*x2
        dx3 = 0.1381*x1*x2 - 0.1442*x3 + 0.1571*x0
