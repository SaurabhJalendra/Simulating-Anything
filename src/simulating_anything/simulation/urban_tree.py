...
class UrbanTreeSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0344*x1 - 0.0875*x0 + 0.0564*np.sin(0.0870*self._t)
        dx1 = -0.0454*x0*x1 + 0.0309*x2 - 0.0245*x1
        dx2 = 0.0381*x0 - 0.0469*x2 + 0.0811*x3 - 0.0630*x1*x2
        dx3 = 0.0495*x1*x2 - 0.0974*x3 + 0.1158*x0
