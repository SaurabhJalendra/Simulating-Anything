...
class LavaCoolingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0442*x1 - 0.0538*x0 + 0.0976*np.sin(0.0532*self._t)
        dx1 = -0.0688*x0*x1 + 0.0264*x2 - 0.1102*x1
        dx2 = 0.0643*x0 - 0.0586*x2 + 0.0784*x3 - 0.0442*x1*x2
        dx3 = 0.0794*x1*x2 - 0.0416*x3 + 0.0524*x0
