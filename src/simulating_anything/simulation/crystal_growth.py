...
class CrystalGrowthSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0419*x1 - 0.0406*x0 + 0.1055*np.sin(0.0281*self._t)
        dx1 = -0.0431*x0*x1 + 0.0798*x2 - 0.0551*x1
        dx2 = 0.0533*x0 - 0.0484*x2 + 0.0611*x3 - 0.1127*x1*x2
        dx3 = 0.0919*x1*x2 - 0.1140*x3 + 0.0919*x0
