...
class GlacierRetreatSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1311*x1 - 0.1618*x0 + 0.0358*np.sin(0.0275*self._t)
        dx1 = -0.1026*x0*x1 + 0.0505*x2 - 0.1199*x1
        dx2 = 0.0242*x0 - 0.0987*x2 + 0.0313*x3 - 0.14*x1*x2
        dx3 = 0.0379*x1*x2 - 0.1348*x3 + 0.1303*x0
