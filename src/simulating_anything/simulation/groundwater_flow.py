...
class GroundwaterFlowSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0577*x1 - 0.1594*x0 + 0.0604*np.sin(0.1497*self._t)
        dx1 = -0.1537*x0*x1 + 0.0623*x2 - 0.0691*x1
        dx2 = 0.1310*x0 - 0.1405*x2 + 0.0976*x3 - 0.0347*x1*x2
        dx3 = 0.0985*x1*x2 - 0.0258*x3 + 0.1421*x0
