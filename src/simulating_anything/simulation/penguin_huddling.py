...
class PenguinHuddlingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0211*x1 - 0.0555*x0 + 0.0293*np.sin(0.1418*self._t)
        dx1 = -0.0692*x0*x1 + 0.1411*x2 - 0.0499*x1
        dx2 = 0.1454*x0 - 0.0851*x2 + 0.1163*x3 - 0.0898*x1*x2
        dx3 = 0.1121*x1*x2 - 0.0872*x3 + 0.1254*x0
