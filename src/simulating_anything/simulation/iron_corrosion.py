...
class IronCorrosionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1052*x1 - 0.1251*x0 + 0.1341*np.sin(0.0985*self._t)
        dx1 = -0.0763*x0*x1 + 0.0748*x2 - 0.0669*x1
        dx2 = 0.1454*x0 - 0.0588*x2 + 0.0978*x3 - 0.0497*x1*x2
        dx3 = 0.0694*x1*x2 - 0.1292*x3 + 0.1200*x0
