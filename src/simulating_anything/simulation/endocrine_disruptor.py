...
class EndocrineDisruptorSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0753*x1 - 0.0878*x0 + 0.0257*np.sin(0.0975*self._t)
        dx1 = -0.0401*x0*x1 + 0.0556*x2 - 0.0297*x1
        dx2 = 0.0396*x0 - 0.1042*x2 + 0.1046*x3 - 0.0984*x1*x2
        dx3 = 0.1120*x1*x2 - 0.0427*x3 + 0.0326*x0
