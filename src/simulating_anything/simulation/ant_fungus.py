...
class AntFungusSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0220*x1 - 0.0560*x0 + 0.0202*np.sin(0.1070*self._t)
        dx1 = -0.0554*x0*x1 + 0.0526*x2 - 0.0544*x1
        dx2 = 0.0917*x0 - 0.0445*x2 + 0.0520*x3 - 0.1039*x1*x2
        dx3 = 0.0335*x1*x2 - 0.0812*x3 + 0.1053*x0
