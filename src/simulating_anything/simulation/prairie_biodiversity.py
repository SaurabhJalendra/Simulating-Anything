...
class PrairieBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0741*x1 - 0.0905*x0 + 0.0437*np.sin(0.0729*self._t)
        dx1 = -0.0298*x0*x1 + 0.0837*x2 - 0.1182*x1
        dx2 = 0.0797*x0 - 0.0679*x2 + 0.1017*x3 - 0.1185*x1*x2
        dx3 = 0.0348*x1*x2 - 0.0878*x3 + 0.1083*x0
