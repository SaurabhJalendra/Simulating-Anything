...
class BatteryThermalManagementSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1129*x1 - 0.0359*x0 + 0.0728*np.sin(0.1021*self._t)
        dx1 = -0.0327*x0*x1 + 0.0271*x2 - 0.1108*x1
        dx2 = 0.0665*x0 - 0.0350*x2 + 0.0582*x3 - 0.0207*x1*x2
        dx3 = 0.1179*x1*x2 - 0.0602*x3 + 0.0919*x0
