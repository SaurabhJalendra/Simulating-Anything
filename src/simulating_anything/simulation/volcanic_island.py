...
class VolcanicIslandSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0467*x1 - 0.0223*x0 + 0.1131*np.sin(0.0405*self._t)
        dx1 = -0.0525*x0*x1 + 0.0478*x2 - 0.0628*x1
        dx2 = 0.0963*x0 - 0.1106*x2 + 0.0943*x3 - 0.0546*x1*x2
        dx3 = 0.0651*x1*x2 - 0.0952*x3 + 0.0921*x0
