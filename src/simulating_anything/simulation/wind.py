...
class WindSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0607*x1 - 0.0974*x0 + 0.0547*np.sin(0.0567*self._t)
        dx1 = -0.0229*x0*x1 + 0.0937*x2 - 0.0339*x1
        dx2 = 0.0882*x0 - 0.0229*x2 + 0.0753*x3 - 0.0281*x1*x2
        dx3 = 0.0260*x1*x2 - 0.0422*x3 + 0.0415*x0
