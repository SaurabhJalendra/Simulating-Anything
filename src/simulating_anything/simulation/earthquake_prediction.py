...
class EarthquakePredictionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0831*x1 - 0.0865*x0 + 0.0697*np.sin(0.0482*self._t)
        dx1 = -0.1152*x0*x1 + 0.0778*x2 - 0.0654*x1
        dx2 = 0.0777*x0 - 0.0836*x2 + 0.0204*x3 - 0.1143*x1*x2
        dx3 = 0.0934*x1*x2 - 0.0616*x3 + 0.1101*x0
