...
class MoldGrowthSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0368*x1 - 0.1310*x0 + 0.1215*np.sin(0.1284*self._t)
        dx1 = -0.1685*x0*x1 + 0.0410*x2 - 0.1163*x1
        dx2 = 0.1023*x0 - 0.0335*x2 + 0.0904*x3 - 0.0341*x1*x2
        dx3 = 0.0966*x1*x2 - 0.1078*x3 + 0.1490*x0
