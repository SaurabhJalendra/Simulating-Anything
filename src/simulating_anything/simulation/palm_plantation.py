...
class PalmPlantationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0664*x1 - 0.1060*x0 + 0.0726*np.sin(0.0667*self._t)
        dx1 = -0.1157*x0*x1 + 0.0991*x2 - 0.0718*x1
        dx2 = 0.0861*x0 - 0.1004*x2 + 0.0311*x3 - 0.0866*x1*x2
        dx3 = 0.1075*x1*x2 - 0.0620*x3 + 0.1035*x0
