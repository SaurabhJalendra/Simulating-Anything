...
class ReservoirEvaporationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0947*x1 - 0.1171*x0 + 0.0554*np.sin(0.0236*self._t)
        dx1 = -0.0516*x0*x1 + 0.0952*x2 - 0.0783*x1
        dx2 = 0.0805*x0 - 0.0411*x2 + 0.0712*x3 - 0.1191*x1*x2
        dx3 = 0.0824*x1*x2 - 0.1047*x3 + 0.0389*x0
