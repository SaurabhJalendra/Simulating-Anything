...
class MonsoonVariabilitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0463*x1 - 0.0754*x0 + 0.0528*np.sin(0.0405*self._t)
        dx1 = -0.0777*x0*x1 + 0.0850*x2 - 0.0914*x1
        dx2 = 0.0736*x0 - 0.0314*x2 + 0.0386*x3 - 0.0438*x1*x2
        dx3 = 0.0205*x1*x2 - 0.0221*x3 + 0.0511*x0
