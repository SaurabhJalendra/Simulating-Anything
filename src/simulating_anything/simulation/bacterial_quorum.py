...
class BacterialQuorumSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0535*x1 - 0.0932*x0 + 0.0347*np.sin(0.0711*self._t)
        dx1 = -0.0994*x0*x1 + 0.0330*x2 - 0.0296*x1
        dx2 = 0.0228*x0 - 0.0498*x2 + 0.1174*x3 - 0.0454*x1*x2
        dx3 = 0.0944*x1*x2 - 0.0248*x3 + 0.0741*x0
