...
class YeastSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0369*x1 - 0.0649*x0 + 0.1113*np.sin(0.0437*self._t)
        dx1 = -0.0669*x0*x1 + 0.0531*x2 - 0.0690*x1
        dx2 = 0.0599*x0 - 0.1043*x2 + 0.1001*x3 - 0.1176*x1*x2
        dx3 = 0.0568*x1*x2 - 0.0693*x3 + 0.0951*x0
