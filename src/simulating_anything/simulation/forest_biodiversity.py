...
class ForestBiodiversitySimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0610*x1 - 0.0483*x0 + 0.1166*np.sin(0.0842*self._t)
        dx1 = -0.1014*x0*x1 + 0.0391*x2 - 0.0943*x1
        dx2 = 0.0556*x0 - 0.0976*x2 + 0.0347*x3 - 0.0413*x1*x2
        dx3 = 0.1200*x1*x2 - 0.1174*x3 + 0.0753*x0
