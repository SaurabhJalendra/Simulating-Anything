...
class PastureDegradationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0304*x1 - 0.0922*x0 + 0.0601*np.sin(0.0486*self._t)
        dx1 = -0.0943*x0*x1 + 0.0435*x2 - 0.0813*x1
        dx2 = 0.0535*x0 - 0.0273*x2 + 0.0420*x3 - 0.0794*x1*x2
        dx3 = 0.0979*x1*x2 - 0.0772*x3 + 0.1086*x0
