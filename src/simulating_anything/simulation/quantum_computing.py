...
class QuantumComputingSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1058*x1 - 0.0386*x0 + 0.0712*np.sin(0.1156*self._t)
        dx1 = -0.1115*x0*x1 + 0.1109*x2 - 0.0939*x1
        dx2 = 0.0485*x0 - 0.0353*x2 + 0.0537*x3 - 0.0616*x1*x2
        dx3 = 0.0452*x1*x2 - 0.0224*x3 + 0.0943*x0
