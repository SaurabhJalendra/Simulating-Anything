...
class DrinkingWaterSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1088*x1 - 0.0924*x0 + 0.1035*np.sin(0.0538*self._t)
        dx1 = -0.0959*x0*x1 + 0.0670*x2 - 0.1008*x1
        dx2 = 0.0590*x0 - 0.0831*x2 + 0.0395*x3 - 0.0334*x1*x2
        dx3 = 0.0724*x1*x2 - 0.0961*x3 + 0.0334*x0
