...
class HabitatRestorationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0823*x1 - 0.1014*x0 + 0.0911*np.sin(0.1198*self._t)
        dx1 = -0.1279*x0*x1 + 0.0278*x2 - 0.0626*x1
        dx2 = 0.0930*x0 - 0.0782*x2 + 0.1255*x3 - 0.0334*x1*x2
        dx3 = 0.0754*x1*x2 - 0.1332*x3 + 0.0634*x0
