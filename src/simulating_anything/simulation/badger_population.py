...
class BadgerPopulationSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0453*x1 - 0.0697*x0 + 0.0228*np.sin(0.0566*self._t)
        dx1 = -0.0978*x0*x1 + 0.0662*x2 - 0.0437*x1
        dx2 = 0.0447*x0 - 0.0515*x2 + 0.0531*x3 - 0.0960*x1*x2
        dx3 = 0.0703*x1*x2 - 0.0849*x3 + 0.1024*x0
