...
class WindFarmSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0891*x1 - 0.1005*x0 + 0.0335*np.sin(0.0975*self._t)
        dx1 = -0.0366*x0*x1 + 0.0893*x2 - 0.0964*x1
        dx2 = 0.0586*x0 - 0.0998*x2 + 0.0918*x3 - 0.0609*x1*x2
        dx3 = 0.0224*x1*x2 - 0.0979*x3 + 0.0686*x0
