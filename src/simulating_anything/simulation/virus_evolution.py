...
class VirusEvolutionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1014*x1 - 0.0544*x0 + 0.0701*np.sin(0.0282*self._t)
        dx1 = -0.0482*x0*x1 + 0.0257*x2 - 0.0442*x1
        dx2 = 0.0659*x0 - 0.0580*x2 + 0.0669*x3 - 0.0860*x1*x2
        dx3 = 0.1058*x1*x2 - 0.0370*x3 + 0.1068*x0
