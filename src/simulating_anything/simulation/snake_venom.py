...
class SnakeVenomSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1149*x1 - 0.0582*x0 + 0.0988*np.sin(0.1191*self._t)
        dx1 = -0.0772*x0*x1 + 0.0333*x2 - 0.0728*x1
        dx2 = 0.0616*x0 - 0.0682*x2 + 0.0479*x3 - 0.0341*x1*x2
        dx3 = 0.0498*x1*x2 - 0.0962*x3 + 0.0907*x0
