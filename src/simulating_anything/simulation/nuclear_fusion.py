...
class NuclearFusionSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.0917*x1 - 0.0577*x0 + 0.1135*np.sin(0.0503*self._t)
        dx1 = -0.0471*x0*x1 + 0.0435*x2 - 0.1170*x1
        dx2 = 0.0730*x0 - 0.0939*x2 + 0.0882*x3 - 0.0314*x1*x2
        dx3 = 0.0484*x1*x2 - 0.0234*x3 + 0.0384*x0
