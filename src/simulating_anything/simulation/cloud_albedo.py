...
class CloudAlbedoSimulation(SimulationEnvironment):
    ...
    def _rhs(self, state):
        x0, x1, x2, x3 = state
        dx0 = 0.1119*x1 - 0.0968*x0 + 0.1118*np.sin(0.0993*self._t)
        dx1 = -0.0384*x0*x1 + 0.0794*x2 - 0.0699*x1
        dx2 = 0.0613*x0 - 0.0846*x2 + 0.0667*x3 - 0.1071*x1*x2
        dx3 = 0.0366*x1*x2 - 0.0795*x3 + 0.0293*x0
