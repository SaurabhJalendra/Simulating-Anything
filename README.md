...
[![Tests](https://img.shields.io/badge/tests-5935%20passing-brightgreen)](tests/unit/)
[![Python](https://img.shields.io/badge/python-3.12-blue)](https://www.python.org/)
[![Domains](https://img.shields.io/badge/domains-167-orange)](src/simulating_anything/simulation/)
...
simulation data across **167 domains** spanning **111 mathematical classes**.
...
**Cross-domain analysis:** 495 mathematical isomorphisms detected across 167 domains
...
**Domain #120: Ueda** -- Forced cubic oscillator, strange attractor chaos.
**Domain #121: Cubic Map** -- 1D discrete map with odd symmetry, Feigenbaum cascade.
**Domain #122: Zombie-SIR** -- Modified epidemic with zombie resurrection dynamics.
**Domain #123: Elastic Collision** -- 1D particle chain, Newton's cradle physics.
**Domain #124: Tent Map** -- Piecewise linear 1D chaos, Lyapunov = ln(r) exact.
**Domain #125: Lozi Map** -- 2D piecewise-linear strange attractor, det(J) = -b.
**Domain #126: Izhikevich** -- Efficient spiking neuron, 7 firing patterns.
**Domain #127: Double Well** -- Bistable potential V = x^4/4 - x^2/2, Kramers escape.
**Domain #128: Tinkerbell Map** -- 2D complex quadratic map, strange attractor.
**Domain #129: Rulkov Map** -- Discrete spiking neuron, fast-slow dynamics.
**Domain #130: Coupled VdP** -- Two coupled Van der Pol oscillators, synchronization.
**Domain #131: Stuart-Landau** -- Hopf normal form, r = sqrt(mu) amplitude scaling.
**Domain #132: Gauss Map** -- 1D Gaussian kernel map, period-doubling chaos.
**Domain #133: Circle Map** -- Arnold tongues, devil's staircase, mode-locking.
**Domain #134: Coupled Rossler** -- Two coupled Rossler oscillators, synchronization.
**Domain #135: SIR Vital** -- SIR with vital dynamics, endemic equilibrium.
**Domain #136: Repressilator** -- 3-gene synthetic oscillatory network, Z3 symmetry.
**Domain #137: Ring Oscillator** -- 3-stage electronic inverter ring, 120-degree phase shifts.
**Domain #138: Jansen-Rit** -- Cortical column neural mass model, alpha rhythm EEG.
**Domain #139: Goldbeter Glycolysis** -- Allosteric metabolic oscillator, Hopf bifurcation.
**Domain #140: Goodwin** -- 3-variable cyclic gene regulatory oscillator, Hill repression.
**Domain #141: Toggle Switch** -- Bistable genetic toggle with mutual repression, cusp catastrophe.
**Domain #142: Stommel** -- Thermohaline ocean circulation box model, hysteresis bistability.
**Domain #143: Predator-Prey-Parasite** -- Eco-epidemiological 3-species model, disease in prey.
**Domain #144: Michaelis-Menten** -- Enzyme kinetics E+S<->ES->E+P, V_max*S/(K_m+S).
**Domain #145: Winfree** -- Pulse-coupled oscillators, predecessor to Kuramoto model.
**Domain #146: FHN Coupled Pair** -- Two diffusively coupled FHN neurons, sync transition.
**Domain #147: Prey Refuge** -- Predator-prey with prey refuge fraction, stabilization.
**Domain #148: Glucose-Insulin** -- Bergman minimal model, glucose effectiveness, insulin sensitivity.
