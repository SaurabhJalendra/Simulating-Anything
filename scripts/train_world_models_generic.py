...
DOMAIN_REGISTRY = {
    ...
    "soil_salinization": ("soil_salinization", "SoilSalinizationSimulation", {}),
    "insect_pollinator": ("insect_pollinator", "InsectPollinatorSimulation", {}),
    "kelp_forest": ("kelp_forest", "KelpForestSimulation", {}),
    "cement_hydration": ("cement_hydration", "CementHydrationSimulation", {}),
    "battery_aging": ("battery_aging", "BatteryAgingSimulation", {}),
    "pandemic_vaccine": ("pandemic_vaccine", "PandemicVaccineSimulation", {}),
    "gene_circuit": ("gene_circuit", "GeneCircuitSimulation", {}),
    "microgrid": ("microgrid", "MicrogridSimulation", {}),
    "pest_resistance": ("pest_resistance", "PestResistanceSimulation", {}),
    "lake_mixing": ("lake_mixing", "LakeMixingSimulation", {}),
    "airplane_dynamics": ("airplane_dynamics", "AirplaneDynamicsSimulation", {}),
    "soil_microbiome": ("soil_microbiome", "SoilMicrobiomeSimulation", {}),
    "ocean_upwelling": ("ocean_upwelling", "OceanUpwellingSimulation", {}),
    "thermal_comfort": ("thermal_comfort", "ThermalComfortSimulation", {}),
    "glacier_erosion": ("glacier_erosion", "GlacierErosionSimulation", {}),
    "tsunami_wave": ("tsunami_wave", "TsunamiWaveSimulation", {}),
    "wildfire_recovery": ("wildfire_recovery", "WildfireRecoverySimulation", {}),
    "aquifer_recharge": ("aquifer_recharge", "AquiferRechargeSimulation", {}),
    "pest_biocontrol": ("pest_biocontrol", "PestBiocontrolSimulation", {}),
    "river_dam": ("river_dam", "RiverDamSimulation", {}),
    "arctic_sea_ice": ("arctic_sea_ice", "ArcticSeaIceSimulation", {}),
    "water_treatment": ("water_treatment", "WaterTreatmentSimulation", {}),
    "solar_panel": ("solar_panel", "SolarPanelSimulation", {}),
    "composting": ("composting", "CompostingSimulation", {}),
    "road_wear": ("road_wear", "RoadWearSimulation", {}),
    "storm_surge": ("storm_surge", "StormSurgeSimulation", {}),
    "seed_germination": ("seed_germination", "SeedGerminationSimulation", {}),
    "glacier_stream": ("glacier_stream", "GlacierStreamSimulation", {}),
    "wind_erosion": ("wind_erosion", "WindErosionSimulation", {}),
    "fishpond": ("fishpond", "FishpondSimulation", {}),
    "dam_breach": ("dam_breach", "DamBreachSimulation", {}),
    "snow_avalanche": ("snow_avalanche", "SnowAvalancheSimulation", {}),
    "cave_formation": ("cave_formation", "CaveFormationSimulation", {}),
    "beach_erosion": ("beach_erosion", "BeachErosionSimulation", {}),
    "malaria_vector": ("malaria_vector", "MalariaVectorSimulation", {}),
    "urban_vegetation": ("urban_vegetation", "UrbanVegetationSimulation", {}),
    "groundwater_arsenic": ("groundwater_arsenic", "GroundwaterArsenicSimulation", {}),
    "coral_disease": ("coral_disease", "CoralDiseaseSimulation", {}),
    "forest_carbon": ("forest_carbon", "ForestCarbonSimulation", {}),
    "oil_spill": ("oil_spill", "OilSpillSimulation", {}),
    "mosquito_population": ("mosquito_population", "MosquitoPopulationSimulation", {}),
    "landslide": ("landslide", "LandslideSimulation", {}),
    "ocean_plastic": ("ocean_plastic", "OceanPlasticSimulation", {}),
