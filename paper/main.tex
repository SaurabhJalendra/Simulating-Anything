...
210 domains spanning 14+ mathematical classes. Given only a natural language
...
We train 50 RSSM world models across all mathematical classes, showing that
...
We train RSSM world models on 50 domains using an RTX 5090 (32GB).
...
\caption{RSSM world model training across 50 domains. (a) Best loss by domain.
...
586+ mathematical isomorphisms across 210 domains, suggesting that scientific
