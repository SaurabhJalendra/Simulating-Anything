...
highlights the top-performing extended domains. Across all 192 domains with
...
Fifteen of the 100 extended domains achieve perfect $R^2 = 1.0$, spanning
quantum mechanics (quantum oscillator energy spectrum), celestial mechanics
(Kepler's third law, three-body Lagrange points), epidemiology (SEIR
reproduction number, vaccination herd immunity threshold), topological
solitons (Sine-Gordon kinks), integrable lattices (Toda), parametric
stabilization (Kapitza), and Hopf normal forms (Stuart-Landau). The
uniformly high accuracy across such diverse mathematical classes---achieved
with zero per-domain hyperparameter tuning---validates the universality
claim: the pipeline discovers equations regardless of the underlying dynamics.
