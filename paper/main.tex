...
We train 48 RSSM world models across all mathematical classes, showing that
...
We train RSSM world models on 48 domains using an RTX 5090 (32GB).
...
\caption{RSSM world model training across 48 domains. (a) Best loss by domain.
