...
250 domains spanning 14+ mathematical classes. Given only a natural language
...
governing equations across 250 domains spanning 38 scientific disciplines,
achieving $R^2 \geq 0.99$ in 137+ of 216 domains with quantitative fits.
We train 82 RSSM world models (78\% stable dreamers, 44\% excellent), showing that
...
We train RSSM world models on 82 domains using an RTX 5090 (32GB).
...
\caption{RSSM world model training across 82 domains. (a) Best loss by domain.
...
rediscover known physical laws across 250 fundamentally different domains.
...
586+ mathematical isomorphisms across 250 domains, suggesting that scientific
...
The pipeline has been extended to 250 domains spanning 125+ mathematical
classes---including
