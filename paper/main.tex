...
We train 63 RSSM world models across all mathematical classes, showing that
...
We train RSSM world models on 63 domains using an RTX 5090 (32GB).
...
\caption{RSSM world model training across 63 domains. (a) Best loss by domain.
