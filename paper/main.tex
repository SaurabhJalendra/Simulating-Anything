...
204 domains spanning 12+ mathematical classes. Given only a natural language
...
We train 42 RSSM world models across all mathematical classes, showing that
...
We train RSSM world models on 42 domains using an RTX 5090 (32GB).
...
\caption{RSSM world model training across 42 domains. (a) Best loss by domain.
...
586+ mathematical isomorphisms across 204 domains, suggesting that scientific
