...
114 domains spanning 12+ mathematical classes. Given only a natural language
...
governing equations in all 114 domains, achieving $R^2 \geq 0.999$ in 41 of
114 cases, with a median $R^2$ of 0.998. Our cross-domain analogy engine
...
\item Successful autonomous rediscovery of governing equations in 114 domains
...
We evaluate \ours{} on 114 domains across 12+ mathematical classes. For each
...
in detail below, followed by a summary of 100 extended domain results
...
100 additional domains spanning quantum mechanics, statistical mechanics,
celestial mechanics, neuroscience, reaction-diffusion PDEs, gene regulatory
networks, and more. Table~\ref{tab:extended} highlights the top-performing
extended domains. Across all 114 domains with equation recovery, 41 achieve
$R^2 \geq 0.999$ and the median $R^2$ is 0.998.
...
rediscover known physical laws across 114 fundamentally different domains.
The system achieves $R^2 \geq 0.999$ in 41 of 114 domains, with a median
$R^2$ of 0.998 across all domains. RSSM world models trained on 17 domains
