...
217 domains spanning 14+ mathematical classes. Given only a natural language
...
We train 57 RSSM world models across all mathematical classes, showing that
...
We train RSSM world models on 57 domains using an RTX 5090 (32GB).
...
\caption{RSSM world model training across 57 domains. (a) Best loss by domain.
...
rediscover known physical laws across 217 fundamentally different domains.
...
586+ mathematical isomorphisms across 217 domains, suggesting that scientific
...
The pipeline has been extended to 217 domains spanning 125+ mathematical
classes---including
