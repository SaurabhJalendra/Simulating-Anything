...
detects 274 structural, dimensional, and topological isomorphisms across
103 domains. The key architectural insight is that only the simulation layer is
...
\caption{Cross-domain analogy strength matrix. 274 isomorphisms detected
across 103 domains. Brighter cells indicate stronger mathematical analogies.}
...
We have verified this with 103 domains across 85 mathematical classes.
...
The total simulation code across all 103 domains is $\sim$7,000 lines,
...
274 mathematical isomorphisms across 103 domains, suggesting that scientific
...
has been extended to 103 domains spanning 85 mathematical classes---including
...
(Genesio-Tesi)---with zero changes to the discovery infrastructure.
