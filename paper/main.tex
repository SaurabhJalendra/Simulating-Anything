...
202 domains spanning 12+ mathematical classes. Given only a natural language
...
We train 40 RSSM world models across all mathematical classes, showing that
...
We train RSSM world models on 40 domains using an RTX 5090 (32GB).
...
\caption{RSSM world model training across 40 domains. (a) Best loss by domain.
...
586+ mathematical isomorphisms across 202 domains, suggesting that scientific
