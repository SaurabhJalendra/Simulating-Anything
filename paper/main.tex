...
87 domains. The key architectural insight is that only the simulation layer is
...
\caption{Cross-domain analogy strength matrix. 221 isomorphisms detected
across 87 domains. Brighter cells indicate stronger mathematical analogies.}
...
We have verified this with 87 domains across 71 mathematical classes.
...
The total simulation code across all 87 domains is $\sim$7,000 lines,
...
175 mathematical isomorphisms across 87 domains, suggesting that scientific
...
has been extended to 87 domains spanning 71 mathematical classes---including
