...
200 domains spanning 12+ mathematical classes. Given only a natural language
...
We train 38 RSSM world models across all mathematical classes, showing that
...
We train RSSM world models on 38 domains using an RTX 5090 (32GB).
...
All 38 domains converge to similar loss values ($32.0\pm0.2$) within
...
\caption{RSSM world model training across 38 domains. (a) Best loss by domain.
...
and a neural-ecosystem (Wilson-Cowan + Lotka-Volterra, $R^2=1.0$,
corr(E,N)=0.82 showing strong neural-foraging synchronization).
Cross-domain analogy detection reveals
579+ mathematical isomorphisms across 200 domains, suggesting that scientific
