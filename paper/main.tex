...
71 domains. The key architectural insight is that only the simulation layer is
...
\caption{Cross-domain analogy strength matrix. 175 isomorphisms detected
across 71 domains. Brighter cells indicate stronger mathematical analogies.}
...
We have verified this with 71 domains across 55 mathematical classes.
...
The total simulation code across all 71 domains is $\sim$6,500 lines,
...
175 mathematical isomorphisms across 71 domains, suggesting that scientific
...
has been extended to 71 domains spanning 55 mathematical classes---including
...
three-timescale bursting (FitzHugh-Rinzel)---with zero changes to the discovery infrastructure.
