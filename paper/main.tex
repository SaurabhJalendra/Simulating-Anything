...
detects 510 structural, dimensional, and topological isomorphisms across
171 domains. The key architectural insight is that only the simulation layer is
...
\caption{Cross-domain analogy strength matrix. 325 isomorphisms detected
across 119 domains. Brighter cells indicate stronger mathematical analogies.}
...
We have verified this with 171 domains across 111 mathematical classes.
...
The total simulation code across all 171 domains is $\sim$7,000 lines,
...
has been extended to 119 domains spanning 73 mathematical classes---including
