...
51 domains. The key architectural insight is that only the simulation layer is
...
\caption{Cross-domain analogy strength matrix. 119 isomorphisms detected
across 51 domains. Brighter cells indicate stronger mathematical analogies.}
...
We have verified this with 51 domains across 35 mathematical classes.
...
The total simulation code across all 51 domains is $\sim$6,000 lines,
...
119 mathematical isomorphisms across 51 domains, suggesting that scientific
...
has been extended to 51 domains spanning 35 mathematical classes---including
...
flocking (Vicsek model)---with zero changes to the discovery infrastructure.
