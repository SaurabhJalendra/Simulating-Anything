...
227 domains spanning 14+ mathematical classes. Given only a natural language
...
governing equations across all 214 domains, achieving $R^2 \geq 0.99$ in 137 of
191 domains with quantitative fits, with a median $R^2 \approx 1.0$.
We train 67 RSSM world models across all mathematical classes, showing that
...
We train RSSM world models on 67 domains using an RTX 5090 (32GB).
...
\caption{RSSM world model training across 67 domains. (a) Best loss by domain.
...
rediscover known physical laws across 227 fundamentally different domains.
...
586+ mathematical isomorphisms across 227 domains, suggesting that scientific
...
The pipeline has been extended to 227 domains spanning 125+ mathematical
classes---including
