...
We train 90 RSSM world models (78\% stable dreamers, 44\% excellent), showing that
...
We train RSSM world models on 90 domains using an RTX 5090 (32GB).
...
\caption{RSSM world model training across 90 domains. (a) Best loss by domain.
