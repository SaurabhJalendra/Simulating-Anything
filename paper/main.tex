...
233 domains spanning 14+ mathematical classes. Given only a natural language
...
We train 72 RSSM world models across all mathematical classes, showing that
...
We train RSSM world models on 72 domains using an RTX 5090 (32GB).
...
\caption{RSSM world model training across 72 domains. (a) Best loss by domain.
...
rediscover known physical laws across 233 fundamentally different domains.
...
586+ mathematical isomorphisms across 233 domains, suggesting that scientific
...
The pipeline has been extended to 233 domains spanning 125+ mathematical
classes---including
