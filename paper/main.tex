...
214 domains spanning 14+ mathematical classes. Given only a natural language
...
We train 54 RSSM world models across all mathematical classes, showing that
...
We train RSSM world models on 54 domains using an RTX 5090 (32GB).
...
\caption{RSSM world model training across 54 domains. (a) Best loss by domain.
...
rediscover known physical laws across 214 fundamentally different domains.
...
586+ mathematical isomorphisms across 214 domains, suggesting that scientific
...
The pipeline has been extended to 214 domains spanning 125+ mathematical
classes---including
