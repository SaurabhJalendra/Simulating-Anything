...
232 domains spanning 14+ mathematical classes. Given only a natural language
...
We train 70 RSSM world models across all mathematical classes, showing that
...
We train RSSM world models on 70 domains using an RTX 5090 (32GB).
...
\caption{RSSM world model training across 70 domains. (a) Best loss by domain.
...
rediscover known physical laws across 232 fundamentally different domains.
...
586+ mathematical isomorphisms across 232 domains, suggesting that scientific
...
The pipeline has been extended to 232 domains spanning 125+ mathematical
classes---including
