...
207 domains spanning 12+ mathematical classes. Given only a natural language
...
We train 45 RSSM world models across all mathematical classes, showing that
...
We train RSSM world models on 45 domains using an RTX 5090 (32GB).
...
\caption{RSSM world model training across 45 domains. (a) Best loss by domain.
...
rediscover known physical laws across 197 fundamentally different domains.
The system achieves $R^2 \geq 0.99$ in 123 of 174 domains with quantitative
...
586+ mathematical isomorphisms across 207 domains, suggesting that scientific
...
The pipeline has been extended to 197 domains spanning 125 mathematical
classes---including
