...
We train RSSM world models on 24+ domains using an RTX 5090 (32GB).
Table~\ref{tab:world_models} shows training results with 200 epochs per domain,
covering the core 14 domains, 3 extended domains (Chua, Duffing,
R\"ossler), 4 V7 novel domains, and additional high-value domains.
...
All 24 domains converge to similar loss values ($32.0\pm0.2$) within
...
PDEs, discrete chaos, stochastic systems, evolutionary games) without
hyperparameter tuning. The best dream MSE
across all trained models is 0.004 (Chua circuit), with the novel
replicator-mutator system achieving dream MSE = 0.037. The Lorenz-Stommel
...
takes $\sim$440s per domain on an RTX 5090 (32GB, 200 epochs), with PDE domains
