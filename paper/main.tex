...
192 domains spanning 12+ mathematical classes. Given only a natural language
...
governing equations across all 192 domains, achieving $R^2 \geq 0.999$ in 95 of
171 domains with quantitative fits, with a median $R^2$ of 0.9998. Our cross-domain analogy engine
detects 570 structural, dimensional, and topological isomorphisms across
192 domains. The key architectural insight is that only the simulation layer is
...
\item Successful autonomous rediscovery of governing equations in 192 domains
...
\item A cross-domain analogy engine that detects 570 mathematical isomorphisms
  across 192 domains (Section~\ref{sec:cross_domain}).
...
code. We demonstrate this with 192 domains (Table~\ref{tab:results})
...
We evaluate \ours{} on 192 domains across 12+ mathematical classes. For each
...
across 192 domains. Brighter cells indicate stronger mathematical analogies.}
...
isomorphisms across 192 domains. The strongest analogies (strength $> 0.9$)
...
We have verified this with 192 domains across 125 mathematical classes.
...
The total simulation code across all 192 domains is $\sim$7,000 lines,
...
rediscover known physical laws across 192 fundamentally different domains.
The system achieves $R^2 \geq 0.999$ in 95 of 171 domains with quantitative
fits, with a median $R^2$ of 0.9998 across all domains. RSSM world models trained on 17 domains
(best dream MSE = 0.004) enable efficient parameter space exploration.
Cross-domain analogy detection reveals
570 mathematical isomorphisms across 192 domains, suggesting that scientific
...
The pipeline has been extended to 192 domains spanning 125 mathematical
classes---including
