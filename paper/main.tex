...
67 domains. The key architectural insight is that only the simulation layer is
...
\caption{Cross-domain analogy strength matrix. 163 isomorphisms detected
across 67 domains. Brighter cells indicate stronger mathematical analogies.}
...
We have verified this with 67 domains across 51 mathematical classes.
...
The total simulation code across all 67 domains is $\sim$6,000 lines,
...
163 mathematical isomorphisms across 67 domains, suggesting that scientific
...
has been extended to 67 domains spanning 51 mathematical classes---including
...
(SIS on graphs)---with zero changes to the discovery infrastructure.
