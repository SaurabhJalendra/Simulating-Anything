...
detects 365 structural, dimensional, and topological isomorphisms across
131 domains. The key architectural insight is that only the simulation layer is
...
We have verified this with 131 domains across 79 mathematical classes.
...
The total simulation code across all 131 domains is $\sim$7,000 lines,
...
(Stuart-Landau)---with zero changes to the discovery infrastructure.
