...
We train 35 RSSM world models across all mathematical classes, showing that
...
We train RSSM world models on 35 domains using an RTX 5090 (32GB).
...
All 35 domains converge to similar loss values ($32.0\pm0.2$) within
...
\caption{RSSM world model training across 35 domains. (a) Best loss by domain.
