...
63 domains. The key architectural insight is that only the simulation layer is
...
\caption{Cross-domain analogy strength matrix. 152 isomorphisms detected
across 63 domains. Brighter cells indicate stronger mathematical analogies.}
...
We have verified this with 63 domains across 47 mathematical classes.
...
The total simulation code across all 63 domains is $\sim$6,000 lines,
...
152 mathematical isomorphisms across 63 domains, suggesting that scientific
...
has been extended to 63 domains spanning 47 mathematical classes---including
...
(May-Leonard)---with zero changes to the discovery infrastructure.
