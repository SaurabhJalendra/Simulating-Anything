...
79 domains. The key architectural insight is that only the simulation layer is
...
\caption{Cross-domain analogy strength matrix. 199 isomorphisms detected
across 79 domains. Brighter cells indicate stronger mathematical analogies.}
...
We have verified this with 79 domains across 63 mathematical classes.
...
The total simulation code across all 79 domains is $\sim$7,000 lines,
...
175 mathematical isomorphisms across 79 domains, suggesting that scientific
...
has been extended to 79 domains spanning 63 mathematical classes---including
...
(Selkov glycolysis)---with zero changes to the discovery infrastructure.
