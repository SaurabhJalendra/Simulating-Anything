...
detects 352 structural, dimensional, and topological isomorphisms across
127 domains. The key architectural insight is that only the simulation layer is
...
We have verified this with 127 domains across 77 mathematical classes.
...
The total simulation code across all 127 domains is $\sim$7,000 lines,
...
(Izhikevich), and bistable mechanics (double well)---with zero changes to the
