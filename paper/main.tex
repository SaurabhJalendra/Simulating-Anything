...
governing equations across all 197 domains, achieving $R^2 \geq 0.99$ in 123 of
174 domains with quantitative fits, with a median $R^2$ of 1.0.
...
The system achieves $R^2 \geq 0.99$ in 138 of 189 domains with quantitative
fits, with a median $R^2 \approx 1.0$ across all domains. RSSM world models
trained on 52 domains (median dream MSE = 0.14, best = 0.001) enable
