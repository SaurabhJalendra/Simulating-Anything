...
- **287 discovery campaigns** across 35+ novel coupled systems
- **1140 discoveries** (bifurcations + scaling laws + phase boundaries + 34 2D phase diagrams)
- **95 validated bifurcations** (34 calibrated with literature params, 5-seed unanimous)
